...
export declare class DatapilotNotebookController implements Disposable_2 {
    ...
    constructor(clientMapper: ClientMapper, queryManifestService: QueryManifestService, telemetry: TelemetryService_2, dbtTerminal: DBTTerminal_2, notebookDependencies: NotebookDependencies, altimate: AltimateRequest);
    ...
    private handleMetadataUpdateInNotebook;
...
declare class DatapilotNotebookSerializer implements NotebookSerializer, Disposable_2 {
    dispose(): void;
