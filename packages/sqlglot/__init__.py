...
from packages.sqlglot import expressions as exp
from packages.sqlglot.dialects.dialect import Dialect as Dialect, Dialects as Dialects
from packages.sqlglot.diff import diff as diff
from packages.sqlglot.errors import (
    ErrorLevel as ErrorLevel,
    ParseError as ParseError,
    TokenError as TokenError,
    UnsupportedError as UnsupportedError,
)
from packages.sqlglot.expressions import (
...
from packages.sqlglot.generator import Generator as Generator
from packages.sqlglot.parser import Parser as Parser
from packages.sqlglot.schema import MappingSchema as MappingSchema, Schema as Schema
from packages.sqlglot.tokens import Tokenizer as Tokenizer, TokenType as TokenType

if t.TYPE_CHECKING:
    from packages.sqlglot._typing import E
    from packages.sqlglot.dialects.dialect import DialectType as DialectType

logger = logging.getLogger("sqlglot")


try:
    from packages.sqlglot._version import __version__, __version_tuple__
except ImportError:
    logger.error(
