...
from packages.sqlglot import Dialect, expressions as exp
...
from packages.sqlglot.dataframe.sql.normalize import normalize
from packages.sqlglot.dataframe.sql.operations import Operation, operation
from packages.sqlglot.dataframe.sql.readwriter import DataFrameWriter
from packages.sqlglot.dataframe.sql.transforms import replace_id_value
from packages.sqlglot.dataframe.sql.util import get_tables_from_expression_with_join
from packages.sqlglot.dataframe.sql.window import Window
from packages.sqlglot.helper import ensure_list, object_to_dict, seq_get
from packages.sqlglot.optimizer import optimize as optimize_func
from packages.sqlglot.optimizer.qualify_columns import quote_identifiers

if t.TYPE_CHECKING:
    from packages.sqlglot.dataframe.sql._typing import (
        ColumnLiterals,
        ColumnOrLiteral,
        ColumnOrName,
...
class DataFrame:
    ...
    def fillna(
        ...
        """
        from packages.sqlglot.dataframe.sql.functions import lit
