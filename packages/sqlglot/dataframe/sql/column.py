...
from packages.sqlglot.dataframe.sql.types import DataType
from packages.sqlglot.helper import flatten, is_iterable

if t.TYPE_CHECKING:
    from packages.sqlglot.dataframe.sql._typing import ColumnOrLiteral
    from packages.sqlglot.dataframe.sql.window import WindowSpec
...
class Column:
    ...
    def when(self, condition: Column, value: t.Any) -> Column:
        from packages.sqlglot.dataframe.sql.functions import when
