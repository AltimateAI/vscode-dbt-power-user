...
from packages.sqlglot.errors import ParseError
from packages.sqlglot.helper import (
    AutoName,
    camel_to_snake_case,
    ensure_collection,
    ensure_list,
...
from packages.sqlglot.tokens import Token
...
class Expression(metaclass=_Expression):
    ...
    def output_name(self) -> str:
        ...
        Example:
            >>> from packages.sqlglot import parse_one
    ...
    def sql(self, dialect: DialectType = None, **opts) -> str:
        ...
        Returns:
            The SQL string.
        """
        from packages.sqlglot.dialects import Dialect
    ...
    def dump(self):
        ...
        """
        from packages.sqlglot.serde import dump
    ...
    def load(cls, obj):
        ...
        """
        from packages.sqlglot.serde import load
...
def table_name(table: Table | str, dialect: DialectType = None) -> str:
    ...
    Examples:
        >>> from packages.sqlglot import exp, parse_one
