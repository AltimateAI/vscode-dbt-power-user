...
import oe, { createContext as Je, useReducer as $o, useCallback as ut, useMemo as ct, useContext as Qe, useLayoutEffect as Lo, useEffect as Re, useRef as Ae, useState as ge, useId as Dr, useInsertionEffect as ko, cloneElement as Bo, Children as Ke, isValidElement as Ir, Component as Ho, createElement as Wn, lazy as zo } from "react";
import { Tooltip as Uo, Button as Nt, Spinner as Vo, Card as yn, CardBody as mn, CardTitle as Wo, CloseButton as qo } from "reactstrap";
  ...
  function s(a, c, l) {
    ...
    if (a && a.defaultProps)
      for (u in c = a.defaultProps, c)
        f[u] === void 0 && (f[u] = c[u]);
    return { $$typeof: t, type: a, key: d, ref: g, props: f, _owner: r.current };
  }
...
function Xo() {
  return Yn || (Yn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function _(h) {
      {
        for (var N = arguments.length, H = new Array(N > 1 ? N - 1 : 0), Z = 1; Z < N; Z++)
          H[Z - 1] = arguments[Z];
        S("error", h, H);
      }
    }
    function S(h, N, H) {
      {
        var Z = b.ReactDebugCurrentFrame, ie = Z.getStackAddendum();
        ie !== "" && (N += "%s", H = H.concat([ie]));
        var ue = H.map(function(re) {
          return String(re);
        });
        ue.unshift("Warning: " + N), Function.prototype.apply.call(console[h], console, ue);
      }
    }
    var A = !1, E = !1, P = !1, F = !1, m = !1, $;
    $ = Symbol.for("react.module.reference");
    function O(h) {
      return !!(typeof h == "string" || typeof h == "function" || h === n || h === i || m || h === r || h === l || h === u || F || h === g || A || E || P || typeof h == "object" && h !== null && (h.$$typeof === d || h.$$typeof === f || h.$$typeof === s || h.$$typeof === a || h.$$typeof === c || // This needs to include all possible module reference object
    ...
    function Y(h) {
      ...
      if (typeof h == "object")
        switch (h.$$typeof) {
          ...
          case d: {
            var ie = h, ue = ie._payload, re = ie._init;
            try {
              return Y(re(ue));
            } catch {
              return null;
    ...
    var x = Object.assign, I = 0, T, w, D, B, C, R, z;
    function U() {
    }
    ...
    function V() {
      {
        if (I === 0) {
          T = console.log, w = console.info, D = console.warn, B = console.error, C = console.group, R = console.groupCollapsed, z = console.groupEnd;
          var h = {
            configurable: !0,
            enumerable: !0,
            value: U,
    ...
    var K = b.ReactCurrentDispatcher, G;
    function J(h, N, H) {
      {
        if (G === void 0)
          try {
...
` + ne[fe].replace(" at new ", " at ");
                    return h.displayName && Se.includes("<anonymous>") && (Se = Se.replace("<anonymous>", h.displayName)), typeof h == "function" && W.set(h, Se), Se;
                  }
                while (fe >= 1 && pe >= 0);
              break;
            }
      ...
      var Ue = h ? h.displayName || h.name : "", Vn = Ue ? J(Ue) : "";
    ...
    function Me(h, N, H) {
      ...
      if (typeof h == "object")
        switch (h.$$typeof) {
          ...
          case d: {
            var Z = h, ie = Z._payload, ue = Z._init;
            try {
              return Me(ue(ie), N, H);
            } catch {
            }
    ...
    var gt = Object.prototype.hasOwnProperty, Pn = {}, Nn = b.ReactDebugCurrentFrame;
    function vt(h) {
      if (h) {
        var N = h._owner, H = Me(h.type, h._source, N ? N.type : null);
          ...
          if (ue(h, re)) {
            ...
            try {
              if (typeof h[re] != "function") {
                var ve = Error((Z || "React class") + ": " + H + " type `" + re + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof h[re] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw ve.name = "Invariant Violation", ve;
              }
              ne = h[re](N, re, Z, H, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (fe) {
              ne = fe;
            }
            ne && !(ne instanceof Error) && (vt(ie), _("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", Z || "React class", H, re, typeof ne), vt(null)), ne instanceof Error && !(ne.message in Pn) && (Pn[ne.message] = !0, vt(ie), _("Failed %s type: %s", H, ne.message), vt(null));
          }
      }
    }
    ...
    function Eo(h) {
      {
        var N = typeof Symbol == "function" && Symbol.toStringTag, H = N && h[Symbol.toStringTag] || h.constructor.name || "Object";
        return H;
      }
    }
    function bo(h) {
    ...
    function jn(h) {
      if (bo(h))
        return _("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Eo(h)), Fn(h);
    }
    var nt = b.ReactCurrentOwner, _o = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function To(h, N) {
      if (typeof h.ref == "string" && nt.current && N && nt.current.stateNode !== N) {
        var H = Y(nt.current.type);
        Ut[H] || (_('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', Y(nt.current.type), h.ref), Ut[H] = !0);
      }
    }
    function Oo(h, N) {
      {
        var H = function() {
          Mn || (Mn = !0, _("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", N));
        };
    ...
    function Ao(h, N) {
      {
        var H = function() {
          $n || ($n = !0, _("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", N));
        };
    ...
    function Do(h, N, H, Z, ie) {
      {
        ...
        H !== void 0 && (jn(H), ne = "" + H), Co(N) && (jn(N.key), ne = "" + N.key), So(N) && (ve = N.ref, To(N, ie));
        for (ue in N)
        ...
        if (ne || ve) {
          var pe = typeof h == "function" ? h.displayName || h.name || "Unknown" : h;
          ne && Oo(re, pe), ve && Ao(re, pe);
        }
        return Ro(h, ne, ve, ie, Z, nt.current, re);
      }
    }
    var Vt = b.ReactCurrentOwner, Ln = b.ReactDebugCurrentFrame;
    function ze(h) {
      if (h) {
        var N = h._owner, H = Me(h.type, h._source, N ? N.type : null);
...
Check the render method of \`` + h + "`.";
    ...
    function Io(h) {
      {
        if (h !== void 0) {
          var N = h.fileName.replace(/^.*[\\\/]/, ""), H = h.lineNumber;
          return `
...
Check the top-level render call using <` + H + ">.");
    ...
    function Hn(h, N) {
      {
        ...
        Bn[H] = !0;
        var Z = "";
        h && h._owner && h._owner !== Vt.current && (Z = " It was passed a child from " + Y(h._owner.type) + "."), ze(h), _('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', H, Z), ze(null);
      }
    }
    function zn(h, N) {
      {
    ...
    function Po(h) {
      {
        for (var N = Object.keys(h.props), H = 0; H < N.length; H++) {
          var Z = N[H];
          if (Z !== "children" && Z !== "key") {
            ze(h), _("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", Z), ze(null);
            break;
          }
        }
    ...
    function Un(h, N, H, Z, ie, ue) {
      {
        ...
        if (!re) {
          ...
          ve ? ne += ve : ne += kn();
          var fe;
          h === null ? fe = "null" : zt(h) ? fe = "array" : h !== void 0 && h.$$typeof === t ? (fe = "<" + (Y(h.type) || "Unknown") + " />", ne = " Did you accidentally export a JSX literal instead of a component?") : fe = typeof h, _("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", fe, ne);
        }
    ...
    var jo = Fo, Mo = No;
    ot.Fragment = n, ot.jsx = jo, ot.jsxs = Mo;
  }()), ot;
}
process.env.NODE_ENV === "production" ? on.exports = Go() : on.exports = Xo();
var j = on.exports;
const Zo = () => {
  var t, o, n;
...
var xr = Symbol.for("immer-nothing"), Kn = Symbol.for("immer-draftable"), be = Symbol.for("immer-state"), ei = process.env.NODE_ENV !== "production" ? [
...
function me(e, ...t) {
  if (process.env.NODE_ENV !== "production") {
    const o = ei[e], n = typeof o == "function" ? o.apply(null, t) : o;
...
function Pe(e) {
  var t;
  return e ? Pr(e) || Array.isArray(e) || !!e[Kn] || !!((t = e.constructor) != null && t[Kn]) || Mt(e) || $t(e) : !1;
}
...
function Pr(e) {
  ...
  return o === Object ? !0 : typeof o == "function" && Function.toString.call(o) === ti;
}
function At(e, t) {
  jt(e) === 0 ? Reflect.ownKeys(e).forEach((o) => {
    t(o, e[o], e);
...
function an(e, t) {
  ...
  if (!t && Pr(e))
    return Ge(e) ? { ...e } : Object.assign(/* @__PURE__ */ Object.create(null), e);
...
function En(e, t = !1) {
  return Lt(e) || Fe(e) || !Pe(e) || (jt(e) > 1 && (e.set = e.add = e.clear = e.delete = ri), Object.freeze(e), t && Object.entries(e).forEach(([o, n]) => En(n, !0))), e;
}
function ri() {
  me(2);
}
...
function Zn(e, t) {
  ...
  const o = t.drafts_[0];
  return e !== void 0 && e !== o ? (o[be].modified_ && (un(t), me(4)), Pe(e) && (e = Rt(t, e), t.parent_ || Dt(t, e)), t.patches_ && Be("Patches").generateReplacementPatches_(
    o[be].base_,
    e,
    t.patches_,
    t.inversePatches_
  )) : e = Rt(t, o, []), un(t), t.patches_ && t.patchListener_(t.patches_, t.inversePatches_), e !== xr ? e : void 0;
}
function Rt(e, t, o) {
  if (Lt(t))
    return t;
  ...
  if (!n.finalized_) {
    ...
    n.type_ === 3 && (i = new Set(r), r.clear(), s = !0), At(
      i,
      (a, c) => Jn(e, n, r, a, c, o, s)
    ), Dt(e, r, !1), o && e.patches_ && Be("Patches").generatePatches_(
      n,
      o,
      e.patches_,
      e.inversePatches_
...
function Jn(e, t, o, n, r, i, s) {
  if (process.env.NODE_ENV !== "production" && r === o && me(5), Fe(r)) {
    ...
    !sn(t.assigned_, n) ? i.concat(n) : void 0, c = Rt(e, r, a);
    if (Nr(o, n, c), Fe(c))
      e.canAutoFreeze_ = !1;
    else
      return;
  ...
  if (Pe(r) && !Lt(r)) {
    if (!e.immer_.autoFreeze_ && e.unfinalizedDrafts_ < 1)
      return;
    Rt(e, r), (!t || !t.scope_.parent_) && typeof n != "symbol" && Object.prototype.propertyIsEnumerable.call(o, n) && Dt(e, r);
  }
}
function Dt(e, t, o = !1) {
...
var bn = {
  get(e, t) {
    ...
    if (!sn(o, t))
      return ui(e, o, t);
    const n = o[t];
    return e.finalized_ || !Pe(n) ? n : n === Yt(e.base_, t) ? (Kt(e), e.copy_[t] = fn(n, e)) : n;
  },
  has(e, t) {
    return t in $e(e);
  },
  ...
  set(e, t, o) {
    ...
    if (!e.modified_) {
      const r = Yt($e(e), t), i = r == null ? void 0 : r[be];
      if (i && i.base_ === o)
        return e.copy_[t] = o, e.assigned_[t] = !1, !0;
      if (ni(o, r) && (o !== void 0 || sn(e.base_, t)))
        return !0;
      Kt(e), ln(e);
    }
  ...
  deleteProperty(e, t) {
    return Yt(e.base_, t) !== void 0 || t in e.base_ ? (e.assigned_[t] = !1, Kt(e), ln(e)) : delete e.assigned_[t], e.copy_ && delete e.copy_[t], !0;
  },
...
ft.deleteProperty = function(e, t) {
  return process.env.NODE_ENV !== "production" && isNaN(parseInt(t)) && me(13), ft.set.call(this, e, t, void 0);
};
ft.set = function(e, t, o) {
  return process.env.NODE_ENV !== "production" && t !== "length" && isNaN(parseInt(t)) && me(14), bn.set.call(this, e[0], t, o, e[0]);
};
function Yt(e, t) {
  const o = e[be];
  return (o ? $e(o) : e)[t];
...
var ci = class {
  constructor(e) {
    this.autoFreeze_ = !0, this.useStrictShallowCopy_ = !1, this.produce = (t, o, n) => {
      ...
      typeof o != "function" && me(6), n !== void 0 && typeof n != "function" && me(7);
      let r;
      if (Pe(t)) {
        const i = Xn(this), s = fn(t, void 0);
        let a = !0;
        try {
          r = o(s), a = !1;
        } finally {
        ...
        if (r = o(t), r === void 0 && (r = t), r === xr && (r = void 0), this.autoFreeze_ && En(r, !0), n) {
          const i = [], s = [];
  ...
  applyPatches(e, t) {
    ...
    return Fe(e) ? n(e, t) : this.produce(
      e,
      (r) => n(r, t)
    );
  }
...
function fn(e, t) {
  const o = Mt(e) ? Be("MapSet").proxyMap_(e, t) : $t(e) ? Be("MapSet").proxySet_(e, t) : ai(e, t);
...
function gi(e, t = "expected all items to be functions, instead received the following types: ") {
...
}, Ei = typeof WeakRef < "u" ? WeakRef : mi, bi = 0, tr = 1;
function yt() {
  return {
    s: bi,
    v: void 0,
...
function _n(e, t = {}) {
  ...
  function s() {
    ...
    const l = a;
    let u;
    if (a.s === tr ? u = a.v : (u = e.apply(null, arguments), i++), l.s = tr, n) {
      const d = ((f = r == null ? void 0 : r.deref) == null ? void 0 : f.call(r)) ?? r;
      d != null && n(d, u) && (u = d, i !== 0 && i--), r = typeof u == "object" && u !== null || typeof u == "function" ? new Ei(u) : u;
    }
    return l.v = u, u;
  }
  return s.clearCache = () => {
...
function kr(e, ...t) {
  const o = typeof e == "function" ? {
    ...
    let i = 0, s = 0, a, c = {}, l = r.pop();
    typeof l == "object" && (c = l, l = r.pop()), pi(
      l,
    ...
    const u = {
      ...
      devModeChecks: y = {}
    } = u, v = Qn(d), b = Qn(p), _ = vi(r), S = f(function() {
      return i++, l.apply(
        null,
        arguments
      );
    ...
    const E = g(function() {
      ...
      if (a = S.apply(null, F), process.env.NODE_ENV !== "production") {
        const { identityFunctionCheck: m, inputStabilityCheck: $ } = yi(A, y);
...
var _i = /* @__PURE__ */ kr(_n), Si = Object.assign(
  (e, t = _i) => {
    hi(
      e,
  ...
  const t = kr(...e), o = Object.assign((...n) => {
    const r = t(...n), i = (s, ...a) => r(Fe(s) ? Mr(s) : s, ...a);
...
function Xe(e, t) {
  ...
  return o.toString = () => `${e}`, o.type = e, o.match = (n) => Qo(n) && n.type === e, o;
}
function nr(e) {
  return Pe(e) ? Lr(e, () => {
  }) : e;
...
function Oi(e, t) {
  ...
  function s(a = i(), c) {
    ...
    return l.filter((u) => !!u).length === 0 && (l = [r]), l.reduce((u, f) => {
      if (f)
        if (Fe(u)) {
          const g = f(u, c);
          return g === void 0 ? u : g;
...
var Ai = "ModuleSymbhasOwnPr-0123456789ABCDEFGHNRVfgctiUvz_KqYTJkLxpZXIjQW", Ri = (e = 21) => {
  let t = "", o = e;
  for (; o--; )
    t += Ai[Math.random() * 64 | 0];
  return t;
...
function wi({
  ...
  return function(r) {
    ...
    const a = (typeof r.reducers == "function" ? r.reducers(Ni()) : r.reducers) || {}, c = Object.keys(a), l = {
      ...
      addCase(S, A) {
        ...
        if (E in l.sliceCaseReducersByType)
          throw new Error(process.env.NODE_ENV === "production" ? de(13) : "`context.addCase` cannot be called with two reducers for the same action type: " + E);
    ...
    function f() {
      ...
      const [S = {}, A = [], E = void 0] = typeof r.extraReducers == "function" ? Br(r.extraReducers) : [r.extraReducers], P = {
        ...S,
        ...l.sliceCaseReducersByType
      };
      return Oi(r.initialState, (F) => {
        for (let m in P)
          F.addCase(m, P[m]);
    ...
    const d = (S) => S, g = /* @__PURE__ */ new Map();
    let p;
    function y(S, A) {
      return p || (p = f()), p(S, A);
    }
...
function Fi({
  ...
  if ("reducer" in n) {
    ...
    i = n;
  r.addCase(e, i).exposeCaseReducer(t, i).exposeAction(t, s ? Xe(e, s) : Xe(e));
}
function ji(e) {
...
function $i({
  ...
  n.exposeAction(t, f), s && n.addCase(f.fulfilled, s), a && n.addCase(f.pending, a), c && n.addCase(f.rejected, c), l && n.addMatcher(f.settled, l), n.exposeCaseReducer(t, {
    fulfilled: s || mt,
    pending: a || mt,
    rejected: c || mt,
    settled: l || mt
...
const Ui = {
  ...
  isStatic: !1,
  reducedMotion: "never"
}), Ji = Je(null), Qi = typeof document < "u", Ur = Qi ? Lo : Re;
class ir {
  constructor() {
...
function es(e) {
  let t = new ir(), o = new ir(), n = 0, r = !1, i = !1;
...
function ns(e, t) {
  ...
  const r = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, i = Et.reduce((f, d) => (f[d] = es(() => o = !0), f), {}), s = (f) => {
    i[f].process(r);
  }, a = () => {
    const f = performance.now();
    o = !1, r.delta = n ? 1e3 / 60 : Math.max(Math.min(f - r.timestamp, ts), 1), r.timestamp = f, r.isProcessing = !0, Et.forEach(s), r.isProcessing = !1, o && t && (n = !1, e(a));
  }, c = () => {
    o = !0, n = !0, r.isProcessing || e(a);
  };
  return { schedule: Et.reduce((f, d) => {
    const g = i[d];
    return f[d] = (p, y = !1, v = !1) => (o || c(), g.schedule(p, y, v)), f;
  }, {}), cancel: (f) => Et.forEach((d) => i[d].cancel(f)), state: r, steps: i };
}
const rs = Je({});
function os(e) {
  const t = Ae(null);
...
const is = (e) => e, { schedule: ss, cancel: pc, state: hc, steps: gc } = ns(typeof requestAnimationFrame < "u" ? requestAnimationFrame : is, !0);
function Vr() {
  const e = Ae(!1);
  return Ur(() => (e.current = !0, () => {
    e.current = !1;
  }), []), e;
}
function as() {
  const e = Vr(), [t, o] = ge(0), n = ut(() => {
    e.current && o(t + 1);
  }, [t]);
  return [ut(() => ss.postRender(n), [n]), t];
}
...
function cs({ children: e, isPresent: t }) {
  ...
  }, [t]), Ee.createElement(us, { isPresent: t, childRef: n, sizeRef: r }, Ee.cloneElement(e, { ref: n }));
}
const Gt = ({ children: e, initial: t, isPresent: o, onExitComplete: n, custom: r, presenceAffectsLayout: i, mode: s }) => {
  const a = os(ls), c = Dr(), l = ct(
    () => ({
      id: c,
      initial: t,
      isPresent: o,
  ...
  return ct(() => {
    ...
    !o && !a.size && n && n();
  }, [o]), s === "popLayout" && (e = Ee.createElement(cs, { isPresent: o }, e)), Ee.createElement(Ji.Provider, { value: l }, e);
};
function ls() {
...
function ps(e) {
  const t = [];
  return Ke.forEach(e, (o) => {
    Ir(o) && t.push(o);
  }), t;
}
const hs = ({ children: e, custom: t, initial: o = !0, onExitComplete: n, exitBeforeEnter: r, presenceAffectsLayout: i = !0, mode: s = "sync" }) => {
  const a = Qe(rs).forceRender || as()[0], c = Vr(), l = ps(e);
  let u = l;
  const f = Ae(/* @__PURE__ */ new Map()).current, d = Ae(u), g = Ae(/* @__PURE__ */ new Map()).current, p = Ae(!0);
  if (Ur(() => {
    p.current = !1, ds(l, g), d.current = u;
  }), fs(() => {
    p.current = !0, g.clear(), f.clear();
  }), p.current)
    return Ee.createElement(Ee.Fragment, null, u.map((_) => Ee.createElement(Gt, { key: Le(_), isPresent: !0, initial: o ? void 0 : !1, presenceAffectsLayout: i, mode: s }, _)));
  u = [...u];
  const y = d.current.map(Le), v = l.map(Le), b = y.length;
  for (let _ = 0; _ < b; _++) {
    const S = y[_];
    v.indexOf(S) === -1 && !f.has(S) && f.set(S, void 0);
  }
  return s === "wait" && f.size && (u = []), f.forEach((_, S) => {
    if (v.indexOf(S) !== -1)
      return;
    const A = g.get(S);
    if (!A)
    ...
    if (!P) {
      const F = () => {
        ...
        if (m.forEach(($) => g.delete($)), d.current = l.filter(($) => {
          const O = Le($);
          return (
      ...
      P = Ee.createElement(Gt, { key: Le(A), isPresent: !1, onExitComplete: F, custom: t, presenceAffectsLayout: i, mode: s }, A), f.set(S, P);
    }
    u.splice(E, 0, P);
  }), u = u.map((_) => {
    const S = _.key;
    return f.has(S) ? _ : Ee.createElement(Gt, { key: Le(_), isPresent: !0, presenceAffectsLayout: i, mode: s }, _);
  }), process.env.NODE_ENV !== "production" && s === "wait" && u.length > 1 && console.warn(`You're attempting to animate multiple children within AnimatePresence, but its mode is set to "wait". This will lead to odd visual behaviour.`), Ee.createElement(Ee.Fragment, null, f.size ? u : u.map((_) => Bo(_)));
}, Bt = "altimate-display-", gs = `${Bt}-highlight`, sr = `${Bt}-highlight-hover`, vs = `${Bt}-active-highlight`, ys = 1049, On = ({
  icon: e,
  className: t = "",
  ...o
}) => /* @__PURE__ */ j.jsx("i", { className: `${t} codicon codicon-${e}`, ...o }), ms = (e) => /* @__PURE__ */ j.jsx(On, { icon: "comment", ...e }), Es = (e) => /* @__PURE__ */ j.jsx(On, { icon: "check", ...e }), bs = (e) => /* @__PURE__ */ j.jsx(On, { icon: "send", ...e }), _s = "_iconButton_eti7u_1", Ss = {
  iconButton: _s
}, Cs = (e) => /* @__PURE__ */ j.jsx(Is, { title: e.title, children: /* @__PURE__ */ j.jsx(
  "button",
  {
    ...e,
    className: `btn ${e.color ? `btn-${e.color}` : ""} ${e.className ?? ""} ${Ss.iconButton}`,
    type: e.type ?? "button",
    children: e.children
  }
) }), Ts = Cs, Os = Je(null), Xt = {
...
class As extends Ho {
  constructor(t) {
    super(t), this.resetErrorBoundary = this.resetErrorBoundary.bind(this), this.state = Xt;
  }
  ...
  componentDidUpdate(t, o) {
    ...
    if (n && o.error !== null && Rs(t.resetKeys, r)) {
      var i, s;
...
const Ds = (e) => {
  const [t, o] = ge(!1), n = () => o(!t), r = Ae(
    (e.id ?? `tooltip-${Math.random().toString(36).substring(3, 9)}`).replace(/\s/g, "-")
  );
  return /* @__PURE__ */ j.jsxs(As, { fallback: /* @__PURE__ */ j.jsx("span", { id: r.current, children: e.children }), children: [
    /* @__PURE__ */ j.jsx("span", { id: r.current, children: e.children }),
    e.title ? /* @__PURE__ */ j.jsx(
      Uo,
      {
        isOpen: t,
        target: r.current,
...
}, Is = Ds, ws = "_loadingBtn_gadec_1", xs = {
  loadingBtn: ws
}, Ps = ({ loading: e, ...t }) => /* @__PURE__ */ j.jsx(
  Nt,
  {
    ...t,
...
), Ns = Ps, Fs = ({ pos: e, onAddComment: t }) => wr(
  /* @__PURE__ */ j.jsx(hs, { children: e && /* @__PURE__ */ j.jsx(
    Nt,
    {
      onClick: t,
      id: `${Bt}-highlight`,
  ...
  return /* @__PURE__ */ j.jsx(Nt, { onClick: o, children: e ? "Hide conversations" : "Show conversations" });
}, $s = Ms, et = {
  get: async (e, t, o) => ({}),
  post: async (e, t, o) => ({})
}, Ls = (e) => et.get(`dbt/dbt_docs_share/${e}`), ks = (e, t) => et.post(`dbt/dbt_docs_share/${e}/conversation_group`, t), Bs = (e, t, o) => et.post(
  `dbt/dbt_docs_share/${e}/conversation_group/${t}/conversation`,
  o
), Hs = (e) => et.get(`dbt/dbt_docs_share/${e}/conversations`), zs = (e) => et.get("/users/", { company: e }), Us = (e, t) => et.post(
...
(function(e, t) {
  (function(o, n) {
    ...
    return function(o) {
      ...
      var i, s = this && this.__extends || (i = function(f, d) {
        return (i = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(g, p) {
          g.__proto__ = p;
        } || function(g, p) {
          for (var y in p)
        ...
        i(f, d), f.prototype = d === null ? Object.create(d) : (g.prototype = d.prototype, new g());
...
`;
      ...
      var a = function() {
        ...
        return c.prototype.on = function(l, u) {
          return this.handlersMap[l] || (this.handlersMap[l] = []), this.handlersMap[l].push(u), this;
        }, c.prototype.off = function(l, u) {
          return this.handlersMap[l] && this.handlersMap[l].splice(this.handlersMap[l].indexOf(u) >>> 0, 1), this;
        }, c.prototype.emit = function(l) {
          for (var u = [], f = 1; f < arguments.length; f++)
            u[f - 1] = arguments[f];
          return this.handlersMap[l] && this.handlersMap[l].slice().forEach(function(d) {
            d.apply(void 0, s(u));
          }), this;
        }, c;
      }();
      ...
      var s = i(r(5)), a = r(9), c = function() {
        function l(u, f, d, g, p) {
          this.startMeta = u, this.endMeta = f, this.text = d, this.id = g, this.__isHighlightSource = {}, p && (this.extra = p);
        }
        return l.prototype.deSerialize = function(u, f) {
          var d = a.queryElementNode(this, u), g = d.start, p = d.end, y = a.getTextChildByOffset(g, this.startMeta.textOffset), v = a.getTextChildByOffset(p, this.endMeta.textOffset);
      ...
      var i = this && this.__values || function(u) {
        var f = typeof Symbol == "function" && Symbol.iterator, d = f && u[f], g = 0;
        if (d)
          return d.call(u);
        if (u && typeof u.length == "number")
          return { next: function() {
            return u && g >= u.length && (u = void 0), { value: u && u[g++], done: !u };
          } };
        throw new TypeError(f ? "Object is not iterable." : "Symbol.iterator is not defined.");
      }, s = this && this.__read || function(u, f) {
        var d = typeof Symbol == "function" && u[Symbol.iterator];
        if (!d)
          return u;
        var g, p, y = d.call(u), v = [];
        try {
      ...
      n.getHighlightId = function(u, f) {
        ...
        return (u = l(u, f)) ? u.dataset[c.CAMEL_DATASET_IDENTIFIER_EXTRA].split(c.ID_DIVISION).filter(function(d) {
          return d;
        }) : [];
        ...
        try {
          for (var y = i(u), v = y.next(); !v.done; v = y.next()) {
            var b = v.value.querySelectorAll(f + "[data-" + c.DATASET_IDENTIFIER + "]");
            p.push.apply(p, b);
          }
        } catch (_) {
          d = { error: _ };
        ...
        var g, p, y = [], v = new RegExp("(" + f + "\\" + c.ID_DIVISION + "|\\" + c.ID_DIVISION + "?" + f + "$)"), b = u.querySelectorAll(d + "[data-" + c.DATASET_IDENTIFIER + "]");
        try {
        ...
        return u.addEventListener(f, d), function() {
      ...
      var i = this && this.__importDefault || function(g) {
        return g && g.__esModule ? g : { default: g };
      };
      Object.defineProperty(n, "__esModule", { value: !0 });
      var s = i(r(3)), a = r(1), c = r(11), l = i(r(6)), u = r(12), f = r(0), d = function() {
        function g(p, y, v, b, _) {
          _ === void 0 && (_ = !1), p.$node.nodeType === 3 && y.$node.nodeType === 3 || f.eventEmitter.emit(f.INTERNAL_ERROR_EVENT, { type: a.ERROR.RANGE_NODE_INVALID }), this.start = u.formatDomNode(p), this.end = u.formatDomNode(y), this.text = v, this.frozen = _, this.id = b;
        }
        return g.fromSelection = function(p) {
          var y = c.getDomRange();
          if (!y)
            return null;
          var v = { $node: y.startContainer, offset: y.startOffset }, b = { $node: y.endContainer, offset: y.endOffset }, _ = y.toString(), S = p.call(v, b, _);
          return new g(v, b, _, S = S ?? l.default());
        }, g.prototype.serialize = function(p, y) {
          var v, b = u.getDomMeta(this.start.$node, this.start.offset, p), _ = u.getDomMeta(this.end.$node, this.end.offset, p);
          return y.Serialize.RecordInfo.isEmpty() || (v = y.Serialize.RecordInfo.call(this.start, this.end, p)), this.frozen = !0, new s.default(b, _, this.text, this.id, v);
      ...
      var i, s = this && this.__extends || (i = function(E, P) {
        return (i = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(F, m) {
          F.__proto__ = m;
        } || function(F, m) {
          for (var $ in m)
        ...
        i(E, P), E.prototype = P === null ? Object.create(P) : (F.prototype = P.prototype, new F());
      }), a = this && this.__assign || function() {
        return (a = Object.assign || function(E) {
          for (var P, F = 1, m = arguments.length; F < m; F++)
            for (var $ in P = arguments[F])
              Object.prototype.hasOwnProperty.call(P, $) && (E[$] = P[$]);
          return E;
      ...
      Object.defineProperty(n, "__esModule", { value: !0 });
      var l = c(r(2)), u = c(r(5)), f = c(r(3)), d = c(r(6)), g = c(r(13)), p = c(r(14)), y = c(r(16)), v = c(r(17)), b = r(0), _ = r(1), S = r(4), A = function(E) {
        function P(F) {
          var m = E.call(this) || this;
          m.event = p.default(), m.run = function() {
            return S.addEventListener(m.options.$root, m.event.PointerEnd, m._handleSelection);
          }, m.stop = function() {
            S.removeEventListener(m.options.$root, m.event.PointerEnd, m._handleSelection);
            ...
            return O ? S.getHighlightById(m.options.$root, O, m.options.wrapTag) : S.getHighlightsByRoot(m.options.$root, m.options.wrapTag);
          }, m.dispose = function() {
            var O = m.options.$root;
            S.removeEventListener(O, m.event.PointerOver, m._handleHighlightHover), S.removeEventListener(O, m.event.PointerEnd, m._handleSelection), S.removeEventListener(O, m.event.PointerTap, m._handleHighlightClick), m.removeAll();
          }, m.setOption = function(O) {
            m.options = a(a({}, m.options), O), m.painter = new v.default({ $root: m.options.$root, wrapTag: m.options.wrapTag, className: m.options.style.className, exceptSelectors: m.options.exceptSelectors }, m.hooks);
          }, m.fromRange = function(O) {
            var M = { $node: O.startContainer, offset: O.startOffset }, q = { $node: O.endContainer, offset: O.endOffset }, Y = O.toString(), x = m.hooks.Render.UUID.call(M, q, Y);
            x = x ?? d.default();
            var I = new u.default(M, q, Y, x);
            return I ? m._highlightFromHRange(I) : (b.eventEmitter.emit(b.INTERNAL_ERROR_EVENT, { type: _.ERROR.RANGE_INVALID }), null);
            ...
            return m.painter.highlightRange(O).length === 0 ? (b.eventEmitter.emit(b.INTERNAL_ERROR_EVENT, { type: _.ERROR.DOM_SELECTION_EMPTY }), null) : (m.cache.save(M), m.emit(_.EventType.CREATE, { sources: [M], type: _.CreateFrom.INPUT }, m), M);
            ...
            if (!S.isHighlightWrapNode(M))
              return m._hoverId && m.emit(_.EventType.HOVER_OUT, { id: m._hoverId }, m, O), void (m._hoverId = null);
            var q = S.getHighlightId(M, m.options.$root);
            m._hoverId !== q && (m._hoverId && m.emit(_.EventType.HOVER_OUT, { id: m._hoverId }, m, O), m._hoverId = q, m.emit(_.EventType.HOVER, { id: m._hoverId }, m, O));
          ...
          }, m.options = b.getDefaultOptions(), m.hooks = m._getHooks(), m.setOption(F), m.cache = new y.default();
          var $ = m.options.$root;
          return S.addEventListener($, m.event.PointerOver, m._handleHighlightHover), S.addEventListener($, m.event.PointerTap, m._handleHighlightClick), b.eventEmitter.on(b.INTERNAL_ERROR_EVENT, m._handleError), m;
        }
        return s(P, E), P.prototype.remove = function(F) {
          if (F) {
            var m = this.painter.removeHighlight(F);
            this.cache.remove(F), m && this.emit(_.EventType.REMOVE, { ids: [F] }, this);
          }
          ...
          this.emit(_.EventType.CREATE, { sources: m, type: _.CreateFrom.STORE }, this), this.cache.save(F);
        }, P.event = _.EventType, P.isHighlightWrapNode = S.isHighlightWrapNode, P.isHighlightSource = function(F) {
      ...
      n.getTextChildByOffset = function(s, a) {
        for (var c = [s], l = null, u = 0, f = 0; l = c.pop(); ) {
          for (var d = l.childNodes, g = d.length - 1; g >= 0; g--)
            c.push(d[g]);
          if (l.nodeType === 3 && (f = a - u, (u += l.textContent.length) >= a))
            break;
        }
      ...
      n.getDomMeta = function(s, a, c) {
        var l = function(d) {
          if (d instanceof HTMLElement && (!d.dataset || !d.dataset[i.CAMEL_DATASET_IDENTIFIER]))
            return d;
          for (var g = d.parentNode; g != null && g.dataset[i.CAMEL_DATASET_IDENTIFIER]; )
            g = g.parentNode;
          return g;
        }(s), u = l === c ? i.ROOT_IDX : function(d, g) {
          for (var p = d.tagName, y = g.getElementsByTagName(p), v = 0; v < y.length; v++)
            if (d === y[v])
              return v;
        ...
        return { parentTagName: l.tagName, parentIndex: u, textOffset: f + a };
      ...
      var i, s = this && this.__extends || (i = function(d, g) {
        return (i = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(p, y) {
          p.__proto__ = y;
        } || function(p, y) {
          for (var v in y)
        ...
        i(d, g), d.prototype = g === null ? Object.create(g) : (p.prototype = g.prototype, new p());
      }), a = this && this.__values || function(d) {
        var g = typeof Symbol == "function" && Symbol.iterator, p = g && d[g], y = 0;
        if (p)
          return p.call(d);
        if (d && typeof d.length == "number")
          return { next: function() {
            return d && y >= d.length && (d = void 0), { value: d && d[y++], done: !d };
          } };
      ...
      Object.defineProperty(n, "__esModule", { value: !0 });
      var l = c(r(2)), u = r(1), f = function(d) {
        function g() {
          var p = d !== null && d.apply(this, arguments) || this;
          return p._data = /* @__PURE__ */ new Map(), p;
        }
        return s(g, d), Object.defineProperty(g.prototype, "data", { get: function() {
          return this.getAll();
        }, set: function(p) {
          ...
          var p, y, v = [];
          try {
            for (var b = a(this._data), _ = b.next(); !_.done; _ = b.next()) {
              var S = _.value;
              v.push(S[1]);
            }
          } catch (A) {
      ...
      Object.defineProperty(n, "__esModule", { value: !0 });
      var l = c(r(3)), u = r(18), f = r(4), d = r(1), g = r(20), p = r(0), y = function() {
        function v(b, _) {
          this.options = { $root: b.$root, wrapTag: b.wrapTag, exceptSelectors: b.exceptSelectors, className: b.className }, this.hooks = _, g.initDefaultStylesheet();
        }
        return v.prototype.highlightRange = function(b) {
          var _ = this;
          if (!b.frozen)
            throw d.ERROR.HIGHLIGHT_RANGE_FROZEN;
          var S = this.options, A = S.$root, E = S.className, P = S.exceptSelectors, F = this.hooks, m = u.getSelectedNodes(A, b.start, b.end, P);
          return F.Render.SelectedNodes.isEmpty() || (m = F.Render.SelectedNodes.call(b.id, m) || []), m.map(function($) {
          ...
          return S.forEach(function(E) {
            if (E instanceof l.default) {
              ...
              _.highlightRange(P).length > 0 ? A.push(E) : p.eventEmitter.emit(p.INTERNAL_ERROR_EVENT, { type: d.ERROR.HIGHLIGHT_SOURCE_NONE_RENDER, detail: E });
            } else
              p.eventEmitter.emit(p.INTERNAL_ERROR_EVENT, { type: d.ERROR.SOURCE_TYPE_ERROR });
          }), A;
        }, v.prototype.removeHighlight = function(b) {
          var _, S, A = new RegExp("(" + b + "\\" + p.ID_DIVISION + "|\\" + p.ID_DIVISION + "?" + b + "$)"), E = this.hooks, P = this.options.wrapTag, F = document.querySelectorAll(P + "[data-" + p.DATASET_IDENTIFIER + "]"), m = [], $ = [], O = [];
          try {
            for (var M = i(F), q = M.next(); !q.done; q = M.next()) {
              var Y = q.value, x = Y.dataset[p.CAMEL_DATASET_IDENTIFIER], I = Y.dataset[p.CAMEL_DATASET_IDENTIFIER_EXTRA];
              x !== b || I ? x === b ? $.push(Y) : x !== b && A.test(I) && O.push(Y) : m.push(Y);
            }
          } catch (T) {
            _ = { error: T };
          } finally {
          ...
          return m.forEach(function(T) {
            var w = T.parentNode, D = document.createDocumentFragment();
            f.forEach(T.childNodes, function(R) {
              return D.appendChild(R.cloneNode(!1));
            });
            var B = T.previousSibling, C = T.nextSibling;
            w.replaceChild(D, T), u.normalizeSiblingText(B, !0), u.normalizeSiblingText(C, !1), E.Remove.UpdateNodes.call(b, T, "remove");
          }), $.forEach(function(T) {
            var w = T.dataset, D = w[p.CAMEL_DATASET_IDENTIFIER_EXTRA].split(p.ID_DIVISION), B = D.shift(), C = document.querySelector(P + "[data-" + p.DATASET_IDENTIFIER + '="' + B + '"]');
            C && (f.removeAllClass(T), f.addClass(T, a(C.classList))), w[p.CAMEL_DATASET_IDENTIFIER] = B, w[p.CAMEL_DATASET_IDENTIFIER_EXTRA] = D.join(p.ID_DIVISION), E.Remove.UpdateNodes.call(b, T, "id-update");
          }), O.forEach(function(T) {
            var w = T.dataset[p.CAMEL_DATASET_IDENTIFIER_EXTRA];
            T.dataset[p.CAMEL_DATASET_IDENTIFIER_EXTRA] = w.replace(A, ""), E.Remove.UpdateNodes.call(b, T, "extra-update");
          ...
          f.getHighlightsByRoot(S, _).forEach(function(A) {
            var E = A.parentNode, P = document.createDocumentFragment();
      ...
      var i = this && this.__read || function(p, y) {
      ...
      var a = r(1), c = r(4), l = r(0), u = r(19), f = function(p, y) {
        if (!p)
          return !1;
        if (/^\./.test(y)) {
          var v = y.replace(/^\./, "");
      ...
      n.getSelectedNodes = function(p, y, v, b) {
        var _ = y.$node, S = v.$node, A = y.offset, E = v.offset;
        if (_ === S && _ instanceof Text)
          return function(x, I, T, w) {
            for (var D = x, B = function(R) {
              return w == null ? void 0 : w.some(function(z) {
                return f(R, z);
              });
            }; D; ) {
              if (D.nodeType === 1 && B(D))
            ...
            x.splitText(I);
            var C = x.nextSibling;
            return C.splitText(T - I), [{ $node: C, type: a.SelectedNodeType.text, splitType: a.SplitType.both }];
          }(_, A, E, b);
        for (var P = [p], F = [], m = function(x) {
          ...
          if (O.nodeType !== 1 || !m(O)) {
            ...
            if (O === _) {
              if (O.nodeType === 3) {
                O.splitText(A);
                var Y = O.nextSibling;
                F.push({ $node: Y, type: a.SelectedNodeType.text, splitType: a.SplitType.head });
              }
              $ = !0;
            } else {
              if (O === S) {
                O.nodeType === 3 && ((Y = O).splitText(E), F.push({ $node: Y, type: a.SelectedNodeType.text, splitType: a.SplitType.tail }));
                break;
              }
              $ && O.nodeType === 3 && F.push({ $node: O, type: a.SelectedNodeType.text, splitType: a.SplitType.none });
            }
          }
        return F;
      };
      ...
      n.wrapHighlight = function(p, y, v, b) {
        ...
        return c.isHighlightWrapNode(_) ? !c.isHighlightWrapNode(_) || g(S) && g(A) ? function(E, P, F) {
          var m = E.$node.parentNode, $ = m;
          c.removeAllClass($), d($, F);
          var O = m.dataset, M = O[l.CAMEL_DATASET_IDENTIFIER];
          return O[l.CAMEL_DATASET_IDENTIFIER] = P.id, O[l.CAMEL_DATASET_IDENTIFIER_EXTRA] = O[l.CAMEL_DATASET_IDENTIFIER_EXTRA] ? M + l.ID_DIVISION + O[l.CAMEL_DATASET_IDENTIFIER_EXTRA] : M, $;
        }(p, y, v) : function(E, P, F, m) {
          var $ = document.createElement(m), O = E.$node.parentNode, M = E.$node.previousSibling, q = E.$node.nextSibling, Y = document.createDocumentFragment(), x = O.dataset[l.CAMEL_DATASET_IDENTIFIER], I = O.dataset[l.CAMEL_DATASET_IDENTIFIER_EXTRA], T = I ? x + l.ID_DIVISION + I : x;
          $.setAttribute("data-" + l.DATASET_IDENTIFIER, P.id), $.setAttribute("data-" + l.DATASET_IDENTIFIER_EXTRA, T), $.appendChild(E.$node.cloneNode(!1));
          var w, D = !1, B = !1;
          M && ((C = O.cloneNode(!1)).textContent = M.textContent, Y.appendChild(C), D = !0);
          var C, R = [];
          return Array.isArray(F) ? R.push.apply(R, s(F)) : R.push(F), d($, u.unique(R)), Y.appendChild($), q && ((C = O.cloneNode(!1)).textContent = q.textContent, Y.appendChild(C), B = !0), w = D && B ? a.SplitType.both : D ? a.SplitType.head : B ? a.SplitType.tail : a.SplitType.none, $.setAttribute("data-" + l.DATASET_SPLIT_TYPE, w), O.parentNode.replaceChild(Y, O), $;
        }(p, y, v, b) : function(E, P, F, m) {
          var $ = document.createElement(m);
          return d($, F), $.appendChild(E.$node.cloneNode(!1)), E.$node.parentNode.replaceChild($, E.$node), $.setAttribute("data-" + l.DATASET_IDENTIFIER, P.id), $.setAttribute("data-" + l.DATASET_SPLIT_TYPE, E.splitType), $.setAttribute("data-" + l.DATASET_IDENTIFIER_EXTRA, ""), $;
        }(p, y, v, b);
        ...
        if (y === void 0 && (y = !0), p && p.nodeType === 3) {
          ...
          if (v.nodeType === 3) {
            var b = v.nodeValue;
            p.nodeValue = y ? p.nodeValue + b : b + p.nodeValue, v.parentNode.removeChild(v);
          }
        }
      };
    }, function(o, n, r) {
      var i = this && this.__values || function(s) {
        var a = typeof Symbol == "function" && Symbol.iterator, c = a && s[a], l = 0;
        if (c)
          return c.call(s);
...
var Ws = Wr.exports;
const qr = /* @__PURE__ */ Ft(Ws), qe = new qr({
  style: {
    className: gs
  }
...
const qs = (e) => {
  ...
  const c = ut(() => {
    console.log("resetHighlights"), r && Ys(r), a(null), i(null);
  }, [r]);
  return Re(() => {
    ...
    onSelectionEnd: (u) => {
      var M;
      const { end: f, start: d } = u.detail.selectionRange, g = document.getSelection();
      if (!g || !g.rangeCount)
        return c(), null;
      const y = g.getRangeAt(0).toString(), v = Gr(), b = v == null ? void 0 : v.innerText;
      if (!y || !b)
        return;
      const _ = v.querySelectorAll(
        ".line-numbers-rows > span"
      ), S = y.split(`
`), A = Math.max(d.y, f.y), E = Array.from(_).findIndex((q) => {
        const { height: Y, y: x } = q.getBoundingClientRect();
        return A >= x && A <= x + Y;
      }), P = _[E], F = E - S.length + 1;
      console.log("start and end lines found", F, E);
      const m = window.location.hash.split("#"), $ = (M = m.find((q) => q.startsWith("!"))) == null ? void 0 : M.split("/");
      if (!$ || $.length < 3) {
  ...
  const o = le(
    ...
    for (let l = e.meta.range.start.line; l <= e.meta.range.end.line; l++) {
      ...
      u && (l === e.meta.range.start.line && (a = u.offsetTop), l === e.meta.range.end.line && (c = u.offsetTop + u.offsetHeight));
    }
  ...
  }, [o]), !s || !(t != null && t.parentElement) ? null : wr(
    /* @__PURE__ */ j.jsx(
      "div",
      {
        ref: r,
  ...
  if (!(n != null && n.length) || !t)
    return null;
  const r = Gr();
  return /* @__PURE__ */ j.jsx(j.Fragment, { children: n.map((i) => /* @__PURE__ */ j.jsx(
    Xs,
    {
      codeSection: r,
      conversationGroup: i
...
}, Js = Zs, Qs = "_dbtDocs_8fz8v_1", ea = "_conversationRightPanelCloseButton_8fz8v_14", ta = "_conversationRightPanel_8fz8v_14", na = "_newConversationForm_8fz8v_46", ra = "_highlightText_8fz8v_59", oa = "_conversationInputForm_8fz8v_65", ia = "_conversationGroup_8fz8v_91", sa = "_replyForm_8fz8v_123", aa = "_resolveButton_8fz8v_149", je = {
  dbtDocs: Qs,
  ...
  replyForm: sa,
  resolveButton: aa
}, ua = "_profileImage_11vaf_1", ca = {
  profileImage: ua
}, la = ({ user: e }) => {
  var t;
  return /* @__PURE__ */ j.jsx("div", { className: ca.profileImage, children: ((t = e == null ? void 0 : e.first_name) == null ? void 0 : t[0]) || "" });
}, Xr = la;
function fa(e) {
  if (Array.isArray(e)) {
...
function dn(e, t) {
  return dn = Object.setPrototypeOf || function(n, r) {
...
function Ct(e) {
  return typeof Symbol == "function" && Ye(Symbol.iterator) === "symbol" ? Ct = function(o) {
    return Ye(o);
  } : Ct = function(o) {
...
function xt(e) {
  return xt = Object.setPrototypeOf ? Object.getPrototypeOf : function(o) {
...
var ma = function(e, t, o, n, r, i, s, a) {
...
function Jr(e, t) {
  ...
  return Tt(e) && Tt(t) && tt(t).forEach(function(n) {
    Tt(t[n]) ? n in e ? o[n] = Jr(e[n], t[n]) : Object.assign(o, pt({}, n, t[n])) : Object.assign(o, pt({}, n, t[n]));
  }), o;
}
var hn = function(t) {
  ...
  for (var o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], n = tt(t), r = {}, i = 0, s = n.length; i < s; i += 1) {
  ...
  for (var n = o.map(ur), r = tt(t), i = {}, s = 0, a = r.length; s < a; s += 1) {
    var c = r[s];
    (o.indexOf(c) >= 0 || n.indexOf(ur(c)) >= 0) && (i[c] = t[c]);
  }
  return i;
}, ja = function e(t, o) {
  for (var n = hn.apply(void 0, [{}, xa(t, o)].concat(xe(Zr(Qr(t, o))))), r = tt(n).filter(Rn), i = 0, s = r.length; i < s; i += 1) {
    var a = r[i], c = e(n[a], o);
...
function lr(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? cr(Object(o), !0).forEach(function(n) {
      pt(e, n, o[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(o)) : cr(Object(o)).forEach(function(n) {
      Object.defineProperty(e, n, Object.getOwnPropertyDescriptor(o, n));
    });
  }
  return e;
}
var Ma = ["animationName"], $a = function(t) {
...
var no = function(t) {
  if (t) {
    ...
    if (!Array.isArray(t)) {
      var o = t;
      return tt(t).reduce(function(n, r) {
...
function ro(e) {
  var t = e.style, o = e.className, n = e.classNames, r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : eo, i = o || Ba(n) || (t == null ? void 0 : t.className), s = typeof t == "function" ? t : ka(function(f, d) {
    var g = no(f);
    Ze(Array.isArray(g), "First parameter must be a string, an array of strings, a plain object with boolean values, or a falsy value."), Ze(!d || Tt(d), "Optional second parameter must be a plain object.");
    var p = g.filter(Rn), y = g.filter(Na), v = y.length > 0 ? function(S) {
      return Zr(Qr(S, y));
    } : function(S) {
      return [S];
    }, b = function() {
    ...
    style: t
  }), c = xe(new Set([].concat(xe(a.className ? a.className.split(" ") : []), xe(i ? i.split(" ") : [])))), l = n ? Pa(c.map(function(f) {
    return n[f];
  })) : c, u = r(Ve(Ve({}, a), l.length > 0 ? {
    className: l.join(" ")
  } : {}));
...
function it(e) {
  for (var t = 1; t < arguments.length; t++) {
    var o = arguments[t] != null ? arguments[t] : {};
    t % 2 ? dr(Object(o), !0).forEach(function(n) {
      pt(e, n, o[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(o)) : dr(Object(o)).forEach(function(n) {
      Object.defineProperty(e, n, Object.getOwnPropertyDescriptor(o, n));
    });
  }
  return e;
...
var za = function() {
  ...
  return o.reduce(function(r, i) {
    return it(it(it({}, r), typeof i == "function" ? i : {}), {}, {
      style: it(it({}, r.style), typeof i == "function" ? i.style : i)
    });
  }, {});
}, Dn = function(t, o, n) {
  var r = o.style, i = o.className, s = o.classNames, a = Qe(to), c = ct(function() {
    return ro({
      style: r,
      className: i,
      classNames: s
...
function Ua() {
  if (pr)
    return se;
  pr = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, o = e ? Symbol.for("react.portal") : 60106, n = e ? Symbol.for("react.fragment") : 60107, r = e ? Symbol.for("react.strict_mode") : 60108, i = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, a = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, l = e ? Symbol.for("react.concurrent_mode") : 60111, u = e ? Symbol.for("react.forward_ref") : 60112, f = e ? Symbol.for("react.suspense") : 60113, d = e ? Symbol.for("react.suspense_list") : 60120, g = e ? Symbol.for("react.memo") : 60115, p = e ? Symbol.for("react.lazy") : 60116, y = e ? Symbol.for("react.block") : 60121, v = e ? Symbol.for("react.fundamental") : 60117, b = e ? Symbol.for("react.responder") : 60118, _ = e ? Symbol.for("react.scope") : 60119;
  function S(E) {
    if (typeof E == "object" && E !== null) {
      var P = E.$$typeof;
      switch (P) {
  ...
  return se.AsyncMode = c, se.ConcurrentMode = l, se.ContextConsumer = a, se.ContextProvider = s, se.Element = t, se.ForwardRef = u, se.Fragment = n, se.Lazy = p, se.Memo = g, se.Portal = o, se.Profiler = i, se.StrictMode = r, se.Suspense = f, se.isAsyncMode = function(E) {
    return A(E) || S(E) === c;
    ...
    return typeof E == "string" || typeof E == "function" || E === n || E === l || E === i || E === r || E === f || E === d || typeof E == "object" && E !== null && (E.$$typeof === p || E.$$typeof === g || E.$$typeof === s || E.$$typeof === a || E.$$typeof === u || E.$$typeof === v || E.$$typeof === b || E.$$typeof === _ || E.$$typeof === y);
  }, se.typeOf = S, se;
}
var ae = {};
/** @license React v16.13.1
...
function Va() {
  return hr || (hr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function S(k) {
      ...
      k === n || k === l || k === i || k === r || k === f || k === d || typeof k == "object" && k !== null && (k.$$typeof === p || k.$$typeof === g || k.$$typeof === s || k.$$typeof === a || k.$$typeof === u || k.$$typeof === v || k.$$typeof === b || k.$$typeof === _ || k.$$typeof === y);
    }
    function A(k) {
    ...
    var E = c, P = l, F = a, m = s, $ = t, O = u, M = n, q = p, Y = g, x = o, I = i, T = r, w = f, D = !1;
    function B(k) {
      return D || (D = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), C(k) || A(k) === c;
    }
    function C(k) {
      return A(k) === l;
    }
    ...
    ae.AsyncMode = E, ae.ConcurrentMode = P, ae.ContextConsumer = F, ae.ContextProvider = m, ae.Element = $, ae.ForwardRef = O, ae.Fragment = M, ae.Lazy = q, ae.Memo = Y, ae.Portal = x, ae.Profiler = I, ae.StrictMode = T, ae.Suspense = w, ae.isAsyncMode = B, ae.isConcurrentMode = C, ae.isContextConsumer = R, ae.isContextProvider = z, ae.isElement = U, ae.isForwardRef = V, ae.isFragment = X, ae.isLazy = K, ae.isMemo = G, ae.isPortal = J, ae.isProfiler = Q, ae.isStrictMode = W, ae.isSuspense = ce, ae.isValidElementType = S, ae.typeOf = A;
  }()), ae;
}
var gr;
function oo() {
  return gr || (gr = 1, process.env.NODE_ENV === "production" ? bt.exports = Ua() : bt.exports = Va()), bt.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Wa() {
  ...
  return Zt = r() ? Object.assign : function(i, s) {
...
var Qt, mr;
function io() {
  return mr || (mr = 1, Qt = Function.call.bind(Object.prototype.hasOwnProperty)), Qt;
}
var en, Er;
function qa() {
  if (Er)
...
function Ya() {
  if (br)
    return tn;
  br = 1;
  var e = oo(), t = Wa(), o = In(), n = io(), r = qa(), i = function() {
  };
  ...
  return tn = function(a, c) {
    ...
    function v(C) {
      ...
      function U(X, K, G, J, Q, W, ce) {
        ...
        return K[G] == null ? X ? K[G] === null ? new y("The " + Q + " `" + W + "` is marked as required " + ("in `" + J + "`, but its value is `null`.")) : new y("The " + Q + " `" + W + "` is marked as required in " + ("`" + J + "`, but its value is `undefined`.")) : null : C(K, G, J, Q, W);
      }
      var V = U.bind(null, !1);
    ...
    function b(C) {
      function R(z, U, V, X, K, G) {
        ...
        if (Q !== C) {
          var W = w(J);
          return new y(
            "Invalid " + X + " `" + K + "` of type " + ("`" + W + "` supplied to `" + V + "`, expected ") + ("`" + C + "`."),
            { expectedType: C }
          );
        }
        return null;
    ...
    function S(C) {
      function R(z, U, V, X, K) {
        if (typeof C != "function")
          return new y("Property `" + K + "` of component `" + V + "` has invalid PropType notation inside arrayOf.");
        var G = z[U];
        if (!Array.isArray(G)) {
          var J = T(G);
          return new y("Invalid " + X + " `" + K + "` of type " + ("`" + J + "` supplied to `" + V + "`, expected an array."));
        }
    ...
    function A() {
      function C(R, z, U, V, X) {
        ...
        if (!a(K)) {
          var G = T(K);
          return new y("Invalid " + V + " `" + X + "` of type " + ("`" + G + "` supplied to `" + U + "`, expected a single ReactElement."));
        }
        return null;
      }
      return v(C);
    ...
    function E() {
      function C(R, z, U, V, X) {
        ...
        if (!e.isValidElementType(K)) {
          var G = T(K);
          return new y("Invalid " + V + " `" + X + "` of type " + ("`" + G + "` supplied to `" + U + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return v(C);
    ...
    function P(C) {
      function R(z, U, V, X, K) {
        if (!(z[U] instanceof C)) {
          var G = C.name || d, J = B(z[U]);
          return new y("Invalid " + X + " `" + K + "` of type " + ("`" + J + "` supplied to `" + V + "`, expected ") + ("instance of `" + G + "`."));
        }
        return null;
      }
      return v(R);
    ...
    function F(C) {
      ...
      function R(z, U, V, X, K) {
        ...
        return new y("Invalid " + X + " `" + K + "` of value `" + String(G) + "` " + ("supplied to `" + V + "`, expected one of " + Q + "."));
      }
      return v(R);
    }
    function m(C) {
      function R(z, U, V, X, K) {
        if (typeof C != "function")
          return new y("Property `" + K + "` of component `" + V + "` has invalid PropType notation inside objectOf.");
        var G = z[U], J = T(G);
        if (J !== "object")
          return new y("Invalid " + X + " `" + K + "` of type " + ("`" + J + "` supplied to `" + V + "`, expected an object."));
        for (var Q in G)
          if (n(G, Q)) {
            var W = C(G, Q, V, X, K + "." + Q, o);
            if (W instanceof Error)
    ...
    function $(C) {
      ...
      for (var R = 0; R < C.length; R++) {
        ...
        if (typeof z != "function")
          return i(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + D(z) + " at index " + R + "."
          ), s;
      }
      function U(V, X, K, G, J) {
        for (var Q = [], W = 0; W < C.length; W++) {
          var ce = C[W], k = ce(V, X, K, G, J, o);
          if (k == null)
            return null;
          k.data && n(k.data, "expectedType") && Q.push(k.data.expectedType);
        }
        var he = Q.length > 0 ? ", expected one of type [" + Q.join(", ") + "]" : "";
        return new y("Invalid " + G + " `" + J + "` supplied to " + ("`" + K + "`" + he + "."));
      }
      return v(U);
    }
    function O() {
      function C(R, z, U, V, X) {
        return x(R[z]) ? null : new y("Invalid " + V + " `" + X + "` supplied to " + ("`" + U + "`, expected a ReactNode."));
      }
      return v(C);
    }
    function M(C, R, z, U, V) {
      return new y(
        (C || "React class") + ": " + R + " type `" + z + "." + U + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + V + "`."
      );
    }
    function q(C) {
      function R(z, U, V, X, K) {
        var G = z[U], J = T(G);
        if (J !== "object")
          return new y("Invalid " + X + " `" + K + "` of type `" + J + "` " + ("supplied to `" + V + "`, expected `object`."));
        for (var Q in C) {
          var W = C[Q];
          if (typeof W != "function")
            return M(V, X, K, Q, w(W));
    ...
    function Y(C) {
      function R(z, U, V, X, K) {
        ...
        for (var W in Q) {
          var ce = C[W];
          if (n(C, W) && typeof ce != "function")
            return M(V, X, K, W, w(ce));
          if (!ce)
            return new y(
...
function Ka() {
  ...
  return o.resetWarningCache = t, nn = function() {
...
var Ot = function(t) {
  ...
  Ze(o === "id" || o === "display", 'Second arg must be either "id" or "display", got: "'.concat(o, '"'));
  var n = t.indexOf(Ie.display), r = t.indexOf(Ie.id);
  return n < 0 && (n = null), r < 0 && (r = null), Ze(n !== null || r !== null, "The markup '".concat(t, "' does not contain either of the placeholders '__id__' or '__display__'")), n !== null && r !== null ? o === "id" && r <= n || o === "display" && n <= r ? 0 : 1 : 0;
}, Ja = function(t) {
  var o = /^\/(.+)\/(\w+)?$/;
  return new RegExp(t.map(function(n) {
    var r = o.exec(n.toString()), i = Pt(r, 3), s = i[1], a = i[2];
    return Ze(!a, "RegExp flags are not supported. Change /".concat(s, "/").concat(a, " into /").concat(s, "/")), "(".concat(s, ")");
  }).join("|"), "g");
}, so = function(t) {
  var o = 0;
  ...
  for (var r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : Qa, i = Ja(o.map(function(E) {
    return E.regex;
  })), s = 2, a = o.map(function(E) {
    var P = E.markup, F = s;
    return s += so(P) + 1, F;
  }), c, l = 0, u = 0; (c = i.exec(t)) !== null; ) {
    var f = a.find(function(E) {
      return !!c[E];
    }), d = a.indexOf(f), g = o[d], p = g.markup, y = g.displayTransform, v = f + Sr(p, "id"), b = f + Sr(p, "display"), _ = c[v], S = y(_, c[b]), A = t.substring(l, c.index);
    r(A, l, u), u += A.length, n(c[0], c.index, u, _, S, d, l), u += S.length, l = i.lastIndex;
  }
  l < t.length && r(t.substring(l), l, u);
}, ke = function(t, o) {
  var n = "";
  return ht(t, o, function(r, i, s, a, c) {
    n += c;
  }, function(r) {
    n += r;
  }), n;
  ...
  if (typeof n != "number")
    return n;
  var i, s = function(l, u, f) {
    i === void 0 && f + l.length >= n && (i = u + n - f);
  }, a = function(l, u, f, d, g, p, y) {
    i === void 0 && f + g.length > n && (r === "NULL" ? i = null : i = u + (r === "END" ? l.length : 0));
  };
  return ht(t, o, a, s), i === void 0 ? t.length : i;
}, at = function(t, o, n, r) {
  return t.substring(0, o) + r + t.substring(n);
}, eu = function(t, o, n, r) {
  var i = n.selectionStartBefore, s = n.selectionEndBefore, a = n.selectionEndAfter, c = ke(t, r), l = c.length - o.length;
  i === "undefined" && (i = a + l), s === "undefined" && (s = i), i === s && s === a && c.length === o.length && (i = i - 1);
  var u = o.slice(i, a), f = Math.min(i, a), d = s;
  i === a && (d = Math.max(s, i + l));
  var g = ye(t, r, f, "START"), p = ye(t, r, d, "END"), y = ye(t, r, f, "NULL"), v = ye(t, r, d, "NULL"), b = y === null || v === null, _ = at(t, g, p, u);
  if (!b) {
    var S = ke(_, r);
    if (S !== o) {
      for (f = 0; o[f] === S[f]; )
        f++;
      u = o.slice(f, a), d = c.lastIndexOf(o.substring(a)), g = ye(t, r, f, "START"), p = ye(t, r, d, "END"), _ = at(t, g, p, u);
    }
  }
  return _;
}, Cr = function(t, o, n) {
  var r = n, i = !1, s = function(c, l, u, f, d, g, p) {
  ...
  var n = [];
  return ht(t, o, function(r, i, s, a, c, l, u) {
    n.push({
      id: a,
      display: c,
      childIndex: l,
  ...
  var n = st(t, o), r = n[n.length - 1];
  return r ? r.plainTextIndex + r.display.length : 0;
}, nu = function(t) {
  var o = Ot(t), n = t[t.indexOf(Ie.display) + Ie.display.length], r = t[t.indexOf(Ie.id) + Ie.id.length];
  return new RegExp(o.replace(Ie.display, "([^".concat(Ot(n || ""), "]+?)")).replace(Ie.id, "([^".concat(Ot(r || ""), "]+?)")));
}, Ne = function(t) {
  ...
  var n = new RegExp(t.toString() + "|").exec("").length - 1, r = so(o);
  return Ze(n === r, "Number of capturing groups in RegExp ".concat(t.toString(), " (").concat(n, ") does not match the number of placeholders in the markup '").concat(o, "' (").concat(r, ")")), t;
}, ou = function(t, o, n) {
...
function Ar(e) {
  for (var t = 1; t < arguments.length; t++) {
    var o = arguments[t] != null ? arguments[t] : {};
    t % 2 ? Or(Object(o), !0).forEach(function(n) {
      ee(e, n, o[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(o)) : Or(Object(o)).forEach(function(n) {
      Object.defineProperty(e, n, Object.getOwnPropertyDescriptor(o, n));
    });
  }
  return e;
...
function Ht(e, t) {
  var o = function(r) {
    var i = function(c) {
      var l = c.style, u = c.className, f = c.classNames, d = Ta(c, lu), g = t ? t(d) : void 0, p = Dn(e, {
        style: l,
        className: u,
        classNames: f
      }, g);
      return /* @__PURE__ */ oe.createElement(r, Te({}, d, {
        style: p
      }));
...
function co(e) {
  ...
  var c = e.style, l = ge({
    left: void 0,
    top: void 0
  }), u = Pt(l, 2), f = u[0], d = u[1], g = ge(), p = Pt(g, 2), y = p[0], v = p[1];
  Re(function() {
    b();
  });
  var b = function() {
    if (y) {
      var x = y.offsetLeft, I = y.offsetTop;
      if (!(f.left === x && f.top === I)) {
        var T = {
          left: x,
          top: I
  ...
  var A = [], E = {}, P = A, F = 0, m = function(x, I, T) {
    ...
    return /* @__PURE__ */ oe.createElement("span", Te({}, c("substring"), {
      key: I
    }), x);
  }, M = function(x, I, T, w) {
    var D = {
    ...
    return /* @__PURE__ */ oe.createElement("span", Te({}, c("caret"), {
      ref: v,
      key: "caret"
    }), x);
  };
  return ht(r, _, $, m), P.push(" "), P !== A && A.push(q(P)), /* @__PURE__ */ oe.createElement("div", Te({}, c, {
    ref: s
  }), A);
}
co.propTypes = {
  ...
  containerRef: L.oneOfType([L.func, L.shape({
...
function lo(e) {
  var t = e.id, o = e.focused, n = e.ignoreAccents, r = e.index, i = e.onClick, s = e.onMouseEnter, a = e.query, c = e.renderSuggestion, l = e.suggestion, u = e.style;
  ...
  var f = {
    ...
    var b = uo(v, a, n);
    return b === -1 ? /* @__PURE__ */ oe.createElement("span", u("display"), v) : /* @__PURE__ */ oe.createElement("span", u("display"), v.substring(0, b), /* @__PURE__ */ oe.createElement("b", u("highlight"), v.substring(b, b + a.length)), v.substring(b + a.length));
  };
  return /* @__PURE__ */ oe.createElement("li", Te({
    id: t,
    role: "option",
    "aria-selected": o
  }, f, u), d());
...
lo.propTypes = {
  ...
  suggestion: L.oneOfType([L.string, L.shape({
...
function vu(e) {
  var t = e.style, o = e.className, n = e.classNames, r = Dn(yu, {
    style: t,
    className: o,
    classNames: n
  }), i = r("spinner");
...
var yu = {};
function fo(e) {
  var t = e.id, o = e.suggestions, n = o === void 0 ? {} : o, r = e.a11ySuggestionsListLabel, i = e.focusIndex, s = e.position, a = e.left, c = e.right, l = e.top, u = e.scrollFocusedIntoView, f = e.isLoading, d = e.isOpened, g = e.onSelect, p = g === void 0 ? function() {
    return null;
  } : g, y = e.ignoreAccents, v = e.containerRef, b = e.children, _ = e.style, S = e.customSuggestionsContainer, A = e.onMouseDown, E = e.onMouseEnter, P = ge(void 0), F = Pt(P, 2), m = F[0], $ = F[1];
  Re(function() {
    if (!(!m || m.offsetHeight >= m.scrollHeight || !u)) {
      var T = m.scrollTop, w = m.children[i].getBoundingClientRect(), D = w.top, B = w.bottom, C = m.getBoundingClientRect(), R = C.top;
      D = D - R + T, B = B - R + T, D < T ? m.scrollTop = D : B > m.offsetHeight && (m.scrollTop = B - m.offsetHeight);
    }
  }, [i, u, m]);
  var O = function() {
    var w = /* @__PURE__ */ oe.createElement("ul", Te({
      ref: $,
      id: t,
      role: "listbox",
      "aria-label": r
    }, _("list")), Object.values(n).reduce(function(D, B) {
      var C = B.results, R = B.queryInfo;
      return [].concat(wt(D), wt(C.map(function(z, U) {
        return M(z, R, D.length + U);
      })));
    }, []));
    return S ? S(w) : w;
  }, M = function(w, D, B) {
    var C = B === i, R = D.childIndex, z = D.query, U = Ke.toArray(b)[R].props.renderSuggestion;
  ...
  return d ? /* @__PURE__ */ oe.createElement("div", Te({}, za({
    position: s || "absolute",
    left: a,
    right: c,
    top: l
...
function Oe(e) {
  for (var t = 1; t < arguments.length; t++) {
    var o = arguments[t] != null ? arguments[t] : {};
    t % 2 ? Rr(Object(o), !0).forEach(function(n) {
      ee(e, n, o[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(o)) : Rr(Object(o)).forEach(function(n) {
      Object.defineProperty(e, n, Object.getOwnPropertyDescriptor(o, n));
    });
  }
  return e;
...
var Su = function(t) {
  ...
  if (t instanceof RegExp)
    return t;
  var n = o.allowSpaceInQuery, r = Ot(t);
  ...
  onBlur: L.func,
  onChange: L.func,
  suggestionsPortalHost: typeof Element > "u" ? L.any : L.PropTypes.instanceOf(Element),
  ...
  function o(n) {
    var r;
    return ha(this, o), r = t.call(this, n), ee(te(r), "setContainerElement", function(i) {
      r.containerElement = i;
    }), ee(te(r), "getInputProps", function() {
      var i = r.props, s = i.readOnly, a = i.disabled, c = i.style, l = cu(
        r.props,
        ["style", "classNames", "className"],
        // substyle props
        uu(po)
      );
      return Oe(Oe(Oe(Oe({}, l), c("input")), {}, {
        ...
        "aria-activedescendant": ao(r.uuidSuggestionsOverlay, r.state.focusIndex)
      });
      ...
      return /* @__PURE__ */ oe.createElement("input", Te({
        type: "text",
        ref: r.setInputRef
      }, i));
    }), ee(te(r), "renderTextarea", function(i) {
      return /* @__PURE__ */ oe.createElement("textarea", Te({
        ref: r.setInputRef
      }, i));
      ...
      if (!vn(r.state.selectionStart))
        return null;
      var i = r.state.suggestionsPosition, s = i.position, a = i.left, c = i.top, l = i.right, u = /* @__PURE__ */ oe.createElement(Eu, {
      ...
      return r.props.suggestionsPortalHost ? /* @__PURE__ */ Yo.createPortal(u, r.props.suggestionsPortalHost) : u;
    }), ee(te(r), "renderHighlighter", function() {
      var i = r.state, s = i.selectionStart, a = i.selectionEnd, c = r.props, l = c.singleLine, u = c.children, f = c.value, d = c.style;
      ...
      var a = r.props.value || "", c = Ne(r.props.children), l = i.target.value, u = r.state.selectionStart;
      ...
      l = ke(d, c);
      var g = i.target.selectionStart, p = i.target.selectionEnd, y = !1, v = Cr(a, c, g);
      v !== void 0 && r.state.selectionEnd > v && (g = v + (i.nativeEvent.data ? i.nativeEvent.data.length : 0), p = g, y = !0), r.setState({
        selectionStart: g,
        selectionEnd: p,
        setSelectionAfterMentionChange: y
      });
      var b = st(d, c);
      i.nativeEvent.isComposing && g === p && r.updateMentionsQueries(r.inputElement.value, g);
      var _ = {
        target: {
          value: d
        }
      ...
      switch (Object.values(We).indexOf(i.keyCode) >= 0 && (i.preventDefault(), i.stopPropagation()), i.keyCode) {
        case We.ESC: {
          r.clearSuggestions();
          return;
        }
      ...
      var i = r.state, s = i.suggestions, a = i.focusIndex, c = Object.values(s).reduce(function(f, d) {
        var g = d.results, p = d.queryInfo;
        return [].concat(wt(f), wt(g.map(function(y) {
          return {
            result: y,
            queryInfo: p
          };
        })));
      }, [])[a], l = c.result, u = c.queryInfo;
      r.addMention(l, u), r.setState({
        focusIndex: 0
      });
      ...
      var i = r.state.caretPosition, s = r.props, a = s.suggestionsPortalHost, c = s.allowSuggestionsAboveCursor, l = s.forceSuggestionsAboveCursor;
      if (!(!i || !r.suggestionsElement)) {
        var u = r.suggestionsElement, f = r.highlighterElement, d = f.getBoundingClientRect(), g = rn(f, "font-size"), p = {
          left: d.left + i.left,
          top: d.top + i.top + g
        ...
        if (u) {
          ...
          if (a) {
            ...
            b -= rn(u, "margin-left"), _ -= rn(u, "margin-top"), b -= f.scrollLeft, _ -= f.scrollTop;
            var S = Math.max(document.documentElement.clientWidth, window.innerWidth || 0);
            b + u.offsetWidth > S ? v.left = Math.max(0, S - u.offsetWidth) : v.left = b, c && _ + u.offsetHeight > y && u.offsetHeight < _ - g || l ? v.top = Math.max(0, _ - u.offsetHeight - g) : v.top = _;
          } else {
            var A = i.left - f.scrollLeft, E = i.top - f.scrollTop;
            A + u.offsetWidth > r.containerElement.offsetWidth ? v.right = 0 : v.left = A, c && p.top - f.scrollTop + u.offsetHeight > y && u.offsetHeight < d.top - g - f.scrollTop || l ? v.top = E - u.offsetHeight - g : v.top = E;
          }
      ...
      var a = r.props.value || "", c = r.props.children, l = Ne(c), u = ye(a, l, s, "NULL");
      if (u !== null) {
        var f = tu(a.substring(0, u), l), d = i.substring(f, s);
        oe.Children.forEach(c, function(g, p) {
          if (g) {
            var y = Su(g.props.trigger, r.props), v = d.match(y);
            if (v) {
      ...
      var u = r.props, f = u.children, d = u.ignoreAccents, g = Ke.toArray(f)[s], p = Cu(g.props.data, d), y = p(i, r.updateSuggestions.bind(null, r._queryId, s, i, a, c, l));
      y instanceof Array && r.updateSuggestions(r._queryId, s, i, a, c, l, y);
    }), ee(te(r), "updateSuggestions", function(i, s, a, c, l, u, f) {
      if (i === r._queryId) {
        r.suggestions = Oe(Oe({}, r.suggestions), {}, ee({}, s, {
          queryInfo: {
            childIndex: s,
            query: a,
        ...
        var d = r.state.focusIndex, g = _t(r.suggestions);
        r.setState({
      ...
      var a = i.id, c = i.display, l = s.childIndex, u = s.querySequenceStart, f = s.querySequenceEnd, d = s.plainTextValue, g = r.props.value || "", p = Ne(r.props.children), y = Ke.toArray(r.props.children)[l], v = y.props, b = v.markup, _ = v.displayTransform, S = v.appendSpaceOnAdd, A = v.onAdd, E = ye(g, p, u, "START"), P = E + f - u, F = ou(b, a, c);
      S && (F += " ");
      var m = at(g, E, P, F);
      ...
      r.executeOnChange(M, m, Y, q), A && A(a, c, E, P), r.clearSuggestions();
      ...
      return vn(r.state.selectionStart) && (_t(r.state.suggestions) !== 0 || r.isLoading());
  ...
  return ga(o, [{
    ...
    key: "render",
    value: function() {
      return /* @__PURE__ */ oe.createElement("div", Te({
    ...
    value: function(r) {
      if (r.target === this.inputElement && this.supportsClipboardActions(r)) {
        r.preventDefault();
        var i = this.state, s = i.selectionStart, a = i.selectionEnd, c = this.props, l = c.value, u = c.children, f = Ne(u), d = ye(l, f, s, "START"), g = ye(l, f, a, "END"), p = r.clipboardData.getData("text/react-mentions"), y = r.clipboardData.getData("text/plain"), v = at(l, d, g, p || y).replace(/\r/g, ""), b = ke(v, f), _ = {
          target: Oe(Oe({}, r.target), {}, {
            value: v
          })
        };
        this.executeOnChange(_, v, b, st(v, f));
        var S = Cr(l, f, s), A = (S || s) + ke(p || y, f).length;
        this.setState({
          selectionStart: A,
          selectionEnd: A,
    ...
    value: function(r) {
      var i = this.inputElement.selectionStart, s = this.inputElement.selectionEnd, a = this.props, c = a.children, l = a.value, u = Ne(c), f = ye(l, u, i, "START"), d = ye(l, u, s, "END");
      r.clipboardData.setData("text/plain", r.target.value.slice(i, s)), r.clipboardData.setData("text/react-mentions", l.slice(f, d));
    }
  }, {
    ...
    value: function(r) {
      if (r.target === this.inputElement && this.supportsClipboardActions(r)) {
        ...
        var i = this.state, s = i.selectionStart, a = i.selectionEnd, c = this.props, l = c.children, u = c.value, f = Ne(l), d = ye(u, f, s, "START"), g = ye(u, f, a, "END"), p = [u.slice(0, d), u.slice(g)].join(""), y = ke(p, f), v = {
          target: Oe(Oe({}, r.target), {}, {
            value: y
          })
        };
...
var rn = function(t, o) {
...
}, Tu = typeof navigator < "u" && /iPhone|iPad|iPod/i.test(navigator.userAgent), Ou = Ht({
  position: "relative",
  overflowY: "visible",
  input: {
    display: "block",
  ...
  var o = t.display, n = t.style, r = t.className, i = t.classNames, s = Dn(Ru, {
    style: n,
    className: r,
    classNames: i
  });
    ...
    Au,
    {
      ...
      children: /* @__PURE__ */ j.jsx(
        xn,
        {
          ...
          data: n,
          appendSpaceOnAdd: !0,
          renderSuggestion: (a, c) => /* @__PURE__ */ j.jsx("div", { className: `user ${c ? "focused" : ""}`, children: a.display }),
          onAdd: i
        }
      )
    }
  );
}, wu = Iu, xu = ({ comment: e, setComment: t, loading: o }) => {
  const n = le(
    (r) => r.currentUserId ? r.users[r.currentUserId] : null
  );
  return /* @__PURE__ */ j.jsxs("div", { className: je.conversationInputForm, children: [
    /* @__PURE__ */ j.jsx(Xr, { user: n }),
    /* @__PURE__ */ j.jsx(wu, { value: e, setValue: t }),
    /* @__PURE__ */ j.jsx(Ns, { loading: o, color: "primary", children: /* @__PURE__ */ j.jsx(bs, {}) })
  ] });
}, ho = xu, Pu = () => {
  var c;
  const e = le(
    ...
    (l) => l.shareId
  ), o = De(), [n, r] = ge(!1), [i, s] = ge(""), a = async (l) => {
    if (l.stopPropagation(), l.preventDefault(), !(!e || !t)) {
      ...
      o(zr()), r(!1), o(Tn(!0)), o(Hr()), s("");
    }
  };
  return /* @__PURE__ */ j.jsx(yn, { className: je.newConversationForm, children: /* @__PURE__ */ j.jsx(mn, { children: /* @__PURE__ */ j.jsxs("form", { onSubmit: a, children: [
    /* @__PURE__ */ j.jsx("h4", { children: "Add comment" }),
    (c = e == null ? void 0 : e.meta) != null && c.highlight ? /* @__PURE__ */ j.jsx("div", { className: je.highlightText, children: e.meta.highlight }) : null,
    /* @__PURE__ */ j.jsx(
      ho,
      {
        comment: i,
...
(function(e, t) {
  (function(o, n) {
    ...
    var o = 1e3, n = 6e4, r = 36e5, i = "millisecond", s = "second", a = "minute", c = "hour", l = "day", u = "week", f = "month", d = "quarter", g = "year", p = "date", y = "Invalid Date", v = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, b = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, _ = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(x) {
      var I = ["th", "st", "nd", "rd"], T = x % 100;
      return "[" + x + (I[(T - 20) % 10] || I[T] || I[0]) + "]";
    } }, S = function(x, I, T) {
      var w = String(x);
      return !w || w.length >= I ? x : "" + Array(I + 1 - w.length).join(T) + x;
    }, A = { s: S, z: function(x) {
      var I = -x.utcOffset(), T = Math.abs(I), w = Math.floor(T / 60), D = T % 60;
      return (I <= 0 ? "+" : "-") + S(w, 2, "0") + ":" + S(D, 2, "0");
    }, m: function x(I, T) {
      if (I.date() < T.date())
        return -x(T, I);
      var w = 12 * (T.year() - I.year()) + (T.month() - I.month()), D = I.clone().add(w, f), B = T - D < 0, C = I.clone().add(w + (B ? -1 : 1), f);
      return +(-(w + (T - D) / (B ? D - C : C - D)) || 0);
    }, a: function(x) {
      return x < 0 ? Math.ceil(x) || 0 : Math.floor(x);
    }, p: function(x) {
      return { M: f, y: g, w: u, d: l, D: p, h: c, m: a, s, ms: i, Q: d }[x] || String(x || "").toLowerCase().replace(/s$/, "");
    }, u: function(x) {
      return x === void 0;
    } }, E = "en", P = {};
    P[E] = _;
    var F = "$isDayjsObject", m = function(x) {
    ...
    M.l = $, M.i = m, M.w = function(x, I) {
      return O(x, { locale: I.$L, utc: I.$u, x: I.$x, $offset: I.$offset });
    };
    var q = function() {
      function x(T) {
        this.$L = $(T.locale, null, !0), this.parse(T), this.$x = this.$x || T.x || {}, this[F] = !0;
      }
      var I = x.prototype;
      return I.parse = function(T) {
        this.$d = function(w) {
          ...
          if (typeof D == "string" && !/Z$/i.test(D)) {
            var C = D.match(v);
            if (C) {
              var R = C[2] - 1 || 0, z = (C[7] || "0").substring(0, 3);
              return B ? new Date(Date.UTC(C[1], R, C[3] || 1, C[4] || 0, C[5] || 0, C[6] || 0, z)) : new Date(C[1], R, C[3] || 1, C[4] || 0, C[5] || 0, C[6] || 0, z);
            }
          }
          return new Date(D);
        }(T), this.init();
        ...
        var D = this, B = !!M.u(w) || w, C = M.p(T), R = function(Q, W) {
          var ce = M.w(D.$u ? Date.UTC(D.$y, W, Q) : new Date(D.$y, W, Q), D);
          return B ? ce : ce.endOf(l);
        }, z = function(Q, W) {
          return M.w(D.toDate()[Q].apply(D.toDate("s"), (B ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(W)), D);
        }, U = this.$W, V = this.$M, X = this.$D, K = "set" + (this.$u ? "UTC" : "");
        switch (C) {
          case g:
          ...
          case u:
            var G = this.$locale().weekStart || 0, J = (U < G ? U + 7 : U) - G;
        ...
        var D, B = M.p(T), C = "set" + (this.$u ? "UTC" : ""), R = (D = {}, D[l] = C + "Date", D[p] = C + "Date", D[f] = C + "Month", D[g] = C + "FullYear", D[c] = C + "Hours", D[a] = C + "Minutes", D[s] = C + "Seconds", D[i] = C + "Milliseconds", D)[B], z = B === l ? this.$D + (w - this.$W) : w;
        if (B === f || B === g) {
          var U = this.clone().set(p, 1);
          U.$d[R](z), U.init(), this.$d = U.set(p, Math.min(this.$D, U.daysInMonth())).$d;
        } else
          R && this.$d[R](z);
        ...
        if (C === u)
          return R(7);
        var z = (D = {}, D[a] = n, D[c] = r, D[s] = o, D)[C] || 1, U = this.$d.getTime() + T * z;
        return M.w(U, this);
        ...
        if (!this.isValid())
          return D.invalidDate || y;
        var B = T || "YYYY-MM-DDTHH:mm:ssZ", C = M.z(this), R = this.$H, z = this.$m, U = this.$M, V = D.weekdays, X = D.months, K = D.meridiem, G = function(W, ce, k, he) {
        ...
        var B, C = this, R = M.p(w), z = O(T), U = (z.utcOffset() - this.utcOffset()) * n, V = this - z, X = function() {
          return M.m(C, z);
        };
        switch (R) {
          case g:
    ...
    return O.prototype = Y, [["$ms", i], ["$s", s], ["$m", a], ["$H", c], ["$W", l], ["$M", f], ["$y", g], ["$D", p]].forEach(function(x) {
      Y[x[1]] = function(I) {
        return this.$g(I, x[0], x[1]);
      };
    }), O.extend = function(x, I) {
      return x.$i || (x(I, q, O), x.$i = !0), O;
    }, O.locale = $, O.isDayjs = m, O.unix = function(x) {
      return O(1e3 * x);
    }, O.en = P[E], O.Ls = P, O.p = {}, O;
  });
})(go);
var Fu = go.exports;
const ju = /* @__PURE__ */ Ft(Fu), Mu = ({
  conversationGroupId: e
}) => {
  const t = le((s) => s.shareId), o = De(), [n, r] = ge(!1), i = async () => {
    e && (r(!0), await Us(t, e), o(Yi({ conversationGroupId: e, shareId: t })), r(!1));
  };
  ...
  showResolveButton: o,
  conversationGroupId: n
}) => /* @__PURE__ */ j.jsxs(Wo, { className: "d-flex align-items-center justify-content-between mb-0", children: [
  /* @__PURE__ */ j.jsxs("div", { className: "d-flex align-items-center gap-1", children: [
    ...
    /* @__PURE__ */ j.jsx("span", { children: ju(t).format("HH:mm, DD MMM YY") })
  ] }),
  o ? /* @__PURE__ */ j.jsx($u, { conversationGroupId: n }) : null
] }), vo = Lu, ku = ({ conversation: e }) => {
  const t = le((o) => {
    var n;
    return (n = o.users) == null ? void 0 : n[e == null ? void 0 : e.user_id];
  });
  return /* @__PURE__ */ j.jsxs(yn, { children: [
    /* @__PURE__ */ j.jsx(vo, { user: t, timestamp: e.timestamp }),
    /* @__PURE__ */ j.jsx(mn, { children: /* @__PURE__ */ j.jsx("p", { children: e.message.replace(/@\[(.*?)\]\(\w+\)/g, "@$1") }) })
  ] });
}, Bu = ku, Hu = ({ conversationGroupId: e }) => {
  const t = le(
    (c) => c.shareId
  ...
  return /* @__PURE__ */ j.jsx("div", { className: je.replyForm, children: /* @__PURE__ */ j.jsx("form", { onSubmit: a, className: "", children: /* @__PURE__ */ j.jsx(
    ho,
    {
      comment: o,
      setComment: n,
...
}, zu = Hu, Uu = ({ conversationGroup: e }) => {
  var f;
  const t = Ae(null), o = le((d) => {
    var g;
  ...
  if (Re(() => {
    var d;
    n && ((d = t.current) == null || d.scrollIntoView({
      behavior: "smooth",
      block: "center"
    }));
  }, [n]), !((f = e == null ? void 0 : e.conversations) != null && f.length) || (e == null ? void 0 : e.status) !== "Pending")
    return null;
  const a = () => {
    r(
      Cn(e.conversation_group_id)
    );
  }, [c, ...l] = e.conversations, u = l.length ? l.length > 1 ? `${l.length} replies` : `${l.length} reply` : "Reply";
  return /* @__PURE__ */ j.jsxs(
    yn,
    {
      className: `${je.conversationGroup} ${n === e.conversation_group_id ? "active" : ""}`,
      onClick: a,
      ref: t,
      children: [
        /* @__PURE__ */ j.jsx(
        ...
        /* @__PURE__ */ j.jsxs(mn, { children: [
          /* @__PURE__ */ j.jsx("p", { children: c.message.replace(/@\[(.*?)\]\(\w+\)/g, "@$1") }),
          /* @__PURE__ */ j.jsx(Nt, { onClick: () => s((d) => !d), color: "link", children: u }),
          l.length ? /* @__PURE__ */ j.jsx(j.Fragment, { children: i ? /* @__PURE__ */ j.jsx(j.Fragment, { children: l.map((d) => /* @__PURE__ */ j.jsx(Bu, { conversation: d }, d.conversation_id)) }) : null }) : null,
          i ? /* @__PURE__ */ j.jsx(
            zu,
            {
              conversationGroupId: e.conversation_group_id
  ...
  return !e || !Object.keys(e).length ? /* @__PURE__ */ j.jsx("div", { children: "No conversations yet!" }) : /* @__PURE__ */ j.jsx("div", { children: Object.values(e).map((t) => /* @__PURE__ */ j.jsx(
    Vu,
    {
      conversationGroup: t
    },
  ...
  return !!o || e || t ? /* @__PURE__ */ j.jsxs(j.Fragment, { children: [
    /* @__PURE__ */ j.jsx(
      qo,
      {
        onClick: r,
    ...
    /* @__PURE__ */ j.jsxs("div", { className: je.conversationRightPanel, children: [
      /* @__PURE__ */ j.jsx("h3", { children: "Comments" }),
      o ? /* @__PURE__ */ j.jsx(Nu, {}) : /* @__PURE__ */ j.jsx(qu, {})
    ] })
  ] }) : null;
}, Ku = Yu, Gu = () => {
  const e = le(
    ...
    (r) => r.conversationsLoadingState
  ), o = De(), n = le(
    (r) => Object.keys(r.conversations || {})
  );
  return Re(() => {
    t !== Ce.UNINITIALIZED || !e || (o(or(Ce.LOADING)), Hs(e).then((r) => {
      console.log("useConversations", r), o(Wi(r == null ? void 0 : r.dbt_docs_share_conversations));
    }).catch(
      (r) => console.error("error while fetching conversations list", r)
    ).finally(() => {
      o(or(Ce.INITIALIZED));
    }));
  }, [o, t, n, e]), { isLoading: t === Ce.LOADING };
}, Xu = () => {
  const e = De(), t = le(
    (r) => Object.keys(r.users || {})
  ), [o, n] = ge(Ce.UNINITIALIZED);
  return Re(() => {
    o !== Ce.UNINITIALIZED || Object.keys(t).length || (n(Ce.LOADING), zs().then((r) => {
      console.log("useConversationUsers", r), e(Vi(r));
    }).catch((r) => console.error("error while fetching users list", r)).finally(() => {
      n(Ce.INITIALIZED);
    }));
  }, [e, o, t]), { isLoading: o === Ce.LOADING };
}, Zu = () => (Xu(), Gu(), /* @__PURE__ */ j.jsxs("div", { children: [
  /* @__PURE__ */ j.jsx(Ku, {}),
  /* @__PURE__ */ j.jsx(Js, {})
] })), Ju = Zu, Qu = zo(() => import("./DbtDocsRenderer.js")), ec = () => {
  const { loading: e, shareDetails: t } = Vs(), o = De(), { getHighlightedSelectionData: n, pos: r, onSelectionEnd: i } = Ks(), s = () => {
    const a = n();
    a && o(qi(a));
  };
  return e ? /* @__PURE__ */ j.jsx("div", { children: "Loading..." }) : !(t != null && t.catalog_presigned_url) || !(t != null && t.manifest_presigned_url) ? /* @__PURE__ */ j.jsx("div", { children: "Unable to load required artifacts. Please try again." }) : /* @__PURE__ */ j.jsxs("div", { children: [
    /* @__PURE__ */ j.jsx("div", { className: "d-flex justify-content-end mb-2", children: /* @__PURE__ */ j.jsx($s, {}) }),
    /* @__PURE__ */ j.jsx(Ju, {}),
    /* @__PURE__ */ j.jsx(
      Qu,
      {
    ...
    r ? /* @__PURE__ */ j.jsx(js, { pos: r, onAddComment: s }) : null
  ] });
}, tc = ec, nc = ({ shareId: e, userId: t, conversationGroupId: o, source: n }) => /* @__PURE__ */ j.jsx("div", { className: "altimate-component", children: /* @__PURE__ */ j.jsx(
  Gi,
  {
    shareId: e,
    userId: t,
