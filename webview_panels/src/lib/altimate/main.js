...
import oe, { createContext as Qe, useReducer as zo, useCallback as Ke, useMemo as lt, useContext as et, useLayoutEffect as Vo, useEffect as Re, useRef as Te, useState as ge, useId as xr, useInsertionEffect as qo, cloneElement as Wo, Children as Ge, isValidElement as Nr, Component as Yo, createElement as Kn, lazy as Ko } from "react";
import { Tooltip as Go, Button as Pt, Spinner as Xo, Card as Ft, CardTitle as jr, CardBody as Mt, CloseButton as Zo } from "reactstrap";
...
function ti() {
  return Xn || (Xn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var R = !1, E = !1, x = !1, F = !1, y = !1, B;
    B = Symbol.for("react.module.reference");
    function O(g) {
      return !!(typeof g == "string" || typeof g == "function" || g === n || g === i || y || g === r || g === f || g === u || F || g === h || R || E || x || typeof g == "object" && g !== null && (g.$$typeof === d || g.$$typeof === l || g.$$typeof === s || g.$$typeof === a || g.$$typeof === c || // This needs to include all possible module reference object
    ...
    var N = Object.assign, I = 0, T, w, D, L, C, A, U;
    function z() {
    }
    ...
    function V() {
      {
        if (I === 0) {
          T = console.log, w = console.info, D = console.warn, L = console.error, C = console.group, A = console.groupCollapsed, U = console.groupEnd;
          var g = {
            configurable: !0,
            enumerable: !0,
            value: z,
    ...
    var W = _.ReactCurrentDispatcher, Y;
    function J(g, j, H) {
      {
        if (Y === void 0)
          try {
...
` + ne[fe].replace(" at new ", " at ");
      ...
      var ze = g ? g.displayName || g.name : "", Yn = ze ? J(ze) : "";
    ...
    var vt = Object.prototype.hasOwnProperty, Fn = {}, Mn = _.ReactDebugCurrentFrame;
    function mt(g) {
      if (g) {
    ...
    function kn(g) {
      if (Ro(g))
        return b("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Oo(g)), $n(g);
    }
    var ot = _.ReactCurrentOwner, Ao = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function wo(g, j) {
      if (typeof g.ref == "string" && ot.current && j && ot.current.stateNode !== j) {
        ...
        qt[H] || (b('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', X(ot.current.type), g.ref), qt[H] = !0);
      }
    }
    function xo(g, j) {
      {
        var H = function() {
          Ln || (Ln = !0, b("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", j));
        };
    ...
    function No(g, j) {
      {
        var H = function() {
          Bn || (Bn = !0, b("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", j));
        };
    ...
    function Po(g, j, H, Z, ie) {
      {
        ...
        H !== void 0 && (kn(H), ne = "" + H), Io(j) && (kn(j.key), ne = "" + j.key), Do(j) && (ve = j.ref, wo(j, ie));
        for (ue in j)
    ...
    var Wt = _.ReactCurrentOwner, Hn = _.ReactDebugCurrentFrame;
    function Ue(g) {
      if (g) {
        var j = g._owner, H = Me(g.type, g._source, j ? j.type : null);
    ...
    function Vn(g, j) {
      {
        ...
        zn[H] = !0;
        var Z = "";
        g && g._owner && g._owner !== Wt.current && (Z = " It was passed a child from " + X(g._owner.type) + "."), Ue(g), b('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', H, Z), Ue(null);
      }
    }
    function qn(g, j) {
      {
    ...
    function Wn(g, j, H, Z, ie, ue) {
      {
        ...
        if (!re) {
          ...
          ve ? ne += ve : ne += Un();
          var fe;
          g === null ? fe = "null" : Vt(g) ? fe = "array" : g !== void 0 && g.$$typeof === t ? (fe = "<" + (X(g.type) || "Unknown") + " />", ne = " Did you accidentally export a JSX literal instead of a component?") : fe = typeof g, b("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", fe, ne);
        }
...
process.env.NODE_ENV === "production" ? un.exports = ei() : un.exports = ti();
var P = un.exports;
const ni = () => {
  var t, o, n;
...
var Fr = Symbol.for("immer-nothing"), Zn = Symbol.for("immer-draftable"), be = Symbol.for("immer-state"), ii = process.env.NODE_ENV !== "production" ? [
...
function ye(e, ...t) {
  if (process.env.NODE_ENV !== "production") {
    const o = ii[e], n = typeof o == "function" ? o.apply(null, t) : o;
...
function Ne(e) {
  var t;
  return e ? Mr(e) || Array.isArray(e) || !!e[Zn] || !!((t = e.constructor) != null && t[Zn]) || kt(e) || Lt(e) : !1;
}
...
function Mr(e) {
  ...
  return o === Object ? !0 : typeof o == "function" && Function.toString.call(o) === si;
}
function At(e, t) {
...
function _n(e, t = !1) {
  return Bt(e) || Pe(e) || !Ne(e) || ($t(e) > 1 && (e.set = e.add = e.clear = e.delete = ui), Object.freeze(e), t && Object.entries(e).forEach(([o, n]) => _n(n, !0))), e;
}
function ui() {
  ye(2);
}
...
function er(e, t) {
  ...
  const o = t.drafts_[0];
  return e !== void 0 && e !== o ? (o[be].modified_ && (fn(t), ye(4)), Ne(e) && (e = Dt(t, e), t.parent_ || It(t, e)), t.patches_ && Be("Patches").generateReplacementPatches_(
    o[be].base_,
    e,
    t.patches_,
    t.inversePatches_
  )) : e = Dt(t, o, []), fn(t), t.patches_ && t.patchListener_(t.patches_, t.inversePatches_), e !== Fr ? e : void 0;
}
function Dt(e, t, o) {
  if (Bt(t))
    return t;
  ...
  if (!n.finalized_) {
    ...
    n.type_ === 3 && (i = new Set(r), r.clear(), s = !0), At(
      i,
      (a, c) => tr(e, n, r, a, c, o, s)
    ), It(e, r, !1), o && e.patches_ && Be("Patches").generatePatches_(
      n,
      o,
      e.patches_,
      e.inversePatches_
...
var Sn = {
  ...
  set(e, t, o) {
    ...
    if (!e.modified_) {
      ...
      if (ai(o, r) && (o !== void 0 || cn(e.base_, t)))
        return !0;
      Xt(e), pn(e);
    }
  ...
  constructor(e) {
    this.autoFreeze_ = !0, this.useStrictShallowCopy_ = !1, this.produce = (t, o, n) => {
      ...
      if (Ne(t)) {
        ...
        if (r = o(t), r === void 0 && (r = t), r === Fr && (r = void 0), this.autoFreeze_ && _n(r, !0), n) {
          const i = [], s = [];
...
function hn(e, t) {
  const o = kt(e) ? Be("MapSet").proxyMap_(e, t) : Lt(e) ? Be("MapSet").proxySet_(e, t) : di(e, t);
...
function bi(e, t = "expected all items to be functions, instead received the following types: ") {
...
}, Ti = typeof WeakRef < "u" ? WeakRef : Ci, Oi = 0, or = 1;
function yt() {
  return {
    s: Oi,
    v: void 0,
...
function Cn(e, t = {}) {
  ...
  function s() {
    ...
    const f = a;
    let u;
    if (a.s === or ? u = a.v : (u = e.apply(null, arguments), i++), f.s = or, n) {
      const d = ((l = r == null ? void 0 : r.deref) == null ? void 0 : l.call(r)) ?? r;
      d != null && n(d, u) && (u = d, i !== 0 && i--), r = typeof u == "object" && u !== null || typeof u == "function" ? new Ti(u) : u;
    }
    return f.v = u, u;
  }
  return s.clearCache = () => {
...
function zr(e, ...t) {
  const o = typeof e == "function" ? {
    ...
    typeof f == "object" && (c = f, f = r.pop()), yi(
      f,
    ...
    const u = {
      ...
      devModeChecks: m = {}
    } = u, v = nr(d), _ = nr(p), b = _i(r), S = l(function() {
      return i++, f.apply(
        null,
        arguments
      );
    ...
    const E = h(function() {
      ...
      if (a = S.apply(null, F), process.env.NODE_ENV !== "production") {
        const { identityFunctionCheck: y, inputStabilityCheck: B } = Si(R, m);
...
var Ri = /* @__PURE__ */ zr(Cn), Ai = Object.assign(
  (e, t = Ri) => {
    Ei(
      e,
  ...
  const t = zr(...e), o = Object.assign((...n) => {
    const r = t(...n), i = (s, ...a) => r(Pe(s) ? Br(s) : s, ...a);
...
function Ze(e, t) {
  ...
  return o.toString = () => `${e}`, o.type = e, o.match = (n) => oi(n) && n.type === e, o;
}
function ir(e) {
  return Ne(e) ? Ur(e, () => {
  }) : e;
...
var xi = "ModuleSymbhasOwnPr-0123456789ABCDEFGHNRVfgctiUvz_KqYTJkLxpZXIjQW", Ni = (e = 21) => {
  let t = "", o = e;
  for (; o--; )
...
function Fi({
  ...
  return function(r) {
    ...
    const a = (typeof r.reducers == "function" ? r.reducers(ki()) : r.reducers) || {}, c = Object.keys(a), f = {
    ...
    function l() {
      ...
      const [S = {}, R = [], E = void 0] = typeof r.extraReducers == "function" ? Vr(r.extraReducers) : [r.extraReducers], x = {
        ...S,
...
const Ki = {
  ...
  isStatic: !1,
  reducedMotion: "never"
}), os = Qe(null), is = typeof document < "u", Wr = is ? Vo : Re;
class ur {
  constructor() {
...
function ss(e) {
  let t = new ur(), o = new ur(), n = 0, r = !1, i = !1;
...
function us(e, t) {
  ...
  const r = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, i = bt.reduce((l, d) => (l[d] = ss(() => o = !0), l), {}), s = (l) => {
    i[l].process(r);
  }, a = () => {
    const l = performance.now();
    o = !1, r.delta = n ? 1e3 / 60 : Math.max(Math.min(l - r.timestamp, as), 1), r.timestamp = l, r.isProcessing = !0, bt.forEach(s), r.isProcessing = !1, o && t && (n = !1, e(a));
  }, c = () => {
...
const fs = (e) => e, { schedule: ds, cancel: $c, state: kc, steps: Lc } = us(typeof requestAnimationFrame < "u" ? requestAnimationFrame : fs, !0);
function Yr() {
  const e = Te(!1);
...
function gs({ children: e, isPresent: t }) {
  ...
  }, [t]), Ee.createElement(hs, { isPresent: t, childRef: n, sizeRef: r }, Ee.cloneElement(e, { ref: n }));
}
const Zt = ({ children: e, initial: t, isPresent: o, onExitComplete: n, custom: r, presenceAffectsLayout: i, mode: s }) => {
  const a = ls(vs), c = xr(), f = lt(
    () => ({
      id: c,
      initial: t,
      isPresent: o,
  ...
  return lt(() => {
    ...
    !o && !a.size && n && n();
  }, [o]), s === "popLayout" && (e = Ee.createElement(gs, { isPresent: o }, e)), Ee.createElement(os.Provider, { value: f }, e);
};
function vs() {
...
const bs = ({ children: e, custom: t, initial: o = !0, onExitComplete: n, exitBeforeEnter: r, presenceAffectsLayout: i = !0, mode: s = "sync" }) => {
  const a = et(cs).forceRender || ps()[0], c = Yr(), f = Es(e);
  let u = f;
  ...
  return s === "wait" && l.size && (u = []), l.forEach((b, S) => {
    ...
    if (!x) {
      const F = () => {
        ...
        if (y.forEach((B) => h.delete(B)), d.current = f.filter((B) => {
          const O = ke(B);
          return (
  ...
  }), process.env.NODE_ENV !== "production" && s === "wait" && u.length > 1 && console.warn(`You're attempting to animate multiple children within AnimatePresence, but its mode is set to "wait". This will lead to odd visual behaviour.`), Ee.createElement(Ee.Fragment, null, l.size ? u : u.map((b) => Wo(b)));
}, Ut = "altimate-display-", _s = `${Ut}-highlight`, cr = `${Ut}-highlight-hover`, Ss = `${Ut}-active-highlight`, Cs = 1049, Dn = ({
  icon: e,
  className: t = "",
  ...o
}) => /* @__PURE__ */ P.jsx("i", { className: `${t} codicon codicon-${e}`, ...o }), Ts = (e) => /* @__PURE__ */ P.jsx(Dn, { icon: "comment", ...e }), Os = (e) => /* @__PURE__ */ P.jsx(Dn, { icon: "check", ...e }), Rs = (e) => /* @__PURE__ */ P.jsx(Dn, { icon: "send", ...e }), As = "_iconButton_eti7u_1", Ds = {
  iconButton: As
}, Is = (e) => /* @__PURE__ */ P.jsx(Fs, { title: e.title, children: /* @__PURE__ */ P.jsx(
  "button",
  {
    ...e,
    className: `btn ${e.color ? `btn-${e.color}` : ""} ${e.className ?? ""} ${Ds.iconButton}`,
    type: e.type ?? "button",
    children: e.children
  }
) }), ws = Is, xs = Qe(null), Jt = {
...
const Ps = (e) => {
  ...
  return /* @__PURE__ */ P.jsxs(Ns, { fallback: /* @__PURE__ */ P.jsx("span", { id: r.current, children: e.children }), children: [
...
}, Fs = Ps, Ms = "_loadingBtn_gadec_1", $s = {
  loadingBtn: Ms
}, ks = ({ loading: e, ...t }) => /* @__PURE__ */ P.jsx(
  Pt,
  {
    ...t,
...
function Hs(e) {
  ...
  function _(b, { exceptions: S, when: R } = {}) {
    const E = R;
    return S = S || [], b.map((x) => x.match(/\|\d+$/) || S.includes(x) ? x : E(x) ? `${x}|0` : x);
  }
  return {
    name: "SQL",
    case_insensitive: !0,
...
}, Xs = "_codeblock_1dekk_1", Zs = {
  codeblock: Xs
};
bn.registerLanguage("javascript", zs);
bn.registerLanguage("javascript", Ws);
const Js = { vs: Gs, solarizedDark: Ys, solarizedLight: Ks }, Qs = ({
  code: e,
  language: t,
  fileName: o,
  theme: n = "vs",
  showLineNumbers: r
}) => /* @__PURE__ */ P.jsxs(Ft, { className: Zs.codeblock, children: [
...
] }), ea = Qs, ta = ({ pos: e, onAddComment: t }) => Pr(
  /* @__PURE__ */ P.jsx(bs, { children: e && /* @__PURE__ */ P.jsx(
    Pt,
    {
      onClick: t,
      id: `${Ut}-highlight`,
  ...
  get: async (e, t, o) => ({}),
  post: async (e, t, o) => ({})
}, ia = (e) => nt.get(`dbt/dbt_docs_share/${e}`), sa = (e, t) => nt.post(`dbt/dbt_docs_share/${e}/conversation_group`, t), aa = (e, t, o) => nt.post(
  `dbt/dbt_docs_share/${e}/conversation_group/${t}/conversation`,
  o
), ua = (e) => nt.get(`dbt/dbt_docs_share/${e}/conversations`), ca = (e) => nt.get("/users/chat", { company: e }), la = (e, t) => nt.post(
  ...
  Re(() => {
    t != null && t.manifest_presigned_url && fetch(t.manifest_presigned_url).then((a) => a.json()).then((a) => {
      i(Qi(a));
    }).catch(
      (a) => console.error(
...
`;
      ...
      var i, s = this && this.__extends || (i = function(E, x) {
        ...
        i(E, x), E.prototype = x === null ? Object.create(x) : (F.prototype = x.prototype, new F());
      }), a = this && this.__assign || function() {
        return (a = Object.assign || function(E) {
          for (var x, F = 1, y = arguments.length; F < y; F++)
            for (var B in x = arguments[F])
              Object.prototype.hasOwnProperty.call(x, B) && (E[B] = x[B]);
          return E;
      ...
      Object.defineProperty(n, "__esModule", { value: !0 });
      var f = c(r(2)), u = c(r(5)), l = c(r(3)), d = c(r(6)), h = c(r(13)), p = c(r(14)), m = c(r(16)), v = c(r(17)), _ = r(0), b = r(1), S = r(4), R = function(E) {
        function x(F) {
          ...
          y.event = p.default(), y.run = function() {
            ...
            y.options = a(a({}, y.options), O), y.painter = new v.default({ $root: y.options.$root, wrapTag: y.options.wrapTag, className: y.options.style.className, exceptSelectors: y.options.exceptSelectors }, y.hooks);
          }, y.fromRange = function(O) {
            var M = { $node: O.startContainer, offset: O.startOffset }, K = { $node: O.endContainer, offset: O.endOffset }, X = O.toString(), N = y.hooks.Render.UUID.call(M, K, X);
            N = N ?? d.default();
            var I = new u.default(M, K, X, N);
            return I ? y._highlightFromHRange(I) : (_.eventEmitter.emit(_.INTERNAL_ERROR_EVENT, { type: b.ERROR.RANGE_INVALID }), null);
          }, y.fromStore = function(O, M, K, X, N) {
            var I = new l.default(O, M, K, X, N);
            try {
              return y._highlightFromHSource(I), I;
            } catch (T) {
              return _.eventEmitter.emit(_.INTERNAL_ERROR_EVENT, { type: b.ERROR.HIGHLIGHT_SOURCE_RECREATE, error: T, detail: I }), null;
            }
            ...
            return y.painter.highlightRange(O).length === 0 ? (_.eventEmitter.emit(_.INTERNAL_ERROR_EVENT, { type: b.ERROR.DOM_SELECTION_EMPTY }), null) : (y.cache.save(M), y.emit(b.EventType.CREATE, { sources: [M], type: b.CreateFrom.INPUT }, y), M);
            ...
            if (!S.isHighlightWrapNode(M))
              return y._hoverId && y.emit(b.EventType.HOVER_OUT, { id: y._hoverId }, y, O), void (y._hoverId = null);
            var K = S.getHighlightId(M, y.options.$root);
            y._hoverId !== K && (y._hoverId && y.emit(b.EventType.HOVER_OUT, { id: y._hoverId }, y, O), y._hoverId = K, y.emit(b.EventType.HOVER, { id: y._hoverId }, y, O));
          ...
          }, y.options = _.getDefaultOptions(), y.hooks = y._getHooks(), y.setOption(F), y.cache = new m.default();
          var B = y.options.$root;
          return S.addEventListener(B, y.event.PointerOver, y._handleHighlightHover), S.addEventListener(B, y.event.PointerTap, y._handleHighlightClick), _.eventEmitter.on(_.INTERNAL_ERROR_EVENT, y._handleError), y;
        }
        return s(x, E), x.prototype.remove = function(F) {
          if (F) {
            var y = this.painter.removeHighlight(F);
            this.cache.remove(F), y && this.emit(b.EventType.REMOVE, { ids: [F] }, this);
          }
          ...
          this.emit(b.EventType.CREATE, { sources: y, type: b.CreateFrom.STORE }, this), this.cache.save(F);
      ...
      var f = c(r(3)), u = r(18), l = r(4), d = r(1), h = r(20), p = r(0), m = function() {
        ...
        return v.prototype.highlightRange = function(_) {
          ...
          var S = this.options, R = S.$root, E = S.className, x = S.exceptSelectors, F = this.hooks, y = u.getSelectedNodes(R, _.start, _.end, x);
          return F.Render.SelectedNodes.isEmpty() || (y = F.Render.SelectedNodes.call(_.id, y) || []), y.map(function(B) {
          ...
          return S.forEach(function(E) {
            if (E instanceof f.default) {
              ...
              b.highlightRange(x).length > 0 ? R.push(E) : p.eventEmitter.emit(p.INTERNAL_ERROR_EVENT, { type: d.ERROR.HIGHLIGHT_SOURCE_NONE_RENDER, detail: E });
            } else
              p.eventEmitter.emit(p.INTERNAL_ERROR_EVENT, { type: d.ERROR.SOURCE_TYPE_ERROR });
          }), R;
        }, v.prototype.removeHighlight = function(_) {
          var b, S, R = new RegExp("(" + _ + "\\" + p.ID_DIVISION + "|\\" + p.ID_DIVISION + "?" + _ + "$)"), E = this.hooks, x = this.options.wrapTag, F = document.querySelectorAll(x + "[data-" + p.DATASET_IDENTIFIER + "]"), y = [], B = [], O = [];
          try {
            for (var M = i(F), K = M.next(); !K.done; K = M.next()) {
              var X = K.value, N = X.dataset[p.CAMEL_DATASET_IDENTIFIER], I = X.dataset[p.CAMEL_DATASET_IDENTIFIER_EXTRA];
              N !== _ || I ? N === _ ? B.push(X) : N !== _ && R.test(I) && O.push(X) : y.push(X);
            }
          } catch (T) {
            b = { error: T };
          } finally {
          ...
          return y.forEach(function(T) {
            ...
            w.replaceChild(D, T), u.normalizeSiblingText(L, !0), u.normalizeSiblingText(C, !1), E.Remove.UpdateNodes.call(_, T, "remove");
          }), B.forEach(function(T) {
            var w = T.dataset, D = w[p.CAMEL_DATASET_IDENTIFIER_EXTRA].split(p.ID_DIVISION), L = D.shift(), C = document.querySelector(x + "[data-" + p.DATASET_IDENTIFIER + '="' + L + '"]');
            C && (l.removeAllClass(T), l.addClass(T, a(C.classList))), w[p.CAMEL_DATASET_IDENTIFIER] = L, w[p.CAMEL_DATASET_IDENTIFIER_EXTRA] = D.join(p.ID_DIVISION), E.Remove.UpdateNodes.call(_, T, "id-update");
          }), O.forEach(function(T) {
            var w = T.dataset[p.CAMEL_DATASET_IDENTIFIER_EXTRA];
            T.dataset[p.CAMEL_DATASET_IDENTIFIER_EXTRA] = w.replace(R, ""), E.Remove.UpdateNodes.call(_, T, "extra-update");
          ...
          l.getHighlightsByRoot(S, b).forEach(function(R) {
            var E = R.parentNode, x = document.createDocumentFragment();
      ...
      n.getSelectedNodes = function(p, m, v, _) {
        var b = m.$node, S = v.$node, R = m.offset, E = v.offset;
        if (b === S && b instanceof Text)
          return function(N, I, T, w) {
            for (var D = N, L = function(A) {
              return w == null ? void 0 : w.some(function(U) {
                return l(A, U);
              });
            }; D; ) {
              if (D.nodeType === 1 && L(D))
        ...
        for (var x = [p], F = [], y = function(N) {
          return _ == null ? void 0 : _.some(function(I) {
            return l(N, I);
          });
        }, B = !1, O = null; O = x.pop(); )
          if (O.nodeType !== 1 || !y(O)) {
            ...
            if (O === b) {
              if (O.nodeType === 3) {
                O.splitText(R);
                var X = O.nextSibling;
                F.push({ $node: X, type: a.SelectedNodeType.text, splitType: a.SplitType.head });
              }
              B = !0;
            } else {
              if (O === S) {
                O.nodeType === 3 && ((X = O).splitText(E), F.push({ $node: X, type: a.SelectedNodeType.text, splitType: a.SplitType.tail }));
                break;
              }
      ...
      n.wrapHighlight = function(p, m, v, _) {
        ...
        return c.isHighlightWrapNode(b) ? !c.isHighlightWrapNode(b) || h(S) && h(R) ? function(E, x, F) {
          var y = E.$node.parentNode, B = y;
          c.removeAllClass(B), d(B, F);
          var O = y.dataset, M = O[f.CAMEL_DATASET_IDENTIFIER];
        ...
        }(p, m, v) : function(E, x, F, y) {
          var B = document.createElement(y), O = E.$node.parentNode, M = E.$node.previousSibling, K = E.$node.nextSibling, X = document.createDocumentFragment(), N = O.dataset[f.CAMEL_DATASET_IDENTIFIER], I = O.dataset[f.CAMEL_DATASET_IDENTIFIER_EXTRA], T = I ? N + f.ID_DIVISION + I : N;
          B.setAttribute("data-" + f.DATASET_IDENTIFIER, x.id), B.setAttribute("data-" + f.DATASET_IDENTIFIER_EXTRA, T), B.appendChild(E.$node.cloneNode(!1));
          var w, D = !1, L = !1;
          M && ((C = O.cloneNode(!1)).textContent = M.textContent, X.appendChild(C), D = !0);
          var C, A = [];
          return Array.isArray(F) ? A.push.apply(A, s(F)) : A.push(F), d(B, u.unique(A)), X.appendChild(B), K && ((C = O.cloneNode(!1)).textContent = K.textContent, X.appendChild(C), L = !0), w = D && L ? a.SplitType.both : D ? a.SplitType.head : L ? a.SplitType.tail : a.SplitType.none, B.setAttribute("data-" + f.DATASET_SPLIT_TYPE, w), O.parentNode.replaceChild(X, O), B;
        }(p, m, v, _) : function(E, x, F, y) {
          var B = document.createElement(y);
          return d(B, F), B.appendChild(E.$node.cloneNode(!1)), E.$node.parentNode.replaceChild(B, E.$node), B.setAttribute("data-" + f.DATASET_IDENTIFIER, x.id), B.setAttribute("data-" + f.DATASET_SPLIT_TYPE, E.splitType), B.setAttribute("data-" + f.DATASET_IDENTIFIER_EXTRA, ""), B;
        }(p, m, v, _);
...
var da = Gr.exports;
const Xr = /* @__PURE__ */ tt(da), We = new Xr({
  style: {
    className: _s
  }
...
const pa = (e) => {
  ...
  var o, n;
  const e = eo(), t = (e == null ? void 0 : e[1]) === "analysis" ? document.getElementById("sql") : document.getElementById("code");
...
`), R = Math.max(d.y, l.y), E = Array.from(b).findIndex((O) => {
        const { height: M, y: K } = O.getBoundingClientRect();
        return R >= K && R <= K + M;
      }), x = b[E], F = E - S.length + 1;
  ...
  }, [o]), !s || !(t != null && t.parentElement) ? null : Pr(
    /* @__PURE__ */ P.jsx(
      "div",
      {
        ref: r,
...
}, Ea = ya, ba = "_dbtDocs_1yt0b_1", _a = "_conversationRightPanelCloseButton_1yt0b_14", Sa = "_conversationRightPanel_1yt0b_14", Ca = "_newConversationForm_1yt0b_46", Ta = "_highlightText_1yt0b_60", Oa = "_conversationInputForm_1yt0b_81", Ra = "_conversationGroup_1yt0b_107", Aa = "_replyForm_1yt0b_139", Da = "_resolveButton_1yt0b_165", Fe = {
  dbtDocs: ba,
  ...
  replyForm: Aa,
  resolveButton: Da
}, Ia = "_profileImage_11vaf_1", wa = {
  profileImage: Ia
}, xa = ({ user: e }) => {
  var t;
  return /* @__PURE__ */ P.jsx("div", { className: wa.profileImage, children: ((t = e == null ? void 0 : e.first_name) == null ? void 0 : t[0]) || "" });
}, to = xa;
function Na(e) {
  if (Array.isArray(e)) {
...
function ro(e, t) {
  ...
  return Ot(e) && Ot(t) && rt(t).forEach(function(n) {
    Ot(t[n]) ? n in e ? o[n] = ro(e[n], t[n]) : Object.assign(o, ht({}, n, t[n])) : Object.assign(o, ht({}, n, t[n]));
  }), o;
}
var mn = function(t) {
  ...
  for (var n = o.map(fr), r = rt(t), i = {}, s = 0, a = r.length; s < a; s += 1) {
    var c = r[s];
    (o.indexOf(c) >= 0 || n.indexOf(fr(c)) >= 0) && (i[c] = t[c]);
  }
  return i;
}, nu = function e(t, o) {
  for (var n = mn.apply(void 0, [{}, Ja(t, o)].concat(xe(no(oo(t, o))))), r = rt(n).filter(wn), i = 0, s = r.length; i < s; i += 1) {
    var a = r[i], c = e(n[a], o);
...
var ru = ["animationName"], ou = function(t) {
...
function uo(e) {
  var t = e.style, o = e.className, n = e.classNames, r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : io, i = o || au(n) || (t == null ? void 0 : t.className), s = typeof t == "function" ? t : su(function(l, d) {
    var h = ao(l);
    ...
    var p = h.filter(wn), m = h.filter(eu), v = m.length > 0 ? function(S) {
      return no(oo(S, m));
    } : function(S) {
      return [S];
    }, _ = function() {
    ...
    style: t
  }), c = xe(new Set([].concat(xe(a.className ? a.className.split(" ") : []), xe(i ? i.split(" ") : [])))), f = n ? Qa(c.map(function(l) {
    return n[l];
...
function at(e) {
  for (var t = 1; t < arguments.length; t++) {
    var o = arguments[t] != null ? arguments[t] : {};
    t % 2 ? gr(Object(o), !0).forEach(function(n) {
      ht(e, n, o[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(o)) : gr(Object(o)).forEach(function(n) {
      Object.defineProperty(e, n, Object.getOwnPropertyDescriptor(o, n));
    });
  }
  return e;
...
var cu = function() {
  ...
  var r = o.style, i = o.className, s = o.classNames, a = et(so), c = lt(function() {
    return uo({
      style: r,
      className: i,
      classNames: s
...
function lu() {
  ...
  return se.AsyncMode = c, se.ConcurrentMode = f, se.ContextConsumer = a, se.ContextProvider = s, se.Element = t, se.ForwardRef = u, se.Fragment = n, se.Lazy = p, se.Memo = h, se.Portal = o, se.Profiler = i, se.StrictMode = r, se.Suspense = l, se.isAsyncMode = function(E) {
    return R(E) || S(E) === c;
    ...
    return typeof E == "string" || typeof E == "function" || E === n || E === f || E === i || E === r || E === l || E === d || typeof E == "object" && E !== null && (E.$$typeof === p || E.$$typeof === h || E.$$typeof === s || E.$$typeof === a || E.$$typeof === u || E.$$typeof === v || E.$$typeof === _ || E.$$typeof === b || E.$$typeof === m);
  }, se.typeOf = S, se;
}
var ae = {};
/** @license React v16.13.1
...
function fu() {
  return mr || (mr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var E = c, x = f, F = a, y = s, B = t, O = u, M = n, K = p, X = h, N = o, I = i, T = r, w = l, D = !1;
    function L(k) {
      return D || (D = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), C(k) || R(k) === c;
    }
    function C(k) {
      return R(k) === f;
    }
    ...
    ae.AsyncMode = E, ae.ConcurrentMode = x, ae.ContextConsumer = F, ae.ContextProvider = y, ae.Element = B, ae.ForwardRef = O, ae.Fragment = M, ae.Lazy = K, ae.Memo = X, ae.Portal = N, ae.Profiler = I, ae.StrictMode = T, ae.Suspense = w, ae.isAsyncMode = L, ae.isConcurrentMode = C, ae.isContextConsumer = A, ae.isContextProvider = U, ae.isElement = z, ae.isForwardRef = V, ae.isFragment = G, ae.isLazy = W, ae.isMemo = Y, ae.isPortal = J, ae.isProfiler = Q, ae.isStrictMode = q, ae.isSuspense = le, ae.isValidElementType = S, ae.typeOf = R;
  }()), ae;
}
var yr;
function co() {
  return yr || (yr = 1, process.env.NODE_ENV === "production" ? _t.exports = lu() : _t.exports = fu()), _t.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var nn, _r;
function lo() {
  return _r || (_r = 1, nn = Function.call.bind(Object.prototype.hasOwnProperty)), nn;
}
var rn, Sr;
function pu() {
  if (Sr)
...
function hu() {
  if (Cr)
    return on;
  Cr = 1;
  var e = co(), t = du(), o = Nn(), n = lo(), r = pu(), i = function() {
  };
  ...
  return on = function(a, c) {
    ...
    function v(C) {
      ...
      function z(G, W, Y, J, Q, q, le) {
        ...
        return W[Y] == null ? G ? W[Y] === null ? new m("The " + Q + " `" + q + "` is marked as required " + ("in `" + J + "`, but its value is `null`.")) : new m("The " + Q + " `" + q + "` is marked as required in " + ("`" + J + "`, but its value is `undefined`.")) : null : C(W, Y, J, Q, q);
      }
      var V = z.bind(null, !1);
    ...
    function _(C) {
      function A(U, z, V, G, W, Y) {
        ...
        if (Q !== C) {
          var q = w(J);
          return new m(
            "Invalid " + G + " `" + W + "` of type " + ("`" + q + "` supplied to `" + V + "`, expected ") + ("`" + C + "`."),
            { expectedType: C }
          );
        }
        return null;
    ...
    function S(C) {
      function A(U, z, V, G, W) {
        ...
        if (!Array.isArray(Y)) {
          var J = T(Y);
          return new m("Invalid " + G + " `" + W + "` of type " + ("`" + J + "` supplied to `" + V + "`, expected an array."));
        }
    ...
    function R() {
      function C(A, U, z, V, G) {
        ...
        if (!a(W)) {
          var Y = T(W);
          return new m("Invalid " + V + " `" + G + "` of type " + ("`" + Y + "` supplied to `" + z + "`, expected a single ReactElement."));
        }
        return null;
      }
      return v(C);
    ...
    function E() {
      function C(A, U, z, V, G) {
        ...
        if (!e.isValidElementType(W)) {
          var Y = T(W);
          return new m("Invalid " + V + " `" + G + "` of type " + ("`" + Y + "` supplied to `" + z + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return v(C);
    ...
    function x(C) {
      function A(U, z, V, G, W) {
        if (!(U[z] instanceof C)) {
          var Y = C.name || d, J = L(U[z]);
          return new m("Invalid " + G + " `" + W + "` of type " + ("`" + J + "` supplied to `" + V + "`, expected ") + ("instance of `" + Y + "`."));
        }
        return null;
      }
      return v(A);
    ...
    function F(C) {
      ...
      function A(U, z, V, G, W) {
        for (var Y = U[z], J = 0; J < C.length; J++)
          if (p(Y, C[J]))
            return null;
        var Q = JSON.stringify(C, function(le, k) {
          var he = w(k);
          return he === "symbol" ? String(k) : k;
        });
        return new m("Invalid " + G + " `" + W + "` of value `" + String(Y) + "` " + ("supplied to `" + V + "`, expected one of " + Q + "."));
      }
      return v(A);
    }
    function y(C) {
      function A(U, z, V, G, W) {
        ...
        var Y = U[z], J = T(Y);
        if (J !== "object")
          return new m("Invalid " + G + " `" + W + "` of type " + ("`" + J + "` supplied to `" + V + "`, expected an object."));
        for (var Q in Y)
          if (n(Y, Q)) {
            var q = C(Y, Q, V, G, W + "." + Q, o);
            if (q instanceof Error)
    ...
    function B(C) {
      ...
      for (var A = 0; A < C.length; A++) {
        ...
        if (typeof U != "function")
          return i(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + D(U) + " at index " + A + "."
          ), s;
      }
      function z(V, G, W, Y, J) {
        for (var Q = [], q = 0; q < C.length; q++) {
          var le = C[q], k = le(V, G, W, Y, J, o);
          if (k == null)
            return null;
    ...
    function O() {
      function C(A, U, z, V, G) {
        return N(A[U]) ? null : new m("Invalid " + V + " `" + G + "` supplied to " + ("`" + z + "`, expected a ReactNode."));
      }
      return v(C);
    }
    ...
    function K(C) {
      function A(U, z, V, G, W) {
        var Y = U[z], J = T(Y);
        if (J !== "object")
          return new m("Invalid " + G + " `" + W + "` of type `" + J + "` " + ("supplied to `" + V + "`, expected `object`."));
        for (var Q in C) {
          var q = C[Q];
          if (typeof q != "function")
            return M(V, G, W, Q, w(q));
          var le = q(Y, Q, V, G, W + "." + Q, o);
          if (le)
            return le;
        }
        return null;
    ...
    function X(C) {
      function A(U, z, V, G, W) {
        ...
        for (var q in Q) {
          var le = C[q];
          if (n(C, q) && typeof le != "function")
            return M(V, G, W, q, w(le));
          if (!le)
            return new m(
              "Invalid " + G + " `" + W + "` key `" + q + "` supplied to `" + V + "`.\nBad object: " + JSON.stringify(U[z], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(C), null, "  ")
            );
          var k = le(Y, q, V, G, W + "." + q, o);
          if (k)
            return k;
        }
        return null;
    ...
    function T(C) {
      var A = typeof C;
      return Array.isArray(C) ? "array" : C instanceof RegExp ? "object" : I(A, C) ? "symbol" : A;
    }
    function w(C) {
...
var Rt = function(t) {
  ...
  for (var r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : bu, i = Eu(o.map(function(E) {
    return E.regex;
    ...
    var l = a.find(function(E) {
      return !!c[E];
    }), d = a.indexOf(l), h = o[d], p = h.markup, m = h.displayTransform, v = l + Or(p, "id"), _ = l + Or(p, "display"), b = c[v], S = m(b, c[_]), R = t.substring(f, c.index);
  ...
  var o = Rt(t), n = t[t.indexOf(Ie.display) + Ie.display.length], r = t[t.indexOf(Ie.id) + Ie.id.length];
  return new RegExp(o.replace(Ie.display, "([^".concat(Rt(n || ""), "]+?)")).replace(Ie.id, "([^".concat(Rt(r || ""), "]+?)")));
}, je = function(t) {
  ...
  var n = new RegExp(t.toString() + "|").exec("").length - 1, r = fo(o);
...
function zt(e, t) {
  var o = function(r) {
    var i = function(c) {
      var f = c.style, u = c.className, l = c.classNames, d = qa(c, xu), h = t ? t(d) : void 0, p = xn(e, {
        style: f,
        className: u,
        classNames: l
      }, h);
...
function go(e) {
  ...
  var _ = function() {
    if (m) {
      var N = m.offsetLeft, I = m.offsetTop;
      if (!(l.left === N && l.top === I)) {
        var T = {
          left: N,
          top: I
  ...
  var R = [], E = {}, x = R, F = 0, y = function(N, I, T) {
  ...
  return gt(r, b, B, y), x.push(" "), x !== R && R.push(K(x)), /* @__PURE__ */ oe.createElement("div", Oe({}, c, {
    ref: s
  }), R);
}
go.propTypes = {
...
function $u(e) {
  var t = e.style, o = e.className, n = e.classNames, r = xn(ku, {
    style: t,
    className: o,
    classNames: n
  }), i = r("spinner");
...
function mo(e) {
  var t = e.id, o = e.suggestions, n = o === void 0 ? {} : o, r = e.a11ySuggestionsListLabel, i = e.focusIndex, s = e.position, a = e.left, c = e.right, f = e.top, u = e.scrollFocusedIntoView, l = e.isLoading, d = e.isOpened, h = e.onSelect, p = h === void 0 ? function() {
    return null;
  } : h, m = e.ignoreAccents, v = e.containerRef, _ = e.children, b = e.style, S = e.customSuggestionsContainer, R = e.onMouseDown, E = e.onMouseEnter, x = ge(void 0), F = jt(x, 2), y = F[0], B = F[1];
  Re(function() {
    if (!(!y || y.offsetHeight >= y.scrollHeight || !u)) {
      var T = y.scrollTop, w = y.children[i].getBoundingClientRect(), D = w.top, L = w.bottom, C = y.getBoundingClientRect(), A = C.top;
      D = D - A + T, L = L - A + T, D < T ? y.scrollTop = D : L > y.offsetHeight && (y.scrollTop = L - y.offsetHeight);
    }
  }, [i, u, y]);
  var O = function() {
    var w = /* @__PURE__ */ oe.createElement("ul", Oe({
      ref: B,
      id: t,
      role: "listbox",
      "aria-label": r
    }, b("list")), Object.values(n).reduce(function(D, L) {
    ...
    var C = L === i, A = D.childIndex, U = D.query, z = Ge.toArray(_)[A].props.renderSuggestion;
  ...
  return d ? /* @__PURE__ */ oe.createElement("div", Oe({}, cu({
    position: s || "absolute",
    left: a,
    right: c,
    top: f
...
var zu = function(t) {
  ...
  function o(n) {
    var r;
    return Fa(this, o), r = t.call(this, n), ee(te(r), "setContainerElement", function(i) {
      r.containerElement = i;
    }), ee(te(r), "getInputProps", function() {
      var i = r.props, s = i.readOnly, a = i.disabled, c = i.style, f = wu(
        r.props,
        ["style", "classNames", "className"],
        // substyle props
        Iu(yo)
      );
      return De(De(De(De({}, f), c("input")), {}, {
        ...
        "aria-activedescendant": po(r.uuidSuggestionsOverlay, r.state.focusIndex)
      });
      ...
      if (!En(r.state.selectionStart))
        return null;
      var i = r.state.suggestionsPosition, s = i.position, a = i.left, c = i.top, f = i.right, u = /* @__PURE__ */ oe.createElement(Bu, {
      ...
      return r.props.suggestionsPortalHost ? /* @__PURE__ */ Jo.createPortal(u, r.props.suggestionsPortalHost) : u;
      ...
      f = Le(d, c);
      var h = i.target.selectionStart, p = i.target.selectionEnd, m = !1, v = Rr(a, c, h);
      ...
      if (!(!i || !r.suggestionsElement)) {
        ...
        if (u) {
          ...
          if (a) {
            ...
            var R = i.left - l.scrollLeft, E = i.top - l.scrollTop;
            R + u.offsetWidth > r.containerElement.offsetWidth ? v.right = 0 : v.left = R, c && p.top - l.scrollTop + u.offsetHeight > m && u.offsetHeight < d.top - h - l.scrollTop || f ? v.top = E - u.offsetHeight - h : v.top = E;
          }
      ...
      if (u !== null) {
        var l = Su(a.substring(0, u), f), d = i.substring(l, s);
        oe.Children.forEach(c, function(h, p) {
          if (h) {
            var m = zu(h.props.trigger, r.props), v = d.match(m);
            if (v) {
      ...
      var u = r.props, l = u.children, d = u.ignoreAccents, h = Ge.toArray(l)[s], p = Vu(h.props.data, d), m = p(i, r.updateSuggestions.bind(null, r._queryId, s, i, a, c, f));
      m instanceof Array && r.updateSuggestions(r._queryId, s, i, a, c, f, m);
    }), ee(te(r), "updateSuggestions", function(i, s, a, c, f, u, l) {
      if (i === r._queryId) {
        r.suggestions = De(De({}, r.suggestions), {}, ee({}, s, {
          queryInfo: {
            childIndex: s,
            query: a,
      ...
      var a = i.id, c = i.display, f = s.childIndex, u = s.querySequenceStart, l = s.querySequenceEnd, d = s.plainTextValue, h = r.props.value || "", p = je(r.props.children), m = Ge.toArray(r.props.children)[f], v = m.props, _ = v.markup, b = v.displayTransform, S = v.appendSpaceOnAdd, R = v.onAdd, E = me(h, p, u, "START"), x = E + l - u, F = Ou(_, a, c);
      S && (F += " ");
      var y = ct(h, E, x, F);
      ...
      }, K = ut(y, p), X = ct(d, u, l, B);
      r.executeOnChange(M, y, X, K), R && R(a, c, E, x), r.clearSuggestions();
    ...
    value: function(r) {
      if (r.target === this.inputElement && this.supportsClipboardActions(r)) {
        ...
        var i = this.state, s = i.selectionStart, a = i.selectionEnd, c = this.props, f = c.value, u = c.children, l = je(u), d = me(f, l, s, "START"), h = me(f, l, a, "END"), p = r.clipboardData.getData("text/react-mentions"), m = r.clipboardData.getData("text/plain"), v = ct(f, d, h, p || m).replace(/\r/g, ""), _ = Le(v, l), b = {
          target: De(De({}, r.target), {}, {
            value: v
          })
        };
        this.executeOnChange(b, v, _, ut(v, l));
        var S = Rr(f, l, s), R = (S || s) + Le(p || m, l).length;
        this.setState({
          selectionStart: R,
          selectionEnd: R,
...
var an = function(t, o) {
...
}, qu = typeof navigator < "u" && /iPhone|iPad|iPod/i.test(navigator.userAgent), Wu = zt({
  position: "relative",
  overflowY: "visible",
  input: {
    display: "block",
  ...
  var o = t.display, n = t.style, r = t.className, i = t.classNames, s = xn(Ku, {
    style: n,
    className: r,
    classNames: i
  });
...
const Gu = {
  ...
  users: n,
  currentUser: r
}) => /* @__PURE__ */ P.jsxs("div", { className: Fe.conversationInputForm, children: [
  r ? /* @__PURE__ */ P.jsx(to, { user: r }) : null,
  /* @__PURE__ */ P.jsx(
    Zu,
    {
      value: e,
  ...
  /* @__PURE__ */ P.jsx(Ls, { loading: o, color: "primary", children: /* @__PURE__ */ P.jsx(Rs, {}) })
] }), Eo = Ju, Qu = ({
  text: e,
  filePath: t
  ...
  var u, l;
  const e = ce((d) => d.users), t = ce(
    (d) => d.newConversation
  ), o = ce(
    (d) => d.currentUserId ? d.users[d.currentUserId] : null
  ), n = ce(
    (d) => d.shareId
  ), r = Ae(), [i, s] = ge(!1), [a, c] = ge(""), f = async (d) => {
    if (d.stopPropagation(), d.preventDefault(), !(!t || !n)) {
      ...
      try {
        ...
        console.error("error while saving conversation", t, h);
      }
      r(qr()), s(!1), r(Rn(!0)), r(An()), c("");
    }
  };
  return /* @__PURE__ */ P.jsx(Ft, { className: Fe.newConversationForm, children: /* @__PURE__ */ P.jsx(Mt, { children: /* @__PURE__ */ P.jsxs("form", { onSubmit: f, children: [
    /* @__PURE__ */ P.jsx("h4", { children: "Add comment" }),
    /* @__PURE__ */ P.jsx(
      bo,
      {
        text: (u = t == null ? void 0 : t.meta) == null ? void 0 : u.highlight,
        filePath: ((l = t == null ? void 0 : t.meta) == null ? void 0 : l.filePath) || ""
      }
    ),
    /* @__PURE__ */ P.jsx(
      Eo,
...
(function(e, t) {
  (function(o, n) {
    ...
    var o = 1e3, n = 6e4, r = 36e5, i = "millisecond", s = "second", a = "minute", c = "hour", f = "day", u = "week", l = "month", d = "quarter", h = "year", p = "date", m = "Invalid Date", v = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, _ = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, b = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(N) {
      var I = ["th", "st", "nd", "rd"], T = N % 100;
      return "[" + N + (I[(T - 20) % 10] || I[T] || I[0]) + "]";
    } }, S = function(N, I, T) {
      var w = String(N);
      return !w || w.length >= I ? N : "" + Array(I + 1 - w.length).join(T) + N;
    }, R = { s: S, z: function(N) {
      var I = -N.utcOffset(), T = Math.abs(I), w = Math.floor(T / 60), D = T % 60;
      return (I <= 0 ? "+" : "-") + S(w, 2, "0") + ":" + S(D, 2, "0");
    }, m: function N(I, T) {
      if (I.date() < T.date())
        return -N(T, I);
      var w = 12 * (T.year() - I.year()) + (T.month() - I.month()), D = I.clone().add(w, l), L = T - D < 0, C = I.clone().add(w + (L ? -1 : 1), l);
    ...
    x[E] = b;
    var F = "$isDayjsObject", y = function(N) {
    ...
    var K = function() {
      ...
      return I.parse = function(T) {
        ...
        var D = this, L = !!M.u(w) || w, C = M.p(T), A = function(Q, q) {
          var le = M.w(D.$u ? Date.UTC(D.$y, q, Q) : new Date(D.$y, q, Q), D);
          return L ? le : le.endOf(f);
        }, U = function(Q, q) {
          return M.w(D.toDate()[Q].apply(D.toDate("s"), (L ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(q)), D);
        }, z = this.$W, V = this.$M, G = this.$D, W = "set" + (this.$u ? "UTC" : "");
        switch (C) {
          case h:
        ...
        var D, L = M.p(T), C = "set" + (this.$u ? "UTC" : ""), A = (D = {}, D[f] = C + "Date", D[p] = C + "Date", D[l] = C + "Month", D[h] = C + "FullYear", D[c] = C + "Hours", D[a] = C + "Minutes", D[s] = C + "Seconds", D[i] = C + "Milliseconds", D)[L], U = L === f ? this.$D + (w - this.$W) : w;
        if (L === l || L === h) {
        ...
        if (C === u)
          return A(7);
        var U = (D = {}, D[a] = n, D[c] = r, D[s] = o, D)[C] || 1, z = this.$d.getTime() + T * U;
        return M.w(z, this);
        ...
        var L = T || "YYYY-MM-DDTHH:mm:ssZ", C = M.z(this), A = this.$H, U = this.$m, z = this.$M, V = D.weekdays, G = D.months, W = D.meridiem, Y = function(q, le, k, he) {
          return q && (q[le] || q(w, L)) || k[le].slice(0, he);
        }, J = function(q) {
        ...
        return L.replace(_, function(q, le) {
        ...
        var L, C = this, A = M.p(w), U = O(T), z = (U.utcOffset() - this.utcOffset()) * n, V = this - U, G = function() {
          return M.m(C, U);
        };
        switch (A) {
          case h:
    ...
    return O.prototype = X, [["$ms", i], ["$s", s], ["$m", a], ["$H", c], ["$W", f], ["$M", l], ["$y", h], ["$D", p]].forEach(function(N) {
      X[N[1]] = function(I) {
        return this.$g(I, N[0], N[1]);
      };
    }), O.extend = function(N, I) {
      return N.$i || (N(I, K, O), N.$i = !0), O;
    }, O.locale = B, O.isDayjs = y, O.unix = function(N) {
      return O(1e3 * N);
    }, O.en = x[E], O.Ls = x, O.p = {}, O;
  });
})(_o);
var nc = _o.exports;
const rc = /* @__PURE__ */ tt(nc), oc = ({
  conversationGroupId: e
}) => {
  const t = ce(
    (s) => s.shareId
  ), o = Ae(), [n, r] = ge(!1), i = async () => {
    e && (r(!0), await la(t, e), o(Ji({ conversationGroupId: e, shareId: t })), r(!1));
  };
  ...
  showResolveButton: o,
  conversationGroupId: n
}) => /* @__PURE__ */ P.jsxs(jr, { className: "d-flex align-items-center justify-content-between mb-0", children: [
  /* @__PURE__ */ P.jsxs("div", { className: "d-flex align-items-center gap-1", children: [
    ...
    /* @__PURE__ */ P.jsx("span", { children: rc(t).format("HH:mm, DD MMM YY") })
  ] }),
  o ? /* @__PURE__ */ P.jsx(ic, { conversationGroupId: n }) : null
] }), So = sc, ac = ({ conversation: e }) => {
  const t = ce((o) => {
    var n;
  ...
  return /* @__PURE__ */ P.jsxs(Ft, { children: [
    ...
    /* @__PURE__ */ P.jsx(Mt, { children: /* @__PURE__ */ P.jsx("p", { children: e.message.replace(/@\[(.*?)\]\((.*?)\)/g, "@$2") }) })
  ] });
}, uc = ac, cc = ({ conversationGroupId: e }) => {
  const t = ce((u) => u.users), o = ce(
    (u) => u.currentUserId ? u.users[u.currentUserId] : null
  ), n = ce(
    (u) => u.shareId
  ), [r, i] = ge(""), [s, a] = ge(!1), c = Ae(), f = async (u) => {
    if (u.stopPropagation(), u.preventDefault(), !(!n || !e)) {
      a(!0), console.log("saving reply", n, e, {
        message: r
      });
      try {
        await aa(n, e, {
  ...
  return /* @__PURE__ */ P.jsx("div", { className: Fe.replyForm, children: /* @__PURE__ */ P.jsx("form", { onSubmit: f, className: "", children: /* @__PURE__ */ P.jsx(
    Eo,
    {
      comment: r,
      setComment: i,
...
}, lc = cc, fc = ({ conversationGroup: e }) => {
  var l, d;
  const t = Te(null), o = ce((h) => {
    var p;
    ...
    Ft,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ P.jsxs(Mt, { children: [
          ...
          /* @__PURE__ */ P.jsx("p", { children: c.message.replace(/@\[(.*?)\]\((.*?)\)/g, "@$2") }),
          /* @__PURE__ */ P.jsx(Pt, { onClick: () => s((h) => !h), color: "link", children: u }),
          f.length ? /* @__PURE__ */ P.jsx(P.Fragment, { children: i ? /* @__PURE__ */ P.jsx(P.Fragment, { children: f.map((h) => /* @__PURE__ */ P.jsx(uc, { conversation: h }, h.conversation_id)) }) : null }) : null,
          i ? /* @__PURE__ */ P.jsx(
            lc,
            {
              conversationGroupId: e.conversation_group_id
  ...
  const e = ce((s) => s.isRightPanelOpen), t = ce(
    (s) => s.selectedConversationId
  ), o = ce((s) => s.newConversation), n = Ae(), r = () => {
  ...
  return !!o || e || t ? /* @__PURE__ */ P.jsxs(P.Fragment, { children: [
    ...
    /* @__PURE__ */ P.jsxs("div", { className: Fe.conversationRightPanel, children: [
      ...
      o ? /* @__PURE__ */ P.jsx(tc, {}) : /* @__PURE__ */ P.jsx(hc, {})
    ] })
  ] }) : null;
}, vc = gc, mc = 120, yc = () => {
  const e = Te(), t = ce(
    ...
    (s) => {
      clearTimeout(e.current), ua(s).then(
        (a) => {
          console.log("useConversations", a), n(Xi(a == null ? void 0 : a.dbt_docs_share_conversations)), e.current = setTimeout(() => {
            i(s);
          }, mc * 1e3);
        }
      ).catch(
  ...
  return Re(() => {
    o !== Ce.UNINITIALIZED || Object.keys(t).length || (n(Ce.LOADING), ca().then((r) => {
...
}, bc = () => (Ec(), yc(), /* @__PURE__ */ P.jsxs("div", { children: [
  /* @__PURE__ */ P.jsx(vc, {}),
  /* @__PURE__ */ P.jsx(Ea, {})
] })), _c = bc, Sc = Ko(() => import("./DbtDocsRenderer.js")), Cc = () => {
  const { loading: e, shareDetails: t } = fa(), o = Ae(), { getHighlightedSelectionData: n, pos: r, onSelectionEnd: i } = ga(), s = () => {
    const a = n();
    a && o(Zi(a));
  };
  return e ? /* @__PURE__ */ P.jsx("div", { children: "Loading..." }) : !(t != null && t.catalog_presigned_url) || !(t != null && t.manifest_presigned_url) ? /* @__PURE__ */ P.jsx("div", { children: "Unable to load required artifacts. Please try again." }) : /* @__PURE__ */ P.jsxs("div", { children: [
    /* @__PURE__ */ P.jsx("div", { className: "d-flex justify-content-end mb-2", children: /* @__PURE__ */ P.jsx(oa, {}) }),
    /* @__PURE__ */ P.jsx(_c, {}),
    /* @__PURE__ */ P.jsx(
      Sc,
      {
...
}, Tc = Cc, Oc = ({ shareId: e, userId: t, conversationGroupId: o, source: n }) => /* @__PURE__ */ P.jsx("div", { className: "altimate-component", children: /* @__PURE__ */ P.jsx(
  ts,
  {
    shareId: e,
    userId: t,
