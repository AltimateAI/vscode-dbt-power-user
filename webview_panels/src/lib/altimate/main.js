...
import './main.css';var xd = Object.defineProperty;
var wd = (e, t, n) => t in e ? xd(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var rr = (e, t, n) => wd(e, typeof t != "symbol" ? t + "" : t, n);
import * as N from "react";
import P, { createContext as ut, Component as Ed, createElement as Wl, isValidElement as w2, useState as ae, useRef as se, forwardRef as js, useEffect as re, useReducer as Rs, useCallback as pe, useMemo as Se, useContext as Re, useLayoutEffect as Sd, useId as E2, useInsertionEffect as _d, Children as Zn, lazy as kd, memo as Oe } from "react";
import { Prism as Ad } from "react-syntax-highlighter";
import { Tooltip as Md, Button as Te, Spinner as Td, Badge as Nd, Card as ln, CardTitle as ea, CardBody as An, CloseButton as Od, Popover as S2, PopoverBody as _2, UncontrolledTooltip as Dd, Input as an, Label as Na, Modal as k2, ModalBody as A2, FormGroup as Ki, FormFeedback as M2, Alert as Hs, CardFooter as Ld, Collapse as jd, Col as Rd, CardImg as Hd, CardSubtitle as Fd, CardText as zd, Row as Id } from "reactstrap";
import Pd, { createPortal as Mn } from "react-dom";
import { ProChat as Bd } from "@ant-design/pro-chat";
import { useFormikContext as Vd, Form as Wd, Field as $d, Formik as Zd, useFormik as qd } from "formik";
import { z as qe } from "zod";
import { Popconfirm as Ud, Select as $l } from "antd";
...
function Yd() {
  ...
  return io.Fragment = n, io.jsx = i, io.jsxs = i, io;
}
var so = {};
/**
 * @license React
...
function Gd() {
  return ql || (ql = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function x(j, U, ee) {
      {
        ...
        var Ce = ee.map(function(ge) {
          return String(ge);
        });
        Ce.unshift("Warning: " + U), Function.prototype.apply.call(console[j], console, Ce);
      }
    }
    var E = !1, v = !1, k = !1, T = !1, _ = !1, H;
    H = Symbol.for("react.module.reference");
    function R(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === o || j === a || _ || j === r || j === u || j === c || T || j === h || E || v || k || typeof j == "object" && j !== null && (j.$$typeof === g || j.$$typeof === d || j.$$typeof === i || j.$$typeof === s || j.$$typeof === l || // This needs to include all possible module reference object
    ...
    function B(j) {
      ...
      if (typeof j == "object")
        switch (j.$$typeof) {
          ...
          case g: {
            var he = j, Ce = he._payload, ge = he._init;
            try {
              return B(ge(Ce));
            } catch {
              return null;
    ...
    var w = Object.assign, A = 0, S, O, L, D, M, F, I;
    function V() {
    }
    ...
    function W() {
      {
        if (A === 0) {
          S = console.log, O = console.info, L = console.warn, D = console.error, M = console.group, F = console.groupCollapsed, I = console.groupEnd;
          var j = {
            configurable: !0,
            enumerable: !0,
            value: V,
...
` + ce[ke].replace(" at new ", " at ");
        ...
        te = !1, K.current = Ce, q(), Error.prepareStackTrace = he;
      }
      ...
      if (typeof j == "object")
        switch (j.$$typeof) {
          case l:
            return ye(j.render);
          case d:
            return Ee(j.type, U, ee);
          case g: {
            var ie = j, he = ie._payload, Ce = ie._init;
            try {
              return Ee(Ce(he), U, ee);
            } catch {
            }
          }
        }
    ...
    var Be = Object.prototype.hasOwnProperty, ve = {}, oe = p.ReactDebugCurrentFrame;
    function He(j) {
      if (j) {
        var U = j._owner, ee = Ee(j.type, j._source, U ? U.type : null);
        oe.setExtraStackFrame(ee);
      } else
        oe.setExtraStackFrame(null);
    }
    function Dt(j, U, ee, ie, he) {
      {
        ...
        for (var ge in j)
          if (Ce(j, ge)) {
            ...
            try {
              ...
              ce = j[ge](U, ge, ie, ee, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (ke) {
              ce = ke;
            }
            ce && !(ce instanceof Error) && (He(he), y("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", ie || "React class", ee, ge, typeof ce), He(null)), ce instanceof Error && !(ce.message in ve) && (ve[ce.message] = !0, He(he), y("Failed %s type: %s", ee, ce.message), He(null));
          }
      }
    }
    ...
    function qt(j) {
      {
        var U = typeof Symbol == "function" && Symbol.toStringTag, ee = U && j[Symbol.toStringTag] || j.constructor.name || "Object";
        return ee;
      }
    }
    function gt(j) {
    ...
    function St(j) {
      if (gt(j))
        return y("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", qt(j)), Lt(j);
    }
    var Je = p.ReactCurrentOwner, Ut = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Qe(j) {
      if (Be.call(j, "ref")) {
        var U = Object.getOwnPropertyDescriptor(j, "ref").get;
    ...
    function Ht(j, U) {
      if (typeof j.ref == "string" && Je.current && U && Je.current.stateNode !== U) {
        var ee = B(Je.current.type);
        De[ee] || (y('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', B(Je.current.type), j.ref), De[ee] = !0);
      }
    }
    function Ft(j, U) {
      {
        var ee = function() {
          jt || (jt = !0, y("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", U));
        };
    ...
    function ht(j, U) {
      {
        var ee = function() {
          Yt || (Yt = !0, y("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", U));
        };
    ...
    var ot = function(j, U, ee, ie, he, Ce, ge) {
      var ce = {
    ...
    function un(j, U, ee, ie, he) {
      {
        var Ce, ge = {}, ce = null, Ie = null;
        ee !== void 0 && (St(ee), ce = "" + ee), Rt(U) && (St(U.key), ce = "" + U.key), Qe(U) && (Ie = U.ref, Ht(U, he));
        for (Ce in U)
          Be.call(U, Ce) && !Ut.hasOwnProperty(Ce) && (ge[Ce] = U[Ce]);
        if (j && j.defaultProps) {
          var ke = j.defaultProps;
          for (Ce in ke)
            ge[Ce] === void 0 && (ge[Ce] = ke[Ce]);
        }
        if (ce || Ie) {
          var Me = typeof j == "function" ? j.displayName || j.name || "Unknown" : j;
          ce && Ft(ge, Me), Ie && ht(ge, Me);
        }
        return ot(j, ce, Ie, he, ie, Je.current, ge);
      }
    }
    var dn = p.ReactCurrentOwner, Gt = p.ReactDebugCurrentFrame;
    function _t(j) {
      if (j) {
        var U = j._owner, ee = Ee(j.type, j._source, U ? U.type : null);
...
Check the top-level render call using <` + ee + ">.");
    ...
    function er(j, U) {
      {
        ...
        Qo[ee] = !0;
        var ie = "";
        j && j._owner && j._owner !== dn.current && (ie = " It was passed a child from " + B(j._owner.type) + "."), _t(j), y('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', ee, ie), _t(null);
      }
    }
    function tr(j, U) {
      {
        ...
        if (Et(j))
          ...
          if (typeof he == "function" && he !== j.entries)
            for (var Ce = he.call(j), ge; !(ge = Ce.next()).done; )
              pt(ge.value) && er(ge.value, U);
        }
      }
    }
    function xa(j) {
    ...
    function wa(j) {
      {
        for (var U = Object.keys(j.props), ee = 0; ee < U.length; ee++) {
          var ie = U[ee];
          if (ie !== "children" && ie !== "key") {
            _t(j), y("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", ie), _t(null);
            break;
          }
        }
        j.ref !== null && (_t(j), y("Invalid attribute `ref` supplied to `React.Fragment`."), _t(null));
      }
    }
    var nr = {};
    function or(j, U, ee, ie, he, Ce) {
      {
        var ge = R(j);
        if (!ge) {
          var ce = "";
          ...
          Ie ? ce += Ie : ce += Jo();
          var ke;
          j === null ? ke = "null" : Et(j) ? ke = "array" : j !== void 0 && j.$$typeof === t ? (ke = "<" + (B(j.type) || "Unknown") + " />", ce = " Did you accidentally export a JSX literal instead of a component?") : ke = typeof j, y("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", ke, ce);
        }
        var Me = un(j, U, ee, he, Ce);
        if (Me == null)
          return Me;
        if (ge) {
          var Ze = U.children;
        ...
        if (Be.call(U, "key")) {
          var zt = B(j), Ve = Object.keys(U).filter(function(Ma) {
            return Ma !== "key";
          }), ao = Ve.length > 0 ? "{key: someKey, " + Ve.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!nr[zt + ao]) {
            var Aa = Ve.length > 0 ? "{" + Ve.join(": ..., ") + ": ...}" : "{}";
            y(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, ao, zt, Aa, zt), nr[zt + ao] = !0;
          }
        }
        return j === o ? wa(Me) : xa(Me), Me;
      }
    }
    function Ea(j, U, ee) {
      return or(j, U, ee, !0);
    ...
    var _a = Sa, ka = Ea;
    so.Fragment = o, so.jsx = _a, so.jsxs = ka;
  }()), so;
}
process.env.NODE_ENV === "production" ? Xi.exports = Yd() : Xi.exports = Gd();
var f = Xi.exports, po = {}, T2 = { exports: {} };
(function(e) {
  function t(n) {
...
(function(e) {
  ...
  var n = t(Xd()), o = t(Jd()), r = t(Qd()), a = t(e3()), i = t(t3()), s = t(n3()), l = t(o3()), u = t(r3()), c = t(a3()), d = t(i3()), g = t(s3()), h = t(l3()), m = t(c3()), b = t(u3()), C = t(d3()), p = t(f3()), y = t(g3()), x = t(h3()), E = t(p3()), v = t(m3()), k = t(b3()), T = t(y3()), _ = t(C3()), H = t(v3()), R = t(x3()), z = t(w3()), $ = t(E3()), B = t(S3()), w = t(_3()), A = t(k3()), S = t(A3()), O = t(M3()), L = t(T3()), D = t(N3()), M = t(O3()), F = t(D3()), I = t(L3()), V = t(j3()), W = t(R3()), q = t(H3()), K = t(F3()), X = t(z3()), J = t(I3()), te = t(P3());
})(po);
const B3 = "_codeblock_19tsp_1", V3 = "_dark_19tsp_1", Fc = {
  codeblock: B3,
  dark: V3
}, W3 = "_iconButton_eti7u_1", $3 = {
  iconButton: W3
}, yn = (e) => /* @__PURE__ */ f.jsx(Wo, { title: e.title, children: /* @__PURE__ */ f.jsx(
  "button",
  {
    ...e,
    className: `btn ${e.color ? `btn-${e.color}` : ""} ${e.className ?? ""} ${$3.iconButton}`,
    type: e.type ?? "button",
    children: e.children
  }
) }), Z3 = ut(null), xi = {
...
class q3 extends Ed {
  constructor(t) {
    super(t), this.resetErrorBoundary = this.resetErrorBoundary.bind(this), this.state = xi;
  }
  ...
  componentDidUpdate(t, n) {
    ...
    if (o && n.error !== null && U3(t.resetKeys, r)) {
      var a, i;
...
const Wo = (e) => {
...
}, Y3 = "_loadingBtn_gadec_1", G3 = {
  loadingBtn: Y3
}, Fs = ({ loading: e, ...t }) => /* @__PURE__ */ f.jsx(
  Te,
  {
    ...t,
    disabled: e ?? t.disabled,
    className: `${t.className ?? ""} ${G3.loadingBtn}`,
    children: e ? /* @__PURE__ */ f.jsx(Td, {}) : t.children
  }
), K3 = "_stack_73h55_1", X3 = {
  stack: K3
}, at = js(function({
  children: t,
  direction: n = "row",
  ...
  return /* @__PURE__ */ f.jsx(
    ...
    {
      ...o,
      className: `${o.className} ${X3.stack} stack-${n}`,
      ref: r,
      children: t
    }
  );
}), J3 = ({ tooltip: e, ...t }) => /* @__PURE__ */ f.jsx(Wo, { title: e, children: /* @__PURE__ */ f.jsx(Nd, { ...t }) }), Q3 = { vs: po.vs, "vsc-dark-plus": po.vscDarkPlus, solarizedLight: po.solarizedlight, tomorrow: po.tomorrow }, $o = ({
  code: e,
  language: t,
  fileName: n,
  editorTheme: o = "vs",
  ...
  ln,
  {
    className: `${Fc.codeblock} ${i || ""} ${r === "dark" ? Fc.dark : ""}`,
    children: [
      n ? /* @__PURE__ */ f.jsxs(ea, { className: "d-flex justify-content-between", children: [
        n,
        " ",
        s
      ] }) : null,
      /* @__PURE__ */ f.jsx(An, { children: /* @__PURE__ */ f.jsx(
        Ad,
        {
          showLineNumbers: a,
          language: t,
...
`;
      ...
      var i = a(r(5)), s = r(9), l = function() {
        ...
        return u.prototype.deSerialize = function(c, d) {
          var g = s.queryElementNode(this, c), h = g.start, m = g.end, b = s.getTextChildByOffset(h, this.startMeta.textOffset), C = s.getTextChildByOffset(m, this.endMeta.textOffset);
      ...
      var a = this && this.__values || function(c) {
        ...
        if (!g) return c;
        var h, m, b = g.call(c), C = [];
        try {
          for (; (d === void 0 || d-- > 0) && !(h = b.next()).done; ) C.push(h.value);
        } catch (p) {
          m = { error: p };
        } finally {
          try {
      ...
      o.getHighlightId = function(c, d) {
        ...
        try {
          for (var b = a(c), C = b.next(); !C.done; C = b.next()) {
            var p = C.value.querySelectorAll(d + "[data-" + l.DATASET_IDENTIFIER + "]");
            m.push.apply(m, p);
          }
        } catch (y) {
          g = { error: y };
        ...
        var h, m, b = [], C = new RegExp("(" + d + "\\" + l.ID_DIVISION + "|\\" + l.ID_DIVISION + "?" + d + "$)"), p = c.querySelectorAll(g + "[data-" + l.DATASET_IDENTIFIER + "]");
        try {
          for (var y = a(p), x = y.next(); !x.done; x = y.next()) {
            var E = x.value;
      ...
      var i = a(r(3)), s = r(1), l = r(11), u = a(r(6)), c = r(12), d = r(0), g = function() {
        function h(m, b, C, p, y) {
          y === void 0 && (y = !1), m.$node.nodeType === 3 && b.$node.nodeType === 3 || d.eventEmitter.emit(d.INTERNAL_ERROR_EVENT, { type: s.ERROR.RANGE_NODE_INVALID }), this.start = c.formatDomNode(m), this.end = c.formatDomNode(b), this.text = C, this.frozen = y, this.id = p;
        }
        return h.fromSelection = function(m) {
          var b = l.getDomRange();
          if (!b) return null;
          var C = { $node: b.startContainer, offset: b.startOffset }, p = { $node: b.endContainer, offset: b.endOffset }, y = b.toString(), x = m.call(C, p, y);
          return new h(C, p, y, x = x ?? u.default());
        }, h.prototype.serialize = function(m, b) {
          var C, p = c.getDomMeta(this.start.$node, this.start.offset, m), y = c.getDomMeta(this.end.$node, this.end.offset, m);
          return b.Serialize.RecordInfo.isEmpty() || (C = b.Serialize.RecordInfo.call(this.start, this.end, m)), this.frozen = !0, new i.default(p, y, this.text, this.id, C);
      ...
      var a, i = this && this.__extends || (a = function(v, k) {
        return (a = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(T, _) {
          T.__proto__ = _;
        } || function(T, _) {
          for (var H in _) Object.prototype.hasOwnProperty.call(_, H) && (T[H] = _[H]);
        })(v, k);
      }, function(v, k) {
        function T() {
          this.constructor = v;
        }
        a(v, k), v.prototype = k === null ? Object.create(k) : (T.prototype = k.prototype, new T());
      }), s = this && this.__assign || function() {
        return (s = Object.assign || function(v) {
          for (var k, T = 1, _ = arguments.length; T < _; T++) for (var H in k = arguments[T]) Object.prototype.hasOwnProperty.call(k, H) && (v[H] = k[H]);
          return v;
      ...
      Object.defineProperty(o, "__esModule", { value: !0 });
      var u = l(r(2)), c = l(r(5)), d = l(r(3)), g = l(r(6)), h = l(r(13)), m = l(r(14)), b = l(r(16)), C = l(r(17)), p = r(0), y = r(1), x = r(4), E = function(v) {
        function k(T) {
          var _ = v.call(this) || this;
          _.event = m.default(), _.run = function() {
            return x.addEventListener(_.options.$root, _.event.PointerEnd, _._handleSelection);
          }, _.stop = function() {
            x.removeEventListener(_.options.$root, _.event.PointerEnd, _._handleSelection);
          }, _.addClass = function(R, z) {
            _.getDoms(z).forEach(function($) {
              x.addClass($, R);
            });
          }, _.removeClass = function(R, z) {
            _.getDoms(z).forEach(function($) {
              x.removeClass($, R);
            });
          }, _.getIdByDom = function(R) {
            return x.getHighlightId(R, _.options.$root);
          }, _.getExtraIdByDom = function(R) {
            return x.getExtraHighlightId(R, _.options.$root);
          }, _.getDoms = function(R) {
            return R ? x.getHighlightById(_.options.$root, R, _.options.wrapTag) : x.getHighlightsByRoot(_.options.$root, _.options.wrapTag);
          }, _.dispose = function() {
            var R = _.options.$root;
            x.removeEventListener(R, _.event.PointerOver, _._handleHighlightHover), x.removeEventListener(R, _.event.PointerEnd, _._handleSelection), x.removeEventListener(R, _.event.PointerTap, _._handleHighlightClick), _.removeAll();
          }, _.setOption = function(R) {
            _.options = s(s({}, _.options), R), _.painter = new C.default({ $root: _.options.$root, wrapTag: _.options.wrapTag, className: _.options.style.className, exceptSelectors: _.options.exceptSelectors }, _.hooks);
          }, _.fromRange = function(R) {
            var z = { $node: R.startContainer, offset: R.startOffset }, $ = { $node: R.endContainer, offset: R.endOffset }, B = R.toString(), w = _.hooks.Render.UUID.call(z, $, B);
            w = w ?? g.default();
            var A = new c.default(z, $, B, w);
            return A ? _._highlightFromHRange(A) : (p.eventEmitter.emit(p.INTERNAL_ERROR_EVENT, { type: y.ERROR.RANGE_INVALID }), null);
          }, _.fromStore = function(R, z, $, B, w) {
            var A = new d.default(R, z, $, B, w);
            try {
              return _._highlightFromHSource(A), A;
            } catch (S) {
              return p.eventEmitter.emit(p.INTERNAL_ERROR_EVENT, { type: y.ERROR.HIGHLIGHT_SOURCE_RECREATE, error: S, detail: A }), null;
            }
            ...
            var z = R.serialize(_.options.$root, _.hooks);
            return _.painter.highlightRange(R).length === 0 ? (p.eventEmitter.emit(p.INTERNAL_ERROR_EVENT, { type: y.ERROR.DOM_SELECTION_EMPTY }), null) : (_.cache.save(z), _.emit(y.EventType.CREATE, { sources: [z], type: y.CreateFrom.INPUT }, _), z);
            ...
            var z = R.target;
            if (!x.isHighlightWrapNode(z)) return _._hoverId && _.emit(y.EventType.HOVER_OUT, { id: _._hoverId }, _, R), void (_._hoverId = null);
            var $ = x.getHighlightId(z, _.options.$root);
            _._hoverId !== $ && (_._hoverId && _.emit(y.EventType.HOVER_OUT, { id: _._hoverId }, _, R), _._hoverId = $, _.emit(y.EventType.HOVER, { id: _._hoverId }, _, R));
            ...
            if (x.isHighlightWrapNode(z)) {
              var $ = x.getHighlightId(z, _.options.$root);
              _.emit(y.EventType.CLICK, { id: $ }, _, R);
            }
          }, _.options = p.getDefaultOptions(), _.hooks = _._getHooks(), _.setOption(T), _.cache = new b.default();
          var H = _.options.$root;
          return x.addEventListener(H, _.event.PointerOver, _._handleHighlightHover), x.addEventListener(H, _.event.PointerTap, _._handleHighlightClick), p.eventEmitter.on(p.INTERNAL_ERROR_EVENT, _._handleError), _;
        }
        return i(k, v), k.prototype.remove = function(T) {
          if (T) {
            var _ = this.painter.removeHighlight(T);
            this.cache.remove(T), _ && this.emit(y.EventType.REMOVE, { ids: [T] }, this);
          }
        }, k.prototype.removeAll = function() {
          this.painter.removeAllHighlight();
          var T = this.cache.removeAll();
          this.emit(y.EventType.REMOVE, { ids: T }, this);
        }, k.prototype._highlightFromHSource = function(T) {
          T === void 0 && (T = []);
          var _ = this.painter.highlightSource(T);
          this.emit(y.EventType.CREATE, { sources: _, type: y.CreateFrom.STORE }, this), this.cache.save(T);
        }, k.event = y.EventType, k.isHighlightWrapNode = x.isHighlightWrapNode, k.isHighlightSource = function(T) {
      ...
      o.getDomMeta = function(i, s, l) {
        var u = function(g) {
          ...
          for (var m = g.tagName, b = h.getElementsByTagName(m), C = 0; C < b.length; C++) if (g === b[C]) return C;
          return a.UNKNOWN_IDX;
        }(u, l), d = function(g, h) {
          for (var m = [g], b = null, C = 0; b = m.pop(); ) {
            for (var p = b.childNodes, y = p.length - 1; y >= 0; y--) m.push(p[y]);
            if (b.nodeType === 3 && b !== h) C += b.textContent.length;
      ...
      var u = l(r(2)), c = r(1), d = function(g) {
        ...
        return i(h, g), Object.defineProperty(h.prototype, "data", { get: function() {
          ...
          var m, b, C = [];
          try {
            for (var p = s(this._data), y = p.next(); !y.done; y = p.next()) {
              var x = y.value;
              C.push(x[1]);
            }
          } catch (E) {
      ...
      var a = this && this.__values || function(C) {
        var p = typeof Symbol == "function" && Symbol.iterator, y = p && C[p], x = 0;
        if (y) return y.call(C);
        if (C && typeof C.length == "number") return { next: function() {
          return C && x >= C.length && (C = void 0), { value: C && C[x++], done: !C };
        } };
      ...
      var u = l(r(3)), c = r(18), d = r(4), g = r(1), h = r(20), m = r(0), b = function() {
        function C(p, y) {
          this.options = { $root: p.$root, wrapTag: p.wrapTag, exceptSelectors: p.exceptSelectors, className: p.className }, this.hooks = y, h.initDefaultStylesheet();
        }
        return C.prototype.highlightRange = function(p) {
          var y = this;
          if (!p.frozen) throw g.ERROR.HIGHLIGHT_RANGE_FROZEN;
          var x = this.options, E = x.$root, v = x.className, k = x.exceptSelectors, T = this.hooks, _ = c.getSelectedNodes(E, p.start, p.end, k);
          return T.Render.SelectedNodes.isEmpty() || (_ = T.Render.SelectedNodes.call(p.id, _) || []), _.map(function(H) {
            var R = c.wrapHighlight(H, p, v, y.options.wrapTag);
            return T.Render.WrapNode.isEmpty() || (R = T.Render.WrapNode.call(p.id, R)), R;
          });
        }, C.prototype.highlightSource = function(p) {
          var y = this, x = Array.isArray(p) ? p : [p], E = [];
          return x.forEach(function(v) {
            if (v instanceof u.default) {
              var k = v.deSerialize(y.options.$root, y.hooks);
              y.highlightRange(k).length > 0 ? E.push(v) : m.eventEmitter.emit(m.INTERNAL_ERROR_EVENT, { type: g.ERROR.HIGHLIGHT_SOURCE_NONE_RENDER, detail: v });
            } else m.eventEmitter.emit(m.INTERNAL_ERROR_EVENT, { type: g.ERROR.SOURCE_TYPE_ERROR });
          }), E;
        }, C.prototype.removeHighlight = function(p) {
          var y, x, E = new RegExp("(" + p + "\\" + m.ID_DIVISION + "|\\" + m.ID_DIVISION + "?" + p + "$)"), v = this.hooks, k = this.options.wrapTag, T = document.querySelectorAll(k + "[data-" + m.DATASET_IDENTIFIER + "]"), _ = [], H = [], R = [];
          try {
            for (var z = a(T), $ = z.next(); !$.done; $ = z.next()) {
              var B = $.value, w = B.dataset[m.CAMEL_DATASET_IDENTIFIER], A = B.dataset[m.CAMEL_DATASET_IDENTIFIER_EXTRA];
              w !== p || A ? w === p ? H.push(B) : w !== p && E.test(A) && R.push(B) : _.push(B);
            }
          } catch (S) {
            y = { error: S };
          } finally {
          ...
          return _.forEach(function(S) {
            var O = S.parentNode, L = document.createDocumentFragment();
            d.forEach(S.childNodes, function(F) {
              return L.appendChild(F.cloneNode(!1));
            });
            var D = S.previousSibling, M = S.nextSibling;
            O.replaceChild(L, S), c.normalizeSiblingText(D, !0), c.normalizeSiblingText(M, !1), v.Remove.UpdateNodes.call(p, S, "remove");
          }), H.forEach(function(S) {
            var O = S.dataset, L = O[m.CAMEL_DATASET_IDENTIFIER_EXTRA].split(m.ID_DIVISION), D = L.shift(), M = document.querySelector(k + "[data-" + m.DATASET_IDENTIFIER + '="' + D + '"]');
            M && (d.removeAllClass(S), d.addClass(S, s(M.classList))), O[m.CAMEL_DATASET_IDENTIFIER] = D, O[m.CAMEL_DATASET_IDENTIFIER_EXTRA] = L.join(m.ID_DIVISION), v.Remove.UpdateNodes.call(p, S, "id-update");
          }), R.forEach(function(S) {
            var O = S.dataset[m.CAMEL_DATASET_IDENTIFIER_EXTRA];
            S.dataset[m.CAMEL_DATASET_IDENTIFIER_EXTRA] = O.replace(E, ""), v.Remove.UpdateNodes.call(p, S, "extra-update");
          }), _.length + H.length + R.length !== 0;
        }, C.prototype.removeAllHighlight = function() {
          var p = this.options, y = p.wrapTag, x = p.$root;
          d.getHighlightsByRoot(x, y).forEach(function(E) {
            var v = E.parentNode, k = document.createDocumentFragment();
            d.forEach(E.childNodes, function(T) {
              return k.appendChild(T.cloneNode(!1));
            }), v.replaceChild(k, E);
          });
        }, C;
      }();
      ...
      var s = r(1), l = r(4), u = r(0), c = r(19), d = function(m, b) {
        ...
        var y = b.toUpperCase();
        return m && m.tagName === y;
      };
      o.getSelectedNodes = function(m, b, C, p) {
        var y = b.$node, x = C.$node, E = b.offset, v = C.offset;
        if (y === x && y instanceof Text) return function(w, A, S, O) {
          ...
          w.splitText(A);
          var M = w.nextSibling;
          return M.splitText(S - A), [{ $node: M, type: s.SelectedNodeType.text, splitType: s.SplitType.both }];
        }(y, E, v, p);
        for (var k = [m], T = [], _ = function(w) {
          return p == null ? void 0 : p.some(function(A) {
            return d(w, A);
          });
        }, H = !1, R = null; R = k.pop(); ) if (R.nodeType !== 1 || !_(R)) {
          for (var z = R.childNodes, $ = z.length - 1; $ >= 0; $--) k.push(z[$]);
          if (R === y) {
            if (R.nodeType === 3) {
              R.splitText(E);
              var B = R.nextSibling;
              T.push({ $node: B, type: s.SelectedNodeType.text, splitType: s.SplitType.head });
            }
            H = !0;
          } else {
            if (R === x) {
              R.nodeType === 3 && ((B = R).splitText(v), T.push({ $node: B, type: s.SelectedNodeType.text, splitType: s.SplitType.tail }));
              break;
            }
            H && R.nodeType === 3 && T.push({ $node: R, type: s.SelectedNodeType.text, splitType: s.SplitType.none });
          }
        }
        return T;
      };
      ...
      o.wrapHighlight = function(m, b, C, p) {
        var y = m.$node.parentNode, x = m.$node.previousSibling, E = m.$node.nextSibling;
        return l.isHighlightWrapNode(y) ? !l.isHighlightWrapNode(y) || h(x) && h(E) ? function(v, k, T) {
          var _ = v.$node.parentNode, H = _;
          l.removeAllClass(H), g(H, T);
          var R = _.dataset, z = R[u.CAMEL_DATASET_IDENTIFIER];
        ...
        }(m, b, C) : function(v, k, T, _) {
          var H = document.createElement(_), R = v.$node.parentNode, z = v.$node.previousSibling, $ = v.$node.nextSibling, B = document.createDocumentFragment(), w = R.dataset[u.CAMEL_DATASET_IDENTIFIER], A = R.dataset[u.CAMEL_DATASET_IDENTIFIER_EXTRA], S = A ? w + u.ID_DIVISION + A : w;
          H.setAttribute("data-" + u.DATASET_IDENTIFIER, k.id), H.setAttribute("data-" + u.DATASET_IDENTIFIER_EXTRA, S), H.appendChild(v.$node.cloneNode(!1));
          var O, L = !1, D = !1;
          z && ((M = R.cloneNode(!1)).textContent = z.textContent, B.appendChild(M), L = !0);
          var M, F = [];
          return Array.isArray(T) ? F.push.apply(F, i(T)) : F.push(T), g(H, c.unique(F)), B.appendChild(H), $ && ((M = R.cloneNode(!1)).textContent = $.textContent, B.appendChild(M), D = !0), O = L && D ? s.SplitType.both : L ? s.SplitType.head : D ? s.SplitType.tail : s.SplitType.none, H.setAttribute("data-" + u.DATASET_SPLIT_TYPE, O), R.parentNode.replaceChild(B, R), H;
        }(m, b, C, p) : function(v, k, T, _) {
          var H = document.createElement(_);
          return g(H, T), H.appendChild(v.$node.cloneNode(!1)), v.$node.parentNode.replaceChild(H, v.$node), H.setAttribute("data-" + u.DATASET_IDENTIFIER, k.id), H.setAttribute("data-" + u.DATASET_SPLIT_TYPE, v.splitType), H.setAttribute("data-" + u.DATASET_IDENTIFIER_EXTRA, ""), H;
        }(m, b, C, p);
...
var nf = N2.exports;
const O2 = /* @__PURE__ */ no(nf), ta = "altimate-display-", of = `${ta}-highlight`, zc = `${ta}-highlight-hover`, rf = `${ta}-active-highlight`, af = 1049, zn = new O2({
  style: {
    className: of
  }
...
zn.hooks.Render.SelectedNodes.tap(D2);
zn.hooks.Serialize.Restore.tap(L2);
Ps.hooks.Render.SelectedNodes.tap(D2);
Ps.hooks.Serialize.Restore.tap(L2);
zn.on("selection:hover", ({ id: e }) => {
  zn.addClass(zc, e);
...
const sf = (e) => {
  ...
  const t = sf(e);
  t && (zn.remove(t.id), Ps.remove(t.id));
}, Bs = () => {
  var n, o;
  const e = Vs(), t = (e == null ? void 0 : e[1]) === "analysis" ? document.getElementById("sql") : document.getElementById("code");
  ...
  ).find((a) => a.innerText === e.column)) == null ? void 0 : t.parentElement) == null ? void 0 : n.querySelector("td:nth-child(3)") : (o = Ws()) == null ? void 0 : o.firstChild : Bs();
}, uf = (e) => {
...
`), s = Math.max(r.y, o.y), l = Array.from(a).findIndex((d) => {
  ...
  var e;
  return [
    (e = Bs()) == null ? void 0 : e.parentElement,
    Ws()
  ];
};
...
var j2 = Symbol.for("immer-nothing"), Ic = Symbol.for("immer-draftable"), et = Symbol.for("immer-state"), hf = process.env.NODE_ENV !== "production" ? [
...
function Ke(e, ...t) {
  if (process.env.NODE_ENV !== "production") {
    const n = hf[e], o = typeof n == "function" ? n.apply(null, t) : n;
...
function Wt(e) {
  var t;
  return e ? R2(e) || Array.isArray(e) || !!e[Ic] || !!((t = e.constructor) != null && t[Ic]) || oa(e) || ra(e) : !1;
}
var pf = Object.prototype.constructor.toString();
function R2(e) {
  ...
  return n === Object ? !0 : typeof n == "function" && Function.toString.call(n) === pf;
}
function Dr(e, t) {
  na(e) === 0 ? Reflect.ownKeys(e).forEach((n) => {
    t(n, e[n], e);
...
function $s(e, t = !1) {
  return aa(e) || wn(e) || !Wt(e) || (na(e) > 1 && (e.set = e.add = e.clear = e.delete = bf), Object.freeze(e), t && Object.entries(e).forEach(([n, o]) => $s(o, !0))), e;
}
function bf() {
  Ke(2);
}
...
function es(e) {
  ts(e), e.drafts_.forEach(vf), e.drafts_ = null;
}
function ts(e) {
  e === Eo && (Eo = e.parent_);
}
...
function Vc(e, t) {
  ...
  const n = t.drafts_[0];
  return e !== void 0 && e !== n ? (n[et].modified_ && (es(t), Ke(4)), Wt(e) && (e = Lr(t, e), t.parent_ || jr(t, e)), t.patches_ && En("Patches").generateReplacementPatches_(
    n[et].base_,
    e,
    t.patches_,
    t.inversePatches_
  )) : e = Lr(t, n, []), es(t), t.patches_ && t.patchListener_(t.patches_, t.inversePatches_), e !== j2 ? e : void 0;
}
function Lr(e, t, n) {
  if (aa(t))
    return t;
  ...
  if (!o.finalized_) {
    ...
    o.type_ === 3 && (a = new Set(r), r.clear(), i = !0), Dr(
      a,
      (s, l) => Wc(e, o, r, s, l, n, i)
    ), jr(e, r, !1), n && e.patches_ && En("Patches").generatePatches_(
      o,
      n,
      e.patches_,
      e.inversePatches_
...
function Wc(e, t, n, o, r, a, i) {
  if (process.env.NODE_ENV !== "production" && r === n && Ke(5), wn(r)) {
    const s = a && t && t.type_ !== 3 && // Set objects are atomic since they have no keys.
    !Ji(t.assigned_, o) ? a.concat(o) : void 0, l = Lr(e, r, s);
    if (H2(n, o, l), wn(l))
      e.canAutoFreeze_ = !1;
    else
      return;
  ...
  if (Wt(r) && !aa(r)) {
    if (!e.immer_.autoFreeze_ && e.unfinalizedDrafts_ < 1)
      return;
    Lr(e, r), (!t || !t.scope_.parent_) && typeof o != "symbol" && Object.prototype.propertyIsEnumerable.call(n, o) && jr(e, r);
  }
}
function jr(e, t, n = !1) {
...
var Zs = {
  get(e, t) {
    ...
    if (!Ji(n, t))
      return wf(e, n, t);
    const o = n[t];
    return e.finalized_ || !Wt(o) ? o : o === wi(e.base_, t) ? (Ei(e), e.copy_[t] = os(o, e)) : o;
  },
  has(e, t) {
    return t in fn(e);
  },
  ...
  set(e, t, n) {
    ...
    if (!e.modified_) {
      const r = wi(fn(e), t), a = r == null ? void 0 : r[et];
      if (a && a.base_ === n)
        return e.copy_[t] = n, e.assigned_[t] = !1, !0;
      if (mf(n, r) && (n !== void 0 || Ji(e.base_, t)))
        return !0;
      Ei(e), ns(e);
    }
  ...
  deleteProperty(e, t) {
    return wi(e.base_, t) !== void 0 || t in e.base_ ? (e.assigned_[t] = !1, Ei(e), ns(e)) : delete e.assigned_[t], e.copy_ && delete e.copy_[t], !0;
  },
  // Note: We never coerce `desc.value` into an Immer draft, because we can't make
  // the same guarantee in ES5 mode.
  getOwnPropertyDescriptor(e, t) {
    const n = fn(e), o = Reflect.getOwnPropertyDescriptor(n, t);
    return o && {
      writable: !0,
...
So.set = function(e, t, n) {
  return process.env.NODE_ENV !== "production" && t !== "length" && isNaN(parseInt(t)) && Ke(14), Zs.set.call(this, e[0], t, n, e[0]);
};
function wi(e, t) {
  const n = e[et];
  return (n ? fn(n) : e)[t];
...
var Ef = class {
  constructor(e) {
    this.autoFreeze_ = !0, this.useStrictShallowCopy_ = !1, this.produce = (t, n, o) => {
      ...
      if (Wt(t)) {
        ...
        return Pc(a, o), Vc(r, a);
      } else if (!t || typeof t != "object") {
        if (r = n(t), r === void 0 && (r = t), r === j2 && (r = void 0), this.autoFreeze_ && $s(r, !0), o) {
          const a = [], i = [];
          En("Patches").generateReplacementPatches_(t, r, a, i), o(a, i);
        }
        return r;
      } else
        Ke(1, t);
  ...
  createDraft(e) {
    Wt(e) || Ke(8), wn(e) && (e = Sf(e));
    const t = Bc(this), n = os(e, void 0);
    return n[et].isManual_ = !0, ts(t), n;
  }
  finishDraft(e, t) {
    const n = e && e[et];
    (!n || !n.isManual_) && Ke(9);
    const { scope_: o } = n;
    return Pc(o, t), Vc(void 0, o);
  }
  /**
  ...
  applyPatches(e, t) {
    ...
    n > -1 && (t = t.slice(n + 1));
    const o = En("Patches").applyPatches_;
    return wn(e) ? o(e, t) : this.produce(
      e,
      (r) => o(r, t)
    );
  }
...
function os(e, t) {
  const n = oa(e) ? En("MapSet").proxyMap_(e, t) : ra(e) ? En("MapSet").proxySet_(e, t) : xf(e, t);
  return (t ? t.scope_ : F2()).drafts_.push(n), n;
}
function Sf(e) {
  return wn(e) || Ke(10, e), I2(e);
}
function I2(e) {
  if (!Wt(e) || aa(e))
    return e;
  ...
  if (t) {
    if (!t.modified_)
      return t.base_;
    t.finalized_ = !0, n = Qi(e, t.scope_.immer_.useStrictShallowCopy_);
  } else
    n = Qi(e, !0);
  return Dr(n, (o, r) => {
    H2(n, o, I2(r));
...
function $c(e, t) {
  ...
  return n.toString = () => `${e}`, n.type = e, n.match = (o) => gf(o) && o.type === e, n;
}
function Zc(e) {
  return Wt(e) ? P2(e, () => {
  }) : e;
...
var Af = /* @__PURE__ */ Symbol.for("rtk-slice-createasyncthunk");
function Mf(e, t) {
  return `${e}/${t}`;
}
function Tf({
  ...
  var n;
  const t = (n = e == null ? void 0 : e.asyncThunk) == null ? void 0 : n[Af];
  return function(r) {
    const {
      name: a,
      reducerPath: i = a
    ...
    const s = (typeof r.reducers == "function" ? r.reducers(Of()) : r.reducers) || {}, l = Object.keys(s), u = {
    ...
    function d() {
      ...
      const [x = {}, E = [], v = void 0] = typeof r.extraReducers == "function" ? B2(r.extraReducers) : [r.extraReducers], k = {
        ...x,
        ...u.sliceCaseReducersByType
      };
      return kf(r.initialState, (T) => {
        for (let _ in k)
          T.addCase(_, k[_]);
        for (let _ of u.sliceMatchers)
          T.addMatcher(_.matcher, _.reducer);
        for (let _ of E)
          T.addMatcher(_.matcher, _.reducer);
        v && T.addDefaultCase(v);
      });
    }
...
function Df({
  ...
  if ("reducer" in o) {
    ...
    a = o;
  r.addCase(e, a).exposeCaseReducer(t, a).exposeAction(t, i ? $c(e, i) : $c(e));
}
function Lf(e) {
...
const Hf = {
  ...
  setCurrentUserId: uC,
  setShareId: dC,
  updateSelectedConversationId: Us,
  updateRightPanelState: Ys,
  setUsers: Ff,
  setConversations: zf,
  resetNewConversation: Gs,
  updateNewConversation: Ks,
  upsertConversation: fC,
  setDocsAppRendered: gC,
  updateCurrentPage: hC,
  updateCodeblockLoaded: pC,
  resolveConversationGroup: If,
  setConversationsLoadingState: Uc,
  refetchConversations: V2,
  ...
  return /* @__PURE__ */ f.jsx(ia.Provider, { value: l, children: e });
}, Vf = () => Re(ia), we = (e) => {
  const { getValue: t } = Re(ia);
  return t(e);
}, dt = () => {
  const { dispatch: e } = Re(ia);
  return e;
}, Wf = (e) => e;
let W2 = Wf;
process.env.NODE_ENV !== "production" && (W2 = (e, t) => {
  if (!e)
    throw new Error(t);
});
const $f = ut(null), Zf = ut({}), qf = ut({
  transformPagePoint: (e) => e,
  isStatic: !1,
  reducedMotion: "never"
}), Uf = typeof window < "u", Yf = Uf ? Sd : re;
function $2(e) {
  const t = se(null);
...
function Kf({ children: e, isPresent: t }) {
  const n = E2(), o = se(null), r = se({
    width: 0,
    height: 0,
    top: 0,
    left: 0
  ...
  }, [t]), f.jsx(Gf, { isPresent: t, childRef: o, sizeRef: r, children: N.cloneElement(e, { ref: o }) });
}
const Xf = ({ children: e, initial: t, isPresent: n, onExitComplete: o, custom: r, presenceAffectsLayout: a, mode: i }) => {
  const s = $2(Jf), l = E2(), u = Se(
    () => ({
      id: l,
      initial: t,
      isPresent: n,
  ...
  return Se(() => {
    ...
    !n && !s.size && o && o();
  }, [n]), i === "popLayout" && (e = f.jsx(Kf, { isPresent: n, children: e })), f.jsx($f.Provider, { value: u, children: e });
};
function Jf() {
...
const Qf = ({ children: e, exitBeforeEnter: t, custom: n, initial: o = !0, onExitComplete: r, presenceAffectsLayout: a = !0, mode: i = "sync" }) => {
  W2(!t, "Replace exitBeforeEnter with mode='wait'");
  const s = Se(() => Yc(e), [e]), l = s.map(ir), u = se(!0), c = se(s), d = $2(() => /* @__PURE__ */ new Map()), [g, h] = ae(s), [m, b] = ae(s);
  Yf(() => {
  ...
  if (s !== g) {
    ...
    for (let x = 0; x < m.length; x++) {
      const E = m[x], v = ir(E);
      l.includes(v) || (y.splice(x, 0, E), C.push(E));
    }
    i === "wait" && C.length && (y = C), b(Yc(y)), h(s);
    return;
  }
  ...
  const { forceRender: p } = Re(Zf);
  return f.jsx(f.Fragment, { children: m.map((y) => {
    const x = ir(y), E = s === m || l.includes(x), v = () => {
      if (d.has(x))
        d.set(x, !0);
      else
        return;
...
}, h5 = (e) => _e.get(`dbt/dbt_docs_share/${e}`), p5 = (e, t, n) => _e.post(`dbt/dbt_docs_share/${e}/conversation_group`, {
  ...t,
  telemetry: {
...
), y5 = (e) => _e.get("users/chat", { company: e }), C5 = (e, t, n) => _e.post(
  ...
  const l = pe(() => {
    console.log("resetHighlights"), r && lf(r), s(null), a(null);
  }, [r]);
  return re(() => {
    ...
    pos: i,
    onSelectionEnd: (c) => {
      const d = c.target, g = uf(d), { end: h, start: m } = c.detail.selectionRange, b = document.getSelection();
      if (!b || !b.rangeCount)
        return l(), null;
      const p = b.getRangeAt(0).toString(), y = d == null ? void 0 : d.innerText;
      if (!p || !y)
        return;
      const { end: x, start: E, x: v, y: k } = df(
        g,
        d,
        p,
        h,
      ...
      o(Gs()), s({
        ...
        y: k,
        element: d
      }), document.body.addEventListener("click", l, { once: !0 }), a(T);
    }
  };
}, w5 = ({
  conversationGroup: e
  ...
  ), n = dt(), o = se(null), r = Se(() => cf(e.meta), [e.meta]), a = () => {
    n(
      Us(e.conversation_group_id)
    );
  }, i = Se(() => {
    if (!r)
      return;
  ...
  }, [e.conversation_group_id, t]), !i || !(r != null && r.parentElement) ? null : Mn(
    /* @__PURE__ */ f.jsx(
      "div",
      {
        ref: o,
...
}, S5 = "_dbtDocs_14zop_9", _5 = "_hotspotButton_14zop_46", k5 = "_pulse_14zop_1", A5 = "_conversationRightPanelCloseButton_14zop_62", M5 = "_conversationRightPanel_14zop_62", T5 = "_newConversationForm_14zop_94", N5 = "_highlightText_14zop_108", O5 = "_conversationInputForm_14zop_130", D5 = "_conversationGroup_14zop_156", L5 = "_replyForm_14zop_189", j5 = "_resolveButton_14zop_237", $t = {
  dbtDocs: S5,
  hotspotButton: _5,
  pulse: k5,
  conversationRightPanelCloseButton: A5,
  conversationRightPanel: M5,
  newConversationForm: T5,
  highlightText: N5,
  conversationInputForm: O5,
  conversationGroup: D5,
  replyForm: L5,
  resolveButton: j5
}, R5 = "_profileImage_11vaf_1", H5 = {
  profileImage: R5
}, U2 = ({ user: e }) => {
  var t;
  return /* @__PURE__ */ f.jsx("div", { className: H5.profileImage, children: ((t = e == null ? void 0 : e.first_name) == null ? void 0 : t[0]) || "" });
};
function F5(e) {
  if (Array.isArray(e)) {
...
function rs(e, t) {
  return rs = Object.setPrototypeOf || function(o, r) {
...
function Er(e) {
  return typeof Symbol == "function" && In(Symbol.iterator) === "symbol" ? Er = function(n) {
    return In(n);
  } : Er = function(n) {
    return n && typeof Symbol == "function" && n.constructor === Symbol && n !== Symbol.prototype ? "symbol" : In(n);
  }, Er(e);
}
function $5(e, t) {
  return t && (Er(t) === "object" || typeof t == "function") ? t : de(e);
}
function Fr(e) {
...
var Z5 = function(e, t, n, o, r, a, i, s) {
...
function ko(e, t, n) {
  return (t = Q5(t)) in e ? Object.defineProperty(e, t, {
    value: n,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
function G2(e, t) {
  ...
  return Sr(e) && Sr(t) && oo(t).forEach(function(o) {
    Sr(t[o]) ? o in e ? n[o] = G2(e[o], t[o]) : Object.assign(n, ko({}, o, t[o])) : Object.assign(n, ko({}, o, t[o]));
  }), n;
}
var is = function(t) {
  ...
  for (var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], o = oo(t), r = {}, a = 0, i = o.length; a < i; a += 1) {
  ...
  for (var o = n.map(Gc), r = oo(t), a = {}, i = 0, s = r.length; i < s; i += 1) {
    var l = r[i];
    (n.indexOf(l) >= 0 || o.indexOf(Gc(l)) >= 0) && (a[l] = t[l]);
  }
  return a;
}, l4 = function e(t, n) {
  for (var o = is.apply(void 0, [{}, r4(t, n)].concat(Pt(Y2(K2(t, n))))), r = oo(o).filter(Xs), a = 0, i = r.length; a < i; a += 1) {
    var s = r[a], l = e(o[s], n);
    n.indexOf(s) >= 0 ? (delete o[s], o = is({}, o, l)) : o[s] = l;
  }
  return o;
};
function Kc(e, t) {
...
var c4 = ["animationName"], X2 = function(t) {
...
var Q2 = function(t) {
  if (t) {
    ...
    if (!Array.isArray(t)) {
      var n = t;
      return oo(t).reduce(function(o, r) {
...
function e0(e) {
  var t = e.style, n = e.className, o = e.classNames, r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : X2, a = n || f4(o) || (t == null ? void 0 : t.className), i = typeof t == "function" ? t : d4(function(d, g) {
    var h = Q2(d);
    Un(Array.isArray(h), "First parameter must be a string, an array of strings, a plain object with boolean values, or a falsy value."), Un(!g || Sr(g), "Optional second parameter must be a plain object.");
    var m = h.filter(Xs), b = h.filter(i4), C = b.length > 0 ? function(x) {
      return Y2(K2(x, b));
    } : function(x) {
      return [x];
    }, p = function() {
    ...
    return e0(On(On(On({}, (t || g) && {
      style: is.apply(void 0, [{}].concat(Pt(p(g)), Pt(p(t))))
    }), y && {
      className: y.join(" ")
    }), o && {
      classNames: o
    }), r);
  }), s = On({}, typeof t == "function" ? t : {
    style: t
  }), l = Pt(new Set([].concat(Pt(s.className ? s.className.split(" ") : []), Pt(a ? a.split(" ") : [])))), u = o ? a4(l.map(function(d) {
    return o[d];
  })) : l, c = r(On(On({}, s), u.length > 0 ? {
    className: u.join(" ")
  } : {}));
...
var h4 = function() {
  ...
  return n.reduce(function(r, a) {
    return lo(lo(lo({}, r), typeof a == "function" ? a : {}), {}, {
      style: lo(lo({}, r.style), typeof a == "function" ? a.style : a)
    });
  }, {});
}, Js = function(t, n, o) {
  var r = n.style, a = n.className, i = n.classNames, s = Re(J2), l = Se(function() {
    return e0({
      style: r,
      className: a,
      classNames: i
...
function p4() {
  ...
  return me.AsyncMode = l, me.ConcurrentMode = u, me.ContextConsumer = s, me.ContextProvider = i, me.Element = t, me.ForwardRef = c, me.Fragment = o, me.Lazy = m, me.Memo = h, me.Portal = n, me.Profiler = a, me.StrictMode = r, me.Suspense = d, me.isAsyncMode = function(v) {
    return E(v) || x(v) === l;
  }, me.isConcurrentMode = E, me.isContextConsumer = function(v) {
    return x(v) === s;
    ...
    return typeof v == "string" || typeof v == "function" || v === o || v === u || v === a || v === r || v === d || v === g || typeof v == "object" && v !== null && (v.$$typeof === m || v.$$typeof === h || v.$$typeof === i || v.$$typeof === s || v.$$typeof === c || v.$$typeof === C || v.$$typeof === p || v.$$typeof === y || v.$$typeof === b);
  }, me.typeOf = x, me;
}
var be = {};
/** @license React v16.13.1
...
function m4() {
  return t1 || (t1 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function x(G) {
      ...
      G === o || G === u || G === a || G === r || G === d || G === g || typeof G == "object" && G !== null && (G.$$typeof === m || G.$$typeof === h || G.$$typeof === i || G.$$typeof === s || G.$$typeof === c || G.$$typeof === C || G.$$typeof === p || G.$$typeof === y || G.$$typeof === b);
    }
    function E(G) {
    ...
    var v = l, k = u, T = s, _ = i, H = t, R = c, z = o, $ = m, B = h, w = n, A = a, S = r, O = d, L = !1;
    function D(G) {
      return L || (L = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), M(G) || E(G) === l;
    }
    function M(G) {
      return E(G) === u;
    }
    ...
    be.AsyncMode = v, be.ConcurrentMode = k, be.ContextConsumer = T, be.ContextProvider = _, be.Element = H, be.ForwardRef = R, be.Fragment = z, be.Lazy = $, be.Memo = B, be.Portal = w, be.Profiler = A, be.StrictMode = S, be.Suspense = O, be.isAsyncMode = D, be.isConcurrentMode = M, be.isContextConsumer = F, be.isContextProvider = I, be.isElement = V, be.isForwardRef = W, be.isFragment = q, be.isLazy = K, be.isMemo = X, be.isPortal = J, be.isProfiler = te, be.isStrictMode = Z, be.isSuspense = fe, be.isValidElementType = x, be.typeOf = E;
  }()), be;
}
var n1;
function t0() {
  return n1 || (n1 = 1, process.env.NODE_ENV === "production" ? sr.exports = p4() : sr.exports = m4()), sr.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function b4() {
  ...
  return Si = r() ? Object.assign : function(a, i) {
...
var ki, a1;
function n0() {
  return a1 || (a1 = 1, ki = Function.call.bind(Object.prototype.hasOwnProperty)), ki;
}
var Ai, i1;
function y4() {
  if (i1) return Ai;
...
function C4() {
  if (s1) return Mi;
  s1 = 1;
  var e = t0(), t = b4(), n = Qs(), o = n0(), r = y4(), a = function() {
  };
  ...
  return Mi = function(s, l) {
    ...
    function p(M) {
      function F(I, V, W, q, K, X) {
        ...
        if (te !== M) {
          var Z = O(J);
          return new b(
            "Invalid " + q + " `" + K + "` of type " + ("`" + Z + "` supplied to `" + W + "`, expected ") + ("`" + M + "`."),
            { expectedType: M }
          );
        }
        return null;
    ...
    function T(M) {
      ...
      function F(I, V, W, q, K) {
        for (var X = I[V], J = 0; J < M.length; J++)
          if (m(X, M[J]))
            return null;
        var te = JSON.stringify(M, function(fe, G) {
          var ye = O(G);
    ...
    function z(M, F, I, V, W) {
      return new b(
        (M || "React class") + ": " + F + " type `" + I + "." + V + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + W + "`."
      );
    }
    function $(M) {
      function F(I, V, W, q, K) {
...
Valid keys: ` + JSON.stringify(Object.keys(M), null, "  ")
    ...
    function S(M) {
      var F = typeof M;
      return Array.isArray(M) ? "array" : M instanceof RegExp ? "object" : A(F, M) ? "symbol" : F;
    }
    function O(M) {
...
function v4() {
  ...
  return n.resetWarningCache = t, Ti = function() {
...
if (process.env.NODE_ENV !== "production") {
  var x4 = t0(), w4 = !0;
  ss.exports = C4()(x4.isElement, w4);
} else
  ss.exports = v4()();
var E4 = ss.exports;
const Q = /* @__PURE__ */ no(E4);
var _r = function(t) {
  ...
  Un(n === "id" || n === "display", 'Second arg must be either "id" or "display", got: "'.concat(n, '"'));
  var o = t.indexOf(At.display), r = t.indexOf(At.id);
  return o < 0 && (o = null), r < 0 && (r = null), Un(o !== null || r !== null, "The markup '".concat(t, "' does not contain either of the placeholders '__id__' or '__display__'")), o !== null && r !== null ? n === "id" && r <= o || n === "display" && o <= r ? 0 : 1 : 0;
}, S4 = function(t) {
  var n = /^\/(.+)\/(\w+)?$/;
  return new RegExp(t.map(function(o) {
    var r = n.exec(o.toString()), a = zr(r, 3), i = a[1], s = a[2];
    return Un(!s, "RegExp flags are not supported. Change /".concat(i, "/").concat(s, " into /").concat(i, "/")), "(".concat(i, ")");
  }).join("|"), "g");
}, o0 = function(t) {
  var n = 0;
  ...
  for (var r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : _4, a = S4(n.map(function(v) {
    return v.regex;
    ...
    var d = s.find(function(v) {
      return !!l[v];
    }), g = s.indexOf(d), h = n[g], m = h.markup, b = h.displayTransform, C = d + c1(m, "id"), p = d + c1(m, "display"), y = l[C], x = b(y, l[p]), E = t.substring(u, l.index);
    r(E, u, c), c += E.length, o(l[0], l.index, c, y, x, g, u), c += x.length, u = a.lastIndex;
  }
  ...
  var a = o.selectionStartBefore, i = o.selectionEndBefore, s = o.selectionEndAfter, l = hn(t, r), u = l.length - n.length;
  ...
  var h = Ye(t, r, d, "START"), m = Ye(t, r, g, "END"), b = Ye(t, r, d, "NULL"), C = Ye(t, r, g, "NULL"), p = b === null || C === null, y = vo(t, h, m, c);
  if (!p) {
    var x = hn(y, r);
    if (x !== n) {
      for (d = 0; n[d] === x[d]; )
        d++;
      c = n.slice(d, s), g = l.lastIndexOf(n.substring(s)), h = Ye(t, r, d, "START"), m = Ye(t, r, g, "END"), y = vo(t, h, m, c);
    }
  }
  return y;
}, u1 = function(t, n, o) {
  ...
  var o = mo(t, n), r = o[o.length - 1];
  return r ? r.plainTextIndex + r.display.length : 0;
}, M4 = function(t) {
  var n = _r(t), o = t[t.indexOf(At.display) + At.display.length], r = t[t.indexOf(At.id) + At.id.length];
  return new RegExp(n.replace(At.display, "([^".concat(_r(o || ""), "]+?)")).replace(At.id, "([^".concat(_r(r || ""), "]+?)")));
}, Qt = function(t) {
  ...
  var o = new RegExp(t.toString() + "|").exec("").length - 1, r = o0(n);
  return Un(o === r, "Number of capturing groups in RegExp ".concat(t.toString(), " (").concat(o, ") does not match the number of placeholders in the markup '").concat(n, "' (").concat(r, ")")), t;
}, N4 = function(t, n, o) {
  ...
  var n = t;
  return O4.forEach(function(o) {
    n = n.replace(o.letters, o.base);
  }), n;
}, d1 = function(t) {
  return D4(t).toLowerCase();
}, a0 = function(t, n, o) {
  return o ? d1(t).indexOf(d1(n)) : t.toLowerCase().indexOf(n.toLowerCase());
}, L4 = function() {
...
function sa(e, t) {
  var n = function(r) {
    var a = function(l) {
      var u = l.style, c = l.className, d = l.classNames, g = X5(l, H4), h = t ? t(g) : void 0, m = Js(e, {
        style: u,
        className: c,
        classNames: d
      }, h);
...
function i0(e) {
  ...
  var l = e.style, u = ae({
    left: void 0,
    top: void 0
  }), c = zr(u, 2), d = c[0], g = c[1], h = ae(), m = zr(h, 2), b = m[0], C = m[1];
  re(function() {
    p();
  });
  var p = function() {
    if (b) {
      var w = b.offsetLeft, A = b.offsetTop;
      if (!(d.left === w && d.top === A)) {
        var S = {
          left: w,
          top: A
  ...
  n === t && (x = Ye(r, y, t, "START"));
  var E = [], v = {}, k = E, T = 0, _ = function(w, A, S) {
    if (ls(x) && x >= A && x <= A + w.length) {
      var O = x - A;
      k.push(R(w.substring(0, O), T)), k = [R(w.substring(O), T)];
    } else
      k.push(R(w, T));
    T++;
  }, H = function(w, A, S, O, L, D, M) {
    var F = F4(v, O);
    k.push(z(O, L, D, F));
  }, R = function(w, A) {
  ...
  return Zo(r, y, H, _), k.push(" "), k !== E && E.push($(k)), /* @__PURE__ */ P.createElement("div", ct({}, l, {
    ref: i
  }), E);
}
i0.propTypes = {
...
function s0(e) {
  ...
  var d = {
    ...
    var p = a0(C, s, o);
    return p === -1 ? /* @__PURE__ */ P.createElement("span", c("display"), C) : /* @__PURE__ */ P.createElement("span", c("display"), C.substring(0, p), /* @__PURE__ */ P.createElement("b", c("highlight"), C.substring(p, p + s.length)), C.substring(p + s.length));
  };
...
function V4(e) {
  var t = e.style, n = e.className, o = e.classNames, r = Js(W4, {
    style: t,
    className: n,
    classNames: o
  }), a = r("spinner");
...
function l0(e) {
  var t = e.id, n = e.suggestions, o = n === void 0 ? {} : n, r = e.a11ySuggestionsListLabel, a = e.focusIndex, i = e.position, s = e.left, l = e.right, u = e.top, c = e.scrollFocusedIntoView, d = e.isLoading, g = e.isOpened, h = e.onSelect, m = h === void 0 ? function() {
    return null;
  } : h, b = e.ignoreAccents, C = e.containerRef, p = e.children, y = e.style, x = e.customSuggestionsContainer, E = e.onMouseDown, v = e.onMouseEnter, k = ae(void 0), T = zr(k, 2), _ = T[0], H = T[1];
  re(function() {
    if (!(!_ || _.offsetHeight >= _.scrollHeight || !c)) {
      var S = _.scrollTop, O = _.children[a].getBoundingClientRect(), L = O.top, D = O.bottom, M = _.getBoundingClientRect(), F = M.top;
      L = L - F + S, D = D - F + S, L < S ? _.scrollTop = L : D > _.offsetHeight && (_.scrollTop = D - _.offsetHeight);
    }
  }, [a, c, _]);
  var R = function() {
    var O = /* @__PURE__ */ P.createElement("ul", ct({
      ...
      role: "listbox",
      "aria-label": r
    }, y("list")), Object.values(o).reduce(function(L, D) {
      var M = D.results, F = D.queryInfo;
      return [].concat(Hr(L), Hr(M.map(function(I, V) {
        return z(I, F, L.length + V);
      })));
    }, []));
    return x ? x(O) : O;
  }, z = function(O, L, D) {
    var M = D === a, F = L.childIndex, I = L.query, V = Zn.toArray(p)[F].props.renderSuggestion;
    return /* @__PURE__ */ P.createElement(B4, {
      style: y("item"),
      key: "".concat(F, "-").concat(A(O)),
      id: r0(t, D),
      query: I,
      index: D,
      ignoreAccents: b,
    ...
    if (d)
      return /* @__PURE__ */ P.createElement(V4, {
        style: y("loadingIndicator")
      });
  }, B = function(O, L) {
    v && v(O);
  }, w = function(O, L) {
  ...
  return g ? /* @__PURE__ */ P.createElement("div", ct({}, h4({
    position: i || "absolute",
    left: s,
    right: l,
    top: u
...
function mt(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? arguments[t] : {};
    t % 2 ? h1(Object(n), !0).forEach(function(o) {
      le(e, o, n[o]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n)) : h1(Object(n)).forEach(function(o) {
      Object.defineProperty(e, o, Object.getOwnPropertyDescriptor(n, o));
    });
  }
  return e;
...
var Y4 = function(t) {
  ...
  if (t instanceof RegExp)
    return t;
  var o = n.allowSpaceInQuery, r = _r(t);
  ...
  function n(o) {
    var r;
    return P5(this, n), r = t.call(this, o), le(de(r), "setContainerElement", function(a) {
      r.containerElement = a;
    }), le(de(r), "getInputProps", function() {
      var a = r.props, i = a.readOnly, s = a.disabled, l = a.style, u = R4(
        r.props,
      ...
      return mt(mt(mt(mt({}, u), l("input")), {}, {
        ...
        "aria-activedescendant": r0(r.uuidSuggestionsOverlay, r.state.focusIndex)
      });
      ...
      if (!ls(r.state.selectionStart))
        return null;
      var a = r.state.suggestionsPosition, i = a.position, s = a.left, l = a.top, u = a.right, c = /* @__PURE__ */ P.createElement(Z4, {
      ...
      return r.props.suggestionsPortalHost ? /* @__PURE__ */ Pd.createPortal(c, r.props.suggestionsPortalHost) : c;
      ...
      return /* @__PURE__ */ P.createElement(I4, {
      ...
      return hn(r.props.value || "", Qt(r.props.children));
      ...
      u = hn(g, l);
      var h = a.target.selectionStart, m = a.target.selectionEnd, b = !1, C = u1(s, l, h);
      C !== void 0 && r.state.selectionEnd > C && (h = C + (a.nativeEvent.data ? a.nativeEvent.data.length : 0), m = h, b = !0), r.setState({
        selectionStart: h,
        selectionEnd: m,
      ...
      switch (Object.values(Dn).indexOf(a.keyCode) >= 0 && (a.preventDefault(), a.stopPropagation()), a.keyCode) {
        case Dn.ESC: {
          r.clearSuggestions();
          return;
        }
      ...
      var a = r.state, i = a.suggestions, s = a.focusIndex, l = Object.values(i).reduce(function(d, g) {
        ...
        return [].concat(Hr(d), Hr(h.map(function(b) {
          return {
            result: b,
            queryInfo: m
          };
      ...
      if (!(!a || !r.suggestionsElement)) {
        var c = r.suggestionsElement, d = r.highlighterElement, g = d.getBoundingClientRect(), h = Ni(d, "font-size"), m = {
          left: g.left + a.left,
          top: g.top + a.top + h
        ...
        if (c) {
          ...
          if (s) {
            C.position = "fixed";
            var p = m.left, y = m.top;
            p -= Ni(c, "margin-left"), y -= Ni(c, "margin-top"), p -= d.scrollLeft, y -= d.scrollTop;
            var x = Math.max(document.documentElement.clientWidth, window.innerWidth || 0);
            p + c.offsetWidth > x ? C.left = Math.max(0, x - c.offsetWidth) : C.left = p, l && y + c.offsetHeight > b && c.offsetHeight < y - h || u ? C.top = Math.max(0, y - c.offsetHeight - h) : C.top = y;
          } else {
            var E = a.left - d.scrollLeft, v = a.top - d.scrollTop;
            E + c.offsetWidth > r.containerElement.offsetWidth ? C.right = 0 : C.left = E, l && m.top - d.scrollTop + c.offsetHeight > b && c.offsetHeight < g.top - h - d.scrollTop || u ? C.top = v - c.offsetHeight - h : C.top = v;
          }
      ...
      if (c !== null) {
        var d = A4(s.substring(0, c), u), g = a.substring(d, i);
        P.Children.forEach(l, function(h, m) {
          if (h) {
            var b = Y4(h.props.trigger, r.props), C = g.match(b);
            if (C) {
              var p = d + g.indexOf(C[1], C.index);
      ...
      var c = r.props, d = c.children, g = c.ignoreAccents, h = Zn.toArray(d)[i], m = G4(h.props.data, g), b = m(a, r.updateSuggestions.bind(null, r._queryId, i, a, s, l, u));
      ...
      var s = a.id, l = a.display, u = i.childIndex, c = i.querySequenceStart, d = i.querySequenceEnd, g = i.plainTextValue, h = r.props.value || "", m = Qt(r.props.children), b = Zn.toArray(r.props.children)[u], C = b.props, p = C.markup, y = C.displayTransform, x = C.appendSpaceOnAdd, E = C.onAdd, v = Ye(h, m, c, "START"), k = v + d - c, T = N4(p, s, l);
      x && (T += " ");
      var _ = vo(h, v, k, T);
      ...
      r.executeOnChange(z, _, B, $), E && E(s, l, v, k), r.clearSuggestions();
      ...
      return ls(r.state.selectionStart) && (lr(r.state.suggestions) !== 0 || r.isLoading());
  ...
  return V5(n, [{
    ...
    value: function(r) {
      if (r.target === this.inputElement && this.supportsClipboardActions(r)) {
        r.preventDefault();
        var a = this.state, i = a.selectionStart, s = a.selectionEnd, l = this.props, u = l.value, c = l.children, d = Qt(c), g = Ye(u, d, i, "START"), h = Ye(u, d, s, "END"), m = r.clipboardData.getData("text/react-mentions"), b = r.clipboardData.getData("text/plain"), C = vo(u, g, h, m || b).replace(/\r/g, ""), p = hn(C, d), y = {
          target: mt(mt({}, r.target), {}, {
            value: C
          })
        };
        this.executeOnChange(y, C, p, mo(C, d));
        var x = u1(u, d, i), E = (x || i) + hn(m || b, d).length;
        this.setState({
          selectionStart: E,
          selectionEnd: E,
    ...
    value: function(r) {
      if (r.target === this.inputElement && this.supportsClipboardActions(r)) {
        ...
        var a = this.state, i = a.selectionStart, s = a.selectionEnd, l = this.props, u = l.children, c = l.value, d = Qt(u), g = Ye(c, d, i, "START"), h = Ye(c, d, s, "END"), m = [c.slice(0, g), c.slice(h)].join(""), b = hn(m, d), C = {
          target: mt(mt({}, r.target), {}, {
            value: b
          })
        };
        this.executeOnChange(C, m, b, mo(c, d));
      }
    }
...
var Ni = function(t, n) {
...
}, K4 = typeof navigator < "u" && /iPhone|iPad|iPod/i.test(navigator.userAgent), X4 = sa({
  position: "relative",
  overflowY: "visible",
  input: {
    display: "block",
  ...
  var n = t.display, o = t.style, r = t.className, a = t.classNames, i = Js(Q4, {
    style: o,
    className: r,
    classNames: a
  });
...
const e8 = {
  ...
  r ? /* @__PURE__ */ f.jsx(U2, { user: r }) : null,
  /* @__PURE__ */ f.jsx(
    t8,
    {
      value: e,
  ...
  /* @__PURE__ */ f.jsx(Fs, { loading: n, color: "primary", children: /* @__PURE__ */ f.jsx(u5, {}) })
] }), d0 = ({
  ...
  const e = we(
    ...
    if (c == null || c.stopPropagation(), c == null || c.preventDefault(), !(!t || !o)) {
      ...
      r(V2()), i(!1), r(Ys(!0)), r(Gs()), l("");
    }
  };
  return /* @__PURE__ */ f.jsx(ln, { className: $t.newConversationForm, children: /* @__PURE__ */ f.jsx(An, { children: /* @__PURE__ */ f.jsxs("form", { onSubmit: u, children: [
...
(function(e, t) {
  (function(n, o) {
    ...
    var n = 1e3, o = 6e4, r = 36e5, a = "millisecond", i = "second", s = "minute", l = "hour", u = "day", c = "week", d = "month", g = "quarter", h = "year", m = "date", b = "Invalid Date", C = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, p = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, y = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(w) {
      var A = ["th", "st", "nd", "rd"], S = w % 100;
      return "[" + w + (A[(S - 20) % 10] || A[S] || A[0]) + "]";
    } }, x = function(w, A, S) {
      var O = String(w);
      return !O || O.length >= A ? w : "" + Array(A + 1 - O.length).join(S) + w;
    }, E = { s: x, z: function(w) {
      var A = -w.utcOffset(), S = Math.abs(A), O = Math.floor(S / 60), L = S % 60;
      return (A <= 0 ? "+" : "-") + x(O, 2, "0") + ":" + x(L, 2, "0");
    }, m: function w(A, S) {
      if (A.date() < S.date()) return -w(S, A);
      var O = 12 * (S.year() - A.year()) + (S.month() - A.month()), L = A.clone().add(O, d), D = S - L < 0, M = A.clone().add(O + (D ? -1 : 1), d);
      return +(-(O + (S - L) / (D ? L - M : M - L)) || 0);
    }, a: function(w) {
    ...
    k[v] = y;
    var T = "$isDayjsObject", _ = function(w) {
      return w instanceof $ || !(!w || !w[T]);
    }, H = function w(A, S, O) {
      var L;
      if (!A) return v;
      if (typeof A == "string") {
      ...
      return S.date = w, S.args = arguments, new $(S);
    }, z = E;
    z.l = H, z.i = _, z.w = function(w, A) {
      return R(w, { locale: A.$L, utc: A.$u, x: A.$x, $offset: A.$offset });
    };
    var $ = function() {
      function w(S) {
        this.$L = H(S.locale, null, !0), this.parse(S), this.$x = this.$x || S.x || {}, this[T] = !0;
      }
      var A = w.prototype;
      return A.parse = function(S) {
        this.$d = function(O) {
          ...
          if (typeof L == "string" && !/Z$/i.test(L)) {
            var M = L.match(C);
            if (M) {
              var F = M[2] - 1 || 0, I = (M[7] || "0").substring(0, 3);
              return D ? new Date(Date.UTC(M[1], F, M[3] || 1, M[4] || 0, M[5] || 0, M[6] || 0, I)) : new Date(M[1], F, M[3] || 1, M[4] || 0, M[5] || 0, M[6] || 0, I);
            }
          }
          return new Date(L);
        }(S), this.init();
      ...
      }, A.isSame = function(S, O) {
        var L = R(S);
        return this.startOf(O) <= L && L <= this.endOf(O);
      }, A.isAfter = function(S, O) {
        return R(S) < this.startOf(O);
      }, A.isBefore = function(S, O) {
        return this.endOf(O) < R(S);
      }, A.$g = function(S, O, L) {
        return z.u(S) ? this[O] : this.set(L, S);
      }, A.unix = function() {
        return Math.floor(this.valueOf() / 1e3);
      }, A.valueOf = function() {
        return this.$d.getTime();
      }, A.startOf = function(S, O) {
        var L = this, D = !!z.u(O) || O, M = z.p(S), F = function(te, Z) {
        ...
        var L, D = z.p(S), M = "set" + (this.$u ? "UTC" : ""), F = (L = {}, L[u] = M + "Date", L[m] = M + "Date", L[d] = M + "Month", L[h] = M + "FullYear", L[l] = M + "Hours", L[s] = M + "Minutes", L[i] = M + "Seconds", L[a] = M + "Milliseconds", L)[D], I = D === u ? this.$D + (O - this.$W) : O;
        if (D === d || D === h) {
        ...
        var L, D = this;
        S = Number(S);
        var M = z.p(O), F = function(W) {
          var q = R(D);
          return z.w(q.date(q.date() + Math.round(W * S)), D);
        };
        if (M === d) return this.set(d, this.$M + S);
        if (M === h) return this.set(h, this.$y + S);
        if (M === u) return F(1);
        if (M === c) return F(7);
        var I = (L = {}, L[s] = o, L[l] = r, L[i] = n, L)[M] || 1, V = this.$d.getTime() + S * I;
        return z.w(V, this);
      }, A.subtract = function(S, O) {
        return this.add(-1 * S, O);
      }, A.format = function(S) {
        var O = this, L = this.$locale();
        if (!this.isValid()) return L.invalidDate || b;
        var D = S || "YYYY-MM-DDTHH:mm:ssZ", M = z.z(this), F = this.$H, I = this.$m, V = this.$M, W = L.weekdays, q = L.months, K = L.meridiem, X = function(Z, fe, G, ye) {
      ...
      }, A.diff = function(S, O, L) {
        var D, M = this, F = z.p(O), I = R(S), V = (I.utcOffset() - this.utcOffset()) * o, W = this - I, q = function() {
          return z.m(M, I);
        };
        switch (F) {
          case h:
        ...
        return k[this.$L];
      }, A.locale = function(S, O) {
        if (!S) return this.$L;
        var L = this.clone(), D = H(S, O, !0);
        return D && (L.$L = D), L;
      }, A.clone = function() {
    ...
    }), R.extend = function(w, A) {
      return w.$i || (w(A, $, R), w.$i = !0), R;
    }, R.locale = H, R.isDayjs = _, R.unix = function(w) {
      return R(1e3 * w);
    }, R.en = k[v], R.Ls = k, R.p = {}, R;
  });
})(f0);
var o8 = f0.exports;
const cs = /* @__PURE__ */ no(o8), r8 = ({
  conversationGroupId: e,
  shareId: t
}) => {
  const { onResolve: n, source: o } = Ao(), [r, a] = ae(!1), i = async () => {
    e && (a(!0), await C5(t, e, o), n(), a(!1));
  };
  ...
  conversationGroupId: o,
  shareId: r
}) => /* @__PURE__ */ f.jsxs(ea, { className: "d-flex align-items-center justify-content-between mb-0", children: [
  /* @__PURE__ */ f.jsxs("div", { className: "d-flex align-items-center gap-1", children: [
    /* @__PURE__ */ f.jsx(U2, { user: e }),
    /* @__PURE__ */ f.jsxs("h4", { children: [
      e == null ? void 0 : e.first_name,
      " ",
      e == null ? void 0 : e.last_name
    ] }),
    /* @__PURE__ */ f.jsx("span", { children: cs(t).format("HH:mm, DD MMM YY") })
  ] }),
  n ? /* @__PURE__ */ f.jsx(
    r8,
    {
  ...
  return /* @__PURE__ */ f.jsxs(ln, { children: [
    ...
    /* @__PURE__ */ f.jsx(An, { children: /* @__PURE__ */ f.jsx("p", { children: e.message.replace(/@\[(.*?)\]\((.*?)\)/g, "@$2") }) })
  ] });
}, i8 = ({ conversationGroupId: e, shareId: t }) => {
  const { currentUser: n, users: o, onReplyAdd: r, source: a } = Ao(), i = Object.values(o), [s, l] = ae(""), [u, c] = ae(!1), d = async (g) => {
  ...
  var g;
  const { users: o } = Ao(), r = Se(() => {
    if (e.owner)
      return o[e.owner];
  }, [e.owner, o]), { isSelected: a } = Ao(), [i, s] = ae(!1), l = pe(
    (h) => {
      !a || !h || (console.log(
  ...
  return !t || !n ? null : /* @__PURE__ */ f.jsx(h0.Provider, { value: u, children: /* @__PURE__ */ f.jsx(
    s8,
    {
      conversationGroup: t,
      shareId: n,
  ...
  if (!a || !o)
    return null;
  const s = r[a], l = (d) => {
    i(If({ shareId: o, conversationGroupId: d }));
  }, u = (d) => {
    i(Us(d));
  }, c = (d) => {
    console.log("onReplyAdd", d), i(V2());
  };
  ...
  return !!n || e || t ? /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
    ...
    /* @__PURE__ */ f.jsxs("div", { className: $t.conversationRightPanel, children: [
      ...
      n ? /* @__PURE__ */ f.jsx(n8, {}) : /* @__PURE__ */ f.jsx(c8, {})
    ] })
  ] }) : null;
}, d8 = 10, f8 = () => {
  const e = se(), t = we(
    ...
    (i) => {
      clearTimeout(e.current), b5(i).then((s) => {
        console.log("useConversations", s), o(zf(s == null ? void 0 : s.dbt_docs_share_conversations)), e.current = setTimeout(() => {
          a(i);
        }, d8 * 1e3);
      }).catch(
  ...
  return re(() => {
    n !== it.UNINITIALIZED || !t || (o(Uc(it.LOADING)), a(t));
  ...
  return re(() => {
    n !== it.UNINITIALIZED || Object.keys(t).length || (o(it.LOADING), y5().then((r) => {
      console.log("useConversationUsers", r), e(Ff(r));
    }).catch((r) => console.error("error while fetching users list", r)).finally(() => {
      o(it.INITIALIZED);
    }));
  }, [e, n, t]), { isLoading: n === it.LOADING };
}, h8 = () => (g8(), f8(), /* @__PURE__ */ f.jsxs("div", { children: [
  /* @__PURE__ */ f.jsx(u8, {}),
  /* @__PURE__ */ f.jsx(E5, {})
] })), p0 = ({ target: e, ...t }) => Mn(
  /* @__PURE__ */ f.jsx(
  ...
  const e = dt(), t = we(
    ...
    (u) => u.manifest
  ), [o, r] = ae(0), a = (l = Bs()) == null ? void 0 : l.parentElement, i = () => {
    var g;
    if (!a || !n.nodes)
      return;
    const u = Vs();
...
`)[o],
  ...
  return !t || !n ? null : /* @__PURE__ */ f.jsx(p0, { target: n, onClick: o });
}, b8 = () => /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
  /* @__PURE__ */ f.jsx(m8, {}),
  /* @__PURE__ */ f.jsx(p8, {})
] }), y8 = kd(() => import("./DbtDocsRenderer.js")), C8 = () => {
  const { loading: e, shareDetails: t } = v5(), n = dt(), { getHighlightedSelectionData: o, pos: r, onSelectionEnd: a } = x5(), i = (s) => {
    s.stopPropagation();
    const l = o();
    l && n(Ks(l));
  };
  return e ? /* @__PURE__ */ f.jsx("div", { children: "Loading..." }) : !(t != null && t.catalog_presigned_url) || !(t != null && t.manifest_presigned_url) ? /* @__PURE__ */ f.jsx("div", { children: "Unable to load required artifacts. Please try again." }) : /* @__PURE__ */ f.jsxs("div", { children: [
    ...
    r ? /* @__PURE__ */ f.jsx(f5, { pos: r, onAddComment: i }) : null
  ] });
}, bC = ({ shareId: e, userId: t, conversationGroupId: n, source: o }) => /* @__PURE__ */ f.jsx("div", { className: "altimate-component", children: /* @__PURE__ */ f.jsx(
  Bf,
  {
    shareId: e,
    userId: t,
  ...
  setSelectedTable: Sn,
  setMoreTables: nl,
  mergeSeeMoreTables: ol,
  setSidebarScreen: Mt,
  setSelectedColumn: pn,
  setCollectColumns: Mo,
  mergeCollectColumns: rl,
  setConfidence: x8,
  updateConfidenceWithOperatorList: al,
  setLeftExpansion: Oi,
  setRightExpansion: Di,
  setMinRange: To,
  setNodeCount: Yn,
  setSelectCheck: m0,
  setNonSelectCheck: b0,
  ...
  setLineageType: yC,
  setStaticLineage: CC,
  setAllowSyncColumnsWithDB: vC,
  setSqlLineageDetails: S8
} = Ir.actions;
function Ge(e) {
...
var us = { exports: {} }, Li = {}, ur = { exports: {} }, ji = {};
/**
 * @license React
...
function _8() {
  ...
  function s(d, g) {
    var h = g(), m = o({ inst: { value: h, getSnapshot: g } }), b = m[0].inst, C = m[1];
    return a(function() {
      b.value = h, b.getSnapshot = g, l(b) && C({ inst: b });
    }, [d, h, g]), r(function() {
      return l(b) && C({ inst: b }), d(function() {
        l(b) && C({ inst: b });
      });
    }, [d]), i(h), h;
  }
  ...
  return ji.useSyncExternalStore = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : c, ji;
}
var Ri = {};
/**
 * @license React
...
function k8() {
  return m1 || (m1 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function o(x, E, v) {
      {
        ...
        T !== "" && (E += "%s", v = v.concat([T]));
        var _ = v.map(function(H) {
          return String(H);
        });
        _.unshift("Warning: " + E), Function.prototype.apply.call(console[x], console, _);
      }
    }
    function r(x, E) {
    ...
    function g(x, E, v) {
      ...
      if (!d) {
        var T = E();
        a(k, T) || (n("The result of getSnapshot should be cached to avoid an infinite loop"), d = !0);
      }
      var _ = i({
        inst: {
          value: k,
    ...
    var b = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", C = !b, p = C ? m : g, y = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : p;
...
var b1;
function C0() {
  return b1 || (b1 = 1, process.env.NODE_ENV === "production" ? ur.exports = _8() : ur.exports = k8()), ur.exports;
}
/**
 * @license React
...
function A8() {
  ...
  return Li.useSyncExternalStoreWithSelector = function(u, c, d, g, h) {
    var m = a(null);
    if (m.current === null) {
    ...
    m = s(function() {
      function p(k) {
        if (!y) {
          if (y = !0, x = k, k = g(k), h !== void 0 && b.hasValue) {
            var T = b.value;
            if (h(T, k)) return E = T;
          }
          return E = k;
        }
        if (T = E, o(x, k)) return T;
        var _ = g(k);
        return h !== void 0 && h(T, _) ? T : (x = k, E = _);
      }
      var y = !1, x, E, v = d === void 0 ? null : d;
      return [function() {
        return p(c());
      ...
      var p = s(function() {
        var v = !1, k, T, _ = function($) {
          ...
          if (o(A, $))
            return S;
          var O = h($);
          return m !== void 0 && m(S, O) ? S : (k = $, T = O, O);
        ...
        return [R, z];
      }, [d, g, h, m]), y = p[0], x = p[1], E = r(c, y, x);
      return i(function() {
        C.hasValue = !0, C.value = E;
      }, [E]), l(E), E;
    }
    Hi.useSyncExternalStoreWithSelector = u, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
  }()), Hi;
}
process.env.NODE_ENV === "production" ? us.exports = A8() : us.exports = M8();
var T8 = us.exports;
const N8 = /* @__PURE__ */ no(T8), O8 = { BASE_URL: "/", DEV: !1, MODE: "production", PROD: !0, SSR: !1 }, v1 = (e) => {
  let t;
  const n = /* @__PURE__ */ new Set(), o = (c, d) => {
    ...
    (O8 ? "production" : void 0) !== "production" && console.warn(
      "[DEPRECATED] The `destroy` method will be unsupported in a future version. Instead use unsubscribe function returned by subscribe. Everything will be garbage-collected if store is garbage-collected."
    ), n.clear();
  } }, u = t = e(o, r, l);
  return l;
}, D8 = (e) => e ? v1(e) : v1, { useDebugValue: L8 } = P, { useSyncExternalStoreWithSelector: j8 } = N8, R8 = (e) => e;
function v0(e, t = R8, n) {
  const o = j8(
    e.subscribe,
    e.getState,
...
kr.prototype = la.prototype = {
  constructor: kr,
  on: function(e, t) {
    var n = this._, o = z8(e + "", n), r, a = -1, i = o.length;
    if (arguments.length < 2) {
      for (; ++a < i; ) if ((r = (e = o[a]).type) && (r = I8(n[r], e.name))) return r;
      return;
    }
    if (t != null && typeof t != "function") throw new Error("invalid callback: " + t);
    for (; ++a < i; )
      if (r = (e = o[a]).type) n[r] = w1(n[r], e.name, t);
      else if (t == null) for (r in n) n[r] = w1(n[r], e.name, null);
    return this;
  },
  copy: function() {
    var e = {}, t = this._;
...
function w1(e, t, n) {
  for (var o = 0, r = e.length; o < r; ++o)
    if (e[o].name === t) {
      e[o] = F8, e = e.slice(0, o).concat(e.slice(o + 1));
      break;
    }
...
function ca(e) {
  var t = e += "", n = t.indexOf(":");
  return n >= 0 && (t = e.slice(0, n)) !== "xmlns" && (e = e.slice(n + 1)), E1.hasOwnProperty(t) ? { space: E1[t], local: e } : e;
}
function P8(e) {
  return function() {
...
function x0(e) {
  var t = ca(e);
  return (t.local ? B8 : P8)(t);
}
function V8() {
}
function il(e) {
  return e == null ? V8 : function() {
...
function w0(e) {
  return e == null ? Z8 : function() {
    return this.querySelectorAll(e);
  };
}
function q8(e) {
  return function() {
    return $8(e.apply(this, arguments));
  };
}
function U8(e) {
  typeof e == "function" ? e = q8(e) : e = w0(e);
...
function X8(e) {
  return this.select(e == null ? K8 : G8(typeof e == "function" ? e : S0(e)));
}
var J8 = Array.prototype.filter;
function Q8() {
  return Array.from(this.children);
}
function e6(e) {
  return function() {
    return J8.call(this.children, e);
  };
}
function t6(e) {
  return this.selectAll(e == null ? Q8 : e6(typeof e == "function" ? e : S0(e)));
}
function n6(e) {
...
function o6() {
  return new nt(this._enter || this._groups.map(_0), this._parents);
}
function Pr(e, t) {
...
function a6(e, t, n, o, r, a) {
  for (var i = 0, s, l = t.length, u = a.length; i < u; ++i)
    (s = t[i]) ? (s.__data__ = a[i], o[i] = s) : n[i] = new Pr(e, a[i]);
  for (; i < l; ++i)
    (s = t[i]) && (r[i] = s);
}
function i6(e, t, n, o, r, a, i) {
  ...
  for (s = 0; s < d; ++s)
    h = i.call(e, a[s], s, a) + "", (l = u.get(h)) ? (o[s] = l, l.__data__ = a[s], u.delete(h)) : n[s] = new Pr(e, a[s]);
  for (s = 0; s < c; ++s)
...
function l6(e, t) {
  if (!arguments.length) return Array.from(this, s6);
  var n = t ? i6 : a6, o = this._parents, r = this._groups;
  typeof e != "function" && (e = r6(e));
  for (var a = r.length, i = new Array(a), s = new Array(a), l = new Array(a), u = 0; u < a; ++u) {
    var c = o[u], d = r[u], g = d.length, h = c6(e.call(c, c && c.__data__, u, o)), m = h.length, b = s[u] = new Array(m), C = i[u] = new Array(m), p = l[u] = new Array(g);
    n(c, d, b, C, p, h, t);
    for (var y = 0, x = 0, E, v; y < m; ++y)
      if (E = b[y]) {
        for (y >= x && (x = y + 1); !(v = C[x]) && ++x < m; ) ;
        E._next = v || null;
      }
  }
  return i = new nt(i, o), i._enter = s, i._exit = l, i;
}
function c6(e) {
  return typeof e == "object" && "length" in e ? e : Array.from(e);
}
function u6() {
  return new nt(this._exit || this._groups.map(_0), this._parents);
}
function d6(e, t, n) {
...
function M6(e, t) {
  ...
  return this.each((t == null ? n.local ? E6 : w6 : typeof t == "function" ? n.local ? A6 : k6 : n.local ? _6 : S6)(n, t));
}
function k0(e) {
...
function D6(e, t, n) {
  return arguments.length > 1 ? this.each((t == null ? T6 : typeof t == "function" ? O6 : N6)(e, t, n ?? "")) : Kn(this.node(), e);
}
function Kn(e, t) {
  return e.style.getPropertyValue(t) || k0(e).getComputedStyle(e, null).getPropertyValue(t);
}
function L6(e) {
  return function() {
    delete this[e];
...
function H6(e, t) {
  return arguments.length > 1 ? this.each((t == null ? L6 : typeof t == "function" ? R6 : j6)(e, t)) : this.node()[e];
}
function A0(e) {
...
function T0(e, t) {
  for (var n = sl(e), o = -1, r = t.length; ++o < r; ) n.add(t[o]);
}
function N0(e, t) {
  for (var n = sl(e), o = -1, r = t.length; ++o < r; ) n.remove(t[o]);
}
function F6(e) {
  return function() {
    T0(this, e);
...
function I6(e, t) {
  return function() {
    (t.apply(this, arguments) ? T0 : N0)(this, e);
  };
}
function P6(e, t) {
  var n = A0(e + "");
  if (arguments.length < 2) {
    for (var o = sl(this.node()), r = -1, a = n.length; ++r < a; ) if (!o.contains(n[r])) return !1;
    return !0;
  }
  return this.each((typeof t == "function" ? I6 : t ? F6 : z6)(n, t));
}
function B6() {
  this.textContent = "";
}
...
function $6(e) {
  return arguments.length ? this.each(e == null ? B6 : (typeof e == "function" ? W6 : V6)(e)) : this.node().textContent;
}
function Z6() {
  this.innerHTML = "";
}
...
function Y6(e) {
  return arguments.length ? this.each(e == null ? Z6 : (typeof e == "function" ? U6 : q6)(e)) : this.node().innerHTML;
}
function G6() {
...
function Q6(e) {
  var t = typeof e == "function" ? e : x0(e);
...
function t7(e, t) {
  var n = typeof e == "function" ? e : x0(e), o = t == null ? e7 : typeof t == "function" ? t : il(t);
  return this.select(function() {
...
function f7(e, t, n) {
  ...
  for (s = t ? d7 : u7, r = 0; r < a; ++r) this.each(s(o[r], t, n));
  return this;
}
function O0(e, t, n) {
  var o = k0(e), r = o.CustomEvent;
...
function h7(e, t) {
  return function() {
    return O0(this, e, t.apply(this, arguments));
  };
}
function p7(e, t) {
  return this.each((typeof t == "function" ? h7 : g7)(e, t));
}
function* m7() {
  for (var e = this._groups, t = 0, n = e.length; t < n; ++t)
...
function qo() {
  return new nt([[document.documentElement]], D0);
}
function b7() {
  return this;
}
nt.prototype = qo.prototype = {
  constructor: nt,
  select: W8,
  selectAll: U8,
  selectChild: X8,
...
function bt(e) {
  return typeof e == "string" ? new nt([[document.querySelector(e)]], [document.documentElement]) : new nt([[e]], D0);
}
function y7(e) {
  let t;
...
function kt(e, t) {
  if (e = y7(e), t === void 0 && (t = e.currentTarget), t) {
...
const C7 = { passive: !1 }, No = { capture: !0, passive: !1 };
function Fi(e) {
...
function L0(e) {
  var t = e.document.documentElement, n = bt(e).on("dragstart.drag", Pn, No);
  "onselectstart" in t ? n.on("selectstart.drag", Pn, No) : (t.__noselect = t.style.MozUserSelect, t.style.MozUserSelect = "none");
}
function j0(e, t) {
  var n = e.document.documentElement, o = bt(e).on("dragstart.drag", null);
  t && (o.on("click.drag", Pn, No), setTimeout(function() {
...
function S7() {
  var e = v7, t = x7, n = w7, o = E7, r = {}, a = la("start", "drag", "end"), i = 0, s, l, u, c, d = 0;
  function g(E) {
    E.on("mousedown.drag", h).filter(o).on("touchstart.drag", C).on("touchmove.drag", p, C7).on("touchend.drag touchcancel.drag", y).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function h(E, v) {
    if (!(c || !e.call(this, E, v))) {
      var k = x(this, t.call(this, E, v), E, v, "mouse");
      k && (bt(E.view).on("mousemove.drag", m, No).on("mouseup.drag", b, No), L0(E.view), Fi(E), u = !1, s = E.clientX, l = E.clientY, k("start", E));
    }
  }
  function m(E) {
    if (Pn(E), !u) {
  ...
  function b(E) {
    bt(E.view).on("mousemove.drag mouseup.drag", null), j0(E.view, u), Pn(E), r.mouse("end", E);
  }
  function C(E, v) {
    if (e.call(this, E, v)) {
      var k = E.changedTouches, T = t.call(this, E, v), _ = k.length, H, R;
      for (H = 0; H < _; ++H)
        (R = x(this, T, E, v, k[H].identifier, k[H])) && (Fi(E), R("start", E, k[H]));
    }
  }
  function p(E) {
    var v = E.changedTouches, k = v.length, T, _;
    for (T = 0; T < k; ++T)
      (_ = r[v[T].identifier]) && (Pn(E), _("drag", E, v[T]));
  }
  function y(E) {
    var v = E.changedTouches, k = v.length, T, _;
    for (c && clearTimeout(c), c = setTimeout(function() {
      ...
      (_ = r[v[T].identifier]) && (Fi(E), _("end", E, v[T]));
  }
  function x(E, v, k, T, _, H) {
    var R = a.copy(), z = kt(H || k, v), $, B, w;
    if ((w = n.call(E, new fs("beforestart", {
      sourceEvent: k,
      target: g,
      identifier: _,
      active: i,
      ...
      return $ = w.x - z[0] || 0, B = w.y - z[1] || 0, function A(S, O, L) {
        var D = z, M;
        switch (S) {
          case "start":
            r[_] = A, M = i++;
...
var Oo = 0.7, Br = 1 / Oo, Bn = "\\s*([+-]?\\d+)\\s*", Do = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Tt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", _7 = /^#([0-9a-f]{3,8})$/, k7 = new RegExp(`^rgb\\(${Bn},${Bn},${Bn}\\)$`), A7 = new RegExp(`^rgb\\(${Tt},${Tt},${Tt}\\)$`), M7 = new RegExp(`^rgba\\(${Bn},${Bn},${Bn},${Do}\\)$`), T7 = new RegExp(`^rgba\\(${Tt},${Tt},${Tt},${Do}\\)$`), N7 = new RegExp(`^hsl\\(${Do},${Tt},${Tt}\\)$`), O7 = new RegExp(`^hsla\\(${Do},${Tt},${Tt},${Do}\\)$`), S1 = {
  aliceblue: 15792383,
...
function Lo(e) {
  var t, n;
  return e = (e + "").trim().toLowerCase(), (t = _7.exec(e)) ? (n = t[1].length, t = parseInt(t[1], 16), n === 6 ? A1(t) : n === 3 ? new Xe(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : n === 8 ? fr(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : n === 4 ? fr(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = k7.exec(e)) ? new Xe(t[1], t[2], t[3], 1) : (t = A7.exec(e)) ? new Xe(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = M7.exec(e)) ? fr(t[1], t[2], t[3], t[4]) : (t = T7.exec(e)) ? fr(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = N7.exec(e)) ? N1(t[1], t[2] / 100, t[3] / 100, 1) : (t = O7.exec(e)) ? N1(t[1], t[2] / 100, t[3] / 100, t[4]) : S1.hasOwnProperty(e) ? A1(S1[e]) : e === "transparent" ? new Xe(NaN, NaN, NaN, 0) : null;
}
function A1(e) {
...
function j7(e) {
  return e instanceof Uo || (e = Lo(e)), e ? (e = e.rgb(), new Xe(e.r, e.g, e.b, e.opacity)) : new Xe();
}
function gs(e, t, n, o) {
  return arguments.length === 1 ? j7(e) : new Xe(e, t, n, o ?? 1);
}
function Xe(e, t, n, o) {
...
ll(Xe, gs, R0(Uo, {
  brighter(e) {
    return e = e == null ? Br : Math.pow(Br, e), new Xe(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  darker(e) {
    return e = e == null ? Oo : Math.pow(Oo, e), new Xe(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  rgb() {
    return this;
  },
  clamp() {
    return new Xe(Cn(this.r), Cn(this.g), Cn(this.b), Vr(this.opacity));
  },
  displayable() {
...
function N1(e, t, n, o) {
  return o <= 0 ? e = t = n = NaN : n <= 0 || n >= 1 ? e = t = NaN : t <= 0 && (e = NaN), new yt(e, t, n, o);
}
function H0(e) {
  if (e instanceof yt) return new yt(e.h, e.s, e.l, e.opacity);
  if (e instanceof Uo || (e = Lo(e)), !e) return new yt();
  if (e instanceof yt) return e;
  e = e.rgb();
  var t = e.r / 255, n = e.g / 255, o = e.b / 255, r = Math.min(t, n, o), a = Math.max(t, n, o), i = NaN, s = a - r, l = (a + r) / 2;
  return s ? (t === a ? i = (n - o) / s + (n < o) * 6 : n === a ? i = (o - t) / s + 2 : i = (t - n) / s + 4, s /= l < 0.5 ? a + r : 2 - a - r, i *= 60) : s = l > 0 && l < 1 ? 0 : i, new yt(i, s, l, e.opacity);
}
function H7(e, t, n, o) {
  return arguments.length === 1 ? H0(e) : new yt(e, t, n, o ?? 1);
}
function yt(e, t, n, o) {
...
ll(yt, H7, R0(Uo, {
  brighter(e) {
    return e = e == null ? Br : Math.pow(Br, e), new yt(this.h, this.s, this.l * e, this.opacity);
  },
  darker(e) {
    return e = e == null ? Oo : Math.pow(Oo, e), new yt(this.h, this.s, this.l * e, this.opacity);
  },
  rgb() {
    var e = this.h % 360 + (this.h < 0) * 360, t = isNaN(e) || isNaN(this.s) ? 0 : this.s, n = this.l, o = n + (n < 0.5 ? n : 1 - n) * t, r = 2 * n - o;
    return new Xe(
      zi(e >= 240 ? e - 240 : e + 120, r, o),
      zi(e, r, o),
      zi(e < 120 ? e + 240 : e - 120, r, o),
      this.opacity
    );
  },
  clamp() {
    return new yt(O1(this.h), gr(this.s), gr(this.l), Vr(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = Vr(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${O1(this.h)}, ${gr(this.s) * 100}%, ${gr(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function O1(e) {
...
function I7(e) {
  return (e = +e) == 1 ? z0 : function(t, n) {
    return n - t ? z7(t, n, e) : F0(isNaN(t) ? n : t);
  };
}
function z0(e, t) {
  var n = t - e;
  return n ? F7(e, n) : F0(isNaN(e) ? t : e);
}
const D1 = function e(t) {
  var n = I7(t);
  function o(r, a) {
    var i = n((r = gs(r)).r, (a = gs(a)).r), s = n(r.g, a.g), l = n(r.b, a.b), u = z0(r.opacity, a.opacity);
    return function(c) {
...
var hs = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Ii = new RegExp(hs.source, "g");
function P7(e) {
  return function() {
    return e;
  };
...
function V7(e, t) {
  var n = hs.lastIndex = Ii.lastIndex = 0, o, r, a, i = -1, s = [], l = [];
  for (e = e + "", t = t + ""; (o = hs.exec(e)) && (r = Ii.exec(t)); )
    (a = r.index) > n && (a = t.slice(n, a), s[i] ? s[i] += a : s[++i] = a), (o = o[0]) === (r = r[0]) ? s[i] ? s[i] += r : s[++i] = r : (s[++i] = null, l.push({ i, x: en(o, r) })), n = Ii.lastIndex;
  return n < t.length && (a = t.slice(n), s[i] ? s[i] += a : s[++i] = a), s.length < 2 ? l[0] ? B7(l[0].x) : P7(t) : (t = l.length, function(u) {
    for (var c = 0, d; c < t; ++c) s[(d = l[c]).i] = d.x(u);
    return s.join("");
  });
}
var L1 = 180 / Math.PI, ps = {
  translateX: 0,
  translateY: 0,
  rotate: 0,
  skewX: 0,
...
function I0(e, t, n, o, r, a) {
  ...
  return (i = Math.sqrt(e * e + t * t)) && (e /= i, t /= i), (l = e * n + t * o) && (n -= e * l, o -= t * l), (s = Math.sqrt(n * n + o * o)) && (n /= s, o /= s, l /= s), e * o < t * n && (e = -e, t = -t, l = -l, i = -i), {
    translateX: r,
    translateY: a,
    rotate: Math.atan2(t, e) * L1,
    skewX: Math.atan(l) * L1,
    scaleX: i,
    scaleY: s
  };
}
...
function W7(e) {
  ...
  return t.isIdentity ? ps : I0(t.a, t.b, t.c, t.d, t.e, t.f);
}
function $7(e) {
  return e == null || (hr || (hr = document.createElementNS("http://www.w3.org/2000/svg", "g")), hr.setAttribute("transform", e), !(e = hr.transform.baseVal.consolidate())) ? ps : (e = e.matrix, I0(e.a, e.b, e.c, e.d, e.e, e.f));
}
function P0(e, t, n, o) {
  function r(u) {
  ...
  return function(u, c) {
    ...
    return u = e(u), c = e(c), a(u.translateX, u.translateY, c.translateX, c.translateY, d, g), i(u.rotate, c.rotate, d, g), s(u.skewX, c.skewX, d, g), l(u.scaleX, u.scaleY, c.scaleX, c.scaleY, d, g), u = c = null, function(h) {
      for (var m = -1, b = g.length, C; ++m < b; ) d[(C = g[m]).i] = C.x(h);
      return d.join("");
    };
  };
}
var Z7 = P0(W7, "px, ", "px)", "deg)"), q7 = P0($7, ", ", ")", ")"), U7 = 1e-12;
function j1(e) {
...
const K7 = function e(t, n, o) {
  function r(a, i) {
    var s = a[0], l = a[1], u = a[2], c = i[0], d = i[1], g = i[2], h = c - s, m = d - l, b = h * h + m * m, C, p;
    if (b < U7)
      p = Math.log(g / u) / t, C = function(T) {
        return [
          s + T * h,
          l + T * m,
          u * Math.exp(t * T * p)
      ...
      var y = Math.sqrt(b), x = (g * g - u * u + o * b) / (2 * u * n * y), E = (g * g - u * u - o * b) / (2 * g * n * y), v = Math.log(Math.sqrt(x * x + 1) - x), k = Math.log(Math.sqrt(E * E + 1) - E);
      p = (k - v) / t, C = function(T) {
        var _ = T * p, H = j1(v), R = u / (n * y) * (H * G7(t * _ + v) - Y7(v));
        return [
          s + R * h,
          l + R * m,
          u * H / j1(t * _ + v)
...
var Xn = 0, bo = 0, co = 0, B0 = 1e3, Wr, yo, $r = 0, _n = 0, ua = 0, jo = typeof performance == "object" && performance.now ? performance : Date, V0 = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function cl() {
  return _n || (V0(X7), _n = jo.now() + ua);
}
function X7() {
  _n = 0;
}
...
Zr.prototype = W0.prototype = {
  constructor: Zr,
  restart: function(e, t, n) {
    if (typeof e != "function") throw new TypeError("callback is not a function");
    n = (n == null ? cl() : +n) + (t == null ? 0 : +t), !this._next && yo !== this && (yo ? yo._next = this : Wr = this, yo = this), this._call = e, this._time = n, ms();
  },
  stop: function() {
...
function J7() {
  cl(), ++Xn;
  for (var e = Wr, t; e; )
    (t = _n - e._time) >= 0 && e._call.call(void 0, t), e = e._next;
  --Xn;
}
function R1() {
  _n = ($r = jo.now()) + ua, Xn = bo = 0;
  try {
    J7();
  } finally {
    Xn = 0, e9(), _n = 0;
...
function e9() {
  for (var e, t = Wr, n, o = 1 / 0; t; )
    t._call ? (o > t._time && (o = t._time), e = t, t = t._next) : (n = t._next, t._next = null, t = e ? e._next = n : Wr = n);
  yo = e, ms(o);
}
function ms(e) {
  if (!Xn) {
    ...
    var t = e - _n;
    t > 24 ? (e < 1 / 0 && (bo = setTimeout(R1, e - jo.now() - ua)), co && (co = clearInterval(co))) : (co || ($r = jo.now(), co = setInterval(Q7, B0)), Xn = 1, V0(R1));
  }
}
function H1(e, t, n) {
  var o = new Zr();
...
var t9 = la("start", "end", "cancel", "interrupt"), n9 = [], $0 = 0, F1 = 1, bs = 2, Ar = 3, z1 = 4, ys = 5, Mr = 6;
function da(e, t, n, o, r, a) {
...
function o9(e, t, n) {
  ...
  o[t] = n, n.timer = W0(a, 0, n.time);
  function a(u) {
    n.state = F1, n.timer.restart(i, n.delay, n.time), n.delay <= u && i(u - n.delay);
  }
  function i(u) {
    var c, d, g, h;
    if (n.state !== F1) return l();
    for (c in o)
      if (h = o[c], h.name === n.name) {
        if (h.state === Ar) return H1(i);
        h.state === z1 ? (h.state = Mr, h.timer.stop(), h.on.call("interrupt", e, e.__data__, h.index, h.group), delete o[c]) : +c < t && (h.state = Mr, h.timer.stop(), h.on.call("cancel", e, e.__data__, h.index, h.group), delete o[c]);
      }
    if (H1(function() {
      n.state === Ar && (n.state = z1, n.timer.restart(s, n.delay, n.time), s(u));
    }), n.state = bs, n.on.call("start", e, e.__data__, n.index, n.group), n.state === bs) {
      for (n.state = Ar, r = new Array(g = n.tween.length), c = 0, d = -1; c < g; ++c)
  ...
  function l() {
    n.state = Mr, n.timer.stop(), delete o[t];
...
function Tr(e, t) {
  ...
  if (n) {
    ...
    for (i in n) {
      ...
      r = o.state > bs && o.state < ys, o.state = Mr, o.timer.stop(), o.on.call(r ? "interrupt" : "cancel", e, e.__data__, o.index, o.group), delete n[i];
    }
...
function s9(e, t) {
  ...
  return this.each((t == null ? a9 : i9)(n, e, t));
}
function dl(e, t, n) {
  var o = e._id;
...
function Z0(e, t) {
  var n;
  return (typeof t == "number" ? en : t instanceof Lo ? D1 : (n = Lo(t)) ? (t = n, D1) : V7)(e, t);
}
function l9(e) {
  return function() {
    this.removeAttribute(e);
...
function h9(e, t) {
  var n = ca(e), o = n === "transform" ? q7 : Z0;
  return this.attrTween(e, typeof t == "function" ? (n.local ? g9 : f9)(n, o, dl(this, "attr." + e, t)) : t == null ? (n.local ? c9 : l9)(n) : (n.local ? d9 : u9)(n, o, t));
}
function p9(e, t) {
  return function(n) {
...
function C9(e, t) {
  ...
  var o = ca(e);
  return this.tween(n, (o.local ? b9 : y9)(o, t));
}
function v9(e, t) {
  return function() {
...
function w9(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? v9 : x9)(t, e)) : xt(this.node(), t).delay;
}
function E9(e, t) {
  return function() {
...
function _9(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? E9 : S9)(t, e)) : xt(this.node(), t).duration;
}
function k9(e, t) {
  if (typeof t != "function") throw new Error();
  return function() {
...
function A9(e) {
  var t = this._id;
  return arguments.length ? this.each(k9(t, e)) : xt(this.node(), t).ease;
}
function M9(e, t) {
  return function() {
    var n = t.apply(this, arguments);
...
function T9(e) {
  ...
  return this.each(M9(this._id, e));
}
function N9(e) {
  typeof e != "function" && (e = E0(e));
  for (var t = this._groups, n = t.length, o = new Array(n), r = 0; r < n; ++r)
...
function j9(e, t) {
  var n = this._id;
  return arguments.length < 2 ? xt(this.node(), n).on.on(e) : this.each(L9(n, e, t));
}
function R9(e) {
  return function() {
...
function H9() {
  return this.on("end.remove", R9(this._id));
}
function F9(e) {
  ...
  for (var o = this._groups, r = o.length, a = new Array(r), i = 0; i < r; ++i)
    for (var s = o[i], l = s.length, u = a[i] = new Array(l), c, d, g = 0; g < l; ++g)
      (c = s[g]) && (d = e.call(c, c.__data__, g, s)) && ("__data__" in c && (d.__data__ = c.__data__), u[g] = d, da(u[g], t, n, g, u, xt(c, n)));
...
function z9(e) {
  ...
  for (var o = this._groups, r = o.length, a = [], i = [], s = 0; s < r; ++s)
    for (var l = o[s], u = l.length, c, d = 0; d < u; ++d)
      if (c = l[d]) {
        for (var g = e.call(c, c.__data__, d, l), h, m = xt(c, n), b = 0, C = g.length; b < C; ++b)
          (h = g[b]) && da(h, t, n, b, g, m);
        a.push(g), i.push(c);
      }
  return new Zt(a, i, t, n);
}
var I9 = qo.prototype.constructor;
function P9() {
  return new I9(this._groups, this._parents);
}
function B9(e, t) {
  var n, o, r;
  return function() {
    var a = Kn(this, e), i = (this.style.removeProperty(e), Kn(this, e));
...
function W9(e, t, n) {
  var o, r, a;
  return function() {
    var i = Kn(this, e), s = n(this), l = s + "";
    return s == null && (l = s = (this.style.removeProperty(e), Kn(this, e))), i === l ? null : i === o && l === r ? a : (r = l, a = t(o = i, s));
  };
}
function $9(e, t) {
...
function Z9(e, t, n) {
  var o = (e += "") == "transform" ? Z7 : Z0;
  return t == null ? this.styleTween(e, B9(e, o)).on("end.style." + e, q0(e)) : typeof t == "function" ? this.styleTween(e, W9(e, o, dl(this, "style." + e, t))).each($9(this._id, e)) : this.styleTween(e, V9(e, o, t), n).on("end.style." + e, null);
}
function q9(e, t, n) {
  return function(o) {
...
function X9(e) {
  return this.tween("text", typeof e == "function" ? K9(dl(this, "text", e)) : G9(e == null ? "" : e + ""));
}
function J9(e) {
  return function(t) {
...
function eg(e) {
  ...
  if (typeof e != "function") throw new Error();
  return this.tween(t, Q9(e));
}
function tg() {
  for (var e = this._name, t = this._id, n = U0(), o = this._groups, r = o.length, a = 0; a < r; ++a)
...
function sg(e) {
  var t, n;
  e instanceof Zt ? (t = e._id, e = e._name) : (t = U0(), (n = ag).time = cl(), e = e == null ? null : e + "");
  for (var o = this._groups, r = o.length, a = 0; a < r; ++a)
    for (var i = o[a], s = i.length, l, u = 0; u < s; ++u)
      (l = i[u]) && da(l, e, t, u, i, n || ig(l, t));
  return new Zt(o, this._parents, e, t);
}
qo.prototype.interrupt = r9;
qo.prototype.transition = sg;
const pr = (e) => () => e;
function lg(e, {
  sourceEvent: t,
  target: n,
...
function hg() {
  var e = cg, t = ug, n = gg, o = dg, r = fg, a = [0, 1 / 0], i = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], s = 250, l = K7, u = la("start", "zoom", "end"), c, d, g, h = 500, m = 150, b = 0, C = 10;
  function p(w) {
    w.property("__zoom", I1).on("wheel.zoom", _, { passive: !1 }).on("mousedown.zoom", H).on("dblclick.zoom", R).filter(r).on("touchstart.zoom", z).on("touchmove.zoom", $).on("touchend.zoom touchcancel.zoom", B).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  p.transform = function(w, A, S, O) {
    var L = w.selection ? w.selection() : w;
    L.property("__zoom", I1), w !== L ? v(w, A, S, O) : L.interrupt().each(function() {
      k(this, arguments).event(O).start().zoom(null, typeof A == "function" ? A.apply(this, arguments) : A).end();
    });
  }, p.scaleBy = function(w, A, S, O) {
    p.scaleTo(w, function() {
      var L = this.__zoom.k, D = typeof A == "function" ? A.apply(this, arguments) : A;
      return L * D;
    }, S, O);
  }, p.scaleTo = function(w, A, S, O) {
    p.transform(w, function() {
      var L = t.apply(this, arguments), D = this.__zoom, M = S == null ? E(L) : typeof S == "function" ? S.apply(this, arguments) : S, F = D.invert(M), I = typeof A == "function" ? A.apply(this, arguments) : A;
      return n(x(y(D, I), M, F), L, i);
    }, S, O);
  }, p.translateBy = function(w, A, S, O) {
    p.transform(w, function() {
  ...
  }, p.translateTo = function(w, A, S, O, L) {
    p.transform(w, function() {
      var D = t.apply(this, arguments), M = this.__zoom, F = O == null ? E(D) : typeof O == "function" ? O.apply(this, arguments) : O;
      return n(on.translate(F[0], F[1]).scale(M.k).translate(
        typeof A == "function" ? -A.apply(this, arguments) : -A,
        typeof S == "function" ? -S.apply(this, arguments) : -S
      ), D, i);
    }, O, L);
  ...
  function y(w, A) {
    return A = Math.max(a[0], Math.min(a[1], A)), A === w.k ? w : new Bt(A, w.x, w.y);
  }
  function x(w, A, S) {
    var O = A[0] - S[0] * w.k, L = A[1] - S[1] * w.k;
  ...
  function v(w, A, S, O) {
    w.on("start.zoom", function() {
      ...
      var L = this, D = arguments, M = k(L, D).event(O), F = t.apply(L, D), I = S == null ? E(F) : typeof S == "function" ? S.apply(L, D) : S, V = Math.max(F[1][0] - F[0][0], F[1][1] - F[0][1]), W = L.__zoom, q = typeof A == "function" ? A.apply(L, D) : A, K = l(W.invert(I).concat(V / W.k), q.invert(I).concat(V / q.k));
      return function(X) {
        if (X === 1) X = q;
        else {
          var J = K(X), te = V / J[2];
  ...
  function k(w, A, S) {
    return !S && w.__zooming || new T(w, A);
  }
  function T(w, A) {
    this.that = w, this.args = A, this.active = 0, this.sourceEvent = null, this.extent = t.apply(w, A), this.taps = 0;
  }
  T.prototype = {
    event: function(w) {
  ...
  function _(w, ...A) {
    ...
    var S = k(this, A).event(w), O = this.__zoom, L = Math.max(a[0], Math.min(a[1], O.k * Math.pow(2, o.apply(this, arguments)))), D = kt(w);
    if (S.wheel)
      (S.mouse[0][0] !== D[0] || S.mouse[0][1] !== D[1]) && (S.mouse[1] = O.invert(S.mouse[0] = D)), clearTimeout(S.wheel);
    else {
      if (O.k === L) return;
      S.mouse = [D, O.invert(D)], Tr(this), S.start();
    }
    uo(w), S.wheel = setTimeout(M, m), S.zoom("mouse", n(x(y(O, L), S.mouse[0], S.mouse[1]), S.extent, i));
    function M() {
      S.wheel = null, S.end();
    }
  }
  function H(w, ...A) {
    ...
    var S = w.currentTarget, O = k(this, A, !0).event(w), L = bt(w.view).on("mousemove.zoom", I, !0).on("mouseup.zoom", V, !0), D = kt(w, S), M = w.clientX, F = w.clientY;
    L0(w.view), Pi(w), O.mouse = [D, this.__zoom.invert(D)], Tr(this), O.start();
    function I(W) {
      if (uo(W), !O.moved) {
        var q = W.clientX - M, K = W.clientY - F;
        O.moved = q * q + K * K > b;
      }
      O.event(W).zoom("mouse", n(x(O.that.__zoom, O.mouse[0] = kt(W, S), O.mouse[1]), O.extent, i));
    }
    function V(W) {
      L.on("mousemove.zoom mouseup.zoom", null), j0(W.view, O.moved), uo(W), O.event(W).end();
    }
  }
  function R(w, ...A) {
    if (e.apply(this, arguments)) {
      var S = this.__zoom, O = kt(w.changedTouches ? w.changedTouches[0] : w, this), L = S.invert(O), D = S.k * (w.shiftKey ? 0.5 : 2), M = n(x(y(S, D), O, L), t.apply(this, A), i);
      uo(w), s > 0 ? bt(this).transition().duration(s).call(v, M, O, w) : bt(this).call(p.transform, M, O, w);
    }
  }
  function z(w, ...A) {
    if (e.apply(this, arguments)) {
      var S = w.touches, O = S.length, L = k(this, A, w.changedTouches.length === O).event(w), D, M, F, I;
      for (Pi(w), M = 0; M < O; ++M)
        F = S[M], I = kt(F, this), I = [I, this.__zoom.invert(I), F.identifier], L.touch0 ? !L.touch1 && L.touch0[2] !== I[2] && (L.touch1 = I, L.taps = 0) : (L.touch0 = I, D = !0, L.taps = 1 + !!c);
  ...
  function $(w, ...A) {
    if (this.__zooming) {
      var S = k(this, A).event(w), O = w.changedTouches, L = O.length, D, M, F, I;
      for (uo(w), D = 0; D < L; ++D)
        M = O[D], F = kt(M, this), S.touch0 && S.touch0[2] === M.identifier ? S.touch0[0] = F : S.touch1 && S.touch1[2] === M.identifier && (S.touch1[0] = F);
      if (M = S.that.__zoom, S.touch1) {
        var V = S.touch0[0], W = S.touch0[1], q = S.touch1[0], K = S.touch1[1], X = (X = q[0] - V[0]) * X + (X = q[1] - V[1]) * X, J = (J = K[0] - W[0]) * J + (J = K[1] - W[1]) * J;
        M = y(M, Math.sqrt(X / J)), F = [(V[0] + q[0]) / 2, (V[1] + q[1]) / 2], I = [(W[0] + K[0]) / 2, (W[1] + K[1]) / 2];
      } else if (S.touch0) F = S.touch0[0], I = S.touch0[1];
      else return;
      S.zoom("touch", n(x(M, F, I), S.extent, i));
    }
  }
  function B(w, ...A) {
    if (this.__zooming) {
      var S = k(this, A).event(w), O = w.changedTouches, L = O.length, D, M;
      for (Pi(w), g && clearTimeout(g), g = setTimeout(function() {
        g = null;
      }, h), D = 0; D < L; ++D)
        M = O[D], S.touch0 && S.touch0[2] === M.identifier ? delete S.touch0 : S.touch1 && S.touch1[2] === M.identifier && delete S.touch1;
...
const fa = ut(null), pg = fa.Provider, vt = {
...
}, mg = (e) => e.userSelectionActive ? "none" : "all";
function G0({ position: e, children: t, className: n, style: o, ...r }) {
  const a = Ae(mg), i = `${e}`.split("-");
  return P.createElement("div", { className: Ge(["react-flow__panel", n, ...i]), style: { ...o, pointerEvents: a }, ...r }, t);
}
function bg({ proOptions: e, position: t = "bottom-right" }) {
...
const yg = ({ x: e, y: t, label: n, labelStyle: o = {}, labelShowBg: r = !0, labelBgStyle: a = {}, labelBgPadding: i = [2, 4], labelBgBorderRadius: s = 2, children: l, className: u, ...c }) => {
...
}), Jn = (e, t = 0, n = 1) => Math.min(Math.max(e, t), n), gl = (e = { x: 0, y: 0 }, t) => ({
  x: Jn(e.x, t[0][0], t[1][0]),
  y: Jn(e.y, t[0][1], t[1][1])
}), P1 = (e, t, n) => e < t ? Jn(Math.abs(e - t), 1, 50) / 50 : e > n ? -Jn(Math.abs(e - n), 1, 50) / 50 : 0, K0 = (e, t) => {
  const n = P1(e.x, 35, t.width - 35) * 20, o = P1(e.y, 35, t.height - 35) * 20;
  return [n, o];
}, X0 = (e) => {
  var t;
...
}), hl = ({ x: e, y: t, width: n, height: o }) => ({
  x: e,
  y: t,
  x2: e + n,
  y2: t + o
}), xg = ({ x: e, y: t, x2: n, y2: o }) => ({
  x: e,
  y: t,
  width: n - e,
  height: o - t
...
}, wg = (e) => lt(e.width) && lt(e.height) && lt(e.x) && lt(e.y), lt = (e) => !isNaN(e) && isFinite(e), Ne = Symbol.for("internals"), J0 = ["Enter", " ", "Escape"], Q0 = (e, t) => {
  process.env.NODE_ENV === "development" && console.warn(`[React Flow]: ${t} Help: https://reactflow.dev/error#${e}`);
}, Eg = (e) => "nativeEvent" in e;
function vs(e) {
  var r, a;
  const t = Eg(e) ? e.nativeEvent : e, n = ((a = (r = t.composedPath) == null ? void 0 : r.call(t)) == null ? void 0 : a[0]) || e.target;
...
const eu = (e) => "clientX" in e, rn = (e, t) => {
  var a, i;
  const n = eu(e), o = n ? e.clientX : (a = e.touches) == null ? void 0 : a[0].clientX, r = n ? e.clientY : (i = e.touches) == null ? void 0 : i[0].clientY;
  return {
...
}, ro = ({ id: e, path: t, labelX: n, labelY: o, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u, style: c, markerEnd: d, markerStart: g, interactionWidth: h = 20 }) => P.createElement(
  P.Fragment,
  null,
  ...
  r && lt(n) && lt(o) ? P.createElement(Cg, { x: n, y: o, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u }) : null
);
...
function tu({ sourceX: e, sourceY: t, targetX: n, targetY: o }) {
  const r = Math.abs(n - e) / 2, a = n < e ? n + r : n - r, i = Math.abs(o - t) / 2, s = o < t ? o + i : o - i;
  return [a, s, r, i];
}
function nu({ sourceX: e, sourceY: t, targetX: n, targetY: o, sourceControlX: r, sourceControlY: a, targetControlX: i, targetControlY: s }) {
...
function V1({ pos: e, x1: t, y1: n, x2: o, y2: r }) {
  return e === ne.Left || e === ne.Right ? [0.5 * (t + o), n] : [t, 0.5 * (n + r)];
}
function ou({ sourceX: e, sourceY: t, sourcePosition: n = ne.Bottom, targetX: o, targetY: r, targetPosition: a = ne.Top }) {
  const [i, s] = V1({
    pos: n,
    x1: e,
    y1: t,
...
const pl = Oe(({ sourceX: e, sourceY: t, targetX: n, targetY: o, sourcePosition: r = ne.Bottom, targetPosition: a = ne.Top, label: i, labelStyle: s, labelShowBg: l, labelBgStyle: u, labelBgPadding: c, labelBgBorderRadius: d, style: g, markerEnd: h, markerStart: m, interactionWidth: b }) => {
  const [C, p, y] = ou({
    sourceX: e,
    sourceY: t,
    sourcePosition: r,
  ...
  return P.createElement(ro, { path: C, labelX: p, labelY: y, label: i, labelStyle: s, labelShowBg: l, labelBgStyle: u, labelBgPadding: c, labelBgBorderRadius: d, style: g, markerEnd: h, markerStart: m, interactionWidth: b });
});
pl.displayName = "SimpleBezierEdge";
const W1 = {
  [ne.Left]: { x: -1, y: 0 },
  [ne.Right]: { x: 1, y: 0 },
  [ne.Top]: { x: 0, y: -1 },
  [ne.Bottom]: { x: 0, y: 1 }
}, Sg = ({ source: e, sourcePosition: t = ne.Bottom, target: n }) => t === ne.Left || t === ne.Right ? e.x < n.x ? { x: 1, y: 0 } : { x: -1, y: 0 } : e.y < n.y ? { x: 0, y: 1 } : { x: 0, y: -1 }, $1 = (e, t) => Math.sqrt(Math.pow(t.x - e.x, 2) + Math.pow(t.y - e.y, 2));
function _g({ source: e, sourcePosition: t = ne.Bottom, target: n, targetPosition: o = ne.Top, center: r, offset: a }) {
  const i = W1[t], s = W1[o], l = { x: e.x + i.x * a, y: e.y + i.y * a }, u = { x: n.x + s.x * a, y: n.y + s.y * a }, c = Sg({
    source: l,
    sourcePosition: t,
    target: u
  }), d = c.x !== 0 ? "x" : "y", g = c[d];
  let h = [], m, b;
  const C = { x: 0, y: 0 }, p = { x: 0, y: 0 }, [y, x, E, v] = tu({
    sourceX: e.x,
    sourceY: e.y,
    targetX: n.x,
    targetY: n.y
  ...
  if (i[d] * s[d] === -1) {
    ...
    i[d] === g ? h = d === "x" ? T : _ : h = d === "x" ? _ : T;
  } else {
    const T = [{ x: l.x, y: u.y }], _ = [{ x: u.x, y: l.y }];
    if (d === "x" ? h = i.x === g ? _ : T : h = i.y === g ? T : _, t === o) {
      const B = Math.abs(e[d] - n[d]);
      if (B <= a) {
        const w = Math.min(a - 1, a - B);
        i[d] === g ? C[d] = (l[d] > e[d] ? -1 : 1) * w : p[d] = (u[d] > n[d] ? -1 : 1) * w;
      }
    }
    if (t !== o) {
      const B = d === "x" ? "y" : "x", w = i[d] === s[B], A = l[B] > u[B], S = l[B] < u[B];
      (i[d] === 1 && (!w && A || w && S) || i[d] !== 1 && (!w && S || w && A)) && (h = d === "x" ? T : _);
    }
    const H = { x: l.x + C.x, y: l.y + C.y }, R = { x: u.x + p.x, y: u.y + p.y }, z = Math.max(Math.abs(H.x - h[0].x), Math.abs(R.x - h[0].x)), $ = Math.max(Math.abs(H.y - h[0].y), Math.abs(R.y - h[0].y));
...
function kg(e, t, n, o) {
  const r = Math.min($1(e, t) / 2, $1(t, n) / 2, o), { x: a, y: i } = t;
...
function xs({ sourceX: e, sourceY: t, sourcePosition: n = ne.Bottom, targetX: o, targetY: r, targetPosition: a = ne.Top, borderRadius: i = 5, centerX: s, centerY: l, offset: u = 20 }) {
  const [c, d, g, h, m] = _g({
    source: { x: e, y: t },
    sourcePosition: n,
    target: { x: o, y: r },
  ...
  return [c.reduce((C, p, y) => {
    let x = "";
    return y > 0 && y < c.length - 1 ? x = kg(c[y - 1], p, c[y + 1], i) : x = `${y === 0 ? "M" : "L"}${p.x} ${p.y}`, C += x, C;
  }, ""), d, g, h, m];
}
const ga = Oe(({ sourceX: e, sourceY: t, targetX: n, targetY: o, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u, style: c, sourcePosition: d = ne.Bottom, targetPosition: g = ne.Top, markerEnd: h, markerStart: m, pathOptions: b, interactionWidth: C }) => {
  const [p, y, x] = xs({
    sourceX: e,
    sourceY: t,
    sourcePosition: d,
  ...
  return P.createElement(ro, { path: p, labelX: y, labelY: x, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u, style: c, markerEnd: h, markerStart: m, interactionWidth: C });
});
ga.displayName = "SmoothStepEdge";
const ml = Oe((e) => {
  var t;
  return P.createElement(ga, { ...e, pathOptions: Se(() => {
    var n;
    return { borderRadius: 0, offset: (n = e.pathOptions) == null ? void 0 : n.offset };
  }, [(t = e.pathOptions) == null ? void 0 : t.offset]) });
});
ml.displayName = "StepEdge";
function Ag({ sourceX: e, sourceY: t, targetX: n, targetY: o }) {
  const [r, a, i, s] = tu({
    sourceX: e,
    sourceY: t,
    targetX: n,
...
const bl = Oe(({ sourceX: e, sourceY: t, targetX: n, targetY: o, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u, style: c, markerEnd: d, markerStart: g, interactionWidth: h }) => {
  const [m, b, C] = Ag({ sourceX: e, sourceY: t, targetX: n, targetY: o });
  return P.createElement(ro, { path: m, labelX: b, labelY: C, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u, style: c, markerEnd: d, markerStart: g, interactionWidth: h });
});
bl.displayName = "StraightEdge";
function mr(e, t) {
  return e >= 0 ? 0.5 * e : t * 25 * Math.sqrt(-e);
}
function Z1({ pos: e, x1: t, y1: n, x2: o, y2: r, c: a }) {
  switch (e) {
    case ne.Left:
      return [t - mr(t - o, a), n];
    case ne.Right:
...
function ru({ sourceX: e, sourceY: t, sourcePosition: n = ne.Bottom, targetX: o, targetY: r, targetPosition: a = ne.Top, curvature: i = 0.25 }) {
  const [s, l] = Z1({
    pos: n,
    x1: e,
    y1: t,
...
const Yr = Oe(({ sourceX: e, sourceY: t, targetX: n, targetY: o, sourcePosition: r = ne.Bottom, targetPosition: a = ne.Top, label: i, labelStyle: s, labelShowBg: l, labelBgStyle: u, labelBgPadding: c, labelBgBorderRadius: d, style: g, markerEnd: h, markerStart: m, pathOptions: b, interactionWidth: C }) => {
  const [p, y, x] = ru({
    sourceX: e,
    sourceY: t,
    sourcePosition: r,
  ...
  return P.createElement(ro, { path: p, labelX: y, labelY: x, label: i, labelStyle: s, labelShowBg: l, labelBgStyle: u, labelBgPadding: c, labelBgBorderRadius: d, style: g, markerEnd: h, markerStart: m, interactionWidth: C });
});
Yr.displayName = "BezierEdge";
const yl = ut(null), Mg = yl.Provider;
yl.Consumer;
const Tg = () => Re(yl), Ng = (e) => "id" in e && "source" in e && "target" in e, Og = (e) => "id" in e && !("source" in e) && !("target" in e), Dg = ({ source: e, sourceHandle: t, target: n, targetHandle: o }) => `reactflow__edge-${e}${t || ""}-${n}${o || ""}`, ws = (e, t) => typeof e > "u" ? "" : typeof e == "string" ? e : `${t ? `${t}__` : ""}${Object.keys(e).sort().map((o) => `${o}=${e[o]}`).join("&")}`, Lg = (e, t) => t.some((n) => n.source === e.source && n.target === e.target && (n.sourceHandle === e.sourceHandle || !n.sourceHandle && !e.sourceHandle) && (n.targetHandle === e.targetHandle || !n.targetHandle && !e.targetHandle)), jg = (e, t) => {
  if (!e.source || !e.target)
    return Q0("006", vt.error006()), t;
  let n;
  return Ng(e) ? n = { ...e } : n = {
    ...e,
    id: Dg(e)
  }, Lg(n, t) ? t : t.concat(n);
}, Es = ({ x: e, y: t }, [n, o, r], a, [i, s]) => {
  const l = {
    x: (e - n) / r,
    y: (t - o) / r
  };
  ...
  const n = e.reduce((o, r) => {
    const { x: a, y: i } = Vn(r, t).positionAbsolute;
    return vg(o, hl({
      x: a,
      y: i,
      width: r.width || 0,
  ...
  return xg(n);
}, iu = (e, t, [n, o, r] = [0, 0, 1], a = !1, i = !1, s = [0, 0]) => {
  const l = {
    x: (t.x - n) / r,
    y: (t.y - o) / r,
    width: t.width / r,
  ...
  return e.forEach((c) => {
    ...
    if (i && !h || m)
      return !1;
    const { positionAbsolute: b } = Vn(c, s), C = {
      x: b.x,
      y: b.y,
      width: d || 0,
      height: g || 0
    }, p = Cs(l, C), y = typeof d > "u" || typeof g > "u" || d === null || g === null, x = a && p > 0, E = (d || 0) * (g || 0);
    (y || x || p >= E || c.dragging) && u.push(c);
  }), u;
}, su = (e, t) => {
  const n = e.map((o) => o.id);
  return t.filter((o) => n.includes(o.source) || n.includes(o.target));
}, lu = (e, t, n, o, r, a = 0.1) => {
  const i = t / (e.width * (1 + a)), s = n / (e.height * (1 + a)), l = Math.min(i, s), u = Jn(l, o, r), c = e.x + e.width / 2, d = e.y + e.height / 2, g = t / 2 - c * u, h = n / 2 - d * u;
  return { x: g, y: h, zoom: u };
}, gn = (e, t = 0) => e.transition().duration(t);
function q1(e, t, n, o) {
...
function Rg(e, t, n, o, r, a) {
  ...
  if (u) {
    ...
    if (m) {
      const b = vl(void 0, u), C = u.getAttribute("data-handleid"), p = a({ nodeId: m, id: C, type: b });
      if (p) {
        const y = r.find((x) => x.nodeId === m && x.type === b && x.id === C);
        return {
          handle: {
            id: C,
            type: b,
            nodeId: m,
            x: (y == null ? void 0 : y.x) || n.x,
            y: (y == null ? void 0 : y.y) || n.y
          },
          validHandleResult: p
        };
      }
  ...
  if (r.forEach((m) => {
    ...
    return { handle: null, validHandleResult: cu() };
  if (c.length === 1)
    return c[0];
...
const Hg = { source: null, target: null, sourceHandle: null, targetHandle: null }, cu = () => ({
  handleDomNode: null,
  isValid: !1,
  connection: Hg,
  endHandle: null
});
function uu(e, t, n, o, r, a, i) {
  ...
  if (l) {
    const c = vl(void 0, l), d = l.getAttribute("data-nodeid"), g = l.getAttribute("data-handleid"), h = l.classList.contains("connectable"), m = l.classList.contains("connectableend"), b = {
      source: s ? d : n,
      sourceHandle: s ? g : o,
      target: s ? n : d,
      targetHandle: s ? o : g
    };
    u.connection = b, h && m && (t === kn.Strict ? s && c === "source" || !s && c === "target" : d !== n || g !== o) && (u.endHandle = {
      nodeId: d,
      handleId: g,
      type: c
    }, u.isValid = a(b));
...
function Fg({ nodes: e, nodeId: t, handleId: n, handleType: o }) {
  return e.reduce((r, a) => {
    if (a[Ne]) {
...
function du({ event: e, handleId: t, nodeId: n, onConnect: o, isTarget: r, getState: a, setState: i, isValidConnection: s, edgeUpdaterType: l, onReconnectEnd: u }) {
  const c = X0(e.target), { connectionMode: d, domNode: g, autoPanOnConnect: h, connectionRadius: m, onConnectStart: b, panBy: C, getNodes: p, cancelConnection: y } = a();
  let x = 0, E;
  const { x: v, y: k } = rn(e), T = c == null ? void 0 : c.elementFromPoint(v, k), _ = vl(l, T), H = g == null ? void 0 : g.getBoundingClientRect();
  if (!H || !_)
    return;
  let R, z = rn(e, H), $ = !1, B = null, w = !1, A = null;
  const S = Fg({
    nodes: p(),
    nodeId: n,
    handleId: t,
    ...
    if (!h)
      return;
    const [M, F] = K0(z, H);
    C({ x: M, y: F }), x = requestAnimationFrame(O);
  };
  i({
  ...
  function L(M) {
    const { transform: F } = a();
    z = rn(M, H);
    const { handle: I, validHandleResult: V } = Rg(M, c, Es(z, F, !1, [1, 1]), m, S, (W) => uu(W, d, n, t, r ? "target" : "source", s, c));
    if (E = I, $ || (O(), $ = !0), A = V.handleDomNode, B = V.connection, w = V.isValid, i({
      connectionPosition: E && w ? au({
        x: E.x,
        y: E.y
      }, F) : z,
      connectionStatus: zg(!!E, w),
      connectionEndHandle: V.endHandle
    }), !E && !w && !A)
      return Bi(R);
    B.source !== B.target && A && (Bi(R), R = A, A.classList.add("connecting", "react-flow__handle-connecting"), A.classList.toggle("valid", w), A.classList.toggle("react-flow__handle-valid", w));
  }
  function D(M) {
    var F, I;
    (E || A) && B && w && (o == null || o(B)), (I = (F = a()).onConnectEnd) == null || I.call(F, M), l && (u == null || u(M)), Bi(R), y(), cancelAnimationFrame(x), $ = !1, w = !1, B = null, A = null, c.removeEventListener("mousemove", L), c.removeEventListener("mouseup", D), c.removeEventListener("touchmove", L), c.removeEventListener("touchend", D);
  }
...
const U1 = () => !0, Ig = (e) => ({
...
}, fu = js(({ type: e = "source", position: t = ne.Top, isValidConnection: n, isConnectable: o = !0, isConnectableStart: r = !0, isConnectableEnd: a = !0, id: i, onConnect: s, children: l, className: u, onMouseDown: c, onTouchStart: d, ...g }, h) => {
  var H, R;
  const m = i || null, b = e === "target", C = ze(), p = Tg(), { connectOnClick: y, noPanClassName: x } = Ae(Ig, Pe), { connecting: E, clickConnecting: v } = Ae(Pg(p, m, e), Pe);
  p || (R = (H = C.getState()).onError) == null || R.call(H, "010", vt.error010());
  const k = (z) => {
    const { defaultEdgeOptions: $, onConnect: B, hasDefaultEdges: w } = C.getState(), A = {
      ...$,
      ...z
    };
    if (w) {
      const { edges: S, setEdges: O } = C.getState();
      O(jg(A, S));
    }
    B == null || B(A), s == null || s(A);
  }, T = (z) => {
    if (!p)
      return;
    const $ = eu(z);
    r && ($ && z.button === 0 || !$) && du({
      ...
      getState: C.getState,
      setState: C.setState,
      isValidConnection: n || C.getState().isValidConnection || U1
    }), $ ? c == null || c(z) : d == null || d(z);
  }, _ = (z) => {
    const { onClickConnectStart: $, onClickConnectEnd: B, connectionClickStartHandle: w, connectionMode: A, isValidConnection: S } = C.getState();
    if (!p || !w && !r)
      return;
    if (!w) {
      $ == null || $(z, { nodeId: p, handleId: m, handleType: e }), C.setState({ connectionClickStartHandle: { nodeId: p, type: e, handleId: m } });
      return;
    }
    const O = X0(z.target), L = n || S || U1, { connection: D, isValid: M } = uu({
      nodeId: p,
      id: m,
      type: e
    }, A, w.nodeId, w.handleId || null, w.type, L, O);
    M && k(D), B == null || B(z), C.setState({ connectionClickStartHandle: null });
  };
  ...
  ]), onMouseDown: T, onTouchStart: T, onClick: y ? _ : void 0, ref: h, ...g }, l);
});
fu.displayName = "Handle";
var rt = Oe(fu);
const gu = ({ data: e, isConnectable: t, targetPosition: n = ne.Top, sourcePosition: o = ne.Bottom }) => P.createElement(
  P.Fragment,
  null,
  P.createElement(rt, { type: "target", position: n, isConnectable: t }),
  e == null ? void 0 : e.label,
  P.createElement(rt, { type: "source", position: o, isConnectable: t })
);
gu.displayName = "DefaultNode";
var Ss = Oe(gu);
const hu = ({ data: e, isConnectable: t, sourcePosition: n = ne.Bottom }) => P.createElement(
  P.Fragment,
  null,
  e == null ? void 0 : e.label,
  P.createElement(rt, { type: "source", position: n, isConnectable: t })
);
hu.displayName = "InputNode";
var pu = Oe(hu);
const mu = ({ data: e, isConnectable: t, targetPosition: n = ne.Top }) => P.createElement(
  P.Fragment,
  null,
  P.createElement(rt, { type: "target", position: n, isConnectable: t }),
  e == null ? void 0 : e.label
);
mu.displayName = "OutputNode";
var bu = Oe(mu);
const xl = () => null;
xl.displayName = "GroupNode";
const Bg = (e) => ({
...
const yu = Oe(({ onSelectionChange: e }) => {
  const t = ze(), { selectedNodes: n, selectedEdges: o } = Ae(Bg, Vg);
  return re(() => {
...
const Wg = (e) => !!e.onSelectionChange;
...
const qg = ({ nodes: e, edges: t, defaultNodes: n, defaultEdges: o, onConnect: r, onConnectStart: a, onConnectEnd: i, onClickConnectStart: s, onClickConnectEnd: l, nodesDraggable: u, nodesConnectable: c, nodesFocusable: d, edgesFocusable: g, edgesUpdatable: h, elevateNodesOnSelect: m, minZoom: b, maxZoom: C, nodeExtent: p, onNodesChange: y, onEdgesChange: x, elementsSelectable: E, connectionMode: v, snapGrid: k, snapToGrid: T, translateExtent: _, connectOnClick: H, defaultEdgeOptions: R, fitView: z, fitViewOptions: $, onNodesDelete: B, onEdgesDelete: w, onNodeDrag: A, onNodeDragStart: S, onNodeDragStop: O, onSelectionDrag: L, onSelectionDragStart: D, onSelectionDragStop: M, noPanClassName: F, nodeOrigin: I, rfId: V, autoPanOnConnect: W, autoPanOnNodeDrag: q, onError: K, connectionRadius: X, isValidConnection: J, nodeDragThreshold: te }) => {
  const { setNodes: Z, setEdges: fe, setDefaultNodesAndEdges: G, setMinZoom: ye, setMaxZoom: je, setTranslateExtent: Ee, setNodeExtent: Be, reset: ve } = Ae(Zg, Pe), oe = ze();
  return re(() => {
    const He = o == null ? void 0 : o.map((Dt) => ({ ...Dt, ...R }));
    return G(n, He), () => {
      ve();
    };
  }, []), ue("defaultEdgeOptions", R, oe.setState), ue("connectionMode", v, oe.setState), ue("onConnect", r, oe.setState), ue("onConnectStart", a, oe.setState), ue("onConnectEnd", i, oe.setState), ue("onClickConnectStart", s, oe.setState), ue("onClickConnectEnd", l, oe.setState), ue("nodesDraggable", u, oe.setState), ue("nodesConnectable", c, oe.setState), ue("nodesFocusable", d, oe.setState), ue("edgesFocusable", g, oe.setState), ue("edgesUpdatable", h, oe.setState), ue("elementsSelectable", E, oe.setState), ue("elevateNodesOnSelect", m, oe.setState), ue("snapToGrid", T, oe.setState), ue("snapGrid", k, oe.setState), ue("onNodesChange", y, oe.setState), ue("onEdgesChange", x, oe.setState), ue("connectOnClick", H, oe.setState), ue("fitViewOnInit", z, oe.setState), ue("fitViewOnInitOptions", $, oe.setState), ue("onNodesDelete", B, oe.setState), ue("onEdgesDelete", w, oe.setState), ue("onNodeDrag", A, oe.setState), ue("onNodeDragStart", S, oe.setState), ue("onNodeDragStop", O, oe.setState), ue("onSelectionDrag", L, oe.setState), ue("onSelectionDragStart", D, oe.setState), ue("onSelectionDragStop", M, oe.setState), ue("noPanClassName", F, oe.setState), ue("nodeOrigin", I, oe.setState), ue("rfId", V, oe.setState), ue("autoPanOnConnect", W, oe.setState), ue("autoPanOnNodeDrag", q, oe.setState), ue("onError", K, oe.setState), ue("connectionRadius", X, oe.setState), ue("isValidConnection", J, oe.setState), ue("nodeDragThreshold", te, oe.setState), Ln(e, Z), Ln(t, fe), Ln(b, ye), Ln(C, je), Ln(_, Ee), Ln(p, Be), null;
}, Y1 = { display: "none" }, Ug = {
  position: "absolute",
  width: 1,
  height: 1,
  ...
  clipPath: "inset(100%)"
}, Cu = "react-flow__node-desc", vu = "react-flow__edge-desc", Yg = "react-flow__aria-live", Gg = (e) => e.ariaLiveMessage;
function Kg({ rfId: e }) {
  const t = Ae(Gg);
  return P.createElement("div", { id: `${Yg}-${e}`, "aria-live": "assertive", "aria-atomic": "true", style: Ug }, t);
}
function Xg({ rfId: e, disableKeyboardA11y: t }) {
  return P.createElement(
    ...
    P.createElement("div", { id: `${vu}-${e}`, style: Y1 }, "Press enter or space to select an edge. You can then press delete to remove it or escape to cancel."),
    !t && P.createElement(Kg, { rfId: e })
  );
}
var Ho = (e = null, t = { actInsideInputWithModifier: !0 }) => {
  const [n, o] = ae(!1), r = se(!1), a = se(/* @__PURE__ */ new Set([])), [i, s] = Se(() => {
    if (e !== null) {
  ...
  return re(() => {
    ...
    if (e !== null) {
      const c = (h) => {
        if (r.current = h.ctrlKey || h.metaKey || h.shiftKey, (!r.current || r.current && !t.actInsideInputWithModifier) && vs(h))
          return !1;
        const b = K1(h.code, s);
        a.current.add(h[b]), G1(i, a.current, !1) && (h.preventDefault(), o(!0));
      }, d = (h) => {
        if ((!r.current || r.current && !t.actInsideInputWithModifier) && vs(h))
          return !1;
        const b = K1(h.code, s);
        G1(i, a.current, !0) ? (o(!1), a.current.clear()) : a.current.delete(h[b]), h.key === "Meta" && a.current.clear(), r.current = !1;
      }, g = () => {
        a.current.clear(), o(!1);
      };
...
function Eu(e, t = {}) {
  ...
  if (s && l && (g || !t.initial)) {
    const m = n().filter((C) => {
      ...
      return (y = t.nodes) != null && y.length ? p && t.nodes.some((x) => x.id === C.id) : p;
    }), b = m.every((C) => C.width && C.height);
    if (m.length > 0 && b) {
      const C = Cl(m, d), { x: p, y, zoom: x } = lu(C, o, r, t.minZoom ?? a, t.maxZoom ?? i, t.padding ?? 0.1), E = on.translate(p, y).scale(x);
      return typeof t.duration == "number" && t.duration > 0 ? s.transform(gn(l, t.duration), E) : s.transform(l, E), !0;
    }
  }
  return !1;
}
...
function yr({ changedNodes: e, changedEdges: t, get: n, set: o }) {
  ...
  e != null && e.length && (l && o({ nodeInternals: Jg(e, r) }), i == null || i(e)), t != null && t.length && (u && o({ edges: Qg(t, a) }), s == null || s(t));
}
const jn = () => {
}, eh = {
  zoomIn: jn,
  ...
  const e = ze(), { d3Zoom: t, d3Selection: n } = Ae(th, Pe);
  return Se(() => n && t ? {
    zoomIn: (r) => t.scaleBy(gn(n, r == null ? void 0 : r.duration), 1.2),
    zoomOut: (r) => t.scaleBy(gn(n, r == null ? void 0 : r.duration), 1 / 1.2),
    zoomTo: (r, a) => t.scaleTo(gn(n, a == null ? void 0 : a.duration), r),
    getZoom: () => e.getState().transform[2],
    setViewport: (r, a) => {
      const [i, s, l] = e.getState().transform, u = on.translate(r.x ?? i, r.y ?? s).scale(r.zoom ?? l);
      t.transform(gn(n, a == null ? void 0 : a.duration), u);
    },
    getViewport: () => {
      const [r, a, i] = e.getState().transform;
      return { x: r, y: a, zoom: i };
    },
    fitView: (r) => Eu(e.getState, r),
    setCenter: (r, a, i) => {
      ...
      t.transform(gn(n, i == null ? void 0 : i.duration), h);
    },
    fitBounds: (r, a) => {
      const { width: i, height: s, minZoom: l, maxZoom: u } = e.getState(), { x: c, y: d, zoom: g } = lu(r, i, s, l, u, (a == null ? void 0 : a.padding) ?? 0.1), h = on.translate(c, d).scale(g);
      t.transform(gn(n, a == null ? void 0 : a.duration), h);
    },
    // @deprecated Use `screenToFlowPosition`.
    project: (r) => {
      const { transform: a, snapToGrid: i, snapGrid: s } = e.getState();
      return console.warn("[DEPRECATED] `project` is deprecated. Instead use `screenToFlowPosition`. There is no need to subtract the react flow bounds anymore! https://reactflow.dev/api-reference/types/react-flow-instance#screen-to-flow-position"), Es(r, a, i, s);
    },
    ...
    flowToScreenPosition: (r) => {
      ...
      if (!i)
        return r;
      const { x: s, y: l } = i.getBoundingClientRect(), u = au(r, a);
      return {
        x: u.x + s,
        y: u.y + l
      };
...
function wt() {
  const e = nh(), t = ze(), n = pe(() => t.getState().getNodes().map((b) => ({ ...b })), []), o = pe((b) => t.getState().nodeInternals.get(b), []), r = pe(() => {
    ...
    const { getNodes: C, setNodes: p, hasDefaultNodes: y, onNodesChange: x } = t.getState(), E = C(), v = typeof b == "function" ? b(E) : b;
    if (y)
      p(v);
    else if (x) {
      const k = v.length === 0 ? E.map((T) => ({ type: "remove", id: T.id })) : v.map((T) => ({ item: T, type: "reset" }));
      x(k);
    }
  }, []), s = pe((b) => {
    const { edges: C = [], setEdges: p, hasDefaultEdges: y, onEdgesChange: x } = t.getState(), E = typeof b == "function" ? b(C) : b;
    if (y)
      p(E);
    else if (x) {
      const v = E.length === 0 ? C.map((k) => ({ type: "remove", id: k.id })) : E.map((k) => ({ item: k, type: "reset" }));
      x(v);
    }
  }, []), l = pe((b) => {
    const C = Array.isArray(b) ? b : [b], { getNodes: p, setNodes: y, hasDefaultNodes: x, onNodesChange: E } = t.getState();
    if (x) {
      const k = [...p(), ...C];
      y(k);
    } else if (E) {
      const v = C.map((k) => ({ item: k, type: "add" }));
      E(v);
    }
  }, []), u = pe((b) => {
    const C = Array.isArray(b) ? b : [b], { edges: p = [], setEdges: y, hasDefaultEdges: x, onEdgesChange: E } = t.getState();
    if (x)
      y([...p, ...C]);
    else if (E) {
      const v = C.map((k) => ({ item: k, type: "add" }));
    ...
    const { getNodes: b, edges: C = [], transform: p } = t.getState(), [y, x, E] = p;
    return {
      nodes: b().map((v) => ({ ...v })),
      edges: C.map((v) => ({ ...v })),
      viewport: {
    ...
    const { nodeInternals: p, getNodes: y, edges: x, hasDefaultNodes: E, hasDefaultEdges: v, onNodesDelete: k, onEdgesDelete: T, onNodesChange: _, onEdgesChange: H } = t.getState(), R = (b || []).map((A) => A.id), z = (C || []).map((A) => A.id), $ = y().reduce((A, S) => {
      const O = S.parentNode || S.parentId, L = !R.includes(S.id) && O && A.find((M) => M.id === O);
      return (typeof S.deletable == "boolean" ? S.deletable : !0) && (R.includes(S.id) || L) && A.push(S), A;
    }, []), B = x.filter((A) => typeof A.deletable == "boolean" ? A.deletable : !0), w = B.filter((A) => z.includes(A.id));
    if ($ || w) {
      const A = su($, B), S = [...w, ...A], O = S.reduce((L, D) => (L.includes(D.id) || L.push(D.id), L), []);
      if ((v || E) && (v && t.setState({
      ...
      }))), O.length > 0 && (T == null || T(S), H && H(O.map((L) => ({
        id: L,
        type: "remove"
      })))), $.length > 0 && (k == null || k($), _)) {
    ...
    const C = wg(b), p = C ? null : t.getState().nodeInternals.get(b.id);
    return !C && !p ? [null, null, C] : [C ? b : B1(p), p, C];
  }, []), h = pe((b, C = !0, p) => {
    const [y, x, E] = g(b);
    return y ? (p || t.getState().getNodes()).filter((v) => {
      if (!E && (v.id === x.id || !v.positionAbsolute))
        return !1;
      const k = B1(v), T = Cs(k, y);
      return C && T > 0 || T >= y.width * y.height;
    }) : [];
  }, []), m = pe((b, C, p = !0) => {
    const [y] = g(b);
    if (!y)
      return !1;
    const x = Cs(y, C);
    return p && x > 0 || x >= y.width * y.height;
  }, []);
  return Se(() => ({
    ...e,
    getNodes: n,
...
const oh = { actInsideInputWithModifier: !1 };
var rh = ({ deleteKeyCode: e, multiSelectionKeyCode: t }) => {
  const n = ze(), { deleteElements: o } = wt(), r = Ho(e, oh), a = Ho(t);
  re(() => {
    if (r) {
...
const wl = {
  ...
  top: 0,
  left: 0
}, ih = (e, t) => e.x !== t.x || e.y !== t.y || e.zoom !== t.k, Cr = (e) => ({
  x: e.x,
  y: e.y,
  zoom: e.k
}), Rn = (e, t) => e.target.closest(`.${t}`), X1 = (e, t) => t === 2 && Array.isArray(e) && e.includes(2), J1 = (e) => {
...
}), lh = ({ onMove: e, onMoveStart: t, onMoveEnd: n, onPaneContextMenu: o, zoomOnScroll: r = !0, zoomOnPinch: a = !0, panOnScroll: i = !1, panOnScrollSpeed: s = 0.5, panOnScrollMode: l = bn.Free, zoomOnDoubleClick: u = !0, elementsSelectable: c, panOnDrag: d = !0, defaultViewport: g, translateExtent: h, minZoom: m, maxZoom: b, zoomActivationKeyCode: C, preventScrolling: p = !0, children: y, noWheelClassName: x, noPanClassName: E }) => {
  const v = se(), k = ze(), T = se(!1), _ = se(!1), H = se(null), R = se({ x: 0, y: 0, zoom: 0 }), { d3Zoom: z, d3Selection: $, d3ZoomHandler: B, userSelectionActive: w } = Ae(sh, Pe), A = Ho(C), S = se(0), O = se(!1), L = se();
  return ah(H), re(() => {
    if (H.current) {
      const D = H.current.getBoundingClientRect(), M = hg().scaleExtent([m, b]).translateExtent(h), F = bt(H.current).call(M), I = on.translate(g.x, g.y).scale(Jn(g.zoom, m, b)), V = [
        [0, 0],
        [D.width, D.height]
      ], W = M.constrain()(I, V, h);
      M.transform(F, W), M.wheelDelta(J1), k.setState({
        d3Zoom: M,
        d3Selection: F,
    ...
    $ && z && (i && !A && !w ? $.on("wheel.zoom", (D) => {
      if (Rn(D, x))
        return !1;
      D.preventDefault(), D.stopImmediatePropagation();
      const M = $.property("__zoom").k || 1;
      if (D.ctrlKey && a) {
        const J = kt(D), te = J1(D), Z = M * Math.pow(2, te);
        z.scaleTo($, Z, J, D);
        return;
      }
      const F = D.deltaMode === 1 ? 20 : 1;
      let I = l === bn.Vertical ? 0 : D.deltaX * F, V = l === bn.Horizontal ? 0 : D.deltaY * F;
      !qr() && D.shiftKey && l !== bn.Vertical && (I = D.deltaY * F, V = 0), z.translateBy(
        $,
        -(I / M) * s,
        -(V / M) * s,
        // @ts-ignore
      ...
      const W = Cr($.property("__zoom")), { onViewportChangeStart: q, onViewportChange: K, onViewportChangeEnd: X } = k.getState();
    ...
    }, { passive: !1 }) : typeof B < "u" && $.on("wheel.zoom", function(D, M) {
      if (!p && D.type === "wheel" && !D.ctrlKey || Rn(D, x))
        return null;
      D.preventDefault(), B.call(this, D, M);
    }, { passive: !1 }));
  }, [
    w,
    i,
    ...
    z && z.on("start", (D) => {
      ...
      if (!D.sourceEvent || D.sourceEvent.internal)
        return null;
      S.current = (I = D.sourceEvent) == null ? void 0 : I.button;
      const { onViewportChangeStart: M } = k.getState(), F = Cr(D.transform);
      T.current = !0, R.current = F, ((V = D.sourceEvent) == null ? void 0 : V.type) === "mousedown" && k.setState({ paneDragging: !0 }), M == null || M(F), t == null || t(D.sourceEvent, F);
    });
  }, [z, t]), re(() => {
    z && (w && !T.current ? z.on("zoom", null) : w || z.on("zoom", (D) => {
      var F;
      const { onViewportChange: M } = k.getState();
      if (k.setState({ transform: [D.transform.x, D.transform.y, D.transform.k] }), _.current = !!(o && X1(d, S.current ?? 0)), (e || M) && !((F = D.sourceEvent) != null && F.internal)) {
        const I = Cr(D.transform);
        M == null || M(I), e == null || e(D.sourceEvent, I);
      }
    }));
  }, [w, z, e, d, o]), re(() => {
    z && z.on("end", (D) => {
      ...
      if (T.current = !1, k.setState({ paneDragging: !1 }), o && X1(d, S.current ?? 0) && !_.current && o(D.sourceEvent), _.current = !1, (n || M) && ih(R.current, D.transform)) {
        const F = Cr(D.transform);
        R.current = F, clearTimeout(v.current), v.current = setTimeout(() => {
          M == null || M(F), n == null || n(D.sourceEvent, F);
        }, i ? 150 : 0);
      }
    });
  }, [z, i, d, n, o]), re(() => {
    z && z.filter((D) => {
      const M = A || r, F = a && D.ctrlKey;
      if ((d === !0 || Array.isArray(d) && d.includes(1)) && D.button === 1 && D.type === "mousedown" && (Rn(D, "react-flow__node") || Rn(D, "react-flow__edge")))
        return !0;
      if (!d && !M && !i && !u && !a || w || !u && D.type === "dblclick" || Rn(D, x) && D.type === "wheel" || Rn(D, E) && (D.type !== "wheel" || i && D.type === "wheel" && !A) || !a && D.ctrlKey && D.type === "wheel" || !M && !i && !F && D.type === "wheel" || !d && (D.type === "mousedown" || D.type === "touchstart") || Array.isArray(d) && !d.includes(D.button) && D.type === "mousedown")
        return !1;
    ...
    c,
    A
  ]), P.createElement("div", { className: "react-flow__renderer", ref: H, style: wl }, y);
}, ch = (e) => ({
  userSelectionActive: e.userSelectionActive,
  userSelectionRect: e.userSelectionRect
});
function uh() {
  const { userSelectionActive: e, userSelectionRect: t } = Ae(ch, Pe);
    ...
    for (const s of a)
      if (s)
        switch (s.type) {
          ...
          case "position": {
            typeof s.position < "u" && (i.position = s.position), typeof s.positionAbsolute < "u" && (i.positionAbsolute = s.positionAbsolute), typeof s.dragging < "u" && (i.dragging = s.dragging), i.expandParent && Q1(o, i);
            break;
          }
          case "dimensions": {
            typeof s.dimensions < "u" && (i.width = s.dimensions.width, i.height = s.dimensions.height), typeof s.updateStyle < "u" && (i.style = { ...i.style || {}, ...s.dimensions }), typeof s.resizing == "boolean" && (i.resizing = s.resizing), i.expandParent && Q1(o, i);
            break;
          }
          case "remove":
            return o;
...
const Wi = (e, t) => (n) => {
...
}), Su = Oe(({ isSelecting: e, selectionMode: t = Ro.Full, panOnDrag: n, onSelectionStart: o, onSelectionEnd: r, onPaneClick: a, onPaneContextMenu: i, onPaneScroll: s, onPaneMouseEnter: l, onPaneMouseMove: u, onPaneMouseLeave: c, children: d }) => {
  const g = se(null), h = ze(), m = se(0), b = se(0), C = se(), { userSelectionActive: p, elementsSelectable: y, dragging: x } = Ae(gh, Pe), E = () => {
    ...
    i == null || i(B);
  }, T = s ? (B) => s(B) : void 0, _ = (B) => {
    const { resetSelectedElements: w, domNode: A } = h.getState();
    if (C.current = A == null ? void 0 : A.getBoundingClientRect(), !y || !e || B.button !== 0 || B.target !== g.current || !C.current)
      return;
    const { x: S, y: O } = rn(B, C.current);
    w(), h.setState({
      userSelectionRect: {
        width: 0,
        height: 0,
    ...
    const { userSelectionRect: w, nodeInternals: A, edges: S, transform: O, onNodesChange: L, onEdgesChange: D, nodeOrigin: M, getNodes: F } = h.getState();
    if (!e || !C.current || !w)
      return;
    h.setState({ userSelectionActive: !0, nodesSelectionActive: !1 });
    const I = rn(B, C.current), V = w.startX ?? 0, W = w.startY ?? 0, q = {
      ...w,
      x: I.x < V ? I.x : V,
      y: I.y < W ? I.y : W,
      width: Math.abs(I.x - V),
      height: Math.abs(I.y - W)
    }, K = F(), X = iu(A, q, O, t === Ro.Partial, !0, M), J = su(X, S).map((Z) => Z.id), te = X.map((Z) => Z.id);
  ...
  return P.createElement(
    "div",
    { className: Ge(["react-flow__pane", { dragging: x, selection: e }]), onClick: $ ? void 0 : Wi(v, g), onContextMenu: Wi(k, g), onWheel: Wi(T, g), onMouseEnter: $ ? void 0 : l, onMouseDown: $ ? _ : void 0, onMouseMove: $ ? H : u, onMouseUp: $ ? R : void 0, onMouseLeave: $ ? z : c, ref: g, style: wl },
    d,
    P.createElement(uh, null)
  );
});
Su.displayName = "Pane";
function _u(e, t) {
  ...
  if (!n)
    return !1;
  const o = t.get(n);
  return o ? o.selected ? !0 : _u(o, t) : !1;
}
function e2(e, t, n) {
  let o = e;
  do {
...
function hh(e, t, n, o) {
  return Array.from(e.values()).filter((r) => (r.selected || r.id === o) && (!r.parentNode || r.parentId || !_u(r, e)) && (r.draggable || t && typeof r.draggable > "u")).map((r) => {
    var a, i;
    return {
      id: r.id,
...
function ku(e, t, n, o, r = [0, 0], a) {
  const i = ph(e, e.extent || o);
  let s = i;
  const l = e.parentNode || e.parentId;
  if (e.extent === "parent" && !e.expandParent)
    if (l && e.width && e.height) {
      const d = n.get(l), { x: g, y: h } = Vn(d, r).positionAbsolute;
  ...
  if (l) {
    const d = n.get(l);
    u = Vn(d, r).positionAbsolute;
  }
  const c = s && s !== "parent" ? gl(t, s) : t;
  return {
    position: {
      x: c.x - u.x,
      y: c.y - u.y
...
function $i({ nodeId: e, dragItems: t, nodeInternals: n }) {
  const o = t.map((r) => ({
    ...n.get(r.id),
    position: r.position,
...
function _s({ id: e, store: t, unselect: n = !1, nodeRef: o }) {
...
function Au({ nodeRef: e, disabled: t = !1, noDragClassName: n, handleSelector: o, nodeId: r, isSelectable: a, selectNodesOnDrag: i }) {
  const s = ze(), [l, u] = ae(!1), c = se([]), d = se({ x: null, y: null }), g = se(0), h = se(null), m = se({ x: 0, y: 0 }), b = se(null), C = se(!1), p = se(!1), y = se(!1), x = mh();
  return re(() => {
    if (e != null && e.current) {
      const E = bt(e.current), v = ({ x: _, y: H }) => {
        const { nodeInternals: R, onNodeDrag: z, onSelectionDrag: $, updateNodePositions: B, nodeExtent: w, snapGrid: A, snapToGrid: S, nodeOrigin: O, onError: L } = s.getState();
        d.current = { x: _, y: H };
        let D = !1, M = { x: 0, y: 0, x2: 0, y2: 0 };
        if (c.current.length > 1 && w) {
          const I = Cl(c.current, O);
          M = hl(I);
        }
        if (c.current = c.current.map((I) => {
          const V = { x: _ - I.distance.x, y: H - I.distance.y };
          S && (V.x = A[0] * Math.round(V.x / A[0]), V.y = A[1] * Math.round(V.y / A[1]));
          const W = [
            [w[0][0], w[0][1]],
            [w[1][0], w[1][1]]
          ];
          c.current.length > 1 && w && !I.extent && (W[0][0] = I.positionAbsolute.x - M.x + w[0][0], W[1][0] = I.positionAbsolute.x + (I.width ?? 0) - M.x2 + w[1][0], W[0][1] = I.positionAbsolute.y - M.y + w[0][1], W[1][1] = I.positionAbsolute.y + (I.height ?? 0) - M.y2 + w[1][1]);
          const q = ku(I, V, R, W, O, L);
        ...
        if (!h.current)
          return;
        const [_, H] = K0(m.current, h.current);
        if (_ !== 0 || H !== 0) {
          const { transform: R, panBy: z } = s.getState();
          d.current.x = (d.current.x ?? 0) - _ / R[2], d.current.y = (d.current.y ?? 0) - H / R[2], z({ x: _, y: H }) && v(d.current);
        }
        ...
        p.current = !0;
        const A = r ? B : Zi(w);
        (!i || !a) && !R && r && ((O = H.get(r)) != null && O.selected || $()), r && a && i && _s({
          id: r,
          store: s,
          nodeRef: e
        });
        const S = x(_);
        if (d.current = S, c.current = hh(H, z, S, r), A && c.current) {
          const [L, D] = $i({
            nodeId: r,
            dragItems: c.current,
            nodeInternals: H
      ...
      if (t)
        ...
        const _ = S7().on("start", (H) => {
          ...
          if (H.sourceEvent.type === "touchmove" && H.sourceEvent.touches.length > 1 && (y.current = !0), !y.current) {
            if (!C.current && p.current && z && (C.current = !0, k()), !p.current) {
              const A = R.xSnapped - (((B = d == null ? void 0 : d.current) == null ? void 0 : B.x) ?? 0), S = R.ySnapped - (((w = d == null ? void 0 : d.current) == null ? void 0 : w.y) ?? 0);
              Math.sqrt(A * A + S * S) > $ && T(H);
            }
          ...
          if (!(!p.current || y.current) && (u(!1), C.current = !1, p.current = !1, cancelAnimationFrame(g.current), c.current)) {
            const { updateNodePositions: R, nodeInternals: z, onNodeDragStop: $, onSelectionDragStop: B } = s.getState(), w = r ? $ : Zi(B);
          ...
          const R = H.target;
          return !H.button && (!n || !e2(R, `.${n}`, e)) && (!o || e2(R, o, e));
        });
        return E.call(_), () => {
          E.on(".drag", null);
        };
...
function Mu() {
  const e = ze();
  return pe((n) => {
    const { nodeInternals: o, nodeExtent: r, updateNodePositions: a, getNodes: i, snapToGrid: s, snapGrid: l, onError: u, nodesDraggable: c } = e.getState(), d = i().filter((y) => y.selected && (y.draggable || c && typeof y.draggable > "u")), g = s ? l[0] : 5, h = s ? l[1] : 5, m = n.isShiftPressed ? 4 : 1, b = n.x * g * m, C = n.y * h * m, p = d.map((y) => {
      if (y.positionAbsolute) {
        const x = { x: y.positionAbsolute.x + b, y: y.positionAbsolute.y + C };
        s && (x.x = l[0] * Math.round(x.x / l[0]), x.y = l[1] * Math.round(x.y / l[1]));
        const { positionAbsolute: E, position: v } = ku(y, x, o, r, void 0, u);
        y.position = v, y.positionAbsolute = E;
      }
      return y;
    });
    a(p, !0, !1);
...
var ho = (e) => {
  const t = ({ id: n, type: o, data: r, xPos: a, yPos: i, xPosOrigin: s, yPosOrigin: l, selected: u, onClick: c, onMouseEnter: d, onMouseMove: g, onMouseLeave: h, onContextMenu: m, onDoubleClick: b, style: C, className: p, isDraggable: y, isSelectable: x, isConnectable: E, isFocusable: v, selectNodesOnDrag: k, sourcePosition: T, targetPosition: _, hidden: H, resizeObserver: R, dragHandle: z, zIndex: $, isParent: B, noDragClassName: w, noPanClassName: A, initialized: S, disableKeyboardA11y: O, ariaLabel: L, rfId: D, hasHandleBounds: M }) => {
    const F = ze(), I = se(null), V = se(null), W = se(T), q = se(_), K = se(o), X = x || y || c || d || g || h, J = Mu(), te = go(n, F.getState, d), Z = go(n, F.getState, g), fe = go(n, F.getState, h), G = go(n, F.getState, m), ye = go(n, F.getState, b), je = (ve) => {
      ...
      if (!vs(ve) && !O)
        ...
        } else y && u && Object.prototype.hasOwnProperty.call(Wn, ve.key) && (F.setState({
          ariaLiveMessage: `Moved selected node ${ve.key.replace("Arrow", "").toLowerCase()}. New position, x: ${~~a}, y: ${~~i}`
        }), J({
          x: Wn[ve.key].x,
          y: Wn[ve.key].y,
          isShiftPressed: ve.shiftKey
        }));
    };
    re(() => () => {
      ...
      if (I.current && !H) {
        const ve = I.current;
        (!S || !M || V.current !== ve) && (V.current && (R == null || R.unobserve(V.current)), R == null || R.observe(ve), V.current = ve);
      }
    }, [H, S, M]), re(() => {
      const ve = K.current !== o, oe = W.current !== T, He = q.current !== _;
      I.current && (ve || oe || He) && (ve && (K.current = o), oe && (W.current = T), He && (q.current = _), F.getState().updateNodeDimensions([{ id: n, nodeElement: I.current, forceUpdate: !0 }]));
    }, [n, o, T, _]);
    const Be = Au({
      nodeRef: I,
      disabled: H || !y,
    ...
    return H ? null : P.createElement(
      ...
      { className: Ge([
        ...
        ...C
      }, "data-id": n, "data-testid": `rf__node-${n}`, onMouseEnter: te, onMouseMove: Z, onMouseLeave: fe, onContextMenu: G, onClick: je, onDoubleClick: ye, onKeyDown: v ? Ee : void 0, tabIndex: v ? 0 : void 0, role: v ? "button" : void 0, "aria-describedby": O ? void 0 : `${Cu}-${D}`, "aria-label": L },
      P.createElement(
        Mg,
        { value: n },
        P.createElement(e, { id: n, data: r, type: o, xPos: a, yPos: i, selected: u, isConnectable: E, sourcePosition: T, targetPosition: _, dragging: Be, dragHandle: z, zIndex: $ })
      )
    );
  };
...
function yh({ onSelectionContextMenu: e, noPanClassName: t, disableKeyboardA11y: n }) {
  const o = ze(), { width: r, height: a, x: i, y: s, transformString: l, userSelectionActive: u } = Ae(bh, Pe), c = Mu(), d = se(null);
  if (re(() => {
    var m;
  ...
  const g = e ? (m) => {
    ...
    Object.prototype.hasOwnProperty.call(Wn, m.key) && c({
      x: Wn[m.key].x,
      y: Wn[m.key].y,
...
var Ch = Oe(yh);
const vh = (e) => e.nodesSelectionActive, Tu = ({ children: e, onPaneClick: t, onPaneMouseEnter: n, onPaneMouseMove: o, onPaneMouseLeave: r, onPaneContextMenu: a, onPaneScroll: i, deleteKeyCode: s, onMove: l, onMoveStart: u, onMoveEnd: c, selectionKeyCode: d, selectionOnDrag: g, selectionMode: h, onSelectionStart: m, onSelectionEnd: b, multiSelectionKeyCode: C, panActivationKeyCode: p, zoomActivationKeyCode: y, elementsSelectable: x, zoomOnScroll: E, zoomOnPinch: v, panOnScroll: k, panOnScrollSpeed: T, panOnScrollMode: _, zoomOnDoubleClick: H, panOnDrag: R, defaultViewport: z, translateExtent: $, minZoom: B, maxZoom: w, preventScrolling: A, onSelectionContextMenu: S, noWheelClassName: O, noPanClassName: L, disableKeyboardA11y: D }) => {
  const M = Ae(vh), F = Ho(d), I = Ho(p), V = I || R, W = I || k, q = F || g && V !== !0;
  return rh({ deleteKeyCode: s, multiSelectionKeyCode: C }), P.createElement(
    lh,
    { onMove: l, onMoveStart: u, onMoveEnd: c, onPaneContextMenu: a, elementsSelectable: x, zoomOnScroll: E, zoomOnPinch: v, panOnScroll: W, panOnScrollSpeed: T, panOnScrollMode: _, zoomOnDoubleClick: H, panOnDrag: !F && V, defaultViewport: z, translateExtent: $, minZoom: B, maxZoom: w, zoomActivationKeyCode: y, preventScrolling: A, noWheelClassName: O, noPanClassName: L },
    P.createElement(
      Su,
      ...
      e,
      M && P.createElement(Ch, { onSelectionContextMenu: S, noPanClassName: L, disableKeyboardA11y: D })
    )
  );
};
...
var xh = Oe(Tu);
function wh(e) {
  return Ae(pe((n) => e ? iu(n.nodeInternals, { x: 0, y: 0, width: n.width, height: n.height }, n.transform, !0) : n.getNodes(), [e]));
}
function Eh(e) {
  const t = {
    input: ho(e.input || pu),
    default: ho(e.default || Ss),
    output: ho(e.output || bu),
    group: ho(e.group || xl)
  }, n = {}, o = Object.keys(e).filter((r) => !["input", "default", "output", "group"].includes(r)).reduce((r, a) => (r[a] = ho(e[a] || Ss), r), n);
  return {
    ...t,
    ...o
  };
}
const Sh = ({ x: e, y: t, width: n, height: o, origin: r }) => !n || !o ? { x: e, y: t } : r[0] < 0 || r[1] < 0 || r[0] > 1 || r[1] > 1 ? { x: e, y: t } : {
  x: e - n * r[0],
  y: t - o * r[1]
}, _h = (e) => ({
  ...
  const { nodesDraggable: t, nodesConnectable: n, nodesFocusable: o, elementsSelectable: r, updateNodeDimensions: a, onError: i } = Ae(_h, Pe), s = wh(e.onlyRenderVisibleElements), l = se(), u = Se(() => {
  ...
  return re(() => () => {
  ...
  }, []), P.createElement("div", { className: "react-flow__nodes", style: wl }, s.map((c) => {
    var v, k, T;
    let d = c.type || "default";
    e.nodeTypes[d] || (i == null || i("003", vt.error003(d)), d = "default");
    const g = e.nodeTypes[d] || e.nodeTypes.default, h = !!(c.draggable || t && typeof c.draggable > "u"), m = !!(c.selectable || r && typeof c.selectable > "u"), b = !!(c.connectable || n && typeof c.connectable > "u"), C = !!(c.focusable || o && typeof c.focusable > "u"), p = e.nodeExtent ? gl(c.positionAbsolute, e.nodeExtent) : c.positionAbsolute, y = (p == null ? void 0 : p.x) ?? 0, x = (p == null ? void 0 : p.y) ?? 0, E = Sh({
      x: y,
      y: x,
      width: c.width ?? 0,
      height: c.height ?? 0,
    ...
    return P.createElement(g, { key: c.id, id: c.id, className: c.className, style: c.style, type: d, data: c.data, sourcePosition: c.sourcePosition || ne.Bottom, targetPosition: c.targetPosition || ne.Top, hidden: c.hidden, xPos: y, yPos: x, xPosOrigin: E.x, yPosOrigin: E.y, selectNodesOnDrag: e.selectNodesOnDrag, onClick: e.onNodeClick, onMouseEnter: e.onNodeMouseEnter, onMouseMove: e.onNodeMouseMove, onMouseLeave: e.onNodeMouseLeave, onContextMenu: e.onNodeContextMenu, onDoubleClick: e.onNodeDoubleClick, selected: !!c.selected, isDraggable: h, isSelectable: m, isConnectable: b, isFocusable: C, resizeObserver: u, dragHandle: c.dragHandle, zIndex: ((v = c[Ne]) == null ? void 0 : v.z) ?? 0, isParent: !!((k = c[Ne]) != null && k.isParent), noDragClassName: e.noDragClassName, noPanClassName: e.noPanClassName, initialized: !!c.width && !!c.height, rfId: e.rfId, disableKeyboardA11y: e.disableKeyboardA11y, ariaLabel: c.ariaLabel, hasHandleBounds: !!((T = c[Ne]) != null && T.handleBounds) });
  }));
};
Nu.displayName = "NodeRenderer";
var kh = Oe(Nu);
const Ah = (e, t, n) => n === ne.Left ? e - t : n === ne.Right ? e + t : e, Mh = (e, t, n) => n === ne.Top ? e - t : n === ne.Bottom ? e + t : e, n2 = "react-flow__edgeupdater", o2 = ({ position: e, centerX: t, centerY: n, radius: o = 10, onMouseDown: r, onMouseEnter: a, onMouseOut: i, type: s }) => P.createElement("circle", { onMouseDown: r, onMouseEnter: a, onMouseOut: i, className: Ge([n2, `${n2}-${s}`]), cx: Ah(t, o, e), cy: Mh(n, o, e), r: o, stroke: "transparent", fill: "transparent" }), Th = () => !0;
var Hn = (e) => {
  const t = ({ id: n, className: o, type: r, data: a, onClick: i, onEdgeDoubleClick: s, selected: l, animated: u, label: c, labelStyle: d, labelShowBg: g, labelBgStyle: h, labelBgPadding: m, labelBgBorderRadius: b, style: C, source: p, target: y, sourceX: x, sourceY: E, targetX: v, targetY: k, sourcePosition: T, targetPosition: _, elementsSelectable: H, hidden: R, sourceHandleId: z, targetHandleId: $, onContextMenu: B, onMouseEnter: w, onMouseMove: A, onMouseLeave: S, reconnectRadius: O, onReconnect: L, onReconnectStart: D, onReconnectEnd: M, markerEnd: F, markerStart: I, rfId: V, ariaLabel: W, isFocusable: q, isReconnectable: K, pathOptions: X, interactionWidth: J, disableKeyboardA11y: te }) => {
    const Z = se(null), [fe, G] = ae(!1), [ye, je] = ae(!1), Ee = ze(), Be = Se(() => `url('#${ws(I, V)}')`, [I, V]), ve = Se(() => `url('#${ws(F, V)}')`, [F, V]);
    if (R)
      return null;
    const oe = (De) => {
      var ot;
      const { edges: Qe, addSelectedEdges: Rt, unselectNodesAndEdges: Ht, multiSelectionActive: Ft } = Ee.getState(), ht = Qe.find((un) => un.id === n);
      ht && (H && (Ee.setState({ nodesSelectionActive: !1 }), ht.selected && Ft ? (Ht({ nodes: [], edges: [ht] }), (ot = Z.current) == null || ot.blur()) : Rt([n])), i && i(De, ht));
    }, He = fo(n, Ee.getState, s), Dt = fo(n, Ee.getState, B), cn = fo(n, Ee.getState, w), Et = fo(n, Ee.getState, A), qt = fo(n, Ee.getState, S), gt = (De, Qe) => {
      if (De.button !== 0)
        return;
      const { edges: Rt, isValidConnection: Ht } = Ee.getState(), Ft = Qe ? y : p, ht = (Qe ? $ : z) || null, ot = Qe ? "target" : "source", un = Ht || Th, dn = Qe, Gt = Rt.find((pt) => pt.id === n);
      je(!0), D == null || D(De, Gt, ot);
      const _t = (pt) => {
        je(!1), M == null || M(pt, Gt, ot);
      };
      du({
        event: De,
        handleId: ht,
    ...
    }, Lt = (De) => gt(De, !0), St = (De) => gt(De, !1), Je = () => G(!0), Ut = () => G(!1), jt = !H && !i, Yt = (De) => {
      var Qe;
      if (!te && J0.includes(De.key) && H) {
        const { unselectNodesAndEdges: Rt, addSelectedEdges: Ht, edges: Ft } = Ee.getState();
        De.key === "Escape" ? ((Qe = Z.current) == null || Qe.blur(), Rt({ edges: [Ft.find((ot) => ot.id === n)] })) : Ht([n]);
      }
    };
    return P.createElement(
      "g",
      ...
      ]), onClick: oe, onDoubleClick: He, onContextMenu: Dt, onMouseEnter: cn, onMouseMove: Et, onMouseLeave: qt, onKeyDown: q ? Yt : void 0, tabIndex: q ? 0 : void 0, role: q ? "button" : "img", "data-testid": `rf__edge-${n}`, "aria-label": W === null ? void 0 : W || `Edge from ${p} to ${y}`, "aria-describedby": q ? `${vu}-${V}` : void 0, ref: Z },
      !ye && P.createElement(e, { id: n, source: p, target: y, selected: l, animated: u, label: c, labelStyle: d, labelShowBg: g, labelBgStyle: h, labelBgPadding: m, labelBgBorderRadius: b, data: a, style: C, sourceX: x, sourceY: E, targetX: v, targetY: k, sourcePosition: T, targetPosition: _, sourceHandleId: z, targetHandleId: $, markerStart: Be, markerEnd: ve, pathOptions: X, interactionWidth: J }),
      K && P.createElement(
        P.Fragment,
        null,
        (K === "source" || K === !0) && P.createElement(o2, { position: T, centerX: x, centerY: E, radius: O, onMouseDown: Lt, onMouseEnter: Je, onMouseOut: Ut, type: "source" }),
        (K === "target" || K === !0) && P.createElement(o2, { position: _, centerX: v, centerY: k, radius: O, onMouseDown: St, onMouseEnter: Je, onMouseOut: Ut, type: "target" })
      )
    );
  };
...
function Nh(e) {
  const t = {
    default: Hn(e.default || Yr),
    straight: Hn(e.bezier || bl),
    step: Hn(e.step || ml),
    smoothstep: Hn(e.step || ga),
    simplebezier: Hn(e.simplebezier || pl)
  }, n = {}, o = Object.keys(e).filter((r) => !["default", "bezier"].includes(r)).reduce((r, a) => (r[a] = Hn(e[a] || Yr), r), n);
  return {
    ...t,
    ...o
  };
}
function r2(e, t, n = null) {
...
const Oh = (e, t, n, o, r, a) => {
  const i = r2(n, e, t), s = r2(a, o, r);
  return {
    sourceX: i.x,
    sourceY: i.y,
    targetX: s.x,
...
function Dh({ sourcePos: e, targetPos: t, sourceWidth: n, sourceHeight: o, targetWidth: r, targetHeight: a, width: i, height: s, transform: l }) {
  const u = {
    x: Math.min(e.x, t.x),
    y: Math.min(e.y, t.y),
...
const Lh = [{ level: 0, isMaxLevel: !0, edges: [] }];
function jh(e, t, n = !1) {
  let o = -1;
  ...
  return a.length === 0 ? Lh : a;
}
function Rh(e, t, n) {
  const o = Ae(pe((r) => e ? r.edges.filter((a) => {
    const i = t.get(a.source), s = t.get(a.target);
    return (i == null ? void 0 : i.width) && (i == null ? void 0 : i.height) && (s == null ? void 0 : s.width) && (s == null ? void 0 : s.height) && Dh({
...
const Hh = ({ color: e = "none", strokeWidth: t = 1 }) => P.createElement("polyline", { style: {
  stroke: e,
  strokeWidth: t
}, strokeLinecap: "round", strokeLinejoin: "round", fill: "none", points: "-5,-4 0,0 -5,4" }), Fh = ({ color: e = "none", strokeWidth: t = 1 }) => P.createElement("polyline", { style: {
  stroke: e,
  fill: e,
  strokeWidth: t
}, strokeLinecap: "round", strokeLinejoin: "round", points: "-5,-4 0,0 -5,4 -5,-4" }), s2 = {
  [Ur.Arrow]: Hh,
  [Ur.ArrowClosed]: Fh
};
function zh(e) {
  ...
  return Se(() => {
    var r, a;
    return Object.prototype.hasOwnProperty.call(s2, e) ? s2[e] : ((a = (r = t.getState()).onError) == null || a.call(r, "009", vt.error009(e)), null);
  }, [e]);
}
const Ih = ({ id: e, type: t, color: n, width: o = 12.5, height: r = 12.5, markerUnits: a = "strokeWidth", strokeWidth: i, orient: s = "auto-start-reverse" }) => {
  const l = zh(t);
...
}, Ou = ({ defaultColor: e, rfId: t }) => {
  const n = Ae(
    pe(Ph({ defaultColor: e, rfId: t }), [e, t]),
    // the id includes all marker options, so we just need to look at that part of the marker
    (o, r) => !(o.length !== r.length || o.some((a, i) => a.id !== r[i].id))
  );
  return P.createElement("defs", null, n.map((o) => P.createElement(Ih, { id: o.id, key: o.id, type: o.type, color: o.color, width: o.width, height: o.height, markerUnits: o.markerUnits, strokeWidth: o.strokeWidth, orient: o.orient })));
};
Ou.displayName = "MarkerDefinitions";
var Bh = Oe(Ou);
const Vh = (e) => ({
  nodesConnectable: e.nodesConnectable,
  ...
  onError: e.onError
}), Du = ({ defaultMarkerColor: e, onlyRenderVisibleElements: t, elevateEdgesOnSelect: n, rfId: o, edgeTypes: r, noPanClassName: a, onEdgeContextMenu: i, onEdgeMouseEnter: s, onEdgeMouseMove: l, onEdgeMouseLeave: u, onEdgeClick: c, onEdgeDoubleClick: d, onReconnect: g, onReconnectStart: h, onReconnectEnd: m, reconnectRadius: b, children: C, disableKeyboardA11y: p }) => {
  const { edgesFocusable: y, edgesUpdatable: x, elementsSelectable: E, width: v, height: k, connectionMode: T, nodeInternals: _, onError: H } = Ae(Vh, Pe), R = Rh(t, _, n);
  return v ? P.createElement(
    ...
    R.map(({ level: z, edges: $, isMaxLevel: B }) => P.createElement(
      ...
      B && P.createElement(Bh, { defaultColor: e, rfId: o }),
      P.createElement("g", null, $.map((w) => {
        const [A, S, O] = i2(_.get(w.source)), [L, D, M] = i2(_.get(w.target));
        if (!O || !M)
          return null;
        let F = w.type || "default";
        r[F] || (H == null || H("011", vt.error011(F)), F = "default");
        const I = r[F] || r.default, V = T === kn.Strict ? D.target : (D.target ?? []).concat(D.source ?? []), W = a2(S.source, w.sourceHandle), q = a2(V, w.targetHandle), K = (W == null ? void 0 : W.position) || ne.Bottom, X = (q == null ? void 0 : q.position) || ne.Top, J = !!(w.focusable || y && typeof w.focusable > "u"), te = w.reconnectable || w.updatable, Z = typeof g < "u" && (te || x && typeof te > "u");
        if (!W || !q)
          return H == null || H("008", vt.error008(W, w)), null;
        const { sourceX: fe, sourceY: G, targetX: ye, targetY: je } = Oh(A, W, K, L, q, X);
...
var Wh = Oe(Du);
const $h = (e) => `translate(${e.transform[0]}px,${e.transform[1]}px) scale(${e.transform[2]})`;
...
const Uh = {
  ...
  [ne.Top]: ne.Bottom,
  [ne.Bottom]: ne.Top
}, Lu = ({ nodeId: e, handleType: t, style: n, type: o = nn.Bezier, CustomComponent: r, connectionStatus: a }) => {
  var k, T, _;
  ...
  if (c === kn.Loose && (g = g || (d == null ? void 0 : d[t === "source" ? "target" : "source"])), !i || !g)
    return null;
  const h = s ? g.find((H) => H.id === s) : g[0], m = h ? h.x + h.width / 2 : (i.width ?? 0) / 2, b = h ? h.y + h.height / 2 : i.height ?? 0, C = (((T = i.positionAbsolute) == null ? void 0 : T.x) ?? 0) + m, p = (((_ = i.positionAbsolute) == null ? void 0 : _.y) ?? 0) + b, y = h == null ? void 0 : h.position, x = y ? Uh[y] : null;
  if (!y || !x)
    return null;
  if (r)
    return P.createElement(r, { connectionLineType: o, connectionLineStyle: n, fromNode: i, fromHandle: h, fromX: C, fromY: p, toX: l, toY: u, fromPosition: y, toPosition: x, connectionStatus: a });
  let E = "";
  const v = {
    sourceX: C,
    sourceY: p,
  ...
  return o === nn.Bezier ? [E] = ru(v) : o === nn.Step ? [E] = xs({
    ...v,
    borderRadius: 0
  }) : o === nn.SmoothStep ? [E] = xs(v) : o === nn.SimpleBezier ? [E] = ou(v) : E = `M${C},${p} ${l},${u}`, P.createElement("path", { d: E, fill: "none", className: "react-flow__connection-path", style: n });
};
Lu.displayName = "ConnectionLine";
const Yh = (e) => ({
...
function Gh({ containerStyle: e, style: t, type: n, component: o }) {
  const { nodeId: r, handleType: a, nodesConnectable: i, width: s, height: l, connectionStatus: u } = Ae(Yh, Pe);
  return !(r && a && s && i) ? null : P.createElement(
    ...
    P.createElement(
      ...
      P.createElement(Lu, { nodeId: r, handleType: a, style: t, type: n, CustomComponent: o, connectionStatus: u })
    )
  );
}
function l2(e, t) {
...
const ju = ({ nodeTypes: e, edgeTypes: t, onMove: n, onMoveStart: o, onMoveEnd: r, onInit: a, onNodeClick: i, onEdgeClick: s, onNodeDoubleClick: l, onEdgeDoubleClick: u, onNodeMouseEnter: c, onNodeMouseMove: d, onNodeMouseLeave: g, onNodeContextMenu: h, onSelectionContextMenu: m, onSelectionStart: b, onSelectionEnd: C, connectionLineType: p, connectionLineStyle: y, connectionLineComponent: x, connectionLineContainerStyle: E, selectionKeyCode: v, selectionOnDrag: k, selectionMode: T, multiSelectionKeyCode: _, panActivationKeyCode: H, zoomActivationKeyCode: R, deleteKeyCode: z, onlyRenderVisibleElements: $, elementsSelectable: B, selectNodesOnDrag: w, defaultViewport: A, translateExtent: S, minZoom: O, maxZoom: L, preventScrolling: D, defaultMarkerColor: M, zoomOnScroll: F, zoomOnPinch: I, panOnScroll: V, panOnScrollSpeed: W, panOnScrollMode: q, zoomOnDoubleClick: K, panOnDrag: X, onPaneClick: J, onPaneMouseEnter: te, onPaneMouseMove: Z, onPaneMouseLeave: fe, onPaneScroll: G, onPaneContextMenu: ye, onEdgeContextMenu: je, onEdgeMouseEnter: Ee, onEdgeMouseMove: Be, onEdgeMouseLeave: ve, onReconnect: oe, onReconnectStart: He, onReconnectEnd: Dt, reconnectRadius: cn, noDragClassName: Et, noWheelClassName: qt, noPanClassName: gt, elevateEdgesOnSelect: Lt, disableKeyboardA11y: St, nodeOrigin: Je, nodeExtent: Ut, rfId: jt }) => {
  const Yt = l2(e, Eh), De = l2(t, Nh);
  return qh(a), P.createElement(
    xh,
    { onPaneClick: J, onPaneMouseEnter: te, onPaneMouseMove: Z, onPaneMouseLeave: fe, onPaneContextMenu: ye, onPaneScroll: G, deleteKeyCode: z, selectionKeyCode: v, selectionOnDrag: k, selectionMode: T, onSelectionStart: b, onSelectionEnd: C, multiSelectionKeyCode: _, panActivationKeyCode: H, zoomActivationKeyCode: R, elementsSelectable: B, onMove: n, onMoveStart: o, onMoveEnd: r, zoomOnScroll: F, zoomOnPinch: I, zoomOnDoubleClick: K, panOnScroll: V, panOnScrollSpeed: W, panOnScrollMode: q, panOnDrag: X, defaultViewport: A, translateExtent: S, minZoom: O, maxZoom: L, onSelectionContextMenu: m, preventScrolling: D, noDragClassName: Et, noWheelClassName: qt, noPanClassName: gt, disableKeyboardA11y: St },
    P.createElement(
      Zh,
      null,
      P.createElement(
        Wh,
        { edgeTypes: De, onEdgeClick: s, onEdgeDoubleClick: u, onlyRenderVisibleElements: $, onEdgeContextMenu: je, onEdgeMouseEnter: Ee, onEdgeMouseMove: Be, onEdgeMouseLeave: ve, onReconnect: oe, onReconnectStart: He, onReconnectEnd: Dt, reconnectRadius: cn, defaultMarkerColor: M, noPanClassName: gt, elevateEdgesOnSelect: !!Lt, disableKeyboardA11y: St, rfId: jt },
        P.createElement(Gh, { style: y, type: p, component: x, containerStyle: E })
      ),
      P.createElement("div", { className: "react-flow__edgelabel-renderer" }),
      P.createElement(kh, { nodeTypes: Yt, onNodeClick: i, onNodeDoubleClick: l, onNodeMouseEnter: c, onNodeMouseMove: d, onNodeMouseLeave: g, onNodeContextMenu: h, selectNodesOnDrag: w, onlyRenderVisibleElements: $, noPanClassName: gt, noDragClassName: Et, disableKeyboardA11y: St, nodeOrigin: Je, nodeExtent: Ut, rfId: jt })
    )
  );
};
...
const ks = [
  ...
  setDefaultNodesAndEdges: (n, o) => {
    const r = typeof n < "u", a = typeof o < "u", i = r ? Vi(n, /* @__PURE__ */ new Map(), t().nodeOrigin, t().elevateNodesOnSelect) : /* @__PURE__ */ new Map();
  ...
  updateNodeDimensions: (n) => {
    ...
    if (!c)
      return;
    const d = window.getComputedStyle(c), { m22: g } = new window.DOMMatrixReadOnly(d.transform), h = n.reduce((b, C) => {
      const p = r.get(C.id);
      if (p != null && p.hidden)
        r.set(p.id, {
          ...p,
        ...
        const y = fl(C.nodeElement);
        !!(y.width && y.height && (p.width !== y.width || p.height !== y.height || C.forceUpdate)) && (r.set(p.id, {
          ...p,
          [Ne]: {
            ...p[Ne],
            handleBounds: {
              source: t2(".source", C.nodeElement, g, u),
              target: t2(".target", C.nodeElement, g, u)
            }
          },
          ...y
        }), b.push({
    ...
    wu(r, u);
    const m = i || a && !i && Eu(t, { initial: !0, ...s });
  ...
  addSelectedNodes: (n) => {
    ...
    let i, s = null;
    o ? i = n.map((l) => tn(l, !0)) : (i = Fn(a(), n), s = Fn(r, [])), yr({
      changedNodes: i,
      changedEdges: s,
      get: t,
      set: e
  ...
  addSelectedEdges: (n) => {
    const { multiSelectionActive: o, edges: r, getNodes: a } = t();
    let i, s = null;
    o ? i = n.map((l) => tn(l, !0)) : (i = Fn(r, n), s = Fn(a(), [])), yr({
      changedNodes: s,
      changedEdges: i,
      get: t,
      set: e
  ...
  setNodeExtent: (n) => {
    ...
    o.forEach((r) => {
      r.positionAbsolute = gl(r.position, n);
    }), e({
      nodeExtent: n,
  ...
  const t = se(null);
  return t.current || (t.current = Xh()), P.createElement(pg, { value: t.current }, e);
};
Yo.displayName = "ReactFlowProvider";
const Ru = ({ children: e }) => Re(fa) ? P.createElement(P.Fragment, null, e) : P.createElement(Yo, null, e);
Ru.displayName = "ReactFlowWrapper";
const Jh = {
  input: pu,
  default: Ss,
  output: bu,
  ...
  smoothstep: ga,
  simplebezier: pl
}, ep = [0, 0], tp = [15, 15], np = { x: 0, y: 0, zoom: 1 }, op = {
  width: "100%",
  height: "100%",
  overflow: "hidden",
  position: "relative",
  zIndex: 0
}, ha = js(({ nodes: e, edges: t, defaultNodes: n, defaultEdges: o, className: r, nodeTypes: a = Jh, edgeTypes: i = Qh, onNodeClick: s, onEdgeClick: l, onInit: u, onMove: c, onMoveStart: d, onMoveEnd: g, onConnect: h, onConnectStart: m, onConnectEnd: b, onClickConnectStart: C, onClickConnectEnd: p, onNodeMouseEnter: y, onNodeMouseMove: x, onNodeMouseLeave: E, onNodeContextMenu: v, onNodeDoubleClick: k, onNodeDragStart: T, onNodeDrag: _, onNodeDragStop: H, onNodesDelete: R, onEdgesDelete: z, onSelectionChange: $, onSelectionDragStart: B, onSelectionDrag: w, onSelectionDragStop: A, onSelectionContextMenu: S, onSelectionStart: O, onSelectionEnd: L, connectionMode: D = kn.Strict, connectionLineType: M = nn.Bezier, connectionLineStyle: F, connectionLineComponent: I, connectionLineContainerStyle: V, deleteKeyCode: W = "Backspace", selectionKeyCode: q = "Shift", selectionOnDrag: K = !1, selectionMode: X = Ro.Full, panActivationKeyCode: J = "Space", multiSelectionKeyCode: te = qr() ? "Meta" : "Control", zoomActivationKeyCode: Z = qr() ? "Meta" : "Control", snapToGrid: fe = !1, snapGrid: G = tp, onlyRenderVisibleElements: ye = !1, selectNodesOnDrag: je = !0, nodesDraggable: Ee, nodesConnectable: Be, nodesFocusable: ve, nodeOrigin: oe = ep, edgesFocusable: He, edgesUpdatable: Dt, elementsSelectable: cn, defaultViewport: Et = np, minZoom: qt = 0.5, maxZoom: gt = 2, translateExtent: Lt = ks, preventScrolling: St = !0, nodeExtent: Je, defaultMarkerColor: Ut = "#b1b1b7", zoomOnScroll: jt = !0, zoomOnPinch: Yt = !0, panOnScroll: De = !1, panOnScrollSpeed: Qe = 0.5, panOnScrollMode: Rt = bn.Free, zoomOnDoubleClick: Ht = !0, panOnDrag: Ft = !0, onPaneClick: ht, onPaneMouseEnter: ot, onPaneMouseMove: un, onPaneMouseLeave: dn, onPaneScroll: Gt, onPaneContextMenu: _t, children: Nn, onEdgeContextMenu: pt, onEdgeDoubleClick: Jo, onEdgeMouseEnter: Ca, onEdgeMouseMove: Qo, onEdgeMouseLeave: va, onEdgeUpdate: er, onEdgeUpdateStart: tr, onEdgeUpdateEnd: xa, onReconnect: wa, onReconnectStart: nr, onReconnectEnd: or, reconnectRadius: Ea = 10, edgeUpdaterRadius: Sa = 10, onNodesChange: _a, onEdgesChange: ka, noDragClassName: j = "nodrag", noWheelClassName: U = "nowheel", noPanClassName: ee = "nopan", fitView: ie = !1, fitViewOptions: he, connectOnClick: Ce = !0, attributionPosition: ge, proOptions: ce, defaultEdgeOptions: Ie, elevateNodesOnSelect: ke = !0, elevateEdgesOnSelect: Me = !1, disableKeyboardA11y: Ze = !1, autoPanOnConnect: Kt = !0, autoPanOnNodeDrag: zt = !0, connectionRadius: Ve = 20, isValidConnection: ao, onError: Aa, style: Ma, id: Vl, nodeDragThreshold: yd, ...Cd }, vd) => {
  const Ta = Vl || "1";
  return P.createElement(
    "div",
    { ...Cd, style: { ...Ma, ...op }, ref: vd, className: Ge(["react-flow", r]), "data-testid": "rf__wrapper", id: Vl },
    P.createElement(
      Ru,
      null,
      P.createElement(Kh, { onInit: u, onMove: c, onMoveStart: d, onMoveEnd: g, onNodeClick: s, onEdgeClick: l, onNodeMouseEnter: y, onNodeMouseMove: x, onNodeMouseLeave: E, onNodeContextMenu: v, onNodeDoubleClick: k, nodeTypes: a, edgeTypes: i, connectionLineType: M, connectionLineStyle: F, connectionLineComponent: I, connectionLineContainerStyle: V, selectionKeyCode: q, selectionOnDrag: K, selectionMode: X, deleteKeyCode: W, multiSelectionKeyCode: te, panActivationKeyCode: J, zoomActivationKeyCode: Z, onlyRenderVisibleElements: ye, selectNodesOnDrag: je, defaultViewport: Et, translateExtent: Lt, minZoom: qt, maxZoom: gt, preventScrolling: St, zoomOnScroll: jt, zoomOnPinch: Yt, zoomOnDoubleClick: Ht, panOnScroll: De, panOnScrollSpeed: Qe, panOnScrollMode: Rt, panOnDrag: Ft, onPaneClick: ht, onPaneMouseEnter: ot, onPaneMouseMove: un, onPaneMouseLeave: dn, onPaneScroll: Gt, onPaneContextMenu: _t, onSelectionContextMenu: S, onSelectionStart: O, onSelectionEnd: L, onEdgeContextMenu: pt, onEdgeDoubleClick: Jo, onEdgeMouseEnter: Ca, onEdgeMouseMove: Qo, onEdgeMouseLeave: va, onReconnect: wa ?? er, onReconnectStart: nr ?? tr, onReconnectEnd: or ?? xa, reconnectRadius: Ea ?? Sa, defaultMarkerColor: Ut, noDragClassName: j, noWheelClassName: U, noPanClassName: ee, elevateEdgesOnSelect: Me, rfId: Ta, disableKeyboardA11y: Ze, nodeOrigin: oe, nodeExtent: Je }),
      P.createElement(qg, { nodes: e, edges: t, defaultNodes: n, defaultEdges: o, onConnect: h, onConnectStart: m, onConnectEnd: b, onClickConnectStart: C, onClickConnectEnd: p, nodesDraggable: Ee, nodesConnectable: Be, nodesFocusable: ve, edgesFocusable: He, edgesUpdatable: Dt, elementsSelectable: cn, elevateNodesOnSelect: ke, minZoom: qt, maxZoom: gt, nodeExtent: Je, onNodesChange: _a, onEdgesChange: ka, snapToGrid: fe, snapGrid: G, connectionMode: D, translateExtent: Lt, connectOnClick: Ce, defaultEdgeOptions: Ie, fitView: ie, fitViewOptions: he, onNodesDelete: R, onEdgesDelete: z, onNodeDragStart: T, onNodeDrag: _, onNodeDragStop: H, onSelectionDrag: w, onSelectionDragStart: B, onSelectionDragStop: A, noPanClassName: ee, nodeOrigin: oe, rfId: Ta, autoPanOnConnect: Kt, autoPanOnNodeDrag: zt, onError: Aa, connectionRadius: Ve, isValidConnection: ao, nodeDragThreshold: yd }),
      P.createElement($g, { onSelectionChange: $ }),
      Nn,
      P.createElement(bg, { proOptions: ce, position: ge }),
      P.createElement(Xg, { rfId: Ta, disableKeyboardA11y: Ze })
    )
  );
});
ha.displayName = "ReactFlow";
function rp() {
  return P.createElement(
    "svg",
...
const Co = ({ children: e, className: t, ...n }) => P.createElement("button", { type: "button", className: Ge(["react-flow__controls-button", t]), ...n }, e);
Co.displayName = "ControlButton";
const cp = (e) => ({
  isInteractive: e.nodesDraggable || e.nodesConnectable || e.elementsSelectable,
  minZoomReached: e.transform[2] <= e.minZoom,
  maxZoomReached: e.transform[2] >= e.maxZoom
}), Hu = ({ style: e, showZoom: t = !0, showFitView: n = !0, showInteractive: o = !0, fitViewOptions: r, onZoomIn: a, onZoomOut: i, onFitView: s, onInteractiveChange: l, className: u, children: c, position: d = "bottom-left" }) => {
  const g = ze(), [h, m] = ae(!1), { isInteractive: b, minZoomReached: C, maxZoomReached: p } = Ae(cp, Pe), { zoomIn: y, zoomOut: x, fitView: E } = wt();
  if (re(() => {
    m(!0);
  }, []), !h)
    return null;
  ...
  return P.createElement(
    ...
    t && P.createElement(
      ...
      P.createElement(
        ...
        P.createElement(rp, null)
      ),
      P.createElement(
        Co,
        { onClick: k, className: "react-flow__controls-zoomout", title: "zoom out", "aria-label": "zoom out", disabled: C },
        P.createElement(ap, null)
      )
    ),
    n && P.createElement(
      Co,
      { className: "react-flow__controls-fitview", onClick: T, title: "fit view", "aria-label": "fit view" },
      P.createElement(ip, null)
    ),
    o && P.createElement(Co, { className: "react-flow__controls-interactive", onClick: _, title: "toggle interactivity", "aria-label": "toggle interactivity" }, b ? P.createElement(lp, null) : P.createElement(sp, null)),
    c
  );
};
...
const fp = {
  ...
  [Ct.Lines]: 1,
  [Ct.Cross]: 6
}, hp = (e) => ({ transform: e.transform, patternId: `pattern-${e.rfId}` });
function Fu({
  id: e,
  variant: t = Ct.Dots,
  ...
  const u = se(null), { transform: c, patternId: d } = Ae(hp, Pe), g = i || fp[t], h = o || gp[t], m = t === Ct.Dots, b = t === Ct.Cross, C = Array.isArray(n) ? n : [n, n], p = [C[0] * c[2] || 1, C[1] * c[2] || 1], y = h * c[2], x = b ? [y, y] : p, E = m ? [y / a, y / a] : [x[0] / a, x[1] / a];
  return P.createElement(
    "svg",
    ...
    P.createElement("pattern", { id: d + e, x: c[0] % p[0], y: c[1] % p[1], width: p[0], height: p[1], patternUnits: "userSpaceOnUse", patternTransform: `translate(-${E[0]},-${E[1]})` }, m ? P.createElement(dp, { color: g, radius: y / a }) : P.createElement(up, { dimensions: x, color: g, lineWidth: r })),
    P.createElement("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: `url(#${d + e})` })
  );
}
Fu.displayName = "Background";
var Sl = Oe(Fu);
const zu = "columns", Iu = "exposure", Pu = "tables", pp = "feedback", Bu = "settings", Vt = "column-", Vu = "see-more-", mp = 5, bp = 100, qi = 100, Go = 272, $n = 80, yp = 12, Cp = $n, Wu = 30, c2 = 4, vp = 280, xp = 80, wp = 80, Ep = 250, As = 0.05, $u = "#7A899E", _l = "#E38E00", kl = {
  Original: "#FDD835",
  Alias: "#40C8AE",
  ...
  height: 16,
  color: _l
}, st = (e) => e.id.startsWith(Vt), vr = (e) => e.id.startsWith(Vu), sn = (e) => !e.id.startsWith(Vt), Tl = (e, t, n, o, r, a = !1) => {
  const [i, s] = r ? [n, o] : [o, n], [l, u] = r ? Ms(e, t, a) : Ms(t, e, a);
  return {
    id: `${i}-${s}`,
    source: i,
    target: s,
  ...
  return {
    ...
    sourceHandle: s,
    targetHandle: l,
    style: r === "direct" ? Al : Ml,
    zIndex: 1e3,
    markerEnd: qu,
    type: n === o ? "smoothstep" : "default",
    hidden: !a[r]
  };
}, ma = (e, t) => Vt + `${e}-${t}`, Xr = (e, t) => {
  e.style = { opacity: t ? 1 : 0.5 };
}, eo = (e, t) => {
  var n;
  e.style = t ? ((n = e.data) == null ? void 0 : n.type) === "indirect" ? Ml : Al : pa, e.markerEnd = t ? qu : Zu;
}, Ms = (e, t, n) => n ? e < t ? ["bottom", "top"] : e > t ? ["top", "bottom"] : e < 0 ? ["top", "top"] : ["bottom", "bottom"] : e < t ? ["right", "left"] : e > t ? ["left", "right"] : e < 0 ? ["left", "left"] : ["right", "right"], Sp = (e, t) => {
  const n = {};
  e.forEach((a) => {
...
}, Fo = (e, t) => Vt + `${e}/${t}`, Jr = (e, t) => Vu + e + "-" + (t ? "1" : "0"), u2 = (e, t) => {
  for (const n of e)
    if (n[0] === t[0] && n[1] === t[1]) return !0;
  return !1;
}, d2 = (e, t, n) => {
  e[t] = e[t] || [], e[t].push(...n);
}, Nr = (e, t = 1) => e * (Wu + c2) + t * c2, f2 = (e, t) => (n) => e <= n && n <= t, _p = (e, t) => (n) => e < n && n < t, g2 = (e, t) => {
  const n = e.findIndex((o) => o.id === t);
  n !== -1 && e.splice(n, 1);
}, h2 = (e, t, n) => e === -1 || n >= t ? t : n >= e ? n : e, zo = (e, t, n = !0) => {
  e.forEach((o) => {
    st(o) || (o.hidden = !t, n && eo(o, t));
  });
}, Io = (e, t, n = !0) => {
  e.forEach((o) => {
    st(o) && (o.hidden = !t, n && eo(o, t));
...
const kp = "_table_node_1srqt_1", Ap = "_header_1srqt_8", Mp = "_collapse_1srqt_16", Tp = "_selected_1srqt_21", Np = "_content_1srqt_24", Op = "_table_header_1srqt_37", Dp = "_seed_1srqt_47", Lp = "_model_1srqt_52", jp = "_source_1srqt_57", Rp = "_exposure_1srqt_62", Hp = "_snapshot_1srqt_67", Fp = "_metrics_1srqt_72", zp = "_macros_1srqt_77", Ip = "_analysis_1srqt_82", Pp = "_node_icon_1srqt_87", Bp = "_dialect_icon_1srqt_99", Vp = "_table_handle_1srqt_107", Wp = "_see_more_node_1srqt_121", $p = "_table_card_1srqt_132", Zp = "_disabled_1srqt_144", qp = "_column_card_1srqt_149", Up = "_edit_icon_1srqt_162", Yp = "_active_1srqt_170", Gp = "_expand_lineage_icon_1srqt_174", Kp = "_processing_div_1srqt_187", Xp = "_gif_img_1srqt_190", Jp = "_card_1srqt_195", Qp = "_column_node_1srqt_210", em = "_column_name_1srqt_221", tm = "_column_top_right_1srqt_226", nm = "_divider_1srqt_234", om = "_table_details_header_1srqt_240", rm = "_verticle_divider_1srqt_248", am = "_low_confidence_1srqt_253", im = "_high_confidence_1srqt_260", sm = "_alert_icon_1srqt_267", lm = "_menu_card_1srqt_273", cm = "_menu_card_container_1srqt_278", um = "_table_details_tabs_1srqt_285", dm = "_tab_1srqt_1", fm = "_table_node_pill_1srqt_305", gm = "_icon_1srqt_315", hm = "_node-checkbox_1srqt_322", pm = "_non_select_node_checkbox_1srqt_322", mm = "_select_node_checkbox_1srqt_322", bm = "_node_extra_info_1srqt_338", ym = "_help_body_1srqt_342", Cm = "_feedback_body_1srqt_346", vm = "_cancel_btn_1srqt_349", xm = "_expand_nav_1srqt_354", wm = "_expand_nav_btn_1srqt_362", Em = "_lineage_legend_1srqt_389", Sm = "_column_legend_1srqt_406", _m = "_dot_1srqt_422", km = "_model_views_type_1srqt_434", Am = "_close_button_1srqt_443", Mm = "_op_node_1srqt_456", Tm = "_light_mode_1srqt_466", Nm = "_dark_mode_1srqt_469", Om = "_op_type_text_1srqt_473", Dm = "_static_table_node_1srqt_482", Lm = "_details_btn_1srqt_527", jm = "_enable_1srqt_536", Rm = "_disable_1srqt_144", Hm = "_code_editor_container_1srqt_547", Fm = "_code_editor_1srqt_547", zm = "_tooltip_container_1srqt_561", Im = "_tooltip_text_1srqt_567", Pm = "_views_type_badge_1srqt_584", Bm = "_column_code_icon_1srqt_615", Vm = "_edge_select_1srqt_631", Wm = "_edge_non_select_1srqt_641", $m = "_modal_views_code_container_1srqt_651", Zm = "_custom_node_code_block_1srqt_656", qm = "_reset_btn_1srqt_668", Y = {
  table_node: kp,
  header: Ap,
  collapse: Mp,
  selected: Tp,
  ...
  table_details_tabs: um,
  tab: dm,
  table_node_pill: fm,
  icon: gm,
  "node-checkbox": "_node-checkbox_1srqt_322",
  nodeCheckbox: hm,
  non_select_node_checkbox: pm,
  select_node_checkbox: mm,
  node_extra_info: bm,
  help_body: ym,
  feedback_body: Cm,
  cancel_btn: vm,
  ...
  return /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
    /* @__PURE__ */ f.jsxs(
      Te,
      {
        ...
        children: [
          "Legend",
          e ? /* @__PURE__ */ f.jsx(ib, {}) : /* @__PURE__ */ f.jsx(ab, {})
        ]
      }
    ),
    /* @__PURE__ */ f.jsx(
      S2,
      {
        ...
        placement: "top",
        children: /* @__PURE__ */ f.jsxs(_2, { children: [
          Object.keys(kl).map((o) => /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-sm mb-1 align-items-center", children: [
            /* @__PURE__ */ f.jsx(Ol, { viewsType: o }),
            /* @__PURE__ */ f.jsx("div", { children: o })
          ] }, o)),
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-sm mb-1 align-items-center", children: [
            /* @__PURE__ */ f.jsx("div", { className: Y.column_code_icon, children: /* @__PURE__ */ f.jsx(Z2, {}) }),
            /* @__PURE__ */ f.jsx("div", { children: "Code" })
          ] }),
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-sm mb-1 align-items-center", children: [
            /* @__PURE__ */ f.jsx("div", { className: Y.edge_select, children: /* @__PURE__ */ f.jsx("div", {}) }),
            /* @__PURE__ */ f.jsx("div", { children: "Select" })
          ] }),
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-sm mb-1 align-items-center", children: [
            /* @__PURE__ */ f.jsx("div", { className: Y.edge_non_select, children: /* @__PURE__ */ f.jsx("div", {}) }),
...
var Db = Ju.exports;
const xe = /* @__PURE__ */ no(Db), Lb = (e) => _e.get("upstreamTables", { table: e }), jb = (e) => _e.get("downstreamTables", { table: e }), Rb = (e) => _e.get("getExposureDetails", {
  name: e
}), Dl = (e, t) => _e.get("getColumns", {
  table: e,
  refresh: t
}), Hb = (e) => _e.get("getConnectedColumns", e), Fb = (e) => _e.get("sendFeedback", e), zb = () => _e.get("getLineageSettings", {}), Yi = (e) => _e.get("persistLineageSettings", e), Qu = () => _e.get("init", {}), Ib = (e) => _e.get("openFile", { url: e }), Pb = () => _e.get("openChat", {}), ed = (e) => _e.get("showInfoNotification", { message: e }), Bb = () => _e.get("previewFeature", {}), Gi = (e) => _e.get("columnLineage", { event: e }), Vb = (e) => _e.get("telemetryEvents", e);
var Wb = /* @__PURE__ */ ((e) => (e.CANCEL = "cancel", e.END = "end", e.START = "start", e))(Wb || {});
const Ue = class Ue {
  static onCancel() {
    Ue.isCancelled = !0, Ue.inProgress = !1;
  }
  static cancel() {
    Ue.onCancel(), Gi(
      "cancel"
  ...
  static start() {
    Ue.inProgress = !0, Ue.isCancelled = !1, Ue.linkCount = 0, Gi(
      "start"
      /* START */
    );
  }
...
rr(Ue, "isCancelled", !1), rr(Ue, "inProgress", !1), rr(Ue, "linkCount", 0);
let Le = Ue;
const $b = ({ datatype: e, color: t, size: n = "1rem" }) => {
  const [o, r] = Se(() => {
  ...
  seed: {
    light: /* @__PURE__ */ f.jsx(m2, { style: { color: "#E6FAF4" } }),
    dark: /* @__PURE__ */ f.jsx(m2, { style: { color: "#344B49" } })
  },
  model: {
    light: /* @__PURE__ */ f.jsx(xr, { style: { color: "#FFECE6" } }),
    dark: /* @__PURE__ */ f.jsx(xr, { style: { color: "#4D4343" } })
  },
  cte: {
    light: /* @__PURE__ */ f.jsx(p2, { style: { color: "#FDF6EA" } }),
    dark: /* @__PURE__ */ f.jsx(p2, { style: { color: "#4B473F" } })
  },
  source: {
    light: /* @__PURE__ */ f.jsx(b2, { style: { color: "#EAF3FF" } }),
    dark: /* @__PURE__ */ f.jsx(b2, { style: { color: "#384454" } })
  },
  exposure: {
    light: /* @__PURE__ */ f.jsx(y2, { style: { color: "#FEEFF7" } }),
    dark: /* @__PURE__ */ f.jsx(y2, { style: { color: "#4C404C" } })
  },
  analysis: { light: /* @__PURE__ */ f.jsx(Ts, {}), dark: /* @__PURE__ */ f.jsx(Ts, {}) },
  snapshot: {
    light: /* @__PURE__ */ f.jsx(C2, { style: { color: "#F6F4FF" } }),
    dark: /* @__PURE__ */ f.jsx(C2, { style: { color: "#444554" } })
  },
  semantic_model: { light: /* @__PURE__ */ f.jsx(bb, {}), dark: /* @__PURE__ */ f.jsx(mb, {}) },
  macros: { light: /* @__PURE__ */ f.jsx(Ns, {}), dark: /* @__PURE__ */ f.jsx(Ns, {}) },
  unknown: {
    light: /* @__PURE__ */ f.jsx(xr, { style: { color: "#FFECE6" } }),
    dark: /* @__PURE__ */ f.jsx(xr, { style: { color: "#4D4343" } })
  }
  ...
  e === "seed" && /* @__PURE__ */ f.jsx(eb, {}),
  e === "model" && /* @__PURE__ */ f.jsx(Ui, {}),
  e === "cte" && /* @__PURE__ */ f.jsx(Ui, {}),
  e === "source" && /* @__PURE__ */ f.jsx(tb, {}),
  e === "exposure" && /* @__PURE__ */ f.jsx(nb, {}),
  e === "analysis" && /* @__PURE__ */ f.jsx(Ts, {}),
  e === "snapshot" && /* @__PURE__ */ f.jsx(ob, {}),
  e === "semantic_model" && /* @__PURE__ */ f.jsx(rb, {}),
  e === "macros" && /* @__PURE__ */ f.jsx(Ns, {}),
  e === "unknown" && /* @__PURE__ */ f.jsx(Ui, {})
] }), qb = ({ nodeType: e }) => {
  const {
    state: { theme: t }
  } = We();
  return /* @__PURE__ */ f.jsx(f.Fragment, { children: Zb[e][t] });
}, xo = ({ id: e, icon: t, text: n, label: o }) => /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
  /* @__PURE__ */ f.jsxs("div", { className: Y.table_node_pill, id: e, children: [
    /* @__PURE__ */ f.jsx("div", { className: Y.icon, children: t }),
    /* @__PURE__ */ f.jsx("div", { children: n })
  ] }),
  /* @__PURE__ */ f.jsx(Dd, { target: e, children: o })
] }), Ll = {
  seed: Y.seed,
  model: Y.model,
  source: Y.source,
  ...
  cte: "CTE",
  unknown: "UNK"
}, td = (e, t) => e ? Lb(t) : jb(t), nd = (e, t) => e ? t + 1 : t - 1, ya = (e, t, n, o, r, a, i = mp, s = !1, l) => {
  const u = nd(r, a), c = (g) => {
    var C, p;
    const h = ((p = (C = e.find((y) => y.id === g)) == null ? void 0 : C.data) == null ? void 0 : p.level) || 0, m = Tl(a, h, o, g, r, s);
    t.find((y) => y.id === m.id) || t.push(m);
  };
  let d = 0;
  for (const g of n) {
    if (d >= i) {
    ...
    e.find((m) => m.id === g.table) || (d++, l ? l[g.table].type in Po ? e.push(Qn(g, u, o)) : e.push(Uu(g.table, u, o, l[g.table])) : e.push(Qn(g, u, o))), c(g.table);
  }
}, Ot = (e, t, n = !1) => {
  let o = 1 / 0;
  const r = {};
  for (const p of e)
    if (st(p) && p.parentNode)
      p.parentNode in r || (r[p.parentNode] = 0), p.position = {
        x: yp,
        y: Cp + Nr(r[p.parentNode])
      }, r[p.parentNode]++;
    else {
      const { level: y } = p.data;
      o = Math.min(o, y);
    }
  const a = {}, i = {}, s = {}, l = {}, u = {}, c = {};
  for (const p of t)
    st(p) || vr(e.find((y) => y.id === p.source)) || vr(e.find((y) => y.id === p.target)) || (u[p.source] = u[p.source] || [], u[p.source].push(p.target), c[p.target] = c[p.target] || [], c[p.target].push(p.source));
  const d = (p) => {
    const { level: y } = p.data;
    if (i[y] = i[y] || [], !i[y].includes(p.id)) {
      s[p.id] = i[y].length, a[p.id] = 0;
      for (const x of i[y])
        a[p.id] += r[x] || 0;
      i[y].push(p.id);
    }
  ...
  for (const p of e)
    st(p) || vr(p) && d(p);
  const h = (p) => {
    const y = s[p.id] || 0, x = a[p.id] || 0;
    return qi + y * ($n + wp) + Nr(x, y);
  }, m = (p) => (p - o) * (Go + vp) + bp, b = (p) => (p - o) * ($n + xp) + qi, C = (p) => {
    const y = s[p.id] || 0, x = a[p.id] || 0;
    return qi + y * ($n + Ep) + Nr(x, y);
  };
  for (const p of e) {
    if (st(p)) continue;
    const { level: y } = p.data;
    p.position = n ? { x: C(p), y: b(y) } : { x: m(y), y: h(p) };
  }
}, od = (e, t) => (e.forEach((n) => Xr(n, !0)), t.forEach((n) => eo(n, !1)), [e, t]), Bo = (e, t, n) => {
  zo(t, !0), Io(t, !1);
  const o = {}, r = {}, a = (l, u) => {
    const c = [n], d = {};
    for (; c.length > 0; ) {
  ...
  const i = [...t];
  i.forEach((l) => eo(l, r[l.id]));
  const s = [...e];
  return s.forEach((l) => Xr(l, !!o[l.id])), [s, i];
}, Os = (e, t) => {
  const n = e.getNodes(), o = e.getEdges(), [r, a] = Bo(n, o, t);
  e.setNodes(r), e.setEdges(a);
}, Ub = async (e, t, n, o, r, a, i, s, l) => {
  var x, E;
  const u = [], c = [], { column_lineage: d, confidence: g } = await Hb({
    targets: r,
    upstreamExpansion: a,
    currAnd1HopTables: i,
    selectedColumn: s,
  ...
  const h = d.filter(
    (v) => a ? u2(r, v.source) : u2(r, v.target)
  ), m = h.map((v) => a ? v.target : v.source), b = {}, C = ([v, k], T) => {
    b[v] = b[v] || [], b[v].find((_) => _.column === k) || b[v].push({ column: k, viewsType: T });
  }, p = (v, k, T, _, H) => {
    const R = ma(T, _);
  ...
  for (const v of h) {
    C(v.source), C(v.target, v.viewsType);
    const [k] = v.source, [T] = v.target, _ = o[k], H = o[T], R = v.source.join("/"), z = v.target.join("/"), $ = Vt + R, B = Vt + z, w = v.type;
    if (_ && H)
      p(k, T, $, B, w);
    else if (_) {
      const A = n[T];
  ...
  for (const v in b) {
    if (!o[v]) continue;
    const k = [...b[v]];
    k.sort((T, _) => T.column.localeCompare(_.column));
    for (const T of k) {
      const _ = {};
      h.filter((H) => H.target.join("/") === `${v}/${T.column}`).forEach((H) => {
        H.type !== "indirect" && (_[H.source.join("/")] = H.viewsCode || []);
      }), u.push(
        Gr(
          v,
          T.column,
  ...
  return { nodes: u, edges: c, collectColumns: b, newCurr: m, confidence: g, seeMoreLineage: y };
}, Yb = async (e, t, n, o) => {
  var h, m, b, C;
  ...
  for (const p of t) {
    ...
    const y = s[p.source], x = s[p.target];
    y && x ? u.push({ src: p.source, dst: p.target }) : y ? (h = e.find((v) => v.id === p.target).data.tables) == null || h.forEach((v) => {
  ...
  for (const p in c) {
    if (!s[p]) continue;
    const y = [...c[p]];
    y.sort((x, E) => x.column.localeCompare(E.column));
    for (const x of y) {
      const E = (C = (b = e.find((v) => v.id === p)) == null ? void 0 : b.data) == null ? void 0 : C.nodeType;
      r.push(Gr(p, x.column, x.viewsType, {}, E));
    }
  }
  a.forEach((p) => p.style = pa);
  const g = (p, y, x, E) => {
    const v = ma(x, E);
    a.find((k) => k.id === v) || a.push(
      Kr(x, E, i[p], i[y], "direct", {
        direct: !0
      })
    );
  };
  for (const p of d) {
    const [y] = p[0].split("/"), [x] = p[1].split("/"), E = s[y], v = s[x], k = Vt + p[0], T = Vt + p[1];
    if (E && v)
      g(y, x, k, T);
    else if (E) {
      const _ = l[x];
  ...
  if (t.nodes.forEach((i) => {
    ...
    const i = {}, s = Fo(n.table, n.name), l = { [s]: "direct" }, u = [s], c = {}, d = o ? "source" : "target", g = o ? "target" : "source";
    for (; u.length > 0; ) {
      const h = u.shift();
      if (!c[h]) {
        c[h] = !0;
    ...
    for (const h of a)
      sn(h) || (h.data.type = i[h.id] || h.data.type, h.style = h.data.type === "direct" ? Al : Ml);
  }
  return Ot(r, a), [r, a];
}, Kb = (e, t) => {
  ...
  for (; i.length > 0; ) {
    ...
    if (s[l]) continue;
    s[l] = !0;
    const { tables: c } = await td(o, l);
    ya(r, a, c, l, o, u), c.forEach((d) => {
  ...
  const a = [...e], i = [...t];
  if (o >= r) return [a, i];
  const s = _p(o, r), l = a.find((c) => c.id === n).data.level, u = async (c) => {
    const d = [
      { table: n, level: l }
    ], g = {};
    for (; d.length > 0; ) {
      ...
      g[h.table] = !0;
      const { tables: m } = await td(c, h.table);
      ya(
        a,
        i,
        m,
      ...
      const b = nd(c, h.level);
      s(b) ? d.push(...m.map((C) => ({ table: C.table, level: b }))) : d.push(
  ...
  v2(e, t, n, !1),
  v2(e, t, n, !0)
], jl = async (e, t, n, o, r, a, i, s, l, u, c) => {
  var E, v, k, T, _, H;
  let d = !1;
  const { levelMap: g, tableNodes: h, seeMoreIdTableReverseMap: m } = Sp(e, t), b = (R) => e.find((z) => z.id === R), C = {}, p = {};
  let y = o.map((R) => [
    R.table,
    R.name
  ]), x = [];
  for (; !(Le.isCancelled || (y = y.filter((V) => !C[V.join("/")]), y.length === 0 && x.length === 0)); ) {
    const R = {};
    y.forEach((V) => {
      C[V.join("/")] = !0, R[V[0]] = !0;
    });
    const [z, $] = n ? ["source", "target"] : ["target", "source"], B = [], w = [], A = [];
    let S = !1;
    for (const V of t) {
      if (st(V)) continue;
      const W = V[z], q = V[$], K = h[q] ? [(E = b(q)) == null ? void 0 : E.data] : (T = (k = (v = b(q)) == null ? void 0 : v.data) == null ? void 0 : k.tables) == null ? void 0 : T.filter(
        (X) => !h[X.table]
      );
      K == null || K.forEach((X) => {
        if (!X) return;
        const { table: J, materialization: te } = X;
        R[W] ? (S = !0, te === "ephemeral" ? (d2(
          p,
          J,
          y.filter((Z) => Z[0] === W)
        ), w.push(J)) : B.push(J)) : x.includes(W) && (S = !0, te === "ephemeral" ? (d2(
          p,
          J,
          p[W]
        ), w.push(J)) : (A.push(W), B.push(J)));
      });
    }
    if (!S)
      break;
    ...
    A.forEach((V) => {
      y.push(...p[V]), O.push(...p[V].map((W) => W[0]));
    });
    const L = await Ub(
      e,
      g,
    ...
    ((_ = L.confidence) == null ? void 0 : _.confidence) === "low" && r(((H = L.confidence) == null ? void 0 : H.operator_list) || []), y = L.newCurr, !d && y.length > 0 && (d = !0), y = y.filter(
  ...
  return d;
}, Xb = (e, t, n, { prevTable: o, tables: r, right: a, level: i, lineage: s }, l) => {
  var g;
  const { table: u } = n;
  if (e.find((h) => h.id === u)) return !1;
  e.push(Qn(n, i, o));
  const d = (g = e.find((h) => h.id === o)) == null ? void 0 : g.data.level;
  if (t.push(Tl(d, i, o, u, a)), s == null || s.forEach((h) => {
    const m = Fo(h.source[0], h.source[1]), b = Fo(h.target[0], h.target[1]), C = {};
    if (a && s.filter((p) => p.target.join("/") === h.target.join("/")).forEach((p) => {
      ...
      e.push(
        ...
        Kr(m, b, i, i + 1, h.type, l)
      );
    }
  }), r.every((h) => !!e.find((m) => m.id === h.table))) {
    const h = Jr(o, a), m = a ? `${o}-${h}` : `${h}-${o}`;
    return g2(e, h), g2(t, m), !0;
  }
  return !1;
}, to = async (e, t, n, o, r) => {
  var u;
  ...
  if (!a) return 0;
  const { level: i } = a, s = e.length, [l] = await Qr(
    e,
    t,
    n,
    i - o,
  ...
  return {
    ...
    edgeIds: r.map((a) => ma(a.source, a.target))
  };
}, Ds = (e, t, n, o = [], r) => {
  const { nodes: a, edgeIds: i } = Jb(
    e,
    t,
    n,
    r
  ...
  const r = Ds(e, n, o, [], !0), a = Ds(e, n, o, [], !1);
  ...
  const {
    ...
    rerender: x
  } = We(), E = $e(), v = Object.keys(h[n] || {}).length, k = v > 0, T = g === n, _ = async (w) => {
    if (Le.inProgress) {
    ...
    if ([A, S] = Bo(A, S, g), Ot(A, S), d.setNodes(A), d.setEdges(S), E(
      To(Vo(A, S, g))
    ), E(
      Yn(
        await to(
      ...
      try {
        Le.start();
        const O = d.getEdges();
        zo(O, !1), Io(O, !0), d.setEdges(O), await jl(
          A,
          S,
          w,
    ...
    w.stopPropagation(), i !== "semantic_model" && (E(Sn(n)), E(Mt(i === "exposure" ? Iu : zu)));
      ...
      children: [
        /* @__PURE__ */ f.jsxs(
          "div",
          {
            ...
            onClick: async () => {
              const w = d.getNodes(), A = d.getEdges();
              E(To(Vo(w, A, n))), E(
                Yn(
                  await to(
                    w,
              ...
              /* @__PURE__ */ f.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column align-items-start gap-xs w-100", children: [
                    /* @__PURE__ */ f.jsxs("div", { className: Y.table_header, children: [
                      i in Po && /* @__PURE__ */ f.jsx(f.Fragment, { children: /* @__PURE__ */ f.jsxs(
                        "div",
                        {
                          className: xe(
                            Y.node_icon,
                          ...
                          children: [
                            /* @__PURE__ */ f.jsx(ba, { nodeType: i }),
                            /* @__PURE__ */ f.jsx("div", { children: Po[i] })
                          ]
                        }
                      ) }),
                      i in x2 && /* @__PURE__ */ f.jsx(
                        "img",
                        {
                          src: x2[i],
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ f.jsx(
                            "div",
                            {
                              className: xe("nodrag", Y.table_handle, {
                                invisible: a === 0 || a === $.filter((w) => w.target === n).length || d.getNode(Jr(n, !1))
                              }),
                              onClick: (w) => {
                                w.stopPropagation(), R();
                              },
                          ...
                          /* @__PURE__ */ f.jsx(
                            "div",
                            {
                              className: xe(
                                "nodrag",
                                T && i !== "semantic_model" ? "text-blue" : "text-grey"
                              ),
                              onClick: z,
                          ...
                          /* @__PURE__ */ f.jsx(
                            ...
                            {
                              className: xe("nodrag", Y.table_handle, {
                                invisible: r === 0 || r === $.filter((w) => w.source === n).length || d.getNode(Jr(n, !0))
                              }),
                              onClick: (w) => {
                                w.stopPropagation(), H();
                              },
  ...
  return /* @__PURE__ */ f.jsxs("div", { className: "position-relative", children: [
    /* @__PURE__ */ f.jsx("div", { className: Y.static_table_node, children: /* @__PURE__ */ f.jsx(
      "div",
      {
        className: xe(
          Y.header,
        ...
        children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex align-items-center w-100 ps-2 pe-2 gap-sm", children: [
          /* @__PURE__ */ f.jsx(
            "div",
            {
              className: xe(Y.node_icon, Ll[a]),
              children: /* @__PURE__ */ f.jsx(qb, { nodeType: a })
            }
          ),
          /* @__PURE__ */ f.jsx("div", { className: "lines-2", children: t }),
          /* @__PURE__ */ f.jsx("div", { className: "spacer" }),
          /* @__PURE__ */ f.jsx(
            "div",
            {
              className: xe(
                Y.details_btn,
                !o || a === "unknown" ? Y.disable : Y.enable
              ),
              onClick: (i) => {
                i.stopPropagation(), a !== "unknown" && r(Sn(t));
              },
              children: /* @__PURE__ */ f.jsx(Xu, {})
            }
          )
        ] })
      }
  ...
  const { tables: t = [], prevTable: n, right: o, level: r } = e, {
    ...
    (u) => {
      u.stopPropagation(), i(Mt(Pu)), i(
        nl({ ...a, tables: t, prevTable: n, right: o, level: r })
      );
    },
    [r, i, a, n, o, t]
  );
  return /* @__PURE__ */ f.jsxs("div", { className: Y.see_more_node, onClick: l, children: [
  ...
  return /* @__PURE__ */ f.jsx(ro, { path: l, markerEnd: a });
}, Fl = ({ data: e }) => {
  const { column: t, table: n, viewsType: o, viewsCode: r, nodeType: a } = e, {
    state: { selectedColumn: i }
  } = We(), s = $e(), l = (i == null ? void 0 : i.table) === n && (i == null ? void 0 : i.name) === t, u = o && kl[o], c = u ? { borderColor: u } : {}, d = wt(), g = () => {
    const m = d.getNode(Fo(n, t));
    m && (s(Sn("")), s(pn({ name: t, table: n })), Qb(m, d));
  }, h = Se(() => {
  ...
  return /* @__PURE__ */ f.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ f.jsx(Ko, {}),
        /* @__PURE__ */ f.jsxs("div", { className: Y.column_top_right, children: [
          h.length > 0 && /* @__PURE__ */ f.jsx(Wo, { title: "Click to view code", children: /* @__PURE__ */ f.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ f.jsx(Z2, {})
            }
          ) }),
          o && o !== "Non select" && /* @__PURE__ */ f.jsx(Ol, { viewsType: o })
        ] })
      ]
    }
  );
}, id = {
  INNER_JOIN: /* @__PURE__ */ f.jsx(vb, {}),
  OUTER_JOIN: /* @__PURE__ */ f.jsx(Sb, {}),
  LEFT_JOIN: /* @__PURE__ */ f.jsx(xb, {}),
  RIGHT_JOIN: /* @__PURE__ */ f.jsx(_b, {}),
  FILTER: /* @__PURE__ */ f.jsx(yb, {}),
  GROUP: /* @__PURE__ */ f.jsx(Cb, {}),
  LIMIT: /* @__PURE__ */ f.jsx(wb, {}),
  SORT: /* @__PURE__ */ f.jsx(Eb, {}),
  UNION: /* @__PURE__ */ f.jsx(kb, {}),
  SELECT: /* @__PURE__ */ f.jsx(Ab, {})
}, x2 = {
  postgres: Tb,
  snowflake: Mb,
  s3: Nb
  ...
  return /* @__PURE__ */ f.jsxs("div", { style: { width: Go, display: "flex", justifyContent: "center" }, children: [
    ...
    /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column", children: [
      ...
      /* @__PURE__ */ f.jsx("div", { className: Y.op_type_text, children: t })
    ] })
  ] });
};
function sd({
  ...
  return Mn(
    /* @__PURE__ */ f.jsx("div", { className: `sidebar-modal ${e ? "" : "d-none"}`, children: e && /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
      ...
      /* @__PURE__ */ f.jsxs("div", { className: "sidebar-modal-content", style: { width: a }, children: [
        /* @__PURE__ */ f.jsx("div", { className: "sidebar-close-button", onClick: t, children: /* @__PURE__ */ f.jsx(Nl, {}) }),
        o
      ] })
    ] }) }),
    r
...
function oy({
  ...
  return /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column align-items-start gap-xs w-100", children: [
    /* @__PURE__ */ f.jsxs("div", { className: Y.table_header, children: [
      /* @__PURE__ */ f.jsxs("div", { className: xe(Y.node_icon, Ll[a]), children: [
        /* @__PURE__ */ f.jsx(ba, { nodeType: a }),
        /* @__PURE__ */ f.jsx("div", { children: Po[a] })
      ] }),
      /* @__PURE__ */ f.jsx("div", { className: "lines-2", children: t })
    ] }),
    /* @__PURE__ */ f.jsxs("div", { className: xe("d-flex gap-xs", Y.node_extra_info), children: [
...
const ay = "_component_13r39_1", iy = "_spin_13r39_1", sy = {
  component: ay,
  spin: iy
}, ld = ({ top: e = 50, left: t = 50, label: n }) => /* @__PURE__ */ f.jsx(
  "div",
  {
    className: sy.component,
    style: { top: `${e}%`, left: `${t}%` },
    children: /* @__PURE__ */ f.jsx("div", { style: { marginTop: "-70px" }, children: n })
  }
), ly = "_level_tag_x6wwh_1", cy = {
  level_tag: ly
}, uy = ({ label: e }) => /* @__PURE__ */ f.jsx("div", { className: xe(cy.level_tag), children: e }), cd = ({ purpose: e }) => /* @__PURE__ */ f.jsx("div", { className: xe(Y.card, "purpose-section"), children: /* @__PURE__ */ f.jsx("div", { className: "d-flex flex-column gap-sm", children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-xs flex-column", children: [
  /* @__PURE__ */ f.jsx("div", { className: "fs-5 fw-semibold", children: "Description" }),
  /* @__PURE__ */ f.jsx("div", { className: xe(Y.column_card), children: /* @__PURE__ */ f.jsx("div", { className: "font-normal fs-xxs", children: e }) })
] }) }) }), ud = ({ column: e, handleClick: t, selected: n, isSelectable: o }) => {
  const {
    state: { theme: r }
  } = Re(Tn);
  return /* @__PURE__ */ f.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ f.jsxs("div", { className: "d-flex align-items-center gap-xs", children: [
          /* @__PURE__ */ f.jsx($b, { datatype: e.datatype || "" }),
          /* @__PURE__ */ f.jsx("div", { className: "lines-2", children: e.name }),
          /* @__PURE__ */ f.jsx("div", { className: "spacer" }),
          e.can_lineage_expand && /* @__PURE__ */ f.jsx("div", { className: Y.expand_lineage_icon, children: /* @__PURE__ */ f.jsx(sb, {}) }),
          e.datatype && /* @__PURE__ */ f.jsx(uy, { label: e.datatype })
        ] }),
  ...
  return /* @__PURE__ */ f.jsx("div", { className: xe(Y.card, "flex-grow column-section"), children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-sm h-100 p-2", children: [
    /* @__PURE__ */ f.jsxs("div", { className: "d-flex align-items-center gap-xs", children: [
  ...
  return /* @__PURE__ */ f.jsx("div", { className: xe(Y.card, "flex-grow column-section"), children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-sm h-100 p-2", children: [
    ...
    /* @__PURE__ */ f.jsx("div", { className: "d-flex flex-column gap-sm", children: t.map((o) => /* @__PURE__ */ f.jsx("div", { className: Y.column_card, children: /* @__PURE__ */ f.jsx("div", { className: "d-flex align-items-center gap-xs", children: /* @__PURE__ */ f.jsx("div", { className: "lines-2", children: o.key }) }) }, o.key)) })
  ] }) });
}, zl = ({
  nodeType: e,
  table: t
}) => /* @__PURE__ */ f.jsxs("div", { className: Y.table_details_header, children: [
  /* @__PURE__ */ f.jsx(ba, { nodeType: e }),
  ...
  } = We(), s = $e(), l = wt(), [u, c] = ae([]), [d, g] = ae(null), [h, m] = ae(0), [b, C] = ae(!0);
  re(() => {
    t && (C(!0), Dl(t, !1).then((v) => {
      g(v), c(v.columns), C(!1);
    }));
  ...
  const p = async (v) => {
    ...
    if ((n == null ? void 0 : n.table) === v.table && (n == null ? void 0 : n.name) === v.name) {
      ...
      zo(O, !0), Io(O, !0), l.setNodes(S), l.setEdges(O), s(pn({ table: "", name: "" })), s(Mo({})), s(Mt(""));
      return;
    }
    const k = (A = l.getNode(v.table)) == null ? void 0 : A.data;
    if (!k)
      throw new Error(`table node ${v.table} isn't visible`);
    let T = l.getNodes(), _ = l.getEdges();
    zo(_, !1), Io(_, !0);
    const H = async (S) => {
      [T, _] = await rd(
        T,
    ...
    R > 0 && _.filter((S) => S.source === v.table).length < R && await H(!0), z > 0 && _.filter((S) => S.target === v.table).length < z && await H(!1), s(pn({ ...v })), s(Mt("")), s(Mo({})), s(x8({ confidence: "high" }));
    const [$, B] = od(
      T.filter(sn),
      _.filter(sn)
    );
    B.forEach((S) => S.style = pa), l.setNodes($), l.setEdges(B), e();
    const w = (S) => jl(
      $,
      B,
      S,
    ...
    try {
      Le.start(), (await Promise.all([
        w(!0),
        w(!1)
      ])).every((O) => !O) && (s(pn({ table: "", name: "" })), Os(l, v.table), Le.isCancelled || ed(
      ...
      console.error(
        ...
        ", error:",
        S
      ), s(pn({ table: "", name: "" })), Os(l, v.table);
    } finally {
      Le.end();
    }
  }, y = (E = l.getNode(t)) == null ? void 0 : E.data;
  if (b || !d || !t) return /* @__PURE__ */ f.jsx(ld, {});
  const x = ["Column"];
  return y.tests.length && x.push("Tests"), /* @__PURE__ */ f.jsxs("div", { className: "p-2 h-100 d-flex flex-column gap-md overflow-y", children: [
    /* @__PURE__ */ f.jsx(
      zl,
      {
        nodeType: y.nodeType,
    ...
    d.purpose && /* @__PURE__ */ f.jsx(cd, { purpose: d.purpose }),
    x.length > 1 && /* @__PURE__ */ f.jsx("div", { className: Y.table_details_tabs, children: x.map((v, k) => /* @__PURE__ */ f.jsx(
      "div",
      {
        className: xe(Y.tab, {
          [Y.selected]: h === k
    ...
    h === 1 && /* @__PURE__ */ f.jsx(fy, { tests: y.tests })
  ] });
}, hy = () => {
  var h, m, b, C;
  const {
  ...
  ), [a, i] = ae(r), [s, l] = ae(r), u = (C = t == null ? void 0 : t.details) == null ? void 0 : C[n];
  if (!u)
    return null;
  ...
  return /* @__PURE__ */ f.jsxs("div", { className: "p-2 h-100 d-flex flex-column gap-md overflow-y", children: [
    /* @__PURE__ */ f.jsx(zl, { nodeType: d || "cte", table: n }),
    c && /* @__PURE__ */ f.jsx("div", { className: xe(Y.card, "mb-0 purpose-section"), children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-sm", children: [
    ...
    /* @__PURE__ */ f.jsx("div", { className: xe(Y.card, "mb-0 flex-grow column-section"), children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-sm h-100", children: [
      /* @__PURE__ */ f.jsxs("div", { className: "d-flex align-items-center gap-xs", children: [
      ...
      /* @__PURE__ */ f.jsx(
        Xo,
        {
          ...
          type: "text",
          onChange: (p) => {
            const y = p.target.value.toLowerCase();
            l(
              a == null ? void 0 : a.filter((x) => x.name.toLowerCase().includes(y))
            );
          }
        }
      ),
...
}, wr = ({ title: e, value: t }) => /* @__PURE__ */ f.jsxs("div", { className: xe(Y.column_card, {}), children: [
  /* @__PURE__ */ f.jsxs("div", { className: "d-flex align-items-center gap-xs", children: [
...
] }), py = ({ label: e }) => /* @__PURE__ */ f.jsx("div", { children: e }), my = () => {
  var s;
  const e = wt(), {
  ...
  return re(() => {
  ...
  }, [t]), a || !n || !t ? /* @__PURE__ */ f.jsx(ld, {}) : /* @__PURE__ */ f.jsxs("div", { className: "p-2 h-100 d-flex flex-column gap-md overflow-y", children: [
    /* @__PURE__ */ f.jsxs("div", { className: Y.table_details_header, children: [
      /* @__PURE__ */ f.jsx(ba, { nodeType: r.nodeType }),
    ...
    n.description ? /* @__PURE__ */ f.jsx(cd, { purpose: n.description }) : null,
    /* @__PURE__ */ f.jsxs("div", { className: xe(Y.card, "flex-grow column-section"), children: [
      /* @__PURE__ */ f.jsx(
        wr,
        {
          title: "Owner",
      ...
      /* @__PURE__ */ f.jsx(wr, { title: "Url", value: n.url }),
      /* @__PURE__ */ f.jsx(
        wr,
        {
          title: "Tags",
          value: n.tags.map((l) => /* @__PURE__ */ f.jsx(py, { label: l }))
        }
      ),
      /* @__PURE__ */ f.jsx(wr, { title: "Maturity", value: n.maturity })
    ] })
  ] });
};
function by({ close: e }) {
    ...
    /* @__PURE__ */ f.jsxs("div", { className: "mb-2 d-flex", children: [
      ...
      /* @__PURE__ */ f.jsx(
        Te,
        {
          ...
          color: "primary",
          onClick: (s) => {
            s.stopPropagation(), Pb();
          },
          children: "Chat with us"
        }
      )
    ] }),
    /* @__PURE__ */ f.jsxs("div", { className: Y.feedback_body, children: [
...
function yy({ applyDefault: e }) {
  ...
  return /* @__PURE__ */ f.jsxs("div", { className: "p-2 h-100 d-flex flex-column", children: [
    ...
    /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-sm", children: [
      /* @__PURE__ */ f.jsxs("div", { children: [
        /* @__PURE__ */ f.jsx(Na, { check: !0, for: "default-expansion", className: "fs-6 mb-1", children: "Default Expansion" }),
        /* @__PURE__ */ f.jsx(
          Xo,
          {
            ...
            onChange: (i) => {
              ...
              a(y0(s)), Yi({ defaultExpansion: s }), e(s);
            }
          }
        )
      ] }),
      r && /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
        ...
        /* @__PURE__ */ f.jsxs("div", { className: Y.select_node_checkbox, children: [
          /* @__PURE__ */ f.jsx(
            an,
            {
              type: "checkbox",
          ...
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column", children: [
            /* @__PURE__ */ f.jsx(Na, { check: !0, for: "select-check", className: "fs-6", children: "Select" }),
        ...
        /* @__PURE__ */ f.jsxs("div", { className: Y.non_select_node_checkbox, children: [
          /* @__PURE__ */ f.jsx(
            an,
            {
              type: "checkbox",
          ...
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column", children: [
            /* @__PURE__ */ f.jsx(Na, { check: !0, for: "non-select-check", className: "fs-6", children: "Non-Select" }),
...
const dd = ut({ isOpen: !1, setIsOpen: () => {
} });
function Cy({
  trigger: e,
  render: t
}) {
  const n = se(null), o = "popover-id", { isOpen: r, setIsOpen: a } = Re(dd);
  return re(() => {
    const i = (s) => {
      if (!n.current) return;
      const { x: l, y: u, width: c, height: d } = n.current.getBoundingClientRect();
      a(
        f2(l - 10, l + c + 10)(s.x) && f2(u - 10, u + d + 10)(s.y)
      );
    };
    ...
    /* @__PURE__ */ f.jsx(
      S2,
      {
        ...
        isOpen: r,
        toggle: () => a((i) => !i),
        children: /* @__PURE__ */ f.jsx(_2, { children: /* @__PURE__ */ f.jsx("div", { ref: n, children: t({ close: () => a(!1) }) }) })
      }
    )
  ] });
}
const vy = () => {
  ...
  re(() => {
    ...
    (async () => {
      ...
      if (!h) return;
      const { level: m } = h, b = e.getNodes(), C = e.getEdges(), [p] = await Qr(
        b,
        C,
        t,
        -1 / 0,
      ...
      let y = 1 / 0, x = -1 / 0;
      for (const v of p)
        y = Math.min(y, v.data.level), x = Math.max(x, v.data.level);
      u([m - y, x - m]);
    })();
  }, [e, t]);
  const d = pe(() => {
      ...
      render: ({ close: h }) => /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-xs", children: [
        /* @__PURE__ */ f.jsxs("div", { className: "w-100 d-flex gap-xl justify-content-between align-items-center", children: [
          /* @__PURE__ */ f.jsxs(
            "div",
            {
              className: xe(Y.expand_nav, {
                [Y.disabled]: r[0] === -1
              }),
              children: [
                /* @__PURE__ */ f.jsxs("div", { className: Y.expand_nav_btn, children: [
                  /* @__PURE__ */ f.jsx(
                    "div",
                    {
                      className: Y.icon,
                      onClick: (m) => {
                        m.stopPropagation(), t && c(Oi(l[0]));
                      },
                      children: /* @__PURE__ */ f.jsx(gb, {})
                    }
                  ),
                  /* @__PURE__ */ f.jsx("div", { className: Y.divider }),
                  /* @__PURE__ */ f.jsx(
        ...
        /* @__PURE__ */ f.jsxs(
          Te,
          {
            ...
            onClick: async (m) => {
              ...
              const b = (y = e.getNode(t)) == null ? void 0 : y.data;
              if (!b) return;
              const [C, p] = await Qr(
                e.getNodes(),
                e.getEdges(),
              ...
              Bo(C, p, t), Ot(C, p), e.setNodes(C), e.setEdges(p), e.fitView({ minZoom: As }), c(
                To(Vo(C, p, t))
              ), c(
                Yn(
                  await to(
  ...
  if (o)
    return Mn(
      /* @__PURE__ */ f.jsx(ln, { className: Y.menu_card_container, children: /* @__PURE__ */ f.jsx(An, { className: Y.menu_card, children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-sm", children: [
        /* @__PURE__ */ f.jsx(vy, {}),
        n && (e == null ? void 0 : e.name) && t.confidence === "low" && /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
          /* @__PURE__ */ f.jsx("div", { className: Y.verticle_divider }),
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-xxs align-items-center", children: [
            ...
            /* @__PURE__ */ f.jsx(
              yn,
              {
                ...
                id: "confidence",
                children: /* @__PURE__ */ f.jsx(c5, {})
              }
            ),
            /* @__PURE__ */ f.jsx("div", { className: Y.low_confidence, children: "Low" })
          ] })
        ] })
      ] }) }) }),
      o
    ...
    return Mn(
      /* @__PURE__ */ f.jsxs(
        Te,
        {
          outline: !0,
          onClick: () => {
            e.setNodes([]), e.setEdges([]), n(pn({ table: "", name: "" })), n(Mo({})), n(nl({})), Qu(), Le.cancel();
          },
  ...
  return /* @__PURE__ */ f.jsx(
    k2,
    {
      ...
      scrollable: !0,
      className: "bs-modal",
      children: /* @__PURE__ */ f.jsxs(A2, { children: [
        /* @__PURE__ */ f.jsx(
          "div",
          {
            className: Y.close_button,
            onClick: () => n(Gn(null)),
            children: /* @__PURE__ */ f.jsx(Nl, {})
          }
        ),
        /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-sm", children: [
          r && /* @__PURE__ */ f.jsx(zl, { nodeType: e.nodeType, table: r }),
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-xs", children: [
            ...
            /* @__PURE__ */ f.jsx("div", { className: Y.model_views_type, children: e.column })
          ] }),
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-xs", children: [
            /* @__PURE__ */ f.jsx("div", { className: "text-dark-grey fs-xs", children: "Type" }),
            /* @__PURE__ */ f.jsxs("div", { className: Y.model_views_type, children: [
              /* @__PURE__ */ f.jsx(Ol, { viewsType: e.viewsType }),
              e.viewsType
            ] })
          ] }),
...
const Il = () => {
  ...
  return e ? /* @__PURE__ */ f.jsx(
    k2,
    {
      ...
      children: /* @__PURE__ */ f.jsxs(A2, { children: [
        ...
        e.type === "op_node" && /* @__PURE__ */ f.jsx(_y, { opNodeArgs: e.args })
      ] })
    }
  ) : null;
}, ky = {
  ...
  const [n, o] = ae(!1), {
    ...
    if (e.current) {
      ...
      zo(y, !0), Io(y, !1), e.current.setEdges(y);
    }
  }, b = pe(
    async (y) => {
      if (g(Mt("")), !y) return;
      g(w8(y.aiEnabled));
      const { node: x } = y, E = e.current;
      if (!E || !x) return;
      if (E.getNode(x.table)) {
        g(Sn(x.table));
        let _ = E.getNodes(), H = E.getEdges();
        u != null && u.name || ([_, H] = Bo(_, H, x.table), E.setNodes(_), E.setEdges(H)), g(
          To(Vo(_, H, x.table))
        ), g(
          Yn(
            await to(
      ...
      let k = [], T = [];
      k = [Qn(x, 0, "")], [k, T] = await Qr(
        k,
        T,
        x.table,
        -h.current,
        h.current
      ), g(Sn(x.table)), g(pn({ table: "", name: "" })), g(Mo({})), g(nl({})), [k, T] = Bo(k, T, x.table), Ot(k, T), E.setNodes(k), E.setEdges(T), E.fitView({ minZoom: As, duration: 500 }), g(To(Vo(k, T, x.table))), g(
        Yn(
          await to(
            k,
            T,
  ...
  re(() => {
    ...
    return document.addEventListener("renderStartNode", y), () => {
      document.removeEventListener("cll_cancelled", m), document.removeEventListener("renderStartNode", y);
    };
  }, []);
  const C = pe(async () => {
    const y = await zb();
    g(m0(y.showSelectEdges)), g(b0(y.showNonSelectEdges)), g(y0(y.defaultExpansion)), h.current = y.defaultExpansion;
  }, [g]);
  re(() => {
    C();
  }, [C]), re(() => {
    ...
    (async () => {
      ...
      if (a) {
        const T = (_) => jl(
          ...
          (H, R) => {
            y.setNodes(H), y.setEdges(R);
          },
          E || { table: "", name: "" },
          { direct: r, indirect: a }
        );
        try {
          Le.start(), await Promise.all([T(!0), T(!1)]);
        } catch (_) {
          console.error(
            "Error while performing cll for ",
      ...
      const v = y.getEdges();
      if (r && a || !r && !a) {
        for (const T of v) T.hidden = !1;
        y.setEdges(v);
        return;
      }
      for (const T of v) {
        T.hidden = !1;
        const _ = (k = T.data) == null ? void 0 : k.type;
        _ && (_ === "direct" && (T.hidden = !r), _ === "indirect" && (T.hidden = !a));
      }
      y.setEdges(v);
    })();
  }, [r, a]);
  ...
  return /* @__PURE__ */ f.jsx(
    "div",
    {
      ...
      "data-theme": t,
      children: /* @__PURE__ */ f.jsx(dd.Provider, { value: { isOpen: n, setIsOpen: o }, children: /* @__PURE__ */ f.jsxs(Yo, { children: [
        /* @__PURE__ */ f.jsxs(
          ha,
          {
            defaultNodes: [],
        ...
        /* @__PURE__ */ f.jsxs(
          sd,
          {
            ...
            width: "30vw",
            children: [
              i === Pu && /* @__PURE__ */ f.jsx(ry, {}),
              i === zu && /* @__PURE__ */ f.jsx(gy, {}),
              i === Iu && /* @__PURE__ */ f.jsx(my, {}),
              i === pp && /* @__PURE__ */ f.jsx(by, { close: () => Mt("") }),
              i === Bu && /* @__PURE__ */ f.jsx(
                yy,
                {
                  applyDefault: (y) => h.current = y
                }
              )
            ]
          }
        ...
        /* @__PURE__ */ f.jsx(xy, {}),
        /* @__PURE__ */ f.jsx(wy, {}),
        e.current ? /* @__PURE__ */ f.jsx(Ey, { flow: e.current }) : null,
        /* @__PURE__ */ f.jsx(Il, {})
      ] }) })
    }
  );
  ...
  return re(() => {
    i(Mo(n)), setTimeout(async () => {
      ...
      const d = [...l], g = {}, h = (C, p) => {
        var E, v;
        const y = C ? r.filter(([k]) => k === p).map(([, k]) => k) : r.filter(([, k]) => k === p).map(([k]) => k), x = ((v = (E = u.find((k) => k.id === p)) == null ? void 0 : E.data) == null ? void 0 : v.level) || 0;
        return ya(
          u,
          c,
          y.map(s),
      ...
      if (t) {
        const C = `${t.table}/${t.name}`, { nodes: p, edges: y } = await Yb(
          u,
          c,
          C,
          async () => ({
  ...
  return re(() => {
    ...
    setTimeout(async () => {
      ...
      if (o) {
        const p = Object.keys(o).map((x) => t[x].type in Po ? Qn(i(x), 0, "") : Uu(x, 0, "", t[x])), y = e.map(
          ([x, E]) => Tl(
            o[x][1],
            o[E][1],
            x,
        ...
        (h = n.current) == null || h.setNodes(p), (m = n.current) == null || m.setEdges(y);
        return;
      }
      const { sinks: s } = Yu(e);
      let l = s.map(
      ...
      const c = [...s], d = {}, g = (p, y) => {
        var v, k;
        const x = p ? e.filter(([T]) => T === y).map(([, T]) => T) : e.filter(([, T]) => T === y).map(([T]) => T), E = ((k = (v = l.find((T) => T.id === y)) == null ? void 0 : v.data) == null ? void 0 : k.level) || 0;
        return ya(
          l,
          u,
          x.map(i),
      ...
      Ot(l, u, !0), (b = n.current) == null || b.setNodes(l), (C = n.current) == null || C.setEdges(u);
    }, 500);
  }, [t, n, e, o]), re(() => {
    const i = setTimeout(() => {
      var s;
    ...
    /* @__PURE__ */ f.jsx(
      sd,
      {
        ...
        closeModal: () => a(Sn("")),
        width: "30vw",
        children: !!r && /* @__PURE__ */ f.jsx(hy, {})
      }
    )
  ] });
}, Tn = ut({
  state: Ir.getInitialState(),
  dispatch: () => null,
  rerender: () => null
}), Ry = ({
  theme: e = "dark",
  ...
  const [i, s] = Rs(Ir.reducer, {
    ...Ir.getInitialState(),
    theme: e,
    lineageType: t,
    sqlLineage: n,
    allowSyncColumnsWithDB: a
  }), l = se(), [, u] = ae(0), c = pe(() => u((g) => (g + 1) % 100), []);
  re(() => {
    s(E8(e));
  }, [e]);
  const d = Se(
  ...
  return /* @__PURE__ */ f.jsx(Tn.Provider, { value: d, children: /* @__PURE__ */ f.jsxs("div", { className: "lineage-component", children: [
    ...
    t === "static" && r && /* @__PURE__ */ f.jsx(Oy, { flow: l, ...r }),
    /* @__PURE__ */ f.jsx("div", { id: "lineage-sidebar" })
  ] }) });
}, We = () => Re(Tn), $e = () => {
  const { dispatch: e } = Re(Tn);
  return e;
}, xC = (e) => /* @__PURE__ */ f.jsx(Ry, { ...e }), fd = {
  showCoachingForm: !1
}, Ls = qs({
  name: "teamMate",
  initialState: fd,
  ...
  return /* @__PURE__ */ f.jsx(gd.Provider, { value: o, children: e });
}, Fy = ({
  errors: e,
  isSubmitting: t,
  taskLabel: n,
  ...
  const { setFieldError: a, values: i, setSubmitting: s } = Vd(), l = async () => await _e.post("coach/training", {
    ...i,
    taskLabel: n
  }), { mutate: u, error: c } = zs({
    // @ts-ignore
  ...
  }, [c, a]), /* @__PURE__ */ f.jsxs(Wd, { children: [
    /* @__PURE__ */ f.jsx(
      $d,
      {
        name: "content",
        render: ({ field: d }) => /* @__PURE__ */ f.jsxs(Ki, { children: [
          /* @__PURE__ */ f.jsx(
            an,
            {
              type: "textarea",
          ...
          e.content ? /* @__PURE__ */ f.jsx(M2, { children: e.content }) : null
        ] })
      }
    ),
    /* @__PURE__ */ f.jsxs(at, { className: "justify-content-end", children: [
  ...
  content: qe.string().min(10, { message: "Feedback must be at least 10 characters" }).max(500, { message: "Feedback must not exceed 500 characters" }).min(1, { message: "Feedback is required" })
}), EC = ({ taskLabel: e, context: t, onClose: n }) => {
  ...
  return m != null && m.frontend_url ? /* @__PURE__ */ f.jsxs(Hs, { children: [
    ...
    o && /* @__PURE__ */ f.jsxs(ln, { className: "mt-4", children: [
      ...
      /* @__PURE__ */ f.jsxs(Ld, { className: "d-flex justify-content-end mt-2 gap-2 border-0", children: [
        ...
        /* @__PURE__ */ f.jsx(Fs, { loading: h, onClick: d, color: "primary", children: "Save" })
      ] })
    ] })
  ] });
}, Iy = () => {
  ...
  const { dispatch: e } = Iy(), t = () => {
    e(Hy.setShowCoachingForm(!0));
  };
  return /* @__PURE__ */ f.jsx(yn, { onClick: t, children: "Show Coaching Form" });
};
var Pl = /* @__PURE__ */ ((e) => (e.TERM_CLARIFICATION = "TermClarification", e.GENERAL_GUIDELINES = "GeneralGuidelines", e.BUSINESS_EXPLANATION = "BusinessExplanation", e))(Pl || {}), Or = /* @__PURE__ */ ((e) => (e.DocGen = "DocGen", e.ChartBot = "ChartBot", e.SqlBot = "SqlExpert", e))(Or || {}), Bl = /* @__PURE__ */ ((e) => (e.USER_SPECIFIC = "UserSpecific", e.ALL_USERS = "AllUsers", e))(Bl || {});
const Py = qe.object({
  train_doc_uid: qe.string(),
  userId: qe.string(),
  display_name: qe.string(),
  taskLabel: qe.string(),
  category: qe.enum(Object.values(Pl)),
  personalizationScope: qe.enum(Object.values(Bl)).default(
    "UserSpecific"
    /* USER_SPECIFIC */
  ),
  createdDate: qe.string(),
  updatedDate: qe.string(),
  content: qe.string().min(10, { message: "Learning must be at least 10 characters" }).max(500, { message: "Learning must not exceed 500 characters" }).min(1, { message: "Learning is required" }),
  metadata: qe.record(qe.unknown()).optional(),
  isActive: qe.boolean().default(!0)
});
var wo = /* @__PURE__ */ ((e) => (e.EXTENSION = "VSCode Extension", e.SAAS = "SaaS", e))(wo || {}), vn = {}, By = xn && xn.__extends || /* @__PURE__ */ function() {
  var e = function(t, n) {
...
}(), hd = xn && xn.__awaiter || function(e, t, n, o) {
  function r(a) {
...
}, pd = xn && xn.__generator || function(e, t) {
...
vn.toFormikValidate = bd = vn.toFormikValidationSchema = vn.ValidationError = void 0;
var md = (
  /** @class */
  function(e) {
    By(t, e);
...
vn.ValidationError = md;
function Vy(e) {
  var t = new md(e.message);
...
var bd = vn.toFormikValidationSchema = Wy;
function $y(e) {
...
function Zy(e, t) {
  var n = this;
  return function(o) {
    return hd(n, void 0, void 0, function() {
      var r;
...
vn.toFormikValidate = Zy;
const qy = ({ learning: e, afterDelete: t, toggle: n, openId: o }) => {
  const [r, a] = ae(!1), {
    errors: i,
    isValid: s,
    isSubmitting: l,
    ...
    initialValues: e,
    validationSchema: bd(Py),
    onSubmit: async (k) => {
      await _e.post(`coach/training/${e.train_doc_uid}`, k, {
        method: "PUT"
      }), a(!1), g(!1);
    }
  }), h = async () => await _e.post(
    `coach/training/${e.train_doc_uid}`,
    {},
    { method: "DELETE" }
  ), { loading: m, error: b, mutate: C } = zs({
    // @ts-ignore
    queryFn: h,
    onSuccess: t
  }), p = (k) => {
  ...
  return /* @__PURE__ */ f.jsx(ln, { className: v ? "active" : "", children: /* @__PURE__ */ f.jsxs("form", { onSubmit: u, children: [
    /* @__PURE__ */ f.jsx(ea, { children: /* @__PURE__ */ f.jsxs(at, { children: [
      /* @__PURE__ */ f.jsxs("div", { style: { flex: 1 }, children: [
        /* @__PURE__ */ f.jsx("div", { children: r ? /* @__PURE__ */ f.jsxs(Ki, { children: [
          /* @__PURE__ */ f.jsx(
            an,
            {
              name: "content",
          ...
          i.content ? /* @__PURE__ */ f.jsx(M2, { children: i.content }) : null
        ] }) : /* @__PURE__ */ f.jsx("h6", { className: v ? "" : "lines-2", children: c.content }) }),
        /* @__PURE__ */ f.jsx(at, { children: /* @__PURE__ */ f.jsxs("dl", { children: [
          /* @__PURE__ */ f.jsxs(at, { children: [
            /* @__PURE__ */ f.jsx("dt", { children: "Created on:" }),
            /* @__PURE__ */ f.jsx("dd", { children: cs(e.createdDate).format(
              "MMMM D, YYYY h:mm A"
            ) })
          ] }),
          /* @__PURE__ */ f.jsxs(at, { children: [
      ...
      /* @__PURE__ */ f.jsxs(at, { className: "align-items-top gap-0", children: [
        /* @__PURE__ */ f.jsx(Ki, { switch: !0, children: /* @__PURE__ */ f.jsx(
          Wo,
          {
        ...
        ] }) : /* @__PURE__ */ f.jsx(yn, { title: "Edit this learning", onClick: E, children: /* @__PURE__ */ f.jsx(d5, {}) }),
        /* @__PURE__ */ f.jsx(yn, { onClick: () => n(e.train_doc_uid), children: v ? /* @__PURE__ */ f.jsx(s5, {}) : /* @__PURE__ */ f.jsx(l5, {}) })
      ] })
    ] }) }),
    /* @__PURE__ */ f.jsxs(jd, { isOpen: v, children: [
      b && /* @__PURE__ */ f.jsx(Hs, { color: "danger", children: b.message }),
      /* @__PURE__ */ f.jsxs(at, { className: "gap-4", children: [
        /* @__PURE__ */ f.jsxs("div", { children: [
          ...
          r ? /* @__PURE__ */ f.jsx(
            ...
            {
              style: { minWidth: 160 },
              options: Object.values(Pl).map((k) => ({
                value: k,
                label: k
              })),
              value: c.category,
        ...
        e.metadata && Object.keys(e.metadata).map((k) => {
          ...
          return /* @__PURE__ */ f.jsxs("div", { children: [
            ...
            " ",
            /* @__PURE__ */ f.jsx(f.Fragment, { children: ((T = e.metadata) == null ? void 0 : T[k]) || "" })
          ] }, k);
        })
      ] })
    ] })
  ] }) });
}, _C = ({ filters: e, learning: t }) => {
  var u;
  const [n, o] = ae(t), { error: r, data: a, loading: i, refetch: s } = ef({
    queryFn: () => _e.get("coach/training", e)
  }), l = (c) => {
    o((d) => d === c ? void 0 : c);
  };
  return /* @__PURE__ */ f.jsx(at, { direction: "column", className: "learnings", children: i ? /* @__PURE__ */ f.jsx("p", { children: "Loading learnings..." }) : r ? /* @__PURE__ */ f.jsxs(Hs, { color: "danger", children: [
...
], Xy = ({ config: e, client: t, onSelect: n }) => /* @__PURE__ */ f.jsx(Rd, { children: /* @__PURE__ */ f.jsxs(ln, { children: [
  /* @__PURE__ */ f.jsxs(at, { className: "justify-content-between", children: [
  ...
  /* @__PURE__ */ f.jsxs(An, { children: [
    /* @__PURE__ */ f.jsx(ea, { tag: "h5", children: e.name }),
    /* @__PURE__ */ f.jsx(Fd, { tag: "h6" }),
    /* @__PURE__ */ f.jsx(zd, { children: e.description }),
    /* @__PURE__ */ f.jsxs(at, { className: "justify-content-start", children: [
      /* @__PURE__ */ f.jsx(
        Te,
        {
          size: "sm",
      ...
      e.seeInAction && e.availability.includes(wo[t]) && /* @__PURE__ */ f.jsx(
        Te,
        {
          color: "primary",
          outline: !0,
...
] }) }), kC = ({ onSelect: e, client: t }) => /* @__PURE__ */ f.jsx("div", { className: "teammates", children: /* @__PURE__ */ f.jsx(Id, { children: Ky.map((n) => /* @__PURE__ */ f.jsx(
  Xy,
  {
    config: n,
    client: t,
