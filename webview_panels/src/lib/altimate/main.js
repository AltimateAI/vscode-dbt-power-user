...
import ie, { createContext as at, useContext as ge, useMemo as nt, Children as Ot, useState as Se, useEffect as Ve, useReducer as Pl, useCallback as $e, useLayoutEffect as Dl, useRef as ke, useInsertionEffect as na, forwardRef as ra, Fragment as Rl, createElement as Ol, useId as oi, cloneElement as Il, isValidElement as Ml, lazy as Fl } from "react";
import { Card as si, CardBody as ai, Button as jt, CardTitle as Nl, CloseButton as jl } from "reactstrap";
...
function $l() {
  return co || (co = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function b(y) {
      {
        for (var F = arguments.length, $ = new Array(F > 1 ? F - 1 : 0), J = 1; J < F; J++)
          $[J - 1] = arguments[J];
        E("error", y, $);
      }
    }
    ...
    var x = !1, T = !1, D = !1, I = !1, S = !1, j;
    j = Symbol.for("react.module.reference");
    function A(y) {
      return !!(typeof y == "string" || typeof y == "function" || y === r || y === o || S || y === i || y === c || y === l || I || y === h || x || T || D || typeof y == "object" && y !== null && (y.$$typeof === d || y.$$typeof === f || y.$$typeof === s || y.$$typeof === a || y.$$typeof === u || // This needs to include all possible module reference object
    ...
    var M = Object.assign, w = 0, _, O, P, k, C, R, H;
    function U() {
    }
    ...
    function z() {
      {
        if (w === 0) {
          _ = console.log, O = console.info, P = console.warn, k = console.error, C = console.group, R = console.groupCollapsed, H = console.groupEnd;
          var y = {
            configurable: !0,
            enumerable: !0,
            value: U,
    ...
    var K = v.ReactCurrentDispatcher, G;
    function Q(y, F, $) {
      {
        if (G === void 0)
          try {
    ...
    function L(y, F) {
      ...
      try {
        ...
        if (Ue && J && typeof Ue.stack == "string") {
          for (var re = Ue.stack.split(`
`), Ae = J.stack.split(`
`), de = re.length - 1, me = Ae.length - 1; de >= 1 && me >= 0 && re[de] !== Ae[me]; )
            me--;
          for (; de >= 1 && me >= 0; de--, me--)
            if (re[de] !== Ae[me]) {
              if (de !== 1 || me !== 1)
...
` + re[de].replace(" at new ", " at ");
                    return y.displayName && Ie.includes("<anonymous>") && (Ie = Ie.replace("<anonymous>", y.displayName)), typeof y == "function" && W.set(y, Ie), Ie;
                  }
                while (de >= 1 && me >= 0);
              break;
            }
      ...
      var Tt = y ? y.displayName || y.name : "", uo = Tt ? Q(Tt) : "";
    ...
    var mn = Object.prototype.hasOwnProperty, Xi = {}, Zi = v.ReactDebugCurrentFrame;
    function gn(y) {
      if (y) {
        var F = y._owner, $ = lt(y.type, y._source, F ? F.type : null);
          ...
          if (le(y, oe)) {
            ...
            try {
              if (typeof y[oe] != "function") {
                var Ae = Error((J || "React class") + ": " + $ + " type `" + oe + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof y[oe] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw Ae.name = "Invariant Violation", Ae;
              }
              re = y[oe](F, oe, J, $, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (de) {
              re = de;
            }
            re && !(re instanceof Error) && (gn(se), b("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", J || "React class", $, oe, typeof re), gn(null)), re instanceof Error && !(re.message in Xi) && (Xi[re.message] = !0, gn(se), b("Failed %s type: %s", $, re.message), gn(null));
          }
      }
    }
    ...
    function cl(y) {
      {
        var F = typeof Symbol == "function" && Symbol.toStringTag, $ = F && y[Symbol.toStringTag] || y.constructor.name || "Object";
        return $;
      }
    }
    function fl(y) {
    ...
    function Qi(y) {
      if (fl(y))
        return b("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", cl(y)), Ji(y);
    }
    var $t = v.ReactCurrentOwner, dl = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function ml(y, F) {
      if (typeof y.ref == "string" && $t.current && F && $t.current.stateNode !== F) {
        var $ = q($t.current.type);
        sr[$] || (b('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', q($t.current.type), y.ref), sr[$] = !0);
      }
    }
    function gl(y, F) {
      {
        var $ = function() {
          eo || (eo = !0, b("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", F));
        };
    ...
    function yl(y, F) {
      {
        var $ = function() {
          to || (to = !0, b("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", F));
        };
    ...
    function El(y, F, $, J, se) {
      {
        ...
        $ !== void 0 && (Qi($), re = "" + $), pl(F) && (Qi(F.key), re = "" + F.key), hl(F) && (Ae = F.ref, ml(F, se));
        for (le in F)
          mn.call(F, le) && !dl.hasOwnProperty(le) && (oe[le] = F[le]);
        if (y && y.defaultProps) {
          var de = y.defaultProps;
          for (le in de)
            oe[le] === void 0 && (oe[le] = de[le]);
        }
        if (re || Ae) {
    ...
    var ar = v.ReactCurrentOwner, no = v.ReactDebugCurrentFrame;
    function St(y) {
      if (y) {
        var F = y._owner, $ = lt(y.type, y._source, F ? F.type : null);
...
Check the render method of \`` + y + "`.";
    ...
    function bl(y) {
      {
        if (y !== void 0) {
          var F = y.fileName.replace(/^.*[\\\/]/, ""), $ = y.lineNumber;
          return `
    ...
    function oo(y, F) {
      {
        ...
        io[$] = !0;
        var J = "";
        y && y._owner && y._owner !== ar.current && (J = " It was passed a child from " + q(y._owner.type) + "."), St(y), b('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', $, J), St(null);
      }
    }
    function so(y, F) {
      {
    ...
    function Cl(y) {
      {
        for (var F = Object.keys(y.props), $ = 0; $ < F.length; $++) {
          var J = F[$];
          if (J !== "children" && J !== "key") {
            St(y), b("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", J), St(null);
            break;
          }
        }
        y.ref !== null && (St(y), b("Invalid attribute `ref` supplied to `React.Fragment`."), St(null));
      }
    }
    function ao(y, F, $, J, se, le) {
      {
        ...
        if (!oe) {
          ...
          Ae ? re += Ae : re += ro();
          var de;
          y === null ? de = "null" : or(y) ? de = "array" : y !== void 0 && y.$$typeof === t ? (de = "<" + (q(y.type) || "Unknown") + " />", re = " Did you accidentally export a JSX literal instead of a component?") : de = typeof y, b("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", de, re);
        }
        var me = El(y, F, $, se, le);
        if (me == null)
          return me;
...
process.env.NODE_ENV === "production" ? Mr.exports = kl() : Mr.exports = $l();
var B = Mr.exports;
function Bl(e) {
...
var ia = Symbol.for("immer-nothing"), fo = Symbol.for("immer-draftable"), De = Symbol.for("immer-state"), Ul = process.env.NODE_ENV !== "production" ? [
...
function Pe(e, ...t) {
  if (process.env.NODE_ENV !== "production") {
    const n = Ul[e], r = typeof n == "function" ? n.apply(null, t) : n;
...
function Xe(e) {
  var t;
  return e ? oa(e) || Array.isArray(e) || !!e[fo] || !!((t = e.constructor) != null && t[fo]) || qn(e) || Kn(e) : !1;
}
...
function oa(e) {
  ...
  return n === Object ? !0 : typeof n == "function" && Function.toString.call(n) === zl;
}
function On(e, t) {
  Yn(e) === 0 ? Reflect.ownKeys(e).forEach((n) => {
    t(n, e[n], e);
...
function Nr(e, t) {
  ...
  if (!t && oa(e))
    return It(e) ? { ...e } : Object.assign(/* @__PURE__ */ Object.create(null), e);
...
function ui(e, t = !1) {
  return Gn(e) || rt(e) || !Xe(e) || (Yn(e) > 1 && (e.set = e.add = e.clear = e.delete = Yl), Object.freeze(e), t && Object.entries(e).forEach(([n, r]) => ui(r, !0))), e;
}
function Yl() {
  Pe(2);
}
...
function mo(e, t) {
  ...
  const n = t.drafts_[0];
  return e !== void 0 && e !== n ? (n[De].modified_ && (jr(t), Pe(4)), Xe(e) && (e = In(t, e), t.parent_ || Mn(t, e)), t.patches_ && vt("Patches").generateReplacementPatches_(
    n[De].base_,
    e,
    t.patches_,
    t.inversePatches_
  )) : e = In(t, n, []), jr(t), t.patches_ && t.patchListener_(t.patches_, t.inversePatches_), e !== ia ? e : void 0;
}
function In(e, t, n) {
  if (Gn(t))
    return t;
  ...
  if (!r.finalized_) {
    ...
    const i = r.copy_;
    let o = i, s = !1;
    r.type_ === 3 && (o = new Set(i), i.clear(), s = !0), On(
      o,
      (a, u) => go(e, r, i, a, u, n, s)
    ), Mn(e, i, !1), n && e.patches_ && vt("Patches").generatePatches_(
      r,
      n,
      e.patches_,
      e.inversePatches_
...
function go(e, t, n, r, i, o, s) {
  if (process.env.NODE_ENV !== "production" && i === n && Pe(5), rt(i)) {
    ...
    !Fr(t.assigned_, r) ? o.concat(r) : void 0, u = In(e, i, a);
    if (sa(n, r, u), rt(u))
      e.canAutoFreeze_ = !1;
    else
      return;
  ...
  if (Xe(i) && !Gn(i)) {
    if (!e.immer_.autoFreeze_ && e.unfinalizedDrafts_ < 1)
      return;
    In(e, i), (!t || !t.scope_.parent_) && typeof r != "symbol" && Object.prototype.propertyIsEnumerable.call(n, r) && Mn(e, i);
  }
}
function Mn(e, t, n = !1) {
...
var li = {
  get(e, t) {
    ...
    if (!Fr(n, t))
      return Zl(e, n, t);
    const r = n[t];
    return e.finalized_ || !Xe(r) ? r : r === cr(e.base_, t) ? (fr(e), e.copy_[t] = kr(r, e)) : r;
  },
  has(e, t) {
    return t in ft(e);
  },
  ...
  set(e, t, n) {
    ...
    if (!e.modified_) {
      const i = cr(ft(e), t), o = i == null ? void 0 : i[De];
      if (o && o.base_ === n)
        return e.copy_[t] = n, e.assigned_[t] = !1, !0;
      if (Wl(n, i) && (n !== void 0 || Fr(e.base_, t)))
        return !0;
      fr(e), Lr(e);
    }
  ...
  deleteProperty(e, t) {
    return cr(e.base_, t) !== void 0 || t in e.base_ ? (e.assigned_[t] = !1, fr(e), Lr(e)) : delete e.assigned_[t], e.copy_ && delete e.copy_[t], !0;
  },
  // Note: We never coerce `desc.value` into an Immer draft, because we can't make
  // the same guarantee in ES5 mode.
  getOwnPropertyDescriptor(e, t) {
    const n = ft(e), r = Reflect.getOwnPropertyDescriptor(n, t);
    return r && {
      writable: !0,
...
Qt.deleteProperty = function(e, t) {
  return process.env.NODE_ENV !== "production" && isNaN(parseInt(t)) && Pe(13), Qt.set.call(this, e, t, void 0);
};
Qt.set = function(e, t, n) {
  return process.env.NODE_ENV !== "production" && t !== "length" && isNaN(parseInt(t)) && Pe(14), li.set.call(this, e[0], t, n, e[0]);
};
function cr(e, t) {
  const n = e[De];
  return (n ? ft(n) : e)[t];
...
var Jl = class {
  constructor(e) {
    this.autoFreeze_ = !0, this.useStrictShallowCopy_ = !1, this.produce = (t, n, r) => {
      ...
      if (Xe(t)) {
        ...
        if (i = n(t), i === void 0 && (i = t), i === ia && (i = void 0), this.autoFreeze_ && ui(i, !0), r) {
          const o = [], s = [];
  ...
  applyPatches(e, t) {
    ...
    return rt(e) ? r(e, t) : this.produce(
      e,
      (i) => r(i, t)
    );
  }
...
function kr(e, t) {
  const n = qn(e) ? vt("MapSet").proxyMap_(e, t) : Kn(e) ? vt("MapSet").proxySet_(e, t) : Xl(e, t);
...
function ic(e, t = "expected all items to be functions, instead received the following types: ") {
...
}, uc = typeof WeakRef < "u" ? WeakRef : ac, lc = 0, Eo = 1;
function yn() {
  return {
    s: lc,
    v: void 0,
...
function ci(e, t = {}) {
  ...
  function s() {
    ...
    const c = a;
    let l;
    if (a.s === Eo ? l = a.v : (l = e.apply(null, arguments), o++), c.s = Eo, r) {
      const d = ((f = i == null ? void 0 : i.deref) == null ? void 0 : f.call(i)) ?? i;
      d != null && r(d, l) && (l = d, o !== 0 && o--), i = typeof l == "object" && l !== null || typeof l == "function" ? new uc(l) : l;
    }
    return c.v = l, l;
  }
  return s.clearCache = () => {
...
function da(e, ...t) {
  const n = typeof e == "function" ? {
    ...
    typeof c == "object" && (u = c, c = i.pop()), nc(
      c,
    ...
    const l = {
      ...
      devModeChecks: m = {}
    } = l, g = yo(d), v = yo(p), b = oc(i), E = f(function() {
      return o++, c.apply(
        null,
        arguments
      );
    ...
    const T = h(function() {
      ...
      if (a = E.apply(null, I), process.env.NODE_ENV !== "production") {
        const { identityFunctionCheck: S, inputStabilityCheck: j } = sc(x, m);
...
var cc = /* @__PURE__ */ da(ci), fc = Object.assign(
  (e, t = cc) => {
    rc(
      e,
  ...
  const t = da(...e), n = Object.assign((...r) => {
    const i = t(...r), o = (s, ...a) => i(rt(s) ? la(s) : s, ...a);
...
function Mt(e, t) {
  ...
  return n.toString = () => `${e}`, n.type = e, n.match = (r) => Hl(r) && r.type === e, n;
}
function bo(e) {
  return Xe(e) ? fa(e, () => {
  }) : e;
...
var mc = "ModuleSymbhasOwnPr-0123456789ABCDEFGHNRVfgctiUvz_KqYTJkLxpZXIjQW", gc = (e = 21) => {
  let t = "", n = e;
  for (; n--; )
...
function Ec({
  ...
  return function(i) {
    ...
    const a = (typeof i.reducers == "function" ? i.reducers(Tc()) : i.reducers) || {}, u = Object.keys(a), c = {
      ...
      addCase(E, x) {
        ...
        if (T in c.sliceCaseReducersByType)
          throw new Error(process.env.NODE_ENV === "production" ? pe(13) : "`context.addCase` cannot be called with two reducers for the same action type: " + T);
    ...
    function f() {
      ...
      const [E = {}, x = [], T = void 0] = typeof i.extraReducers == "function" ? ha(i.extraReducers) : [i.extraReducers], D = {
        ...E,
      ...
      return pc(i.initialState, (I) => {
        ...
        for (let S of c.sliceMatchers)
          I.addMatcher(S.matcher, S.reducer);
        for (let S of x)
          I.addMatcher(S.matcher, S.reducer);
...
function Cc({
  ...
  if ("reducer" in r) {
    ...
    o = r;
  i.addCase(e, o).exposeCaseReducer(t, o).exposeAction(t, s ? Mt(e, s) : Mt(e));
}
function xc(e) {
...
var wc = (e, t) => {
  if (typeof e != "function")
    throw new Error(process.env.NODE_ENV === "production" ? pe(32) : `${t} is not a function`);
}, fi = "listenerMiddleware", Pc = (e) => {
  let {
    type: t,
    actionCreator: n,
    matcher: r,
  ...
  if (t)
    ...
    throw new Error(process.env.NODE_ENV === "production" ? pe(21) : "Creating or removing a listener requires one of the known fields for matching an action");
  return wc(o, "options.listener"), {
    predicate: i,
    type: t,
    effect: o
  };
...
const Ic = {
...
} = Fn.actions, Nc = "_dbtDocs_9r9nz_1", jc = "_conversationRightPanelCloseButton_9r9nz_14", Vc = "_conversationRightPanel_9r9nz_14", Lc = "_newConversationForm_9r9nz_41", kc = "_conversationGroup_9r9nz_69", $c = "_replyForm_9r9nz_82", en = {
  dbtDocs: Nc,
  ...
  get: async (e, t, n) => ({}),
  post: async (e, t, n) => ({})
}, Bc = (e) => un.get(`dbt/dbt_docs_share/${e}`), Hc = (e, t) => un.post(`dbt/dbt_docs_share/${e}/conversation_group`, t), Uc = (e, t, n) => un.post(
  `dbt/dbt_docs_share/${e}/conversation_group/${t}/conversation`,
  n
), zc = (e) => un.get(`dbt/dbt_docs_share/${e}/conversations`), Wc = (e) => un.get("/users/", { company: e }), Yc = ({ user: e }) => {
  var t, n;
  return /* @__PURE__ */ B.jsx("div", { className: "rounded-circle d-inline-block p-2", children: (((t = e == null ? void 0 : e.first_name) == null ? void 0 : t[0]) || "") + (((n = e == null ? void 0 : e.last_name) == null ? void 0 : n[0]) || "") });
}, ga = Yc;
function qc(e) {
  if (Array.isArray(e)) {
...
function $r(e, t) {
  return $r = Object.setPrototypeOf || function(r, i) {
...
function An(e) {
  return typeof Symbol == "function" && Dt(Symbol.iterator) === "symbol" ? An = function(n) {
    return Dt(n);
  } : An = function(n) {
    return n && typeof Symbol == "function" && n.constructor === Symbol && n !== Symbol.prototype ? "symbol" : Dt(n);
  }, An(e);
}
function Qc(e, t) {
...
function va(e, t) {
  ...
  return _n(e) && _n(t) && Vt(t).forEach(function(r) {
    _n(t[r]) ? r in e ? n[r] = va(e[r], t[r]) : Object.assign(n, nn({}, r, t[r])) : Object.assign(n, nn({}, r, t[r]));
  }), n;
}
var Hr = function(t) {
  ...
  for (var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], r = Vt(t), i = {}, o = 0, s = r.length; o < s; o += 1) {
  ...
  for (var r = n.map(Co), i = Vt(t), o = {}, s = 0, a = i.length; s < a; s += 1) {
    var u = i[s];
    (n.indexOf(u) >= 0 || r.indexOf(Co(u)) >= 0) && (o[u] = t[u]);
  }
  return o;
}, vf = function e(t, n) {
  for (var r = Hr.apply(void 0, [{}, pf(t, n)].concat(ze(ya(Ea(t, n))))), i = Vt(r).filter(pi), o = 0, s = i.length; o < s; o += 1) {
    var a = i[o], u = e(r[a], n);
...
var Ef = ["animationName"], bf = function(t) {
...
var Cf = function(t) {
  ...
  if (t) {
    var i = t.split(" ")[0], o = [].concat(ze(n.length === 0 ? r.map(function(s) {
...
function Ca(e) {
  var t = e.style, n = e.className, r = e.classNames, i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : ba, o = n || Cf(r) || (t == null ? void 0 : t.className), s = typeof t == "function" ? t : Tf(function(f, d) {
    var h = Ta(f);
    Ft(Array.isArray(h), "First parameter must be a string, an array of strings, a plain object with boolean values, or a falsy value."), Ft(!d || _n(d), "Optional second parameter must be a plain object.");
    var p = h.filter(pi), m = h.filter(gf), g = m.length > 0 ? function(E) {
      return ya(Ea(E, m));
    } : function(E) {
      return [E];
    }, v = function() {
  ...
  }), a = Ct({}, typeof t == "function" ? t : {
    style: t
  }), u = ze(new Set([].concat(ze(a.className ? a.className.split(" ") : []), ze(o ? o.split(" ") : [])))), c = r ? mf(u.map(function(f) {
    return r[f];
  })) : u, l = i(Ct(Ct({}, a), c.length > 0 ? {
    className: c.join(" ")
  } : {}));
...
var Af = function() {
  ...
  return n.reduce(function(i, o) {
    return Ut(Ut(Ut({}, i), typeof o == "function" ? o : {}), {}, {
      style: Ut(Ut({}, i.style), typeof o == "function" ? o.style : o)
    });
  }, {});
}, mi = function(t, n, r) {
  var i = n.style, o = n.className, s = n.classNames, a = ge(Sa), u = nt(function() {
    return Ca({
      style: i,
      className: o,
      classNames: s
...
function wf() {
  return Do || (Do = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function E(L) {
      ...
      L === r || L === c || L === o || L === i || L === f || L === d || typeof L == "object" && L !== null && (L.$$typeof === p || L.$$typeof === h || L.$$typeof === s || L.$$typeof === a || L.$$typeof === l || L.$$typeof === g || L.$$typeof === v || L.$$typeof === b || L.$$typeof === m);
    }
    function x(L) {
    ...
    var T = u, D = c, I = a, S = s, j = t, A = l, N = r, X = p, q = h, M = n, w = o, _ = i, O = f, P = !1;
    function k(L) {
      return P || (P = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), C(L) || x(L) === u;
    }
    function C(L) {
      return x(L) === c;
    }
    ...
    ue.AsyncMode = T, ue.ConcurrentMode = D, ue.ContextConsumer = I, ue.ContextProvider = S, ue.Element = j, ue.ForwardRef = A, ue.Fragment = N, ue.Lazy = X, ue.Memo = q, ue.Portal = M, ue.Profiler = w, ue.StrictMode = _, ue.Suspense = O, ue.isAsyncMode = k, ue.isConcurrentMode = C, ue.isContextConsumer = R, ue.isContextProvider = H, ue.isElement = U, ue.isForwardRef = z, ue.isFragment = Z, ue.isLazy = K, ue.isMemo = G, ue.isPortal = Q, ue.isProfiler = ee, ue.isStrictMode = W, ue.isSuspense = ce, ue.isValidElementType = E, ue.typeOf = x;
  }()), ue;
}
var Ro;
function xa() {
  return Ro || (Ro = 1, process.env.NODE_ENV === "production" ? En.exports = _f() : En.exports = wf()), En.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var pr, Mo;
function Aa() {
  return Mo || (Mo = 1, pr = Function.call.bind(Object.prototype.hasOwnProperty)), pr;
}
var mr, Fo;
function Df() {
  if (Fo)
...
function Rf() {
  if (No)
    return gr;
  No = 1;
  var e = xa(), t = Pf(), n = gi(), r = Aa(), i = Df(), o = function() {
  };
  ...
  return gr = function(a, u) {
    ...
    function g(C) {
      ...
      function U(Z, K, G, Q, ee, W, ce) {
        ...
        return K[G] == null ? Z ? K[G] === null ? new m("The " + ee + " `" + W + "` is marked as required " + ("in `" + Q + "`, but its value is `null`.")) : new m("The " + ee + " `" + W + "` is marked as required in " + ("`" + Q + "`, but its value is `undefined`.")) : null : C(K, G, Q, ee, W);
      }
      var z = U.bind(null, !1);
    ...
    function v(C) {
      function R(H, U, z, Z, K, G) {
        ...
        if (ee !== C) {
          var W = O(Q);
          return new m(
            "Invalid " + Z + " `" + K + "` of type " + ("`" + W + "` supplied to `" + z + "`, expected ") + ("`" + C + "`."),
            { expectedType: C }
          );
        }
        return null;
    ...
    function E(C) {
      function R(H, U, z, Z, K) {
        if (typeof C != "function")
          return new m("Property `" + K + "` of component `" + z + "` has invalid PropType notation inside arrayOf.");
        var G = H[U];
        if (!Array.isArray(G)) {
          var Q = _(G);
          return new m("Invalid " + Z + " `" + K + "` of type " + ("`" + Q + "` supplied to `" + z + "`, expected an array."));
        }
    ...
    function x() {
      function C(R, H, U, z, Z) {
        ...
        if (!a(K)) {
          var G = _(K);
          return new m("Invalid " + z + " `" + Z + "` of type " + ("`" + G + "` supplied to `" + U + "`, expected a single ReactElement."));
        }
        return null;
      }
      return g(C);
    ...
    function T() {
      function C(R, H, U, z, Z) {
        ...
        if (!e.isValidElementType(K)) {
          var G = _(K);
          return new m("Invalid " + z + " `" + Z + "` of type " + ("`" + G + "` supplied to `" + U + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return g(C);
    ...
    function D(C) {
      function R(H, U, z, Z, K) {
        if (!(H[U] instanceof C)) {
          var G = C.name || d, Q = k(H[U]);
          return new m("Invalid " + Z + " `" + K + "` of type " + ("`" + Q + "` supplied to `" + z + "`, expected ") + ("instance of `" + G + "`."));
        }
        return null;
      }
      return g(R);
    ...
    function I(C) {
      ...
      function R(H, U, z, Z, K) {
        ...
        return new m("Invalid " + Z + " `" + K + "` of value `" + String(G) + "` " + ("supplied to `" + z + "`, expected one of " + ee + "."));
      }
      return g(R);
    }
    function S(C) {
      function R(H, U, z, Z, K) {
        if (typeof C != "function")
          return new m("Property `" + K + "` of component `" + z + "` has invalid PropType notation inside objectOf.");
        var G = H[U], Q = _(G);
        if (Q !== "object")
          return new m("Invalid " + Z + " `" + K + "` of type " + ("`" + Q + "` supplied to `" + z + "`, expected an object."));
        for (var ee in G)
          if (r(G, ee)) {
            var W = C(G, ee, z, Z, K + "." + ee, n);
            if (W instanceof Error)
    ...
    function j(C) {
      ...
      function U(z, Z, K, G, Q) {
        for (var ee = [], W = 0; W < C.length; W++) {
          var ce = C[W], L = ce(z, Z, K, G, Q, n);
          if (L == null)
            return null;
          L.data && r(L.data, "expectedType") && ee.push(L.data.expectedType);
        }
        var ve = ee.length > 0 ? ", expected one of type [" + ee.join(", ") + "]" : "";
        return new m("Invalid " + G + " `" + Q + "` supplied to " + ("`" + K + "`" + ve + "."));
      }
      return g(U);
    }
    function A() {
      function C(R, H, U, z, Z) {
        return M(R[H]) ? null : new m("Invalid " + z + " `" + Z + "` supplied to " + ("`" + U + "`, expected a ReactNode."));
      }
      return g(C);
    }
    ...
    function X(C) {
      function R(H, U, z, Z, K) {
        var G = H[U], Q = _(G);
        if (Q !== "object")
          return new m("Invalid " + Z + " `" + K + "` of type `" + Q + "` " + ("supplied to `" + z + "`, expected `object`."));
        for (var ee in C) {
          var W = C[ee];
          if (typeof W != "function")
            return N(z, Z, K, ee, O(W));
      ...
      function R(H, U, z, Z, K) {
        ...
        for (var W in ee) {
          ...
          if (r(C, W) && typeof ce != "function")
            return N(z, Z, K, W, O(ce));
          if (!ce)
            return new m(
              "Invalid " + Z + " `" + K + "` key `" + W + "` supplied to `" + z + "`.\nBad object: " + JSON.stringify(H[U], null, "  ") + `
...
var wn = function(t) {
  ...
  Ft(n === "id" || n === "display", 'Second arg must be either "id" or "display", got: "'.concat(n, '"'));
  var r = t.indexOf(Le.display), i = t.indexOf(Le.id);
  return r < 0 && (r = null), i < 0 && (i = null), Ft(r !== null || i !== null, "The markup '".concat(t, "' does not contain either of the placeholders '__id__' or '__display__'")), r !== null && i !== null ? n === "id" && i <= r || n === "display" && r <= i ? 0 : 1 : 0;
}, Nf = function(t) {
  var n = /^\/(.+)\/(\w+)?$/;
  return new RegExp(t.map(function(r) {
    var i = n.exec(r.toString()), o = Vn(i, 3), s = o[1], a = o[2];
    return Ft(!a, "RegExp flags are not supported. Change /".concat(s, "/").concat(a, " into /").concat(s, "/")), "(".concat(s, ")");
  }).join("|"), "g");
}, _a = function(t) {
  var n = 0;
  ...
  for (var i = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : jf, o = Nf(n.map(function(T) {
    return T.regex;
    ...
    var f = a.find(function(T) {
      return !!u[T];
    }), d = a.indexOf(f), h = n[d], p = h.markup, m = h.displayTransform, g = f + Vo(p, "id"), v = f + Vo(p, "display"), b = u[g], E = m(b, u[v]), x = t.substring(c, u.index);
    i(x, c, l), l += x.length, r(u[0], u.index, l, b, E, d, c), l += E.length, c = o.lastIndex;
  }
  c < t.length && i(t.substring(c), c, l);
}, mt = function(t, n) {
  var r = "";
  return ln(t, n, function(i, o, s, a, u) {
    r += u;
  }, function(i) {
    r += i;
  }), r;
  ...
  var o = r.selectionStartBefore, s = r.selectionEndBefore, a = r.selectionEndAfter, u = mt(t, i), c = u.length - n.length;
  ...
  var r = [];
  return ln(t, n, function(i, o, s, a, u, c, l) {
    r.push({
      id: a,
      display: u,
      childIndex: c,
  ...
  var r = Wt(t, n), i = r[r.length - 1];
  return i ? i.plainTextIndex + i.display.length : 0;
}, kf = function(t) {
  var n = wn(t), r = t[t.indexOf(Le.display) + Le.display.length], i = t[t.indexOf(Le.id) + Le.id.length];
  return new RegExp(n.replace(Le.display, "([^".concat(wn(r || ""), "]+?)")).replace(Le.id, "([^".concat(wn(i || ""), "]+?)")));
}, Je = function(t) {
  ...
  var r = new RegExp(t.toString() + "|").exec("").length - 1, i = _a(n);
  return Ft(r === i, "Number of capturing groups in RegExp ".concat(t.toString(), " (").concat(r, ") does not match the number of placeholders in the markup '").concat(n, "' (").concat(i, ")")), t;
}, Bf = function(t, n, r) {
...
function Xn(e, t) {
  var n = function(i) {
    var o = function(u) {
      var c = u.style, l = u.className, f = u.classNames, d = af(u, qf), h = t ? t(d) : void 0, p = mi(e, {
        style: c,
        className: l,
        classNames: f
      }, h);
      return /* @__PURE__ */ ie.createElement(i, Ne({}, d, {
        style: p
      }));
...
function Da(e) {
  ...
  var u = e.style, c = Se({
    left: void 0,
    top: void 0
  }), l = Vn(c, 2), f = l[0], d = l[1], h = Se(), p = Vn(h, 2), m = p[0], g = p[1];
  Ve(function() {
    v();
  });
  var v = function() {
    if (m) {
      var M = m.offsetLeft, w = m.offsetTop;
      if (!(f.left === M && f.top === w)) {
        var _ = {
          left: M,
          top: w
  ...
  var x = [], T = {}, D = x, I = 0, S = function(M, w, _) {
    ...
    return /* @__PURE__ */ ie.createElement("span", Ne({}, u("substring"), {
      key: w
    }), M);
  }, N = function(M, w, _, O) {
    var P = {
    ...
    return /* @__PURE__ */ ie.createElement("span", Ne({}, u("caret"), {
      ref: g,
      key: "caret"
    }), M);
  };
  return ln(i, b, j, S), D.push(" "), D !== x && x.push(X(D)), /* @__PURE__ */ ie.createElement("div", Ne({}, u, {
    ref: s
  }), x);
}
Da.propTypes = {
...
function Ra(e) {
  ...
  return /* @__PURE__ */ ie.createElement("li", Ne({
    id: t,
    role: "option",
    "aria-selected": n
  }, f, l), d());
...
function Qf(e) {
  var t = e.style, n = e.className, r = e.classNames, i = mi(ed, {
    style: t,
    className: n,
    classNames: r
  }), o = i("spinner");
...
function Oa(e) {
  var t = e.id, n = e.suggestions, r = n === void 0 ? {} : n, i = e.a11ySuggestionsListLabel, o = e.focusIndex, s = e.position, a = e.left, u = e.right, c = e.top, l = e.scrollFocusedIntoView, f = e.isLoading, d = e.isOpened, h = e.onSelect, p = h === void 0 ? function() {
    return null;
  } : h, m = e.ignoreAccents, g = e.containerRef, v = e.children, b = e.style, E = e.customSuggestionsContainer, x = e.onMouseDown, T = e.onMouseEnter, D = Se(void 0), I = Vn(D, 2), S = I[0], j = I[1];
  Ve(function() {
    if (!(!S || S.offsetHeight >= S.scrollHeight || !l)) {
      var _ = S.scrollTop, O = S.children[o].getBoundingClientRect(), P = O.top, k = O.bottom, C = S.getBoundingClientRect(), R = C.top;
      P = P - R + _, k = k - R + _, P < _ ? S.scrollTop = P : k > S.offsetHeight && (S.scrollTop = k - S.offsetHeight);
    }
  }, [o, l, S]);
  var A = function() {
    var O = /* @__PURE__ */ ie.createElement("ul", Ne({
      ref: j,
      id: t,
      role: "listbox",
      "aria-label": i
    }, b("list")), Object.values(r).reduce(function(P, k) {
      var C = k.results, R = k.queryInfo;
      return [].concat(Nn(P), Nn(C.map(function(H, U) {
        return N(H, R, P.length + U);
      })));
    }, []));
    return E ? E(O) : O;
  }, N = function(O, P, k) {
    var C = k === o, R = P.childIndex, H = P.query, U = Ot.toArray(v)[R].props.renderSuggestion;
  ...
  return d ? /* @__PURE__ */ ie.createElement("div", Ne({}, Af({
    position: s || "absolute",
    left: a,
    right: u,
    top: c
...
var od = function(t) {
  ...
  if (t instanceof RegExp)
    return t;
  var r = n.allowSpaceInQuery, i = wn(t);
  ...
  function n(r) {
    var i;
    return Xc(this, n), i = t.call(this, r), te(ne(i), "setContainerElement", function(o) {
      i.containerElement = o;
    }), te(ne(i), "getInputProps", function() {
      var o = i.props, s = o.readOnly, a = o.disabled, u = o.style, c = Yf(
        i.props,
        ["style", "classNames", "className"],
        // substyle props
        Wf(Ia)
      );
      return je(je(je(je({}, c), u("input")), {}, {
        ...
        "aria-activedescendant": wa(i.uuidSuggestionsOverlay, i.state.focusIndex)
      });
      ...
      return /* @__PURE__ */ ie.createElement("input", Ne({
        type: "text",
        ref: i.setInputRef
      }, o));
    }), te(ne(i), "renderTextarea", function(o) {
      return /* @__PURE__ */ ie.createElement("textarea", Ne({
        ref: i.setInputRef
      }, o));
      ...
      if (!zr(i.state.selectionStart))
        return null;
      var o = i.state.suggestionsPosition, s = o.position, a = o.left, u = o.top, c = o.right, l = /* @__PURE__ */ ie.createElement(nd, {
      ...
      return i.props.suggestionsPortalHost ? /* @__PURE__ */ Vl.createPortal(l, i.props.suggestionsPortalHost) : l;
      ...
      return /* @__PURE__ */ ie.createElement(Xf, {
      ...
      var a = i.props.value || "", u = Je(i.props.children), c = o.target.value, l = i.state.selectionStart;
      ...
      c = mt(d, u);
      var h = o.target.selectionStart, p = o.target.selectionEnd, m = !1, g = Lo(a, u, h);
      ...
      switch (Object.values(xt).indexOf(o.keyCode) >= 0 && (o.preventDefault(), o.stopPropagation()), o.keyCode) {
        case xt.ESC: {
          i.clearSuggestions();
          return;
        }
      ...
      var o = i.state, s = o.suggestions, a = o.focusIndex, u = Object.values(s).reduce(function(f, d) {
        ...
        return [].concat(Nn(f), Nn(h.map(function(m) {
          return {
            result: m,
            queryInfo: p
          };
      ...
      if (!(!o || !i.suggestionsElement)) {
        var l = i.suggestionsElement, f = i.highlighterElement, d = f.getBoundingClientRect(), h = vr(f, "font-size"), p = {
          left: d.left + o.left,
          top: d.top + o.top + h
        ...
        if (l) {
          ...
          if (a) {
            ...
            v -= vr(l, "margin-left"), b -= vr(l, "margin-top"), v -= f.scrollLeft, b -= f.scrollTop;
      ...
      var a = i.props.value || "", u = i.props.children, c = Je(u), l = _e(a, c, s, "NULL");
      if (l !== null) {
        var f = Lf(a.substring(0, l), c), d = o.substring(f, s);
        ie.Children.forEach(u, function(h, p) {
          if (h) {
            var m = od(h.props.trigger, i.props), g = d.match(m);
            if (g) {
      ...
      var l = i.props, f = l.children, d = l.ignoreAccents, h = Ot.toArray(f)[s], p = sd(h.props.data, d), m = p(o, i.updateSuggestions.bind(null, i._queryId, s, o, a, u, c));
      m instanceof Array && i.updateSuggestions(i._queryId, s, o, a, u, c, m);
    }), te(ne(i), "updateSuggestions", function(o, s, a, u, c, l, f) {
      if (o === i._queryId) {
        i.suggestions = je(je({}, i.suggestions), {}, te({}, s, {
          queryInfo: {
            childIndex: s,
            query: a,
        ...
        var d = i.state.focusIndex, h = bn(i.suggestions);
        i.setState({
      ...
      var a = o.id, u = o.display, c = s.childIndex, l = s.querySequenceStart, f = s.querySequenceEnd, d = s.plainTextValue, h = i.props.value || "", p = Je(i.props.children), m = Ot.toArray(i.props.children)[c], g = m.props, v = g.markup, b = g.displayTransform, E = g.appendSpaceOnAdd, x = g.onAdd, T = _e(h, p, l, "START"), D = T + f - l, I = Bf(v, a, u);
      E && (I += " ");
      var S = qt(h, T, D, I);
      ...
      }, X = Wt(S, p), q = qt(d, l, f, j);
      i.executeOnChange(N, S, q, X), x && x(a, u, T, D), i.clearSuggestions();
      ...
      return zr(i.state.selectionStart) && (bn(i.state.suggestions) !== 0 || i.isLoading());
  ...
  return Zc(n, [{
    ...
    key: "render",
    value: function() {
      return /* @__PURE__ */ ie.createElement("div", Ne({
    ...
    value: function(i) {
      if (i.target === this.inputElement && this.supportsClipboardActions(i)) {
        i.preventDefault();
        var o = this.state, s = o.selectionStart, a = o.selectionEnd, u = this.props, c = u.value, l = u.children, f = Je(l), d = _e(c, f, s, "START"), h = _e(c, f, a, "END"), p = i.clipboardData.getData("text/react-mentions"), m = i.clipboardData.getData("text/plain"), g = qt(c, d, h, p || m).replace(/\r/g, ""), v = mt(g, f), b = {
          target: je(je({}, i.target), {}, {
            value: g
          })
        };
        this.executeOnChange(b, g, v, Wt(g, f));
        var E = Lo(c, f, s), x = (E || s) + mt(p || m, f).length;
        this.setState({
          selectionStart: x,
          selectionEnd: x,
    ...
    value: function(i) {
      var o = this.inputElement.selectionStart, s = this.inputElement.selectionEnd, a = this.props, u = a.children, c = a.value, l = Je(u), f = _e(c, l, o, "START"), d = _e(c, l, s, "END");
    ...
    value: function(i) {
      if (i.target === this.inputElement && this.supportsClipboardActions(i)) {
        ...
        var o = this.state, s = o.selectionStart, a = o.selectionEnd, u = this.props, c = u.children, l = u.value, f = Je(c), d = _e(l, f, s, "START"), h = _e(l, f, a, "END"), p = [l.slice(0, d), l.slice(h)].join(""), m = mt(p, f), g = {
          target: je(je({}, i.target), {}, {
            value: m
          })
        };
...
var vr = function(t, n) {
...
}, ad = typeof navigator < "u" && /iPhone|iPad|iPod/i.test(navigator.userAgent), ud = Xn({
  position: "relative",
  overflowY: "visible",
  input: {
    display: "block",
  ...
  var n = t.display, r = t.style, i = t.className, o = t.classNames, s = mi(cd, {
    style: r,
    className: i,
    classNames: o
  });
...
const fd = {
  ...
  const n = xe((a) => a.users), r = Object.values(n).map((a) => ({
    ...a,
    ...
    ld,
    {
      ...
      children: /* @__PURE__ */ B.jsx(
        vi,
        {
          ...
          data: r,
          appendSpaceOnAdd: !0,
          renderSuggestion: (a, u) => /* @__PURE__ */ B.jsx("div", { className: `user ${u ? "focused" : ""}`, children: a.display }),
          onAdd: o
        }
      )
    }
  ...
  const e = xe(
    ...
    (c) => c.shareId
  ), r = Ze(), [i, o] = Se(!1), [s, a] = Se(""), u = async (c) => {
  ...
  return /* @__PURE__ */ B.jsx(si, { className: en.newConversationForm, children: /* @__PURE__ */ B.jsx(ai, { children: /* @__PURE__ */ B.jsxs("form", { onSubmit: u, children: [
...
(function(e, t) {
  (function(n, r) {
    ...
    var n = 1e3, r = 6e4, i = 36e5, o = "millisecond", s = "second", a = "minute", u = "hour", c = "day", l = "week", f = "month", d = "quarter", h = "year", p = "date", m = "Invalid Date", g = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, v = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, b = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(M) {
      var w = ["th", "st", "nd", "rd"], _ = M % 100;
      return "[" + M + (w[(_ - 20) % 10] || w[_] || w[0]) + "]";
    } }, E = function(M, w, _) {
      var O = String(M);
      return !O || O.length >= w ? M : "" + Array(w + 1 - O.length).join(_) + M;
    }, x = { s: E, z: function(M) {
      var w = -M.utcOffset(), _ = Math.abs(w), O = Math.floor(_ / 60), P = _ % 60;
      return (w <= 0 ? "+" : "-") + E(O, 2, "0") + ":" + E(P, 2, "0");
    }, m: function M(w, _) {
      if (w.date() < _.date())
        return -M(_, w);
      var O = 12 * (_.year() - w.year()) + (_.month() - w.month()), P = w.clone().add(O, f), k = _ - P < 0, C = w.clone().add(O + (k ? -1 : 1), f);
      return +(-(O + (_ - P) / (k ? P - C : C - P)) || 0);
    }, a: function(M) {
      return M < 0 ? Math.ceil(M) || 0 : Math.floor(M);
    }, p: function(M) {
      return { M: f, y: h, w: l, d: c, D: p, h: u, m: a, s, ms: o, Q: d }[M] || String(M || "").toLowerCase().replace(/s$/, "");
    }, u: function(M) {
      return M === void 0;
    } }, T = "en", D = {};
    D[T] = b;
    var I = "$isDayjsObject", S = function(M) {
    ...
    N.l = j, N.i = S, N.w = function(M, w) {
      return A(M, { locale: w.$L, utc: w.$u, x: w.$x, $offset: w.$offset });
    };
    var X = function() {
      function M(_) {
        this.$L = j(_.locale, null, !0), this.parse(_), this.$x = this.$x || _.x || {}, this[I] = !0;
      }
      var w = M.prototype;
      return w.parse = function(_) {
        this.$d = function(O) {
          var P = O.date, k = O.utc;
          if (P === null)
          ...
          if (typeof P == "string" && !/Z$/i.test(P)) {
            ...
            if (C) {
              ...
              return k ? new Date(Date.UTC(C[1], R, C[3] || 1, C[4] || 0, C[5] || 0, C[6] || 0, H)) : new Date(C[1], R, C[3] || 1, C[4] || 0, C[5] || 0, C[6] || 0, H);
            }
          }
          return new Date(P);
        }(_), this.init();
        ...
        var P = this, k = !!N.u(O) || O, C = N.p(_), R = function(ee, W) {
          var ce = N.w(P.$u ? Date.UTC(P.$y, W, ee) : new Date(P.$y, W, ee), P);
          return k ? ce : ce.endOf(c);
        }, H = function(ee, W) {
          return N.w(P.toDate()[ee].apply(P.toDate("s"), (k ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(W)), P);
        }, U = this.$W, z = this.$M, Z = this.$D, K = "set" + (this.$u ? "UTC" : "");
        switch (C) {
          case h:
          ...
          case l:
            var G = this.$locale().weekStart || 0, Q = (U < G ? U + 7 : U) - G;
        ...
        var P, k = N.p(_), C = "set" + (this.$u ? "UTC" : ""), R = (P = {}, P[c] = C + "Date", P[p] = C + "Date", P[f] = C + "Month", P[h] = C + "FullYear", P[u] = C + "Hours", P[a] = C + "Minutes", P[s] = C + "Seconds", P[o] = C + "Milliseconds", P)[k], H = k === c ? this.$D + (O - this.$W) : O;
        if (k === f || k === h) {
        ...
        if (C === h)
          return this.set(h, this.$y + _);
        if (C === c)
          return R(1);
        if (C === l)
          return R(7);
        var H = (P = {}, P[a] = r, P[u] = i, P[s] = n, P)[C] || 1, U = this.$d.getTime() + _ * H;
        return N.w(U, this);
        ...
        var k = _ || "YYYY-MM-DDTHH:mm:ssZ", C = N.z(this), R = this.$H, H = this.$m, U = this.$M, z = P.weekdays, Z = P.months, K = P.meridiem, G = function(W, ce, L, ve) {
          return W && (W[ce] || W(O, k)) || L[ce].slice(0, ve);
        }, Q = function(W) {
          return N.s(R % 12 || 12, W, "0");
        }, ee = K || function(W, ce, L) {
          var ve = W < 12 ? "AM" : "PM";
        ...
        var k, C = this, R = N.p(O), H = A(_), U = (H.utcOffset() - this.utcOffset()) * r, z = this - H, Z = function() {
          return N.m(C, H);
        };
        switch (R) {
          case h:
    ...
    return A.prototype = q, [["$ms", o], ["$s", s], ["$m", a], ["$H", u], ["$W", c], ["$M", f], ["$y", h], ["$D", p]].forEach(function(M) {
      q[M[1]] = function(w) {
        return this.$g(w, M[0], M[1]);
      };
    }), A.extend = function(M, w) {
      return M.$i || (M(w, X, A), M.$i = !0), A;
    }, A.locale = j, A.isDayjs = S, A.unix = function(M) {
      return A(1e3 * M);
    }, A.en = D[T], A.Ls = D, A.p = {}, A;
  });
})(Fa);
var md = Fa.exports;
const gd = /* @__PURE__ */ Wn(md), yd = ({ user: e, timestamp: t }) => /* @__PURE__ */ B.jsxs(Nl, { className: "d-flex align-items-center justify-content-between", children: [
  /* @__PURE__ */ B.jsxs("div", { className: "d-flex align-items-center", children: [
  ...
  /* @__PURE__ */ B.jsx("span", { children: gd(t).format("HH:mm, DD MMM YY") })
] }), Na = yd, vd = ({ conversation: e }) => {
  const t = xe((n) => {
    var r;
    return (r = n.users) == null ? void 0 : r[e == null ? void 0 : e.user_id];
  });
  return /* @__PURE__ */ B.jsxs(si, { children: [
    /* @__PURE__ */ B.jsx(Na, { user: t, timestamp: e.timestamp }),
    /* @__PURE__ */ B.jsx(ai, { children: /* @__PURE__ */ B.jsx("p", { children: e.message }) })
  ] });
}, Ed = vd, bd = ({ conversationGroupId: e }) => {
  const t = xe(
    (u) => u.shareId
  ), [n, r] = Se(""), [i, o] = Se(!1), s = Ze(), a = async (u) => {
  ...
  return /* @__PURE__ */ B.jsx("div", { className: en.replyForm, children: /* @__PURE__ */ B.jsxs("form", { onSubmit: a, className: "", children: [
...
}, Sd = bd, Td = ({ conversationGroup: e }) => {
  var u;
  const t = xe((c) => {
    var l;
    return (l = c.users) == null ? void 0 : l[e == null ? void 0 : e.owner];
  }), n = Ze(), [r, i] = Se(!1);
  if (!((u = e == null ? void 0 : e.conversations) != null && u.length) || (e == null ? void 0 : e.status) !== "Pending")
    return null;
  const o = () => {
    n(
      Mc(e.conversation_group_id)
    );
  }, [s, ...a] = e.conversations;
  return /* @__PURE__ */ B.jsxs(si, { className: en.conversationGroup, onClick: o, children: [
    /* @__PURE__ */ B.jsx(Na, { user: t, timestamp: s.timestamp }),
    /* @__PURE__ */ B.jsxs(ai, { children: [
      /* @__PURE__ */ B.jsx("p", { children: s.message }),
      a.length ? /* @__PURE__ */ B.jsxs(B.Fragment, { children: [
        /* @__PURE__ */ B.jsx(
          jt,
          {
            onClick: () => i((c) => !c),
            color: "link",
            children: a.length > 1 ? `${a.length} replies` : `${a.length} reply`
          }
        ),
        r ? /* @__PURE__ */ B.jsx(B.Fragment, { children: a.map((c) => /* @__PURE__ */ B.jsx(Ed, { conversation: c }, c.conversation_id)) }) : null
      ] }) : null,
      /* @__PURE__ */ B.jsx(
        Sd,
        {
  ...
  const e = xe(
    ...
    (o) => Object.keys(o.conversations || {})
  ), [r, i] = Se(!1);
  return Ve(() => {
    r || !e || Object.keys(n).length || (i(!0), zc(e).then((o) => {
      console.log("useConversations", o), t(hi(o == null ? void 0 : o.dbt_docs_share_conversations));
    }).catch(
      (o) => console.error("error while fetching conversations list", o)
    ).finally(() => {
      i(!1);
    }));
  }, [t, r, n, e]), { isLoading: r };
}, Ad = () => {
  const { isLoading: e } = xd(), t = xe(
    (n) => n.conversations
  );
  return e ? /* @__PURE__ */ B.jsx("div", { children: "Loading..." }) : !t || !Object.keys(t).length ? /* @__PURE__ */ B.jsx("div", { children: "No conversations yet!" }) : /* @__PURE__ */ B.jsx("div", { children: Object.values(t).map((n) => /* @__PURE__ */ B.jsx(
    Cd,
    {
      conversationGroup: n
    },
  ...
  const e = xe((o) => o.isRightPanelOpen), t = xe((o) => o.newConversation), n = Ze(), r = () => {
    n(di(!1)), n(pa());
  };
  return !!t || e ? /* @__PURE__ */ B.jsxs(B.Fragment, { children: [
    /* @__PURE__ */ B.jsx(
      jl,
      {
        onClick: r,
    ...
    /* @__PURE__ */ B.jsxs("div", { className: en.conversationRightPanel, children: [
...
}, Rd = () => (Dd(), /* @__PURE__ */ B.jsx("div", { children: /* @__PURE__ */ B.jsx(Pd, {}) })), Od = Rd, Zn = at({
  ...
  return /* @__PURE__ */ B.jsxs(Zn.Provider, { value: a, children: [
    /* @__PURE__ */ B.jsx(Od, {}),
    e
  ] });
}, Md = Id, Fd = () => ge(Zn), xe = (e) => {
  ...
  isStatic: !1,
  reducedMotion: "never"
}), Jn = at({}), Qn = at(null), bi = typeof document < "u", Si = bi ? Dl : Ve, ja = at({ strict: !1 }), Ti = (e) => e.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(), Nd = "framerAppearId", Va = "data-" + Ti(Nd), jd = {
  skipAnimations: !1,
  useManualTiming: !1
};
class Uo {
...
function Vd(e) {
  let t = new Uo(), n = new Uo(), r = 0, i = !1, o = !1;
...
function La(e, t) {
  ...
  const i = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, o = Tn.reduce((f, d) => (f[d] = Vd(() => n = !0), f), {}), s = (f) => {
    o[f].process(i);
  }, a = () => {
    const f = performance.now();
    n = !1, i.delta = r ? 1e3 / 60 : Math.max(Math.min(f - i.timestamp, Ld), 1), i.timestamp = f, i.isProcessing = !0, Tn.forEach(s), i.isProcessing = !1, n && t && (r = !1, e(a));
  }, u = () => {
    n = !0, r = !0, i.isProcessing || e(a);
  };
  return { schedule: Tn.reduce((f, d) => {
    const h = o[d];
    return f[d] = (p, m = !1, g = !1) => (n || u(), h.schedule(p, m, g)), f;
  }, {}), cancel: (f) => Tn.forEach((d) => o[d].cancel(f)), state: i, steps: o };
}
const { schedule: Ci, cancel: wy } = La(queueMicrotask, !1);
function kd(e, t, n, r) {
  const { visualElement: i } = ge(Jn), o = ge(ja), s = ge(Qn), a = ge(Ei).reducedMotion, u = ke();
  ...
  return Si(() => {
    c && (Ci.postRender(c.render), l.current && c.animationState && c.animationState.animateChanges());
  }), Ve(() => {
...
function $d(e, t, n) {
  return $e(
    (r) => {
      r && e.mount && e.mount(r), t && (r ? t.mount(r) : t.unmount()), n && (typeof n == "function" ? n(r) : At(n) && (n.current = r));
    },
    /**
...
const _i = at({}), $a = at({}), zd = Symbol.for("motionComponentSymbol");
function Wd({ preloadedFeatures: e, createVisualElement: t, useRender: n, useVisualState: r, Component: i }) {
  e && Ud(e);
  function o(a, u) {
    let c;
    const l = {
      ...
      ...a,
      layoutId: Yd(a)
    }, { isStatic: f } = l, d = Hd(a), h = r(a, f);
    if (!f && bi) {
      d.visualElement = kd(i, h, l, t);
      const p = ge($a), m = ge(ja).strict;
...
function Ba(e, { layout: t, layoutId: n }) {
  return Et.has(e) || e.startsWith("origin") || (t || n !== void 0) && (!!Ln[e] || e === "opacity");
}
const Ce = (e) => !!(e && e.getVelocity), Xd = {
  x: "translateX",
  y: "translateY",
  z: "translateZ",
  transformPerspective: "perspective"
}, Zd = cn.length;
function Jd(e, { enableHardwareAcceleration: t = !0, allowTransformNone: n = !0 }, r, i) {
  let o = "";
  for (let s = 0; s < Zd; s++) {
    const a = cn[s];
    if (e[a] !== void 0) {
...
const Ha = (e) => (t) => typeof t == "string" && t.startsWith(e), Ua = Ha("--"), Qd = Ha("var(--"), Pi = (e) => Qd(e) ? eh.test(e.split("/*")[0].trim()) : !1, eh = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu, th = (e, t) => t && typeof e == "number" ? t.transform(e) : e, it = (e, t, n) => n > t ? t : n < e ? e : n, Lt = {
  ...
  ...Lt,
  default: 1
}, Gt = (e) => Math.round(e * 1e5) / 1e5, Di = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu, nh = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu, rh = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu;
function fn(e) {
...
const dn = (e) => ({
  ...
  parse: parseFloat,
  transform: (t) => `${t}${e}`
}), Qe = dn("deg"), Be = dn("%"), Y = dn("px"), ih = dn("vh"), oh = dn("vw"), Yo = {
  ...Be,
...
function Ri(e, t, n, r) {
  ...
  if (t.transform || (u || r ? i.transform = Jd(e.transform, n, l, r) : i.transform && (i.transform = "none")), c) {
...
function Wa(e, t, n) {
  for (const r in t)
    !Ce(t[r]) && !Ba(r, n) && (e[r] = t[r]);
}
function sh({ transformTemplate: e }, t, n) {
  return nt(() => {
    const r = Oi();
    return Ri(r, t, { enableHardwareAcceleration: !n }, e), Object.assign({}, r.vars, r.style);
  }, [t]);
}
function ah(e, t, n) {
  const r = e.style || {}, i = {};
...
function kn(e) {
  return e.startsWith("while") || e.startsWith("drag") && e !== "draggable" || e.startsWith("layout") || e.startsWith("onTap") || e.startsWith("onPan") || e.startsWith("onLayout") || lh.has(e);
}
let Ya = (e) => !kn(e);
function ch(e) {
...
function fh(e, t, n) {
  const r = {};
  for (const i in e)
    i === "values" && typeof e.values == "object" || (Ya(i) || n === !0 && kn(i) || !t && !kn(i) || // If trying to use native HTML drag events, forward drag listeners
...
function dh(e, t, n) {
  const r = Ko(t, e.x, e.width), i = Ko(n, e.y, e.height);
  return `${r} ${i}`;
}
const hh = {
...
function Ii(e, {
  ...
  h.transform && (m && (p.transform = h.transform), delete h.transform), m && (i !== void 0 || o !== void 0 || p.transform) && (p.transformOrigin = dh(m, i !== void 0 ? i : 0.5, o !== void 0 ? o : 0.5)), t !== void 0 && (h.x = t), n !== void 0 && (h.y = n), r !== void 0 && (h.scale = r), s !== void 0 && mh(h, s, a, u, !1);
}
const qa = () => ({
  ...Oi(),
  attrs: {}
...
function gh(e, t, n, r) {
  const i = nt(() => {
    const o = qa();
    return Ii(o, t, { enableHardwareAcceleration: !1 }, Mi(r), e.transformTemplate), {
      ...o.attrs,
      style: { ...o.style }
    };
  }, [t]);
...
function yh(e = !1) {
  return (n, r, i, { latestValues: o }, s) => {
    const u = (wi(n) ? gh : uh)(r, o, s, n), c = fh(r, typeof n == "string", e), l = n !== Rl ? { ...c, ...u, ref: i } : {}, { children: f } = r, d = nt(() => Ce(f) ? f.get() : f, [f]);
    return Ol(n, {
      ...l,
      children: d
    });
...
function Xa(e, t, n, r) {
  ...
  for (const i in t.attrs)
    e.setAttribute(Ga.has(i) ? i : Ti(i), t.attrs[i]);
}
function Fi(e, t) {
  const { style: n } = e, r = {};
  for (const i in n)
...
const Wr = (e) => Array.isArray(e), vh = (e) => !!(e && typeof e == "object" && e.mix && e.toValue), Eh = (e) => Wr(e) ? e[e.length - 1] || 0 : e;
function Pn(e) {
  const t = Ce(e) ? e.get() : e;
  return vh(t) ? t.toValue() : t;
}
function bh({ scrapeMotionValuesFromProps: e, createRenderState: t, onMount: n }, r, i, o) {
  const s = {
...
const Qa = (e) => (t, n) => {
  const r = ge(Jn), i = ge(Qn), o = () => bh(e, t, r, i);
  return n ? o() : Ja(o);
};
function Sh(e, t, n, r) {
  const i = {}, o = r(e, {});
...
const be = (e) => e, { schedule: ye, cancel: ot, state: Ee, steps: Er } = La(typeof requestAnimationFrame < "u" ? requestAnimationFrame : be, !0), Th = {
  useVisualState: Qa({
    ...
    onMount: (e, t, { renderState: n, latestValues: r }) => {
      ye.read(() => {
        ...
        Ii(n, r, { enableHardwareAcceleration: !1 }, Mi(t.tagName), e.transformTemplate), Xa(t, n);
      });
    }
  })
}, Ch = {
...
const eu = (e) => e.pointerType === "mouse" ? typeof e.button != "number" || e.button <= 0 : e.isPrimary !== !1;
...
const _h = (e, t) => (n) => t(e(n)), qe = (...e) => e.reduce(_h);
function tu(e) {
  let t = null;
  return () => {
    const n = () => {
...
const Go = tu("dragHorizontal"), Xo = tu("dragVertical");
function nu(e) {
  let t = !1;
  if (e === "y")
    t = Xo();
...
class Ph extends ut {
  ...
  mount() {
    this.unmount = qe(We(this.node.current, "focus", () => this.onFocus()), We(this.node.current, "blur", () => this.onBlur()));
  }
  unmount() {
  }
}
...
class Dh extends ut {
  constructor() {
    super(...arguments), this.removeStartListeners = be, this.removeEndListeners = be, this.removeAccessibleListeners = be, this.startPointerPress = (t, n) => {
      if (this.isPressing)
        return;
      this.removeEndListeners();
      const r = this.node.getProps(), o = Ye(window, "pointerup", (a, u) => {
        if (!this.checkPressEnd())
          return;
        const { onTap: c, onTapCancel: l, globalTapTarget: f } = this.node.getProps();
        !f && !iu(this.node.current, a.target) ? l && l(a, u) : c && c(a, u);
      }, { passive: !(r.onTap || r.onPointerUp) }), s = Ye(window, "pointercancel", (a, u) => this.cancelPress(a, u), { passive: !(r.onTapCancel || r.onPointerCancel) });
      ...
      const t = (o) => {
        if (o.key !== "Enter" || this.isPressing)
          return;
        const s = (a) => {
          a.key !== "Enter" || !this.checkPressEnd() || br("up", (u, c) => {
            const { onTap: l } = this.node.getProps();
            l && l(u, c);
          });
        };
        this.removeEndListeners(), this.removeEndListeners = We(this.node.current, "keyup", s), br("down", (a, u) => {
          this.startPress(a, u);
        });
  ...
  checkPressEnd() {
    return this.removeEndListeners(), this.isPressing = !1, this.node.getProps().whileTap && this.node.animationState && this.node.animationState.setActive("whileTap", !1), !ru();
  }
  cancelPress(t, n) {
    if (!this.checkPressEnd())
      return;
  ...
  mount() {
    const t = this.node.getProps(), n = Ye(t.globalTapTarget ? window : this.node.current, "pointerdown", this.startPointerPress, { passive: !(t.onTapStart || t.onPointerStart) }), r = We(this.node.current, "focus", this.startAccessiblePress);
...
const Yr = /* @__PURE__ */ new WeakMap(), Sr = /* @__PURE__ */ new WeakMap(), Rh = (e) => {
...
function Ih({ root: e, ...t }) {
  const n = e || document;
  Sr.has(n) || Sr.set(n, {});
  const r = Sr.get(n), i = JSON.stringify(t);
  return r[i] || (r[i] = new IntersectionObserver(Oh, { root: e, ...t })), r[i];
}
function Mh(e, t, n) {
  const r = Ih(t);
  return Yr.set(e, n), r.observe(e), () => {
...
const Ke = (e) => e * 1e3, Ge = (e) => e / 1e3, $h = {
  ...
  duration: 0.3
}, zh = (e, { keyframes: t }) => t.length > 2 ? Hh : Et.has(e) ? e.startsWith("scale") ? Bh(t[1]) : $h : Uh;
function Wh({ when: e, delay: t, delayChildren: n, staggerChildren: r, staggerDirection: i, repeat: o, repeatType: s, repeatDelay: a, from: u, elapsed: c, ...l }) {
...
function ir(e, { repeat: t, repeatType: n = "loop" }, r) {
  const i = e.filter(Yh), o = t && n !== "loop" && t % 2 === 1 ? 0 : i.length - 1;
...
const tt = {
  now: () => (Dn === void 0 && tt.set(Ee.isProcessing || jd.useManualTiming ? Ee.timestamp : performance.now()), Dn),
  set: (e) => {
    Dn = e, queueMicrotask(qh);
  }
}, su = (e) => /^0[^.\s]+$/u.test(e);
function Kh(e) {
  return typeof e == "number" ? e === 0 : e !== null ? e === "none" || e === "0" || su(e) : !0;
}
let hn = be, He = be;
...
const Zh = 4;
function uu(e, t, n = 1) {
  He(n <= Zh, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`);
  const [r, i] = Xh(e);
  if (!r)
    return;
...
const Jh = /* @__PURE__ */ new Set([
  ...
  "translateX",
  "translateY"
]), Jo = (e) => e === Lt || e === Y, Qo = (e, t) => parseFloat(e.split(", ")[t]), es = (e, t) => (n, { transform: r }) => {
  if (r === "none" || !r)
    return 0;
...
}, Qh = /* @__PURE__ */ new Set(["x", "y", "z"]), ep = cn.filter((e) => !Qh.has(e));
function ts(e) {
  const t = [];
  return ep.forEach((n) => {
...
Nt.translateX = Nt.x;
Nt.translateY = Nt.y;
const lu = (e) => (t) => t.test(e), tp = {
  test: (e) => e === "auto",
  parse: (e) => e
}, cu = [Lt, Y, Be, Qe, oh, ih, tp], ns = (e) => cu.find(lu(e)), yt = /* @__PURE__ */ new Set();
let qr = !1, Kr = !1;
function fu() {
  if (Kr) {
...
class Vi {
  ...
  scheduleResolve() {
    this.isScheduled = !0, this.isAsync ? (yt.add(this), qr || (qr = !0, ye.read(du), ye.resolveKeyframes(fu))) : (this.readKeyframes(), this.complete());
  }
  readKeyframes() {
...
const Li = (e, t) => (n) => !!(fn(n) && rh.test(n) && n.startsWith(e) || t && Object.prototype.hasOwnProperty.call(n, t)), hu = (e, t, n) => (r) => {
  if (!fn(r))
    return r;
  ...
  transform: ({ red: e, green: t, blue: n, alpha: r = 1 }) => "rgba(" + Tr.transform(e) + ", " + Tr.transform(t) + ", " + Tr.transform(n) + ", " + Gt(Kt.transform(r)) + ")"
};
function ip(e) {
  let t = "", n = "", r = "", i = "";
...
const Gr = {
  ...
  transform: ({ hue: e, saturation: t, lightness: n, alpha: r = 1 }) => "hsla(" + Math.round(e) + ", " + Be.transform(Gt(t)) + ", " + Be.transform(Gt(n)) + ", " + Gt(Kt.transform(r)) + ")"
}, Te = {
  test: (e) => gt.test(e) || Gr.test(e) || _t.test(e),
  parse: (e) => gt.test(e) ? gt.parse(e) : _t.test(e) ? _t.parse(e) : Gr.parse(e),
  transform: (e) => fn(e) ? e : e.hasOwnProperty("red") ? gt.transform(e) : _t.transform(e)
};
function op(e) {
  var t, n;
  return isNaN(e) && fn(e) && (((t = e.match(Di)) === null || t === void 0 ? void 0 : t.length) || 0) + (((n = e.match(nh)) === null || n === void 0 ? void 0 : n.length) || 0) > 0;
}
const pu = "number", mu = "color", sp = "var", ap = "var(", rs = "${}", up = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function $n(e) {
  ...
  let o = 0;
  const a = t.replace(up, (u) => (Te.test(u) ? (r.color.push(o), i.push(mu), n.push(Te.parse(u))) : u.startsWith(ap) ? (r.var.push(o), i.push(sp), n.push(u)) : (r.number.push(o), i.push(pu), n.push(parseFloat(u))), ++o, rs)).split(rs);
...
function yu(e) {
  ...
  return (i) => {
    ...
    for (let s = 0; s < r; s++)
      if (o += t[s], i[s] !== void 0) {
        const a = n[s];
        a === pu ? o += Gt(i[s]) : a === mu ? o += Te.transform(i[s]) : o += i[s];
      }
    return o;
  };
}
...
function vu(e, t) {
  let n = ki(e);
  return n !== Xr && (n = st), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0;
}
function mp(e, t, n) {
  let r = 0, i;
  for (; r < e.length && !i; )
...
class Eu extends Vi {
  ...
  readKeyframes() {
    ...
    if (!Jh.has(r) || t.length !== 2)
      return this.resolveNoneKeyframes();
    const [i, o] = t, s = ns(i), a = ns(o);
    if (s !== a)
      if (Jo(s) && Jo(a))
        for (let u = 0; u < t.length; u++) {
          const c = t[u];
  ...
  measureEndState() {
    ...
    i[s] = Nt[r](n.measureViewportBox(), window.getComputedStyle(n.current)), a !== null && (this.finalKeyframe = a), !((t = this.removedTransforms) === null || t === void 0) && t.length && this.removedTransforms.forEach(([u, c]) => {
      n.getValue(u).set(c);
...
function vp(e, t, n, r) {
  ...
  if (i === null)
    return !1;
  const o = e[e.length - 1], s = is(i, t), a = is(o, t);
  return hn(s === a, `You are trying to animate ${t} from "${i}" to "${o}". ${i} is not an animatable value - to enable this animation set ${i} to a value animatable to ${o} via the \`style\` property.`), !s || !a ? !1 : yp(e) || n === "spring" && r;
}
class bu {
...
const Cr = 1e-3, bp = 0.01, os = 10, Sp = 0.05, Tp = 1;
function Cp({ duration: e = 800, bounce: t = 0.25, velocity: n = 0, mass: r = 1 }) {
  let i, o;
  hn(e <= Ke(os), "Spring duration must be 10 seconds or less");
  let s = 1 - t;
  s = it(Sp, Tp, s), e = it(bp, os, Ge(e)), s < 1 ? (i = (c) => {
    const l = c * s, f = l * e, d = l - n, h = Zr(c, s), p = Math.exp(-f);
    return Cr - d / h * p;
  }, o = (c) => {
    const f = c * s * e, d = f * n + n, h = Math.pow(s, 2) * Math.pow(c, 2) * e, p = Math.exp(-f), m = Zr(Math.pow(c, 2), s);
...
const _p = ["duration", "bounce"], wp = ["stiffness", "damping", "mass"];
function ss(e, t) {
...
function Cu({ keyframes: e, restDelta: t, restSpeed: n, ...r }) {
  const i = e[0], o = e[e.length - 1], s = { done: !1, value: i }, { stiffness: a, damping: u, mass: c, duration: l, velocity: f, isResolvedFromDuration: d } = Pp({
    ...r,
    velocity: -Ge(r.velocity || 0)
  }), h = f || 0, p = u / (2 * Math.sqrt(a * c)), m = o - i, g = Ge(Math.sqrt(a / c)), v = Math.abs(m) < 5;
  ...
  return {
    ...
    next: (E) => {
      ...
      if (d)
        ...
        const D = Math.abs(T) <= n, I = Math.abs(o - x) <= t;
        s.done = D && I;
      }
...
function as({ keyframes: e, velocity: t = 0, power: n = 0.8, timeConstant: r = 325, bounceDamping: i = 10, bounceStiffness: o = 500, modifyTarget: s, min: a, max: u, restDelta: c = 0.5, restSpeed: l }) {
  const f = e[0], d = {
    done: !1,
    value: f
  ...
  return I(0), {
    ...
    next: (S) => {
      let j = !1;
      return !D && T === void 0 && (j = !0, x(S), I(S)), T !== void 0 && S >= T ? D.next(S - T) : (!j && x(S), d);
    }
  };
}
const xu = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e, Dp = 1e-7, Rp = 12;
function Op(e, t, n, r, i) {
  let o, s, a = 0;
  do
    s = t + (n - t) / 2, o = xu(s, r, i) - e, o > 0 ? n = s : t = s;
...
const Ip = pn(0.42, 0, 1, 1), Mp = pn(0, 0, 0.58, 1), Au = pn(0.42, 0, 0.58, 1), Fp = (e) => Array.isArray(e) && typeof e[0] != "number", _u = (e) => (t) => t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2, wu = (e) => (t) => 1 - e(1 - t), $i = (e) => 1 - Math.sin(Math.acos(e)), Pu = wu($i), Np = _u($i), Du = pn(0.33, 1.53, 0.69, 0.99), Bi = wu(Du), jp = _u(Bi), Vp = (e) => (e *= 2) < 1 ? 0.5 * Bi(e) : 0.5 * (2 - Math.pow(2, -10 * (e - 1))), us = {
  linear: be,
  easeIn: Ip,
  easeInOut: Au,
  easeOut: Mp,
...
}, kp = [Gr, gt, _t], $p = (e) => kp.find((t) => t.test(e));
function cs(e) {
  const t = $p(e);
...
const fs = (e, t) => {
  const n = cs(e), r = cs(t), i = { ...n };
  return (o) => (i.red = Ar(n.red, r.red, o), i.green = Ar(n.green, r.green, o), i.blue = Ar(n.blue, r.blue, o), i.alpha = fe(n.alpha, r.alpha, o), gt.transform(i));
};
function Jr(e, t) {
  return (n) => n > 0 ? t : e;
}
...
function Hi(e) {
  return typeof e == "number" ? Bp : typeof e == "string" ? Pi(e) ? Jr : Te.test(e) ? fs : zp : Array.isArray(e) ? Ru : typeof e == "object" ? Te.test(e) ? fs : Hp : Jr;
}
function Ru(e, t) {
  const n = [...e], r = n.length, i = e.map((o, s) => Hi(o)(o, t[s]));
  return (o) => {
    for (let s = 0; s < r; s++)
      n[s] = i[s](o);
    return n;
...
const zp = (e, t) => {
  const n = st.createTransformer(t), r = $n(e), i = $n(t);
  return r.indexes.var.length === i.indexes.var.length && r.indexes.color.length === i.indexes.color.length && r.indexes.number.length >= i.indexes.number.length ? qe(Ru(Up(r, i), i.values), n) : (hn(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`), Jr(e, t));
};
function Ou(e, t, n) {
  return typeof e == "number" && typeof t == "number" && typeof n == "number" ? fe(e, t, n) : Hi(e)(e, t);
}
function Wp(e, t, n) {
  const r = [], i = n || Ou, o = e.length - 1;
  for (let s = 0; s < o; s++) {
    let a = i(e[s], e[s + 1]);
    if (t) {
...
function Yp(e, t, { clamp: n = !0, ease: r, mixer: i } = {}) {
  const o = e.length;
  if (He(o === t.length, "Both input and output ranges must be the same length"), o === 1)
    return () => t[0];
  if (o === 2 && e[0] === e[1])
    return () => t[1];
  e[0] > e[o - 1] && (e = [...e].reverse(), t = [...t].reverse());
  const s = Wp(t, r, i), a = s.length, u = (c) => {
    let l = 0;
    if (a > 1)
...
class Ui extends bu {
  ...
  initPlayback(t) {
    const { type: n = "keyframes", repeat: r = 0, repeatDelay: i = 0, repeatType: o, velocity: s = 0 } = this.options, a = Qp[n] || Bn;
    let u, c;
    a !== Bn && typeof t[0] != "number" && (process.env.NODE_ENV !== "production" && He(t.length === 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${t}`), u = qe(em, Ou(t[0], t[1])), t = [0, 100]);
  ...
  tick(t, n = !1) {
    ...
    if (h) {
      ...
      let j = Math.floor(S), A = S % 1;
      !A && S >= 1 && (A = 1), A === 1 && j--, j = Math.min(j, h + 1), !!(j % 2) && (p === "reverse" ? (A = 1 - A, m && (A -= m / f)) : p === "mirror" && (x = s)), E = it(0, 1, A) * f;
    }
    const T = b ? { done: !1, value: u[0] } : x.next(E);
    a && (T.value = a(T.value));
    let { done: D } = T;
    !b && c !== null && (D = this.speed >= 0 ? this.currentTime >= l : this.currentTime <= 0);
    const I = this.holdTime === null && (this.state === "finished" || this.state === "running" && D);
    return I && i !== void 0 && (T.value = ir(u, this.options, i)), g && g(T.value), I && this.finish(), T;
  }
  get duration() {
  ...
  set time(t) {
    t = Ke(t), this.currentTime = t, this.holdTime !== null || this.speed === 0 ? this.holdTime = t : this.driver && (this.startTime = this.driver.now() - t / this.speed);
  }
  get speed() {
...
function Mu(e) {
  return !!(!e || typeof e == "string" && Fu[e] || Iu(e) || Array.isArray(e) && e.every(Mu));
}
const Yt = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`, Fu = {
  linear: "linear",
  ease: "ease",
  easeIn: "ease-in",
  easeOut: "ease-out",
...
function Nu(e) {
  if (e)
    return Iu(e) ? Yt(e) : Array.isArray(e) ? e.map(Nu) : Fu[e];
}
function tm(e, t, n, { delay: r = 0, duration: i = 300, repeat: o = 0, repeatType: s = "loop", ease: a, times: u } = {}) {
  const c = { [t]: n };
  u && (c.offset = u);
  const l = Nu(a);
...
const nm = gp(() => Object.hasOwnProperty.call(Element.prototype, "animate")), rm = /* @__PURE__ */ new Set([
  "opacity",
  "clipPath",
  "filter",
  "transform"
...
function sm(e, t) {
  ...
  let o = 0;
  for (; !r.done && o < im; )
    r = n.sample(o), i.push(r.value), o += Hn;
  return {
    times: void 0,
    keyframes: i,
    duration: o - Hn,
...
class hs extends bu {
  constructor(t) {
    ...
    this.resolver = new Eu(i, (o, s) => this.onKeyframesResolved(o, s), n, r), this.resolver.scheduleResolve();
  }
  initPlayback(t, n) {
    var r;
    ...
    if (!(!((r = u.owner) === null || r === void 0) && r.current))
      return !1;
    if (om(this.options)) {
      const { onComplete: f, onUpdate: d, motionValue: h, ...p } = this.options, m = sm(t, p);
      t = m.keyframes, t.length === 1 && (t[1] = t[0]), i = m.duration, o = m.times, s = m.ease, a = "keyframes";
    }
    const l = tm(u.owner.current, c, t, { ...this.options, duration: i, times: o, ease: s });
    return l.startTime = tt.now(), this.pendingTimeline ? (l.timeline = this.pendingTimeline, this.pendingTimeline = void 0) : l.onfinish = () => {
  ...
  stop() {
    ...
    if (!(n.playState === "idle" || n.playState === "finished")) {
      if (this.time) {
        const { motionValue: u, onUpdate: c, onComplete: l, ...f } = this.options, d = new Ui({
          ...f,
          keyframes: r,
          duration: i,
          type: o,
  ...
  static supports(t) {
    ...
    return nm() && r && rm.has(r) && n && n.owner && n.owner.current instanceof HTMLElement && /**
...
const zi = (e, t, n, r = {}, i, o) => (s) => {
  const a = ji(r, e) || {}, u = a.delay || r.delay || 0;
  let { elapsed: c = 0 } = r;
  c = c - Ke(u);
  let l = {
  ...
  Wh(a) || (l = {
    ...l,
    ...zh(e, l)
  }), l.duration && (l.duration = Ke(l.duration)), l.repeatDelay && (l.repeatDelay = Ke(l.repeatDelay)), l.from !== void 0 && (l.keyframes[0] = l.from);
  let f = !1;
...
const ms = 30, am = (e) => !isNaN(parseFloat(e));
class um {
  /**
  ...
  constructor(t, n = {}) {
    ...
    }, this.hasAnimated = !1, this.setCurrent(t), this.canTrackVelocity = am(this.current), this.owner = n.owner;
  }
  setCurrent(t) {
   ...
   */
  onChange(t) {
    return process.env.NODE_ENV !== "production" && Ki(!1, 'value.onChange(callback) is deprecated. Switch to value.on("change", callback).'), this.on("change", t);
  }
  on(t, n) {
...
function ju(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (const d in u) {
    ...
    h.start(zi(d, h, p, e.shouldReduceMotion && Et.has(d) ? { type: !1 } : m, e, g));
    const v = h.animation;
...
function Qr(e, t, n = {}) {
  ...
  const s = i ? () => Promise.all(ju(e, i, n)) : () => Promise.resolve(), a = e.variantChildren && e.variantChildren.size ? (c = 0) => {
...
function dm(e, t, n = 0, r = 0, i = 1, o) {
  ...
  return Array.from(e.variantChildren).sort(hm).forEach((c, l) => {
    c.notify("AnimationStart", t), s.push(Qr(c, t, {
      ...o,
      delay: n + u(l)
...
const mm = [...xi].reverse(), gm = xi.length;
function ym(e) {
  return (t) => Promise.all(t.map(({ animation: n, options: r }) => pm(e, n, r)));
}
function vm(e) {
  let t = ym(e);
  const n = bm();
  ...
  function s(u) {
    ...
    let h = {}, p = 1 / 0;
    for (let g = 0; g < gm; g++) {
      const v = mm[g], b = n[v], E = c[v] !== void 0 ? c[v] : l[v], x = rn(E), T = v === u ? b.isActive : null;
      T === !1 && (p = g);
      let D = E === l[v] && E !== c[v] && x;
      ...
      er(E) || typeof E == "boolean")
        continue;
      let S = Em(b.prevProp, E) || // If we're making this variant active, we want to always make it active
      v === u && b.isActive && !D && x || // If we removed a higher-priority variant (i is in reverse order)
      g > p && x, j = !1;
      const A = Array.isArray(E) ? E : [E];
      let N = A.reduce(i(v), {});
      T === !1 && (N = {});
      const { prevResolvedValues: X = {} } = b, q = {
        ...X,
        ...N
      }, M = (w) => {
      ...
      for (const w in q) {
        ...
        if (h.hasOwnProperty(w))
          continue;
        let P = !1;
        Wr(_) && Wr(O) ? P = !ou(_, O) : P = _ !== O, P ? _ != null ? M(w) : d.add(w) : _ !== void 0 && d.has(w) ? M(w) : b.protectedKeys[w] = !0;
      }
      b.prevProp = E, b.prevResolvedValues = N, b.isActive && (h = { ...h, ...N }), r && e.blockInitialAnimation && (S = !1), S && (!D || j) && f.push(...A.map((w) => ({
        animation: w,
        options: { type: v }
      })));
    }
...
function Am(e, t) {
  const n = gs(e.x, t.x), r = gs(e.y, t.y);
  ...
  constructor(t, n, { transformPagePoint: r, contextWindow: i, dragSnapToOrigin: o = !1 } = {}) {
    if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
      if (!(this.lastMoveEvent && this.lastMoveEventInfo))
        return;
      const f = wr(this.lastMoveEventInfo, this.history), d = this.startEvent !== null, h = Am(f.offset, { x: 0, y: 0 }) >= 3;
      if (!d && !h)
        return;
      const { point: p } = f, { timestamp: m } = Ee;
      ...
      this.lastMoveEvent = f, this.lastMoveEventInfo = _r(d, this.transformPagePoint), ye.update(this.updatePoint, !0);
    }, this.handlePointerUp = (f, d) => {
      this.end();
      const { onEnd: h, onSessionEnd: p, resumeAnimation: m } = this.handlers;
      if (this.dragSnapToOrigin && m && m(), !(this.lastMoveEvent && this.lastMoveEventInfo))
        return;
      const g = wr(f.type === "pointercancel" ? this.lastMoveEventInfo : _r(d, this.transformPagePoint), this.history);
      this.startEvent && h && h(f, g), p && p(f, g);
    }, !eu(t))
      return;
    this.dragSnapToOrigin = o, this.handlers = n, this.transformPagePoint = r, this.contextWindow = i || window;
    const s = nr(t), a = _r(s, this.transformPagePoint), { point: u } = a, { timestamp: c } = Ee;
    this.history = [{ ...u, timestamp: c }];
    const { onSessionStart: l } = n;
    l && l(t, wr(a, this.history)), this.removeListeners = qe(Ye(this.contextWindow, "pointermove", this.handlePointerMove), Ye(this.contextWindow, "pointerup", this.handlePointerUp), Ye(this.contextWindow, "pointercancel", this.handlePointerUp));
  }
  updateHandlers(t) {
    this.handlers = t;
  }
...
function wm(e, t) {
  ...
  const i = Lu(e);
  for (; n >= 0 && (r = e[n], !(i.timestamp - r.timestamp > Ke(t))); )
    n--;
  if (!r)
    return { x: 0, y: 0 };
...
function vs(e, t, n, r = 0.5) {
  e.origin = r, e.originPoint = fe(t.min, t.max, e.origin), e.scale = Oe(n) / Oe(t), (ei(e.scale, 1, 1e-4) || isNaN(e.scale)) && (e.scale = 1), e.translate = fe(n.min, n.max, e.origin) - e.originPoint, (ei(e.translate) || isNaN(e.translate)) && (e.translate = 0);
}
function Xt(e, t, n, r) {
...
function Im(e, t) {
  let n = 0.5;
  const r = Oe(e), i = Oe(t);
  return i > r ? n = sn(t.min, t.max - r, e.min) : r > i && (n = sn(e.min, e.max - i, t.min)), it(0, 1, n);
}
function Mm(e, t) {
  const n = {};
...
function dt(e) {
  return ni(e) || $u(e) || e.z || e.rotate || e.rotateX || e.rotateY || e.skewX || e.skewY;
}
function $u(e) {
...
function Vm(e, t, n, r = !1) {
  ...
  for (let a = 0; a < i; a++) {
    ...
    const u = o.instance;
    u && u.style && u.style.display === "contents" || (r && o.options.layoutScroll && o.scroll && o !== o.root && Pt(e, {
      x: -o.scroll.offset.x,
      y: -o.scroll.offset.y
    }), s && (t.x *= s.x.scale, t.y *= s.y.scale, Bu(e, s)), r && dt(o.latestValues) && Pt(e, o.latestValues));
  }
...
function Rs(e, t, [n, r, i]) {
  const o = t[i] !== void 0 ? t[i] : 0.5, s = fe(e.min, e.max, o);
  ri(e, t[n], t[r], s, t.scale);
}
const Lm = ["x", "scaleX", "originX"], km = ["y", "scaleY", "originY"];
function Pt(e, t) {
...
function $m(e, t, n) {
  const r = Hu(e, n), { scroll: i } = t;
  return i && (et(r.x, i.offset.x), et(r.y, i.offset.y)), r;
}
const Uu = ({ current: e }) => e ? e.ownerDocument.defaultView : null, Bm = /* @__PURE__ */ new WeakMap();
class Hm {
  constructor(t) {
  ...
  start(t, { snapToCursor: n = !1 } = {}) {
    ...
    const i = (l) => {
      ...
      if (d && !h && (this.openGlobalLock && this.openGlobalLock(), this.openGlobalLock = nu(d), !this.openGlobalLock))
        return;
      this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), Fe((g) => {
  ...
  updateAxis(t, n, r) {
    ...
    if (!r || !xn(t, i, this.currentDirection))
      return;
    const o = this.getAxisMotionValue(t);
    let s = this.originPoint[t] + r[t];
    this.constraints && this.constraints[t] && (s = Dm(s, this.constraints[t], this.elastic[t])), o.set(s);
  }
  resolveConstraints() {
    var t;
    ...
    n && At(n) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : n && i ? this.constraints = Rm(i.layoutBox, n) : this.constraints = !1, this.elastic = Fm(r), o !== this.constraints && i && this.constraints && !this.hasMutatedConstraints && Fe((s) => {
      this.getAxisMotionValue(s) && (this.constraints[s] = Mm(i.layoutBox[s], this.constraints[s]));
    });
  }
  ...
  startAnimation(t) {
    const { drag: n, dragMomentum: r, dragElastic: i, dragTransition: o, dragSnapToOrigin: s, onDragTransitionEnd: a } = this.getProps(), u = this.constraints || {}, c = Fe((l) => {
      if (!xn(l, n, this.currentDirection))
        return;
      let f = u && u[l] || {};
      s && (f = { min: 0, max: 0 });
  ...
  addListeners() {
    ...
    const t = this.visualElement.current, n = Ye(t, "pointerdown", (u) => {
    ...
    const s = We(window, "resize", () => this.scalePositionWithinConstraints()), a = i.addEventListener("didUpdate", ({ delta: u, hasLayoutChanged: c }) => {
      this.isDragging && c && (Fe((l) => {
  ...
  getProps() {
    const t = this.visualElement.getProps(), { drag: n = !1, dragDirectionLock: r = !1, dragPropagation: i = !1, dragConstraints: o = !1, dragElastic: s = ti, dragMomentum: a = !0 } = t;
    return {
      ...t,
      drag: n,
      dragDirectionLock: r,
...
class zm extends ut {
  constructor(t) {
    super(t), this.removeGroupControls = be, this.removeListeners = be, this.controls = new Hm(t);
  }
  mount() {
...
class Wm extends ut {
  ...
  mount() {
    this.removePointerDownListener = Ye(this.node.current, "pointerdown", (t) => this.onPointerDown(t));
  }
  update() {
...
function Ym() {
  ...
  if (e === null)
    return [!0, null];
  const { isPresent: t, onExitComplete: n, register: r } = e, i = oi();
  ...
  correct: (e, t) => {
    ...
    if (typeof e == "string")
      if (Y.test(e))
        ...
        return e;
    const n = Is(e, t.target.x), r = Is(e, t.target.y);
    return `${n}% ${r}%`;
  }
}, qm = {
  correct: (e, { treeScale: t, projectionDelta: n }) => {
    const r = e, i = st.parse(e);
    if (i.length > 5)
      return r;
    const o = st.createTransformer(e), s = typeof i[0] != "number" ? 1 : 0, a = n.x.scale * t.x, u = n.y.scale * t.y;
    i[0 + s] /= a, i[1 + s] /= u;
    const c = fe(a, u, 0.5);
...
class Km extends ie.Component {
  ...
  componentDidMount() {
    ...
    Gd(Gm), o && (n.group && n.group.add(o), r && r.register && i && r.register(o), o.root.didUpdate(), o.addEventListener("animationComplete", () => {
      this.safeToRemove();
    }), o.setOptions({
      ...o.options,
  ...
  getSnapshotBeforeUpdate(t) {
    ...
    return s && (s.isPresent = o, i || t.layoutDependency !== n || n === void 0 ? s.willUpdate() : this.safeToRemove(), t.isPresent !== o && (o ? s.promote() : s.relegate() || ye.postRender(() => {
      const a = s.getStack();
  ...
  componentDidUpdate() {
    ...
    t && (t.root.didUpdate(), Ci.postRender(() => {
...
function zu(e) {
  const [t, n] = Ym(), r = ge(_i);
  return ie.createElement(Km, { ...e, layoutGroup: r, switchLayoutGroup: ge($a), isPresent: t, safeToRemove: n });
}
const Gm = {
  borderRadius: {
    ...zt,
  ...
  boxShadow: qm
}, Wu = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"], Xm = Wu.length, Ms = (e) => typeof e == "string" ? parseFloat(e) : e, Fs = (e) => typeof e == "number" || Y.test(e);
function Zm(e, t, n, r, i, o) {
  i ? (e.opacity = fe(
    ...
    Jm(r)
  ), e.opacityExit = fe(t.opacity !== void 0 ? t.opacity : 1, 0, Qm(r))) : o && (e.opacity = fe(t.opacity !== void 0 ? t.opacity : 1, n.opacity !== void 0 ? n.opacity : 1, r));
  for (let s = 0; s < Xm; s++) {
    const a = `border${Wu[s]}Radius`;
    let u = Ns(t, a), c = Ns(n, a);
    if (u === void 0 && c === void 0)
      continue;
    u || (u = 0), c || (c = 0), u === 0 || c === 0 || Fs(u) === Fs(c) ? (e[a] = Math.max(fe(Ms(u), Ms(c), r), 0), (Be.test(c) || Be.test(u)) && (e[a] += "%")) : e[a] = c;
  }
...
const Jm = Yu(0, 0.5, Pu), Qm = Yu(0.5, 0.95, be);
function Yu(e, t, n) {
...
function Vs(e, t, n, r, i) {
  return e -= t, e = zn(e, 1 / n, r), i !== void 0 && (e = zn(e, 1 / i, r)), e;
}
function eg(e, t = 0, n = 1, r = 0.5, i, o = e, s = e) {
  if (Be.test(t) && (t = parseFloat(t), t = fe(s.min, s.max, t / 100) - s.min), typeof t != "number")
    return;
  let a = fe(o.min, o.max, r);
  e === o && (a -= t), e.min = Vs(e.min, t, n, a, i), e.max = Vs(e.max, t, n, a, i);
}
function Ls(e, t, [n, r, i], o, s) {
  eg(e, t[n], t[r], t[i], t.scale, o, s);
}
const tg = ["x", "scaleX", "originX"], ng = ["y", "scaleY", "originY"];
function ks(e, t, n, r) {
  Ls(e.x, t, tg, n ? n.x : void 0, r ? r.x : void 0), Ls(e.y, t, ng, n ? n.y : void 0, r ? r.y : void 0);
}
function $s(e) {
...
class ig {
  ...
  remove(t) {
    if (Yi(this.members, t), t === this.prevLead && (this.prevLead = void 0), t === this.lead) {
...
class sg {
  ...
  forEach(t) {
    this.isDirty && this.children.sort(og), this.isDirty = !1, this.children.forEach(t);
  }
}
function ag(e, t) {
...
const Dr = ["", "X", "Y", "Z"], fg = { visibility: "hidden" }, Us = 1e3;
let dg = 0;
const ht = {
...
function Gu({ attachResizeListener: e, defaultParent: t, measureScroll: n, checkIsScrollRoot: r, resetTransform: i }) {
  return class {
    constructor(s = {}, a = t == null ? void 0 : t()) {
      this.id = dg++, this.animationId = 0, this.children = /* @__PURE__ */ new Set(), this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.treeScale = { x: 1, y: 1 }, this.eventHandlers = /* @__PURE__ */ new Map(), this.hasTreeAnimated = !1, this.updateScheduled = !1, this.projectionUpdateScheduled = !1, this.checkUpdateFailed = () => {
        this.isUpdating && (this.isUpdating = !1, this.clearAllSnapshots());
      }, this.updateProjection = () => {
        this.projectionUpdateScheduled = !1, ht.totalNodes = ht.resolvedTargetDeltas = ht.recalculatedProjection = 0, this.nodes.forEach(mg), this.nodes.forEach(bg), this.nodes.forEach(Sg), this.nodes.forEach(gg), ug(ht);
    ...
    addEventListener(s, a) {
      return this.eventHandlers.has(s) || this.eventHandlers.set(s, new qi()), this.eventHandlers.get(s).add(a);
    }
    notifyListeners(s, ...a) {
    ...
    mount(s, a = this.root.hasTreeAnimated) {
      ...
      if (l && !l.current && l.mount(s), this.root.nodes.add(this), this.parent && this.parent.children.add(this), a && (c || u) && (this.isLayoutDirty = !0), e) {
        ...
        e(s, () => {
          this.root.updateBlockedByResize = !0, f && f(), f = ag(d, 250), Rn.hasAnimatedSinceResize && (Rn.hasAnimatedSinceResize = !1, this.nodes.forEach(Ws));
        });
      }
      u && this.root.registerSharedNode(u, this), this.options.animate !== !1 && l && (u || c) && this.addEventListener("didUpdate", ({ delta: f, hasLayoutChanged: d, hasRelativeTargetChanged: h, layout: p }) => {
        ...
        const m = this.options.transition || l.getDefaultTransition() || _g, { onLayoutAnimationStart: g, onLayoutAnimationComplete: v } = l.getProps(), b = !this.targetLayout || !Ku(this.targetLayout, p) || h, E = !d && h;
        if (this.options.layoutRoot || this.resumeFrom && this.resumeFrom.instance || E || d && (b || !this.currentAnimation)) {
          ...
          d || Ws(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
        this.targetLayout = p;
      });
    }
    unmount() {
    ...
    startUpdate() {
      this.isUpdateBlocked() || (this.isUpdating = !0, this.nodes && this.nodes.forEach(Tg), this.animationId++);
    }
    ...
    update() {
      ...
      this.isUpdating || this.nodes.forEach(vg), this.isUpdating = !1, window.HandoffCancelAllAnimations && window.HandoffCancelAllAnimations(), this.nodes.forEach(Eg), this.nodes.forEach(hg), this.nodes.forEach(pg), this.clearAllSnapshots();
      const a = tt.now();
      Ee.delta = it(0, 1e3 / 60, a - Ee.timestamp), Ee.timestamp = a, Ee.isProcessing = !0, Er.update.process(Ee), Er.preRender.process(Ee), Er.render.process(Ee), Ee.isProcessing = !1;
    }
    didUpdate() {
      this.updateScheduled || (this.updateScheduled = !0, Ci.read(() => this.update()));
    }
    clearAllSnapshots() {
    ...
    resetTransform() {
      if (!i)
        return;
      const s = this.isLayoutDirty || this.shouldResetTransform, a = this.projectionDelta && !qu(this.projectionDelta), u = this.getTransformTemplate(), c = u ? u(this.latestValues, "") : void 0, l = c !== this.prevTransformTemplateValue;
      s && (a || dt(this.latestValues) || l) && (i(this.instance, c), this.shouldResetTransform = !1, this.scheduleRender());
    }
    measure(s = !0) {
      const a = this.measurePageBox();
      let u = this.removeElementScroll(a);
      return s && (u = this.removeTransform(u)), wg(u), {
        animationId: this.root.animationId,
        measuredBox: a,
        layoutBox: u,
        latestValues: {},
    ...
    applyTransform(s, a = !1) {
      ...
      for (let c = 0; c < this.path.length; c++) {
        const l = this.path[c];
        !a && l.options.layoutScroll && l.scroll && l !== l.root && Pt(u, {
          x: -l.scroll.offset.x,
          y: -l.scroll.offset.y
    ...
    removeTransform(s) {
      ...
      for (let u = 0; u < this.path.length; u++) {
        ...
        const l = he(), f = c.measurePageBox();
        Me(l, f), ks(a, c.latestValues, c.snapshot ? c.snapshot.layoutBox : void 0, l);
      }
    ...
    resolveTargetDelta(s = !1) {
      ...
      if (!(!this.layout || !(f || d))) {
        if (this.resolvedRelativeTargetAt = Ee.timestamp, !this.targetDelta && !this.relativeTarget) {
          ...
          h && h.layout && this.animationProgress !== 1 ? (this.relativeParent = h, this.forceRelativeParentToResolveTarget(), this.relativeTarget = he(), this.relativeTargetOrigin = he(), Zt(this.relativeTargetOrigin, this.layout.layoutBox, h.layout.layoutBox), Me(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0;
        }
        if (!(!this.relativeTarget && !this.targetDelta)) {
          if (this.target || (this.target = he(), this.targetWithTransforms = he()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), Pm(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : Me(this.target, this.layout.layoutBox), Bu(this.target, this.targetDelta)) : Me(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget) {
            this.attemptToResolveRelativeTarget = !1;
            const h = this.getClosestProjectingParent();
            h && !!h.resumingFrom == !!this.resumingFrom && !h.options.layoutScroll && h.target && this.animationProgress !== 1 ? (this.relativeParent = h, this.forceRelativeParentToResolveTarget(), this.relativeTarget = he(), this.relativeTargetOrigin = he(), Zt(this.relativeTargetOrigin, this.target, h.target), Me(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0;
          }
    ...
    getClosestProjectingParent() {
      if (!(!this.parent || ni(this.parent.latestValues) || $u(this.parent.latestValues)))
    ...
    calcProjection() {
      ...
      let c = !0;
      if ((this.isProjectionDirty || !((s = this.parent) === null || s === void 0) && s.isProjectionDirty) && (c = !1), u && (this.isSharedProjectionDirty || this.isTransformDirty) && (c = !1), this.resolvedRelativeTargetAt === Ee.timestamp && (c = !1), c)
        return;
      ...
      Vm(this.layoutCorrected, this.treeScale, this.path, u), a.layout && !a.target && (this.treeScale.x !== 1 || this.treeScale.y !== 1) && (a.target = a.layout.layoutBox, a.targetWithTransforms = he());
      const { target: p } = a;
      if (!p) {
      ...
      Xt(this.projectionDelta, this.layoutCorrected, p, this.latestValues), this.projectionTransform = Hs(this.projectionDelta, this.treeScale), (this.projectionTransform !== m || this.treeScale.x !== d || this.treeScale.y !== h) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", p)), ht.recalculatedProjection++;
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    setAnimationOrigin(s, a = !1) {
      const u = this.snapshot, c = u ? u.latestValues : {}, l = { ...this.latestValues }, f = wt();
      (!this.relativeParent || !this.relativeParent.options.layoutRoot) && (this.relativeTarget = this.relativeTargetOrigin = void 0), this.attemptToResolveRelativeTarget = !a;
      const d = he(), h = u ? u.source : void 0, p = this.layout ? this.layout.source : void 0, m = h !== p, g = this.getStack(), v = !g || g.members.length <= 1, b = !!(m && !v && this.options.crossfade === !0 && !this.path.some(Ag));
      this.animationProgress = 0;
      let E;
      this.mixTargetDelta = (x) => {
        const T = x / 1e3;
        Ys(f.x, s.x, T), Ys(f.y, s.y, T), this.setTargetDelta(f), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (Zt(d, this.layout.layoutBox, this.relativeParent.layout.layoutBox), xg(this.relativeTarget, this.relativeTargetOrigin, d, T), E && rg(this.relativeTarget, E) && (this.isProjectionDirty = !1), E || (E = he()), Me(E, this.relativeTarget)), m && (this.animationValues = l, Zm(l, c, this.latestValues, T, b, v)), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = T;
      }, this.mixTargetDelta(this.options.layoutRoot ? 1e3 : 0);
    }
    startAnimation(s) {
      this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && (ot(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = ye.update(() => {
        Rn.hasAnimatedSinceResize = !0, this.currentAnimation = cg(0, Us, {
          ...s,
          onUpdate: (a) => {
    ...
    applyTransformsToTarget() {
      ...
      if (!(!a || !u || !c)) {
        if (this !== s && this.layout && c && Xu(this.options.animationType, this.layout.layoutBox, c.layoutBox)) {
          u = this.target || he();
        ...
        Me(a, u), Pt(a, l), Xt(this.projectionDeltaWithTransform, this.layoutCorrected, a, l);
      }
    }
    registerSharedNode(s, a) {
      this.sharedNodes.has(s) || this.sharedNodes.set(s, new ig()), this.sharedNodes.get(s).add(a);
    ...
    resetSkewAndRotation() {
      ...
      for (let l = 0; l < Dr.length; l++)
        Rr(`rotate${Dr[l]}`, s, c, this.animationValues), Rr(`skew${Dr[l]}`, s, c, this.animationValues);
      s.render();
      for (const l in c)
    ...
    getProjectionStyles(s) {
      ...
      if (this.needsReset)
        return this.needsReset = !1, c.opacity = "", c.pointerEvents = Pn(s == null ? void 0 : s.pointerEvents) || "", c.transform = l ? l(this.latestValues, "") : "none", c;
      const f = this.getLead();
      if (!this.projectionDelta || !this.layout || !f.target) {
        const m = {};
        return this.options.layoutId && (m.opacity = this.latestValues.opacity !== void 0 ? this.latestValues.opacity : 1, m.pointerEvents = Pn(s == null ? void 0 : s.pointerEvents) || ""), this.hasProjected && !dt(this.latestValues) && (m.transform = l ? l({}, "") : "none", this.hasProjected = !1), m;
      }
      const d = f.animationValues || f.latestValues;
      this.applyTransformsToTarget(), c.transform = Hs(this.projectionDeltaWithTransform, this.treeScale, d), l && (c.transform = l(d, c.transform));
      ...
      for (const m in Ln) {
        if (d[m] === void 0)
          continue;
        const { correct: g, applyTo: v } = Ln[m], b = c.transform === "none" ? d[m] : g(d[m], f);
        if (v) {
          const E = v.length;
          for (let x = 0; x < E; x++)
            c[v[x]] = b;
      ...
      return this.options.layoutId && (c.pointerEvents = f === this ? Pn(s == null ? void 0 : s.pointerEvents) || "" : "none"), c;
    }
    clearSnapshot() {
...
function pg(e) {
  ...
  if (e.isLead() && e.layout && n && e.hasListeners("didUpdate")) {
    ...
    o === "size" ? Fe((f) => {
      const d = s ? n.measuredBox[f] : n.layoutBox[f], h = Oe(d);
      d.min = r[f].min, d.max = d.min + h;
    }) : Xu(o, n.layoutBox, r) && Fe((f) => {
      const d = s ? n.measuredBox[f] : n.layoutBox[f], h = Oe(r[f]);
    ...
    if (!e.resumeFrom) {
      ...
      if (f && !f.resumeFrom) {
        ...
        if (d && h) {
          ...
          const m = he();
          Zt(m, r, h.layoutBox), Ku(p, m) || (l = !0), f.options.layoutRoot && (e.relativeTarget = m, e.relativeTargetOrigin = p, e.relativeParent = f);
        }
      }
    }
...
const _g = {
  duration: 0.45,
  ease: [0.4, 0, 0.1, 1]
}, Ks = (e) => typeof navigator < "u" && navigator.userAgent && navigator.userAgent.toLowerCase().includes(e), Gs = Ks("applewebkit/") && !Ks("chrome/") ? Math.round : be;
function Xs(e) {
...
function Xu(e, t, n) {
  return e === "position" || e === "preserve-aspect" && !ei(Bs(t), Bs(n), 0.2);
}
const Pg = Gu({
...
function Og(e, t, n) {
  ...
  for (const i in t) {
    const o = t[i], s = n[i];
    if (Ce(o))
      e.addValue(i, o), Un(r) && r.add(i), process.env.NODE_ENV === "development" && Ki(o.version === "11.0.23", `Attempting to mix Framer Motion versions ${o.version} with 11.0.23 may not work as expected.`);
    else if (Ce(s))
      e.addValue(i, an(o, { owner: e })), Un(r) && r.remove(i);
    else if (s !== o)
      if (e.hasValue(i)) {
...
const Zs = /* @__PURE__ */ new WeakMap(), Ig = [...cu, Te, st], Mg = (e) => Ig.find(lu(e)), Qu = Object.keys(on), Fg = Qu.length, Js = [
  "AnimationStart",
  "AnimationComplete",
  "Update",
  "BeforeLayoutMeasure",
...
class jg {
  constructor({ parent: t, props: n, presenceContext: r, reducedMotionConfig: i, blockInitialAnimation: o, visualState: s }, a = {}) {
    ...
    this.latestValues = u, this.baseTarget = { ...u }, this.initialValues = n.initial ? { ...u } : {}, this.renderState = c, this.parent = t, this.props = n, this.presenceContext = r, this.depth = t ? t.depth + 1 : 0, this.reducedMotionConfig = i, this.options = a, this.blockInitialAnimation = !!o, this.isControllingVariants = tr(n), this.isVariantNode = ka(n), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(t && t.current);
  ...
  mount(t) {
    this.current = t, Zs.set(t, this), this.projection && !this.projection.instance && this.projection.mount(t), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((n, r) => this.bindToMotionValue(r, n)), Ju.current || Rg(), this.shouldReduceMotion = this.reducedMotionConfig === "never" ? !1 : this.reducedMotionConfig === "always" ? !0 : ii.current, process.env.NODE_ENV !== "production" && Ki(this.shouldReduceMotion !== !0, "You have Reduced Motion enabled on your device. Animations may not appear as expected."), this.parent && this.parent.children.add(this), this.update(this.props, this.presenceContext);
  }
  unmount() {
    Zs.delete(this.current), this.projection && this.projection.unmount(), ot(this.notifyUpdate), ot(this.render), this.valueSubscriptions.forEach((t) => t()), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this);
    for (const t in this.events)
      this.events[t].clear();
  ...
  loadFeatures({ children: t, ...n }, r, i, o) {
    ...
    for (let u = 0; u < Fg; u++) {
      const c = Qu[u], { isEnabled: l, Feature: f, ProjectionNode: d, MeasureLayout: h } = on[c];
  ...
  update(t, n) {
    ...
    this.prevMotionValues = Og(this, this.scrapeMotionValuesFromProps(t, this.prevProps), this.prevMotionValues), this.handleChildMotionValue && this.handleChildMotionValue();
  }
  getProps() {
    return this.props;
  }
  ...
  getValue(t, n) {
    ...
    return r === void 0 && n !== void 0 && (r = an(n === null ? void 0 : n, { owner: this }), this.addValue(t, r)), r;
  }
  /**
  ...
  readValue(t, n) {
    ...
    return i != null && (typeof i == "string" && (au(i) || su(i)) ? i = parseFloat(i) : !Mg(i) && st.test(n) && (i = vu(t, n)), this.setBaseTarget(t, Ce(i) ? i.get() : i)), Ce(i) ? i.get() : i;
  }
  /**
  ...
  getBaseTarget(t) {
    var n, r;
    const { initial: i } = this.props, o = typeof i == "string" || typeof i == "object" ? (r = Ni(this.props, i, (n = this.presenceContext) === null || n === void 0 ? void 0 : n.custom)) === null || r === void 0 ? void 0 : r[t] : void 0;
    if (i && o !== void 0)
      return o;
    const s = this.getBaseTargetFromProps(this.props, t);
    return s !== void 0 && !Ce(s) ? s : this.initialValues[t] !== void 0 && o === void 0 ? void 0 : this.baseTarget[t];
  }
  on(t, n) {
...
class Lg extends el {
  ...
  readValueFromInstance(t, n) {
    if (Et.has(n)) {
      ...
      const r = Vg(t), i = (Ua(n) ? r.getPropertyValue(n) : r[n]) || 0;
...
const $g = (e, t) => wi(e) ? new kg(t, { enableHardwareAcceleration: !1 }) : new Lg(t, { enableHardwareAcceleration: !0 }), Bg = {
  layout: {
    ProjectionNode: Zu,
    MeasureLayout: zu
  }
...
function Yg({ children: e, isPresent: t }) {
  ...
  }, [t]), we.createElement(Wg, { isPresent: t, childRef: r, sizeRef: i }, we.cloneElement(e, { ref: r }));
}
const Ir = ({ children: e, initial: t, isPresent: n, onExitComplete: r, custom: i, presenceAffectsLayout: o, mode: s }) => {
  const a = Ja(qg), u = oi(), c = nt(
    () => ({
      id: u,
      initial: t,
      isPresent: n,
  ...
  return nt(() => {
    ...
    !n && !a.size && r && r();
  }, [n]), s === "popLayout" && (e = we.createElement(Yg, { isPresent: n }, e)), we.createElement(Qn.Provider, { value: c }, e);
};
function qg() {
...
function Xg(e) {
  const t = [];
  return Ot.forEach(e, (n) => {
    Ml(n) && t.push(n);
  }), t;
}
const nl = ({ children: e, custom: t, initial: n = !0, onExitComplete: r, exitBeforeEnter: i, presenceAffectsLayout: o = !0, mode: s = "sync" }) => {
  He(!i, "Replace exitBeforeEnter with mode='wait'");
  const a = ge(_i).forceRender || zg()[0], u = tl(), c = Xg(e);
  let l = c;
  const f = ke(/* @__PURE__ */ new Map()).current, d = ke(l), h = ke(/* @__PURE__ */ new Map()).current, p = ke(!0);
  if (Si(() => {
    p.current = !1, Gg(c, h), d.current = l;
  }), Kg(() => {
    p.current = !0, h.clear(), f.clear();
  }), p.current)
    return we.createElement(we.Fragment, null, l.map((b) => we.createElement(Ir, { key: pt(b), isPresent: !0, initial: n ? void 0 : !1, presenceAffectsLayout: o, mode: s }, b)));
  l = [...l];
  const m = d.current.map(pt), g = c.map(pt), v = m.length;
  for (let b = 0; b < v; b++) {
    const E = m[b];
  ...
  return s === "wait" && f.size && (l = []), f.forEach((b, E) => {
    ...
    if (!D) {
      ...
      D = we.createElement(Ir, { key: pt(x), isPresent: !1, onExitComplete: I, custom: t, presenceAffectsLayout: o, mode: s }, x), f.set(E, D);
    }
    l.splice(T, 0, D);
  }), l = l.map((b) => {
    const E = b.key;
    return f.has(E) ? b : we.createElement(Ir, { key: pt(b), isPresent: !0, presenceAffectsLayout: o, mode: s }, b);
  }), process.env.NODE_ENV !== "production" && s === "wait" && l.length > 1 && console.warn(`You're attempting to animate multiple children within AnimatePresence, but its mode is set to "wait". This will lead to odd visual behaviour.`), we.createElement(we.Fragment, null, f.size ? l : l.map((b) => Il(b)));
}, kt = "altimate-display-", Zg = `${kt}-highlight`, Qs = `${kt}-highlight-hover`, Jg = `${kt}-active-highlight`, Qg = 1049, ey = ({ pos: e, onAddComment: t }) => /* @__PURE__ */ B.jsx(nl, { children: e && /* @__PURE__ */ B.jsx(
  jt,
  {
    onClick: t,
    id: `${kt}-highlight`,
  ...
  return /* @__PURE__ */ B.jsx(jt, { onClick: n, children: e ? "Hide conversations" : "Show conversations" });
}, ry = ny, iy = () => {
  const e = xe(
    (s) => s.shareId
  ), [t, n] = Se(
...
`;
      ...
      var o, s = this && this.__extends || (o = function(T, D) {
        ...
        o(T, D), T.prototype = D === null ? Object.create(D) : (I.prototype = D.prototype, new I());
      ...
      var c = u(i(2)), l = u(i(5)), f = u(i(3)), d = u(i(6)), h = u(i(13)), p = u(i(14)), m = u(i(16)), g = u(i(17)), v = i(0), b = i(1), E = i(4), x = function(T) {
        function D(I) {
          ...
          S.event = p.default(), S.run = function() {
            ...
            return A ? E.getHighlightById(S.options.$root, A, S.options.wrapTag) : E.getHighlightsByRoot(S.options.$root, S.options.wrapTag);
          }, S.dispose = function() {
            var A = S.options.$root;
            E.removeEventListener(A, S.event.PointerOver, S._handleHighlightHover), E.removeEventListener(A, S.event.PointerEnd, S._handleSelection), E.removeEventListener(A, S.event.PointerTap, S._handleHighlightClick), S.removeAll();
          }, S.setOption = function(A) {
            S.options = a(a({}, S.options), A), S.painter = new g.default({ $root: S.options.$root, wrapTag: S.options.wrapTag, className: S.options.style.className, exceptSelectors: S.options.exceptSelectors }, S.hooks);
          }, S.fromRange = function(A) {
            var N = { $node: A.startContainer, offset: A.startOffset }, X = { $node: A.endContainer, offset: A.endOffset }, q = A.toString(), M = S.hooks.Render.UUID.call(N, X, q);
            M = M ?? d.default();
            ...
            try {
              ...
              return v.eventEmitter.emit(v.INTERNAL_ERROR_EVENT, { type: b.ERROR.HIGHLIGHT_SOURCE_RECREATE, error: _, detail: w }), null;
            }
            ...
            return S.painter.highlightRange(A).length === 0 ? (v.eventEmitter.emit(v.INTERNAL_ERROR_EVENT, { type: b.ERROR.DOM_SELECTION_EMPTY }), null) : (S.cache.save(N), S.emit(b.EventType.CREATE, { sources: [N], type: b.CreateFrom.INPUT }, S), N);
            ...
            if (!E.isHighlightWrapNode(N))
              return S._hoverId && S.emit(b.EventType.HOVER_OUT, { id: S._hoverId }, S, A), void (S._hoverId = null);
            var X = E.getHighlightId(N, S.options.$root);
            S._hoverId !== X && (S._hoverId && S.emit(b.EventType.HOVER_OUT, { id: S._hoverId }, S, A), S._hoverId = X, S.emit(b.EventType.HOVER, { id: S._hoverId }, S, A));
          ...
          }, S.options = v.getDefaultOptions(), S.hooks = S._getHooks(), S.setOption(I), S.cache = new m.default();
        ...
        return s(D, T), D.prototype.remove = function(I) {
          if (I) {
            var S = this.painter.removeHighlight(I);
            this.cache.remove(I), S && this.emit(b.EventType.REMOVE, { ids: [I] }, this);
          }
          ...
          this.emit(b.EventType.CREATE, { sources: S, type: b.CreateFrom.STORE }, this), this.cache.save(I);
        }, D.event = b.EventType, D.isHighlightWrapNode = E.isHighlightWrapNode, D.isHighlightSource = function(I) {
      ...
      var c = u(i(3)), l = i(18), f = i(4), d = i(1), h = i(20), p = i(0), m = function() {
        ...
        return g.prototype.highlightRange = function(v) {
          ...
          var E = this.options, x = E.$root, T = E.className, D = E.exceptSelectors, I = this.hooks, S = l.getSelectedNodes(x, v.start, v.end, D);
          return I.Render.SelectedNodes.isEmpty() || (S = I.Render.SelectedNodes.call(v.id, S) || []), S.map(function(j) {
            var A = l.wrapHighlight(j, v, T, b.options.wrapTag);
            return I.Render.WrapNode.isEmpty() || (A = I.Render.WrapNode.call(v.id, A)), A;
          });
          ...
          var b, E, x = new RegExp("(" + v + "\\" + p.ID_DIVISION + "|\\" + p.ID_DIVISION + "?" + v + "$)"), T = this.hooks, D = this.options.wrapTag, I = document.querySelectorAll(D + "[data-" + p.DATASET_IDENTIFIER + "]"), S = [], j = [], A = [];
          try {
            for (var N = o(I), X = N.next(); !X.done; X = N.next()) {
              var q = X.value, M = q.dataset[p.CAMEL_DATASET_IDENTIFIER], w = q.dataset[p.CAMEL_DATASET_IDENTIFIER_EXTRA];
              M !== v || w ? M === v ? j.push(q) : M !== v && x.test(w) && A.push(q) : S.push(q);
            }
          } catch (_) {
            b = { error: _ };
          } finally {
          ...
          return S.forEach(function(_) {
            var O = _.parentNode, P = document.createDocumentFragment();
            f.forEach(_.childNodes, function(R) {
              return P.appendChild(R.cloneNode(!1));
            });
            var k = _.previousSibling, C = _.nextSibling;
            O.replaceChild(P, _), l.normalizeSiblingText(k, !0), l.normalizeSiblingText(C, !1), T.Remove.UpdateNodes.call(v, _, "remove");
          }), j.forEach(function(_) {
            var O = _.dataset, P = O[p.CAMEL_DATASET_IDENTIFIER_EXTRA].split(p.ID_DIVISION), k = P.shift(), C = document.querySelector(D + "[data-" + p.DATASET_IDENTIFIER + '="' + k + '"]');
            C && (f.removeAllClass(_), f.addClass(_, a(C.classList))), O[p.CAMEL_DATASET_IDENTIFIER] = k, O[p.CAMEL_DATASET_IDENTIFIER_EXTRA] = P.join(p.ID_DIVISION), T.Remove.UpdateNodes.call(v, _, "id-update");
          }), A.forEach(function(_) {
            var O = _.dataset[p.CAMEL_DATASET_IDENTIFIER_EXTRA];
            _.dataset[p.CAMEL_DATASET_IDENTIFIER_EXTRA] = O.replace(x, ""), T.Remove.UpdateNodes.call(v, _, "extra-update");
      ...
      r.getSelectedNodes = function(p, m, g, v) {
        ...
        if (b === E && b instanceof Text)
          return function(M, w, _, O) {
            ...
            M.splitText(w);
            var C = M.nextSibling;
            return C.splitText(_ - w), [{ $node: C, type: a.SelectedNodeType.text, splitType: a.SplitType.both }];
          }(b, x, T, v);
        for (var D = [p], I = [], S = function(M) {
          ...
          if (A.nodeType !== 1 || !S(A)) {
            ...
            if (A === b) {
              if (A.nodeType === 3) {
                A.splitText(x);
                var q = A.nextSibling;
                I.push({ $node: q, type: a.SelectedNodeType.text, splitType: a.SplitType.head });
              }
              j = !0;
            } else {
              if (A === E) {
                A.nodeType === 3 && ((q = A).splitText(T), I.push({ $node: q, type: a.SelectedNodeType.text, splitType: a.SplitType.tail }));
                break;
              }
              j && A.nodeType === 3 && I.push({ $node: A, type: a.SelectedNodeType.text, splitType: a.SplitType.none });
            }
          }
        return I;
      };
      ...
      r.wrapHighlight = function(p, m, g, v) {
        ...
        return u.isHighlightWrapNode(b) ? !u.isHighlightWrapNode(b) || h(E) && h(x) ? function(T, D, I) {
          var S = T.$node.parentNode, j = S;
          u.removeAllClass(j), d(j, I);
          var A = S.dataset, N = A[c.CAMEL_DATASET_IDENTIFIER];
          return A[c.CAMEL_DATASET_IDENTIFIER] = D.id, A[c.CAMEL_DATASET_IDENTIFIER_EXTRA] = A[c.CAMEL_DATASET_IDENTIFIER_EXTRA] ? N + c.ID_DIVISION + A[c.CAMEL_DATASET_IDENTIFIER_EXTRA] : N, j;
        }(p, m, g) : function(T, D, I, S) {
          var j = document.createElement(S), A = T.$node.parentNode, N = T.$node.previousSibling, X = T.$node.nextSibling, q = document.createDocumentFragment(), M = A.dataset[c.CAMEL_DATASET_IDENTIFIER], w = A.dataset[c.CAMEL_DATASET_IDENTIFIER_EXTRA], _ = w ? M + c.ID_DIVISION + w : M;
          j.setAttribute("data-" + c.DATASET_IDENTIFIER, D.id), j.setAttribute("data-" + c.DATASET_IDENTIFIER_EXTRA, _), j.appendChild(T.$node.cloneNode(!1));
          var O, P = !1, k = !1;
          N && ((C = A.cloneNode(!1)).textContent = N.textContent, q.appendChild(C), P = !0);
          var C, R = [];
          return Array.isArray(I) ? R.push.apply(R, s(I)) : R.push(I), d(j, l.unique(R)), q.appendChild(j), X && ((C = A.cloneNode(!1)).textContent = X.textContent, q.appendChild(C), k = !0), O = P && k ? a.SplitType.both : P ? a.SplitType.head : k ? a.SplitType.tail : a.SplitType.none, j.setAttribute("data-" + c.DATASET_SPLIT_TYPE, O), A.parentNode.replaceChild(q, A), j;
        }(p, m, g, v) : function(T, D, I, S) {
          var j = document.createElement(S);
          return d(j, I), j.appendChild(T.$node.cloneNode(!1)), T.$node.parentNode.replaceChild(j, T.$node), j.setAttribute("data-" + c.DATASET_IDENTIFIER, D.id), j.setAttribute("data-" + c.DATASET_SPLIT_TYPE, T.splitType), j.setAttribute("data-" + c.DATASET_IDENTIFIER_EXTRA, ""), j;
        }(p, m, g, v);
...
var oy = rl.exports;
const il = /* @__PURE__ */ Wn(oy), Rt = new il({
  style: {
    className: Zg
  }
...
const sy = (e) => e.highlight ? JSON.parse(e.highlight) : null, ay = (e) => {
  const t = sy(e);
  t && (Rt.remove(t.id), Gi.remove(t.id));
}, ea = () => {
  var e, t;
  return (t = (e = document.getElementById("code")) == null ? void 0 : e.parentElement) == null ? void 0 : t.querySelector("code-block");
}, uy = () => {
  const e = xe(
    (u) => u.selectedConversationId ? u.conversations[u.selectedConversationId] : null
  ), t = xe(
    (u) => u.docsAppRendered
  ), [n, r] = Se(null), [i, o] = Se(null), s = $e(() => {
    console.log("resetHighlights"), n && ay(n), o(null), r(null);
  }, [n]);
  Ve(() => {
    !e || !t || (window.location.hash = `#!/${e.meta.resource_type}/${e.meta.uniqueId}`, setTimeout(() => {
      const u = ea();
      if (u) {
        u.scrollIntoView({ behavior: "smooth", block: "center" });
        let c = 0, l = 0;
        for (let h = e.meta.range.start.line; h <= e.meta.range.end.line; h++) {
          const p = u.querySelector(
            `code .line-numbers-rows > span:nth-child(${h + 1})`
          );
          p && (h === e.meta.range.start.line && (c = p.offsetTop), h === e.meta.range.end.line && (l = p.offsetTop + p.offsetHeight), p.style.backgroundColor = "red");
        }
        const f = u.querySelector("pre code"), d = document.getElementById("altimate-highlighter") ?? document.createElement("div");
        d.style.position = "absolute", d.style.zIndex = "0", d.id = "altimate-highlighter", d.style.top = `${c + 12}px`, d.style.height = `${l - c}px`, d.style.width = "100%", d.style.backgroundColor = "rgba(0,0,0,0.1)", f != null && f.parentElement && (f.parentElement.appendChild(d), f.style.zIndex = "1");
      }
    }, 100));
  }, [e, t]);
  const a = $e(async () => {
    ...
    if (!u || !u.rangeCount)
      return s(), null;
    const c = u.getRangeAt(0), l = c.toString(), f = (S = (I = ea()) == null ? void 0 : I.querySelector("code")) == null ? void 0 : S.innerText;
    if (!l || !f)
      return;
    const d = l.split(`
`), h = f.split(`
`);
    ...
    const {
      ...
      height: b,
      width: E
    } = c.getClientRects()[0], x = window.location.hash.split("#"), T = (j = x.find((A) => A.startsWith("!"))) == null ? void 0 : j.split("/");
    if (!T || T.length < 3) {
  ...
  ({ onClick: e, rect: t }, n) => /* @__PURE__ */ B.jsx(nl, { children: t && /* @__PURE__ */ B.jsx(
    Ug.div,
    {
      ref: n,
  ...
  "select",
  "textarea"
], fy = (e) => e.hasAttribute("altimate-anchor") && e.id !== `${kt}highlight-blocker`, dy = (e) => document != null && document.body ? document.body.contains(e) : (console.error(
  ...
  try {
    if (e) {
      ...
      return al(e.parentElement) + "/" + e.tagName.toLowerCase() + // @ts-expect-error valid
      (o.length > 1 ? "[" + ([].indexOf.call(o, e) + 1) + "]" : "");
    }
    return "";
  } catch (o) {
    return console.error("Error in DomService calculateXPath:", void 0, o), null;
  }
}, py = () => {
  const e = Ze(), [t, n] = Se(!1), [r, i] = Se(null), o = $e((c) => {
    const l = ta(c.clientX, c.clientY);
    i(
      l ? l.getBoundingClientRect() : null
    );
  }, []);
  Ve(() => (document.body.removeEventListener("pointermove", o), t && document.body.addEventListener("pointermove", o), () => {
  ...
  const s = $e((c) => {
    ...
    (c) => {
      ...
      const l = ta(c.clientX, c.clientY) || c.target, f = al(l);
      if (!f)
        return;
      e(ma({
        xpath: f
  ...
  return /* @__PURE__ */ B.jsxs(B.Fragment, { children: [
    ...
    /* @__PURE__ */ B.jsx(jt, { onClick: u, style: { zIndex: 1, marginRight: "1rem" }, children: "Add comment" })
  ] });
}, my = py, gy = Fl(() => import("./DbtDocsRenderer.js")), yy = () => {
  const { loading: e, shareDetails: t } = iy(), n = Ze(), { getHighlightedSelectionData: r, pos: i, onSelectionEnd: o } = uy(), s = () => {
    const a = r();
    a && n(ma(a));
  };
  return e ? /* @__PURE__ */ B.jsx("div", { children: "Loading..." }) : !(t != null && t.catalog_presigned_url) || !(t != null && t.manifest_presigned_url) ? /* @__PURE__ */ B.jsx("div", { children: "Unable to load required artifacts. Please try again." }) : /* @__PURE__ */ B.jsxs("div", { children: [
    /* @__PURE__ */ B.jsxs("div", { className: "d-flex justify-content-end mb-2", children: [
      /* @__PURE__ */ B.jsx(my, {}),
      /* @__PURE__ */ B.jsx(ry, {})
    ] }),
    /* @__PURE__ */ B.jsx(
...
}, vy = yy, Ey = ({ shareId: e, userId: t, conversationGroupId: n }) => /* @__PURE__ */ B.jsx(
  Md,
  {
    shareId: e,
    userId: t,
