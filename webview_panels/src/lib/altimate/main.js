...
import './main.css';var Sd = Object.defineProperty;
var kd = (e, t, n) => t in e ? Sd(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var ar = (e, t, n) => kd(e, typeof t != "symbol" ? t + "" : t, n);
import { Tooltip as Ad, Button as ke, Spinner as Md, Card as ln, CardTitle as oa, CardBody as Tn, Badge as Td, CloseButton as Nd, Popover as kc, PopoverBody as Ac, UncontrolledTooltip as Dd, Input as sn, Label as Ha, Modal as Mc, ModalBody as Tc, FormGroup as es, FormFeedback as Nc, Alert as Is, CardFooter as Od, Collapse as Ld, Col as jd, CardImg as Hd, CardSubtitle as Rd, CardText as Fd, Row as Id } from "reactstrap";
import * as _ from "react";
import P, { createContext as dt, Component as zd, createElement as Ul, isValidElement as Dc, useState as ae, useRef as se, forwardRef as zs, useEffect as re, useReducer as Ps, useCallback as pe, useMemo as Se, useContext as He, useLayoutEffect as Pd, useId as Oc, useInsertionEffect as Bd, Children as qn, lazy as Vd, memo as De } from "react";
import { Prism as Wd } from "react-syntax-highlighter";
import $d, { createPortal as cn } from "react-dom";
import { ProChat as Zd } from "@ant-design/pro-chat";
import { useFormikContext as Ud, Form as qd, Field as Yd, Formik as Gd, useFormik as Kd } from "formik";
import { z as Ue } from "zod";
import { Popconfirm as Xd, Select as ql } from "antd";
...
function Qd() {
  return Gl || (Gl = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var E = !1, v = !1, A = !1, N = !1, k = !1, R;
    R = Symbol.for("react.module.reference");
    function H(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === o || j === a || k || j === r || j === u || j === c || N || j === h || E || v || A || typeof j == "object" && j !== null && (j.$$typeof === g || j.$$typeof === d || j.$$typeof === i || j.$$typeof === s || j.$$typeof === l || // This needs to include all possible module reference object
    ...
    var w = Object.assign, M = 0, S, D, L, O, T, F, z;
    function V() {
    }
    ...
    function W() {
      {
        if (M === 0) {
          S = console.log, D = console.info, L = console.warn, O = console.error, T = console.group, F = console.groupCollapsed, z = console.groupEnd;
          var j = {
            configurable: !0,
            enumerable: !0,
            value: V,
...
` + X + j;
    ...
    function G(j, Y) {
      ...
      try {
        ...
        if (We && ie && typeof We.stack == "string") {
          for (var ce = We.stack.split(`
`), ze = ie.stack.split(`
`), Ae = ce.length - 1, Te = ze.length - 1; Ae >= 1 && Te >= 0 && ce[Ae] !== ze[Te]; )
            Te--;
          for (; Ae >= 1 && Te >= 0; Ae--, Te--)
            if (ce[Ae] !== ze[Te]) {
              if (Ae !== 1 || Te !== 1)
                do
                  if (Ae--, Te--, Te < 0 || ce[Ae] !== ze[Te]) {
                    var Ze = `
` + ce[Ae].replace(" at new ", " at ");
      ...
      var Xt = j ? j.displayName || j.name : "", It = Xt ? J(Xt) : "";
      return typeof j == "function" && Z.set(j, It), It;
    }
    function ye(j, Y, ee) {
      return G(j, !1);
    }
    ...
    var Ve = Object.prototype.hasOwnProperty, xe = {}, oe = p.ReactDebugCurrentFrame;
    function Re(j) {
      if (j) {
          ...
          if (ve(j, ge)) {
            ...
            try {
              if (typeof j[ge] != "function") {
                var ze = Error((ie || "React class") + ": " + ee + " type `" + ge + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof j[ge] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
            ...
            ce && !(ce instanceof Error) && (Re(he), C("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", ie || "React class", ee, ge, typeof ce), Re(null)), ce instanceof Error && !(ce.message in xe) && (xe[ce.message] = !0, Re(he), C("Failed %s type: %s", ee, ce.message), Re(null));
          }
      }
    }
    ...
    function _t(j) {
      if (gt(j))
        return C("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", qt(j)), Lt(j);
    }
    var Qe = p.ReactCurrentOwner, Yt = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Rt(j, Y) {
      if (typeof j.ref == "string" && Qe.current && Y && Qe.current.stateNode !== Y) {
        var ee = B(Qe.current.type);
        Oe[ee] || (C('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', B(Qe.current.type), j.ref), Oe[ee] = !0);
      }
    }
    function Ft(j, Y) {
      {
    ...
    function ht(j, Y) {
      {
        var ee = function() {
          Gt || (Gt = !0, C("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", Y));
        };
    ...
    var it = function(j, Y, ee, ie, he, ve, ge) {
      var ce = {
    ...
    function fn(j, Y, ee, ie, he) {
      {
        var ve, ge = {}, ce = null, ze = null;
        ee !== void 0 && (_t(ee), ce = "" + ee), Ht(Y) && (_t(Y.key), ce = "" + Y.key), et(Y) && (ze = Y.ref, Rt(Y, he));
        for (ve in Y)
          Ve.call(Y, ve) && !Yt.hasOwnProperty(ve) && (ge[ve] = Y[ve]);
        if (j && j.defaultProps) {
          var Ae = j.defaultProps;
          for (ve in Ae)
            ge[ve] === void 0 && (ge[ve] = Ae[ve]);
        }
        if (ce || ze) {
          var Te = typeof j == "function" ? j.displayName || j.name || "Unknown" : j;
          ce && Ft(ge, Te), ze && ht(ge, Te);
        }
        return it(j, ce, ze, he, ie, Qe.current, ge);
      }
    }
    var gn = p.ReactCurrentOwner, Kt = p.ReactDebugCurrentFrame;
    function St(j) {
      if (j) {
        var Y = j._owner, ee = Ee(j.type, j._source, Y ? Y.type : null);
        Kt.setExtraStackFrame(ee);
      } else
    ...
    function tr(j, Y) {
      {
        ...
        er[ee] = !0;
        var ie = "";
        j && j._owner && j._owner !== gn.current && (ie = " It was passed a child from " + B(j._owner.type) + "."), St(j), C('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', ee, ie), St(null);
      }
    }
    function nr(j, Y) {
      {
    ...
    function rr(j, Y, ee, ie, he, ve) {
      {
        ...
        if (!ge) {
          ...
          ze ? ce += ze : ce += Qo();
          var Ae;
          j === null ? Ae = "null" : Et(j) ? Ae = "array" : j !== void 0 && j.$$typeof === t ? (Ae = "<" + (B(j.type) || "Unknown") + " />", ce = " Did you accidentally export a JSX literal instead of a component?") : Ae = typeof j, C("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", Ae, ce);
        }
        var Te = fn(j, Y, ee, he, ve);
        if (Te == null)
          return Te;
        if (ge) {
          var Ze = Y.children;
        ...
        if (Ve.call(Y, "key")) {
          var It = B(j), We = Object.keys(Y).filter(function(La) {
            return La !== "key";
          }), lo = We.length > 0 ? "{key: someKey, " + We.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!or[It + lo]) {
            var Oa = We.length > 0 ? "{" + We.join(": ..., ") + ": ...}" : "{}";
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`, lo, It, Oa, It), or[It + lo] = !0;
    ...
    var Na = Ta, Da = Ma;
    uo.Fragment = o, uo.jsx = Na, uo.jsxs = Da;
  }()), uo;
}
process.env.NODE_ENV === "production" ? ts.exports = Jd() : ts.exports = Qd();
var f = ts.exports;
const e3 = "_iconButton_eti7u_1", t3 = {
  iconButton: e3
}, vn = (e) => /* @__PURE__ */ f.jsx(un, { title: e.title, children: /* @__PURE__ */ f.jsx(
  "button",
  {
    ...e,
    className: `btn ${e.color ? `btn-${e.color}` : ""} ${e.className ?? ""} ${t3.iconButton}`,
    type: e.type ?? "button",
    children: e.children
  }
) }), n3 = dt(null), Ra = {
...
class o3 extends zd {
  constructor(t) {
    super(t), this.resetErrorBoundary = this.resetErrorBoundary.bind(this), this.state = Ra;
  }
  ...
  componentDidUpdate(t, n) {
    ...
    if (o && n.error !== null && r3(t.resetKeys, r)) {
      var a, i;
...
const un = (e) => {
  ...
  return /* @__PURE__ */ f.jsxs(o3, { fallback: /* @__PURE__ */ f.jsx("span", { id: r.current, children: e.children }), children: [
  ...
  ke,
  {
    ...
    className: `${t.className ?? ""} ${i3.loadingBtn}`,
    children: e ? /* @__PURE__ */ f.jsx(Md, {}) : t.children
  }
);
var Co = {}, Lc = { exports: {} };
(function(e) {
...
(function(e) {
  ...
  var n = t(l3()), o = t(c3()), r = t(u3()), a = t(d3()), i = t(f3()), s = t(g3()), l = t(h3()), u = t(p3()), c = t(m3()), d = t(b3()), g = t(C3()), h = t(y3()), m = t(v3()), b = t(x3()), y = t(w3()), p = t(E3()), C = t(_3()), x = t(S3()), E = t(k3()), v = t(A3()), A = t(M3()), N = t(T3()), k = t(N3()), R = t(D3()), H = t(O3()), I = t(L3()), $ = t(j3()), B = t(H3()), w = t(R3()), M = t(F3()), S = t(I3()), D = t(z3()), L = t(P3()), O = t(B3()), T = t(V3()), F = t(W3()), z = t($3()), V = t(Z3()), W = t(U3()), q = t(q3()), K = t(Y3()), X = t(G3()), J = t(K3()), te = t(X3());
})(Co);
const J3 = "_codeblock_19tsp_1", Q3 = "_dark_19tsp_1", P1 = {
  codeblock: J3,
  dark: Q3
}, e5 = { vs: Co.vs, "vsc-dark-plus": Co.vscDarkPlus, solarizedLight: Co.solarizedlight, tomorrow: Co.tomorrow }, Uo = ({
  code: e,
  language: t,
  fileName: n,
  editorTheme: o = "vs",
  ...
  ln,
  {
    className: `${P1.codeblock} ${i || ""} ${r === "dark" ? P1.dark : ""}`,
    children: [
  ...
  return /* @__PURE__ */ f.jsx(
    ...
    {
      ...o,
      className: `${o.className} ${n5.stack} stack-${n}`,
      ref: r,
      children: t
    }
  );
}), o5 = ({ tooltip: e, ...t }) => /* @__PURE__ */ f.jsx(un, { title: e, children: /* @__PURE__ */ f.jsx(Td, { ...t }) }), r5 = ({ queryFn: e }) => {
...
var Bs = /* @__PURE__ */ ((e) => (e.DBT_DOCS = "dbt-docs", e.DOCUMENTATION_EDITOR = "documentation-editor", e.SAAS = "saas", e))(Bs || {});
const a5 = () => {
  var t, n, o;
...
`;
      ...
      var a, i = this && this.__extends || (a = function(v, A) {
        return (a = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(N, k) {
          N.__proto__ = k;
        } || function(N, k) {
          for (var R in k) Object.prototype.hasOwnProperty.call(k, R) && (N[R] = k[R]);
        })(v, A);
      }, function(v, A) {
        function N() {
          this.constructor = v;
        }
        a(v, A), v.prototype = A === null ? Object.create(A) : (N.prototype = A.prototype, new N());
      }), s = this && this.__assign || function() {
        return (s = Object.assign || function(v) {
          for (var A, N = 1, k = arguments.length; N < k; N++) for (var R in A = arguments[N]) Object.prototype.hasOwnProperty.call(A, R) && (v[R] = A[R]);
          return v;
      ...
      var u = l(r(2)), c = l(r(5)), d = l(r(3)), g = l(r(6)), h = l(r(13)), m = l(r(14)), b = l(r(16)), y = l(r(17)), p = r(0), C = r(1), x = r(4), E = function(v) {
        function A(N) {
          var k = v.call(this) || this;
          k.event = m.default(), k.run = function() {
            return x.addEventListener(k.options.$root, k.event.PointerEnd, k._handleSelection);
          }, k.stop = function() {
            x.removeEventListener(k.options.$root, k.event.PointerEnd, k._handleSelection);
          }, k.addClass = function(H, I) {
            k.getDoms(I).forEach(function($) {
              x.addClass($, H);
            });
          }, k.removeClass = function(H, I) {
            k.getDoms(I).forEach(function($) {
              x.removeClass($, H);
            });
          }, k.getIdByDom = function(H) {
            return x.getHighlightId(H, k.options.$root);
          }, k.getExtraIdByDom = function(H) {
            return x.getExtraHighlightId(H, k.options.$root);
          }, k.getDoms = function(H) {
            return H ? x.getHighlightById(k.options.$root, H, k.options.wrapTag) : x.getHighlightsByRoot(k.options.$root, k.options.wrapTag);
          }, k.dispose = function() {
            var H = k.options.$root;
            x.removeEventListener(H, k.event.PointerOver, k._handleHighlightHover), x.removeEventListener(H, k.event.PointerEnd, k._handleSelection), x.removeEventListener(H, k.event.PointerTap, k._handleHighlightClick), k.removeAll();
          }, k.setOption = function(H) {
            k.options = s(s({}, k.options), H), k.painter = new y.default({ $root: k.options.$root, wrapTag: k.options.wrapTag, className: k.options.style.className, exceptSelectors: k.options.exceptSelectors }, k.hooks);
          }, k.fromRange = function(H) {
            var I = { $node: H.startContainer, offset: H.startOffset }, $ = { $node: H.endContainer, offset: H.endOffset }, B = H.toString(), w = k.hooks.Render.UUID.call(I, $, B);
            w = w ?? g.default();
            var M = new c.default(I, $, B, w);
            return M ? k._highlightFromHRange(M) : (p.eventEmitter.emit(p.INTERNAL_ERROR_EVENT, { type: C.ERROR.RANGE_INVALID }), null);
          }, k.fromStore = function(H, I, $, B, w) {
            var M = new d.default(H, I, $, B, w);
            try {
              return k._highlightFromHSource(M), M;
            } catch (S) {
              return p.eventEmitter.emit(p.INTERNAL_ERROR_EVENT, { type: C.ERROR.HIGHLIGHT_SOURCE_RECREATE, error: S, detail: M }), null;
            }
          ...
          }, k._highlightFromHRange = function(H) {
            var I = H.serialize(k.options.$root, k.hooks);
            return k.painter.highlightRange(H).length === 0 ? (p.eventEmitter.emit(p.INTERNAL_ERROR_EVENT, { type: C.ERROR.DOM_SELECTION_EMPTY }), null) : (k.cache.save(I), k.emit(C.EventType.CREATE, { sources: [I], type: C.CreateFrom.INPUT }, k), I);
          }, k._handleSelection = function() {
            var H = c.default.fromSelection(k.hooks.Render.UUID);
            H && (k._highlightFromHRange(H), c.default.removeDomRange());
          }, k._handleHighlightHover = function(H) {
            var I = H.target;
            if (!x.isHighlightWrapNode(I)) return k._hoverId && k.emit(C.EventType.HOVER_OUT, { id: k._hoverId }, k, H), void (k._hoverId = null);
            var $ = x.getHighlightId(I, k.options.$root);
            k._hoverId !== $ && (k._hoverId && k.emit(C.EventType.HOVER_OUT, { id: k._hoverId }, k, H), k._hoverId = $, k.emit(C.EventType.HOVER, { id: k._hoverId }, k, H));
          }, k._handleError = function(H) {
            k.options.verbose && console.warn(H);
          }, k._handleHighlightClick = function(H) {
            var I = H.target;
            if (x.isHighlightWrapNode(I)) {
              var $ = x.getHighlightId(I, k.options.$root);
              k.emit(C.EventType.CLICK, { id: $ }, k, H);
            }
          }, k.options = p.getDefaultOptions(), k.hooks = k._getHooks(), k.setOption(N), k.cache = new b.default();
          var R = k.options.$root;
          return x.addEventListener(R, k.event.PointerOver, k._handleHighlightHover), x.addEventListener(R, k.event.PointerTap, k._handleHighlightClick), p.eventEmitter.on(p.INTERNAL_ERROR_EVENT, k._handleError), k;
        }
        return i(A, v), A.prototype.remove = function(N) {
          if (N) {
            var k = this.painter.removeHighlight(N);
            this.cache.remove(N), k && this.emit(C.EventType.REMOVE, { ids: [N] }, this);
          }
        }, A.prototype.removeAll = function() {
          this.painter.removeAllHighlight();
          var N = this.cache.removeAll();
          this.emit(C.EventType.REMOVE, { ids: N }, this);
        }, A.prototype._highlightFromHSource = function(N) {
          N === void 0 && (N = []);
          var k = this.painter.highlightSource(N);
          this.emit(C.EventType.CREATE, { sources: k, type: C.CreateFrom.STORE }, this), this.cache.save(N);
        }, A.event = C.EventType, A.isHighlightWrapNode = x.isHighlightWrapNode, A.isHighlightSource = function(N) {
      ...
      var a = this && this.__values || function(y) {
        ...
        if (!C) return y;
        var x, E, v = C.call(y), A = [];
        try {
          for (; (p === void 0 || p-- > 0) && !(x = v.next()).done; ) A.push(x.value);
        } catch (N) {
          E = { error: N };
        } finally {
          try {
      ...
      var u = l(r(3)), c = r(18), d = r(4), g = r(1), h = r(20), m = r(0), b = function() {
        ...
        return y.prototype.highlightRange = function(p) {
          ...
          var x = this.options, E = x.$root, v = x.className, A = x.exceptSelectors, N = this.hooks, k = c.getSelectedNodes(E, p.start, p.end, A);
          return N.Render.SelectedNodes.isEmpty() || (k = N.Render.SelectedNodes.call(p.id, k) || []), k.map(function(R) {
            var H = c.wrapHighlight(R, p, v, C.options.wrapTag);
            return N.Render.WrapNode.isEmpty() || (H = N.Render.WrapNode.call(p.id, H)), H;
          });
          ...
          return x.forEach(function(v) {
            if (v instanceof u.default) {
              var A = v.deSerialize(C.options.$root, C.hooks);
              C.highlightRange(A).length > 0 ? E.push(v) : m.eventEmitter.emit(m.INTERNAL_ERROR_EVENT, { type: g.ERROR.HIGHLIGHT_SOURCE_NONE_RENDER, detail: v });
            } else m.eventEmitter.emit(m.INTERNAL_ERROR_EVENT, { type: g.ERROR.SOURCE_TYPE_ERROR });
          }), E;
        }, y.prototype.removeHighlight = function(p) {
          var C, x, E = new RegExp("(" + p + "\\" + m.ID_DIVISION + "|\\" + m.ID_DIVISION + "?" + p + "$)"), v = this.hooks, A = this.options.wrapTag, N = document.querySelectorAll(A + "[data-" + m.DATASET_IDENTIFIER + "]"), k = [], R = [], H = [];
          try {
            for (var I = a(N), $ = I.next(); !$.done; $ = I.next()) {
              ...
              w !== p || M ? w === p ? R.push(B) : w !== p && E.test(M) && H.push(B) : k.push(B);
            }
          } catch (S) {
            C = { error: S };
          } finally {
            try {
              $ && !$.done && (x = I.return) && x.call(I);
            } finally {
              if (C) throw C.error;
            }
          }
          return k.forEach(function(S) {
            var D = S.parentNode, L = document.createDocumentFragment();
            d.forEach(S.childNodes, function(F) {
              return L.appendChild(F.cloneNode(!1));
            });
            var O = S.previousSibling, T = S.nextSibling;
            D.replaceChild(L, S), c.normalizeSiblingText(O, !0), c.normalizeSiblingText(T, !1), v.Remove.UpdateNodes.call(p, S, "remove");
          }), R.forEach(function(S) {
            var D = S.dataset, L = D[m.CAMEL_DATASET_IDENTIFIER_EXTRA].split(m.ID_DIVISION), O = L.shift(), T = document.querySelector(A + "[data-" + m.DATASET_IDENTIFIER + '="' + O + '"]');
            T && (d.removeAllClass(S), d.addClass(S, s(T.classList))), D[m.CAMEL_DATASET_IDENTIFIER] = O, D[m.CAMEL_DATASET_IDENTIFIER_EXTRA] = L.join(m.ID_DIVISION), v.Remove.UpdateNodes.call(p, S, "id-update");
          }), H.forEach(function(S) {
            var D = S.dataset[m.CAMEL_DATASET_IDENTIFIER_EXTRA];
            S.dataset[m.CAMEL_DATASET_IDENTIFIER_EXTRA] = D.replace(E, ""), v.Remove.UpdateNodes.call(p, S, "extra-update");
          }), k.length + R.length + H.length !== 0;
          ...
          d.getHighlightsByRoot(x, C).forEach(function(E) {
            var v = E.parentNode, A = document.createDocumentFragment();
            d.forEach(E.childNodes, function(N) {
              return A.appendChild(N.cloneNode(!1));
            }), v.replaceChild(A, E);
          });
        }, y;
      }();
      ...
      o.getSelectedNodes = function(m, b, y, p) {
        ...
        if (C === x && C instanceof Text) return function(w, M, S, D) {
          for (var L = w, O = function(F) {
            return D == null ? void 0 : D.some(function(z) {
              return d(F, z);
            });
          }; L; ) {
            if (L.nodeType === 1 && O(L)) return [];
            L = L.parentNode;
          }
          w.splitText(M);
          var T = w.nextSibling;
          return T.splitText(S - M), [{ $node: T, type: s.SelectedNodeType.text, splitType: s.SplitType.both }];
        }(C, E, v, p);
        for (var A = [m], N = [], k = function(w) {
          return p == null ? void 0 : p.some(function(M) {
            return d(w, M);
          });
        }, R = !1, H = null; H = A.pop(); ) if (H.nodeType !== 1 || !k(H)) {
          for (var I = H.childNodes, $ = I.length - 1; $ >= 0; $--) A.push(I[$]);
          if (H === C) {
            if (H.nodeType === 3) {
              H.splitText(E);
              var B = H.nextSibling;
            ...
            if (H === x) {
              H.nodeType === 3 && ((B = H).splitText(v), N.push({ $node: B, type: s.SelectedNodeType.text, splitType: s.SplitType.tail }));
              break;
            }
            R && H.nodeType === 3 && N.push({ $node: H, type: s.SelectedNodeType.text, splitType: s.SplitType.none });
          }
        }
        return N;
      };
      ...
      o.wrapHighlight = function(m, b, y, p) {
        ...
        return l.isHighlightWrapNode(C) ? !l.isHighlightWrapNode(C) || h(x) && h(E) ? function(v, A, N) {
          var k = v.$node.parentNode, R = k;
          l.removeAllClass(R), g(R, N);
          var H = k.dataset, I = H[u.CAMEL_DATASET_IDENTIFIER];
          return H[u.CAMEL_DATASET_IDENTIFIER] = A.id, H[u.CAMEL_DATASET_IDENTIFIER_EXTRA] = H[u.CAMEL_DATASET_IDENTIFIER_EXTRA] ? I + u.ID_DIVISION + H[u.CAMEL_DATASET_IDENTIFIER_EXTRA] : I, R;
        }(m, b, y) : function(v, A, N, k) {
          var R = document.createElement(k), H = v.$node.parentNode, I = v.$node.previousSibling, $ = v.$node.nextSibling, B = document.createDocumentFragment(), w = H.dataset[u.CAMEL_DATASET_IDENTIFIER], M = H.dataset[u.CAMEL_DATASET_IDENTIFIER_EXTRA], S = M ? w + u.ID_DIVISION + M : w;
          R.setAttribute("data-" + u.DATASET_IDENTIFIER, A.id), R.setAttribute("data-" + u.DATASET_IDENTIFIER_EXTRA, S), R.appendChild(v.$node.cloneNode(!1));
          var D, L = !1, O = !1;
          I && ((T = H.cloneNode(!1)).textContent = I.textContent, B.appendChild(T), L = !0);
          var T, F = [];
          return Array.isArray(N) ? F.push.apply(F, i(N)) : F.push(N), g(R, c.unique(F)), B.appendChild(R), $ && ((T = H.cloneNode(!1)).textContent = $.textContent, B.appendChild(T), O = !0), D = L && O ? s.SplitType.both : L ? s.SplitType.head : O ? s.SplitType.tail : s.SplitType.none, R.setAttribute("data-" + u.DATASET_SPLIT_TYPE, D), H.parentNode.replaceChild(B, H), R;
        }(m, b, y, p) : function(v, A, N, k) {
          var R = document.createElement(k);
          return g(R, N), R.appendChild(v.$node.cloneNode(!1)), v.$node.parentNode.replaceChild(R, v.$node), R.setAttribute("data-" + u.DATASET_IDENTIFIER, A.id), R.setAttribute("data-" + u.DATASET_SPLIT_TYPE, v.splitType), R.setAttribute("data-" + u.DATASET_IDENTIFIER_EXTRA, ""), R;
        }(m, b, y, p);
...
var i5 = jc.exports;
const Hc = /* @__PURE__ */ ro(i5), ia = "altimate-display-", s5 = `${ia}-highlight`, B1 = `${ia}-highlight-hover`, l5 = `${ia}-active-highlight`, c5 = 1049, Pn = new Hc({
  style: {
    className: s5
  }
...
Pn.hooks.Render.SelectedNodes.tap(Rc);
Pn.hooks.Serialize.Restore.tap(Fc);
Vs.hooks.Render.SelectedNodes.tap(Rc);
Vs.hooks.Serialize.Restore.tap(Fc);
...
const u5 = (e) => {
  ...
  const t = u5(e);
  t && (Pn.remove(t.id), Vs.remove(t.id));
}, Ws = () => {
  var n, o;
  const e = $s(), t = (e == null ? void 0 : e[1]) === "analysis" ? document.getElementById("sql") : document.getElementById("code");
  ...
  ).find((a) => a.innerText === e.column)) == null ? void 0 : t.parentElement) == null ? void 0 : n.querySelector("td:nth-child(3)") : (o = Zs()) == null ? void 0 : o.firstChild : Ws();
}, g5 = (e) => {
...
`), s = Math.max(r.y, o.y), l = Array.from(a).findIndex((d) => {
  ...
  var e;
  return [
    (e = Ws()) == null ? void 0 : e.parentElement,
    Zs()
  ];
};
var lt = /* @__PURE__ */ ((e) => (e[e.LOADING = 0] = "LOADING", e[e.UNINITIALIZED = 1] = "UNINITIALIZED", e[e.INITIALIZED = 2] = "INITIALIZED", e))(lt || {});
function p5(e) {
...
function m5(e) {
  return p5(e) && "type" in e && typeof e.type == "string";
}
var Ic = Symbol.for("immer-nothing"), V1 = Symbol.for("immer-draftable"), nt = Symbol.for("immer-state"), b5 = process.env.NODE_ENV !== "production" ? [
...
function Xe(e, ...t) {
  if (process.env.NODE_ENV !== "production") {
    const n = b5[e], o = typeof n == "function" ? n.apply(null, t) : n;
...
function Wt(e) {
  var t;
  return e ? zc(e) || Array.isArray(e) || !!e[V1] || !!((t = e.constructor) != null && t[V1]) || la(e) || ca(e) : !1;
}
var C5 = Object.prototype.constructor.toString();
function zc(e) {
  ...
  return n === Object ? !0 : typeof n == "function" && Function.toString.call(n) === C5;
}
function jr(e, t) {
  sa(e) === 0 ? Reflect.ownKeys(e).forEach((n) => {
    t(n, e[n], e);
  }) : e.forEach((n, o) => t(o, n, e));
}
function sa(e) {
  const t = e[nt];
  return t ? t.type_ : Array.isArray(e) ? 1 : la(e) ? 2 : ca(e) ? 3 : 0;
}
function ns(e, t) {
...
function Us(e, t = !1) {
  return ua(e) || _n(e) || !Wt(e) || (sa(e) > 1 && (e.set = e.add = e.clear = e.delete = v5), Object.freeze(e), t && Object.entries(e).forEach(([n, o]) => Us(o, !0))), e;
}
function v5() {
  Xe(2);
}
...
function rs(e) {
  as(e), e.drafts_.forEach(E5), e.drafts_ = null;
}
function as(e) {
  e === ko && (ko = e.parent_);
}
...
function Z1(e, t) {
  ...
  const n = t.drafts_[0];
  return e !== void 0 && e !== n ? (n[nt].modified_ && (rs(t), Xe(4)), Wt(e) && (e = Hr(t, e), t.parent_ || Rr(t, e)), t.patches_ && Sn("Patches").generateReplacementPatches_(
    n[nt].base_,
    e,
    t.patches_,
    t.inversePatches_
  )) : e = Hr(t, n, []), rs(t), t.patches_ && t.patchListener_(t.patches_, t.inversePatches_), e !== Ic ? e : void 0;
}
function Hr(e, t, n) {
  if (ua(t))
    return t;
  ...
  if (!o.finalized_) {
    ...
    ), Rr(e, r, !1), n && e.patches_ && Sn("Patches").generatePatches_(
      o,
      n,
      e.patches_,
      e.inversePatches_
...
function U1(e, t, n, o, r, a, i) {
  if (process.env.NODE_ENV !== "production" && r === n && Xe(5), _n(r)) {
    ...
    !ns(t.assigned_, o) ? a.concat(o) : void 0, l = Hr(e, r, s);
    if (Pc(n, o, l), _n(l))
      e.canAutoFreeze_ = !1;
    else
      return;
  ...
  if (Wt(r) && !ua(r)) {
    if (!e.immer_.autoFreeze_ && e.unfinalizedDrafts_ < 1)
      return;
    Hr(e, r), (!t || !t.scope_.parent_) && typeof o != "symbol" && Object.prototype.propertyIsEnumerable.call(n, o) && Rr(e, r);
  }
}
function Rr(e, t, n = !1) {
...
var qs = {
  get(e, t) {
    ...
    if (!ns(n, t))
      return S5(e, n, t);
    const o = n[t];
    return e.finalized_ || !Wt(o) ? o : o === Ai(e.base_, t) ? (Mi(e), e.copy_[t] = ss(o, e)) : o;
  },
  has(e, t) {
    return t in hn(e);
  },
  ...
  set(e, t, n) {
    ...
    if (!e.modified_) {
      const r = Ai(hn(e), t), a = r == null ? void 0 : r[nt];
      if (a && a.base_ === n)
        return e.copy_[t] = n, e.assigned_[t] = !1, !0;
      if (y5(n, r) && (n !== void 0 || ns(e.base_, t)))
        return !0;
      Mi(e), is(e);
    }
  ...
  deleteProperty(e, t) {
    return Ai(e.base_, t) !== void 0 || t in e.base_ ? (e.assigned_[t] = !1, Mi(e), is(e)) : delete e.assigned_[t], e.copy_ && delete e.copy_[t], !0;
  },
...
Ao.deleteProperty = function(e, t) {
  return process.env.NODE_ENV !== "production" && isNaN(parseInt(t)) && Xe(13), Ao.set.call(this, e, t, void 0);
};
Ao.set = function(e, t, n) {
  return process.env.NODE_ENV !== "production" && t !== "length" && isNaN(parseInt(t)) && Xe(14), qs.set.call(this, e[0], t, n, e[0]);
};
function Ai(e, t) {
  const n = e[nt];
  return (n ? hn(n) : e)[t];
...
var k5 = class {
  constructor(e) {
    this.autoFreeze_ = !0, this.useStrictShallowCopy_ = !1, this.produce = (t, n, o) => {
      ...
      if (Wt(t)) {
        ...
        return W1(a, o), Z1(r, a);
      } else if (!t || typeof t != "object") {
        if (r = n(t), r === void 0 && (r = t), r === Ic && (r = void 0), this.autoFreeze_ && Us(r, !0), o) {
          const a = [], i = [];
  ...
  createDraft(e) {
    Wt(e) || Xe(8), _n(e) && (e = A5(e));
    const t = $1(this), n = ss(e, void 0);
    return n[nt].isManual_ = !0, as(t), n;
  }
  finishDraft(e, t) {
    const n = e && e[nt];
    (!n || !n.isManual_) && Xe(9);
    const { scope_: o } = n;
    return W1(o, t), Z1(void 0, o);
  }
  /**
...
function ss(e, t) {
  const n = la(e) ? Sn("MapSet").proxyMap_(e, t) : ca(e) ? Sn("MapSet").proxySet_(e, t) : _5(e, t);
  return (t ? t.scope_ : Bc()).drafts_.push(n), n;
}
function A5(e) {
  return _n(e) || Xe(10, e), Wc(e);
}
function Wc(e) {
  if (!Wt(e) || ua(e))
    return e;
...
function q1(e, t) {
  ...
  return n.toString = () => `${e}`, n.type = e, n.match = (o) => m5(o) && o.type === e, n;
}
function Y1(e) {
  return Wt(e) ? $c(e, () => {
  }) : e;
...
var N5 = /* @__PURE__ */ Symbol.for("rtk-slice-createasyncthunk");
function D5(e, t) {
  return `${e}/${t}`;
}
function O5({
  ...
  var n;
  const t = (n = e == null ? void 0 : e.asyncThunk) == null ? void 0 : n[N5];
  return function(r) {
    const {
      name: a,
      reducerPath: i = a
    ...
    const s = (typeof r.reducers == "function" ? r.reducers(j5()) : r.reducers) || {}, l = Object.keys(s), u = {
    ...
    function d() {
      ...
      const [x = {}, E = [], v = void 0] = typeof r.extraReducers == "function" ? Zc(r.extraReducers) : [r.extraReducers], A = {
        ...x,
        ...u.sliceCaseReducersByType
      };
      return T5(r.initialState, (N) => {
        for (let k in A)
          N.addCase(k, A[k]);
    ...
    function p(x, E = !1) {
      ...
      function A(N = g) {
        ...
        return G1(k, N, {
          insert: () => {
            const R = {};
            for (const [H, I] of Object.entries(r.selectors ?? {}))
              R[H] = L5(I, N, y, E);
            return R;
          }
        });
...
function H5({
  ...
  if ("reducer" in o) {
    ...
    a = o;
  r.addCase(e, a).exposeCaseReducer(t, a).exposeAction(t, i ? q1(e, i) : q1(e));
}
function R5(e) {
...
const z5 = {
  ...
  conversations: {},
  conversationsLoadingState: lt.UNINITIALIZED,
  ...
  reducers: {
    ...
    refetchConversations: (e) => {
      e.conversationsLoadingState = lt.UNINITIALIZED;
    },
    setUsers: (e, t) => {
      var n;
  ...
  setCurrentUserId: jy,
  setShareId: Hy,
  updateSelectedConversationId: Gs,
  updateRightPanelState: Ks,
  setUsers: P5,
  setConversations: B5,
  resetNewConversation: Xs,
  updateNewConversation: Js,
  upsertConversation: Ry,
  setDocsAppRendered: Fy,
  updateCurrentPage: Iy,
  updateCodeblockLoaded: zy,
  resolveConversationGroup: V5,
  setConversationsLoadingState: K1,
  refetchConversations: Uc,
  setConversationSource: Py,
  setManifest: W5
} = Fr.actions, da = dt({
  ...
  return /* @__PURE__ */ f.jsx(da.Provider, { value: l, children: e });
}, Z5 = () => He(da), we = (e) => {
  const { getValue: t } = He(da);
  return t(e);
}, ft = () => {
  const { dispatch: e } = He(da);
  return e;
}, U5 = (e) => e;
let qc = U5;
process.env.NODE_ENV !== "production" && (qc = (e, t) => {
  if (!e)
    throw new Error(t);
});
const q5 = dt(null), Y5 = dt({}), G5 = dt({
  transformPagePoint: (e) => e,
  isStatic: !1,
  reducedMotion: "never"
}), K5 = typeof window < "u", X5 = K5 ? Pd : re;
function Yc(e) {
  const t = se(null);
  return t.current === null && (t.current = e()), t.current;
}
class J5 extends _.Component {
...
function Q5({ children: e, isPresent: t }) {
  const n = Oc(), o = se(null), r = se({
    width: 0,
    height: 0,
    top: 0,
    left: 0
  ...
  }, [t]), f.jsx(J5, { isPresent: t, childRef: o, sizeRef: r, children: _.cloneElement(e, { ref: o }) });
}
const e4 = ({ children: e, initial: t, isPresent: n, onExitComplete: o, custom: r, presenceAffectsLayout: a, mode: i }) => {
  const s = Yc(t4), l = Oc(), u = Se(
    () => ({
      id: l,
      initial: t,
      isPresent: n,
  ...
  return Se(() => {
    ...
    !n && !s.size && o && o();
  }, [n]), i === "popLayout" && (e = f.jsx(Q5, { isPresent: n, children: e })), f.jsx(q5.Provider, { value: u, children: e });
};
function t4() {
...
const n4 = ({ children: e, exitBeforeEnter: t, custom: n, initial: o = !0, onExitComplete: r, presenceAffectsLayout: a = !0, mode: i = "sync" }) => {
  qc(!t, "Replace exitBeforeEnter with mode='wait'");
  const s = Se(() => X1(e), [e]), l = s.map(sr), u = se(!0), c = se(s), d = Yc(() => /* @__PURE__ */ new Map()), [g, h] = ae(s), [m, b] = ae(s);
  X5(() => {
  ...
  if (s !== g) {
    ...
    i === "wait" && y.length && (C = y), b(X1(C)), h(s);
    return;
  }
  ...
  const { forceRender: p } = He(Y5);
  return f.jsx(f.Fragment, { children: m.map((C) => {
    const x = sr(C), E = s === m || l.includes(x), v = () => {
      if (d.has(x))
        d.set(x, !0);
      else
        return;
...
}, b4 = (e) => _e.get(`dbt/dbt_docs_share/${e}`), C4 = (e, t, n) => _e.post(`dbt/dbt_docs_share/${e}/conversation_group`, {
  ...t,
  telemetry: {
...
), x4 = (e) => _e.get("users/chat", { company: e }), w4 = (e, t, n) => _e.post(
  ...
  const e = we(
    ...
    (c) => c.newConversation
  ), o = ft(), [r, a] = ae(null), [i, s] = ae(null);
  re(() => {
    n && (a(null), s(null));
  }, [n]);
  const l = pe(() => {
    console.log("resetHighlights"), r && d5(r), s(null), a(null);
  }, [r]);
  return re(() => {
    ...
    pos: i,
    onSelectionEnd: (c) => {
      const d = c.target, g = g5(d), { end: h, start: m } = c.detail.selectionRange, b = document.getSelection();
      if (!b || !b.rangeCount)
        return l(), null;
      const p = b.getRangeAt(0).toString(), C = d == null ? void 0 : d.innerText;
      if (!p || !C)
        return;
      const { end: x, start: E, x: v, y: A } = h5(
        g,
        d,
        p,
        h,
      ...
      console.log("selection range", x, E, v, A);
      const N = {
        meta: {
          filePath: "",
          field: g,
  ...
  ), n = ft(), o = se(null), r = Se(() => f5(e.meta), [e.meta]), a = () => {
    n(
      Gs(e.conversation_group_id)
    );
  }, i = Se(() => {
    if (!r)
      return;
...
}, A4 = "_dbtDocs_14zop_9", M4 = "_hotspotButton_14zop_46", T4 = "_pulse_14zop_1", N4 = "_conversationRightPanelCloseButton_14zop_62", D4 = "_conversationRightPanel_14zop_62", O4 = "_newConversationForm_14zop_94", L4 = "_highlightText_14zop_108", j4 = "_conversationInputForm_14zop_130", H4 = "_conversationGroup_14zop_156", R4 = "_replyForm_14zop_189", F4 = "_resolveButton_14zop_237", $t = {
  dbtDocs: A4,
  hotspotButton: M4,
  pulse: T4,
  conversationRightPanelCloseButton: N4,
  conversationRightPanel: D4,
  newConversationForm: O4,
  highlightText: L4,
  conversationInputForm: j4,
  conversationGroup: H4,
  replyForm: R4,
  resolveButton: F4
}, I4 = "_profileImage_11vaf_1", z4 = {
  profileImage: I4
}, Xc = ({ user: e }) => {
  var t;
  return /* @__PURE__ */ f.jsx("div", { className: z4.profileImage, children: ((t = e == null ? void 0 : e.first_name) == null ? void 0 : t[0]) || "" });
};
function P4(e) {
  if (Array.isArray(e)) {
...
function ls(e, t) {
  return ls = Object.setPrototypeOf || function(o, r) {
...
var Y4 = function(e, t, n, o, r, a, i, s) {
...
function To(e, t, n) {
  return (t = n6(t)) in e ? Object.defineProperty(e, t, {
    value: n,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
function Qc(e, t) {
  ...
  return kr(e) && kr(t) && ao(t).forEach(function(o) {
    kr(t[o]) ? o in e ? n[o] = Qc(e[o], t[o]) : Object.assign(n, To({}, o, t[o])) : Object.assign(n, To({}, o, t[o]));
  }), n;
}
var us = function(t) {
  ...
  for (var o = n.map(Q1), r = ao(t), a = {}, i = 0, s = r.length; i < s; i += 1) {
    var l = r[i];
    (n.indexOf(l) >= 0 || o.indexOf(Q1(l)) >= 0) && (a[l] = t[l]);
  }
  return a;
}, d6 = function e(t, n) {
  for (var o = us.apply(void 0, [{}, s6(t, n)].concat(Pt(Jc(e0(t, n))))), r = ao(o).filter(Qs), a = 0, i = r.length; a < i; a += 1) {
    var s = r[a], l = e(o[s], n);
    n.indexOf(s) >= 0 ? (delete o[s], o = us({}, o, l)) : o[s] = l;
  }
  return o;
};
function e2(e, t) {
...
var f6 = ["animationName"], t0 = function(t) {
...
function r0(e) {
  var t = e.style, n = e.className, o = e.classNames, r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : t0, a = n || p6(o) || (t == null ? void 0 : t.className), i = typeof t == "function" ? t : h6(function(d, g) {
    var h = o0(d);
    Gn(Array.isArray(h), "First parameter must be a string, an array of strings, a plain object with boolean values, or a falsy value."), Gn(!g || kr(g), "Optional second parameter must be a plain object.");
    var m = h.filter(Qs), b = h.filter(c6), y = b.length > 0 ? function(x) {
      return Jc(e0(x, b));
    } : function(x) {
      return [x];
    }, p = function() {
    ...
    return r0(On(On(On({}, (t || g) && {
      style: us.apply(void 0, [{}].concat(Pt(p(g)), Pt(p(t))))
    }), C && {
      className: C.join(" ")
    }), o && {
      classNames: o
    ...
    style: t
  }), l = Pt(new Set([].concat(Pt(s.className ? s.className.split(" ") : []), Pt(a ? a.split(" ") : [])))), u = o ? l6(l.map(function(d) {
    return o[d];
...
var b6 = function() {
  ...
  return n.reduce(function(r, a) {
    return fo(fo(fo({}, r), typeof a == "function" ? a : {}), {}, {
      style: fo(fo({}, r.style), typeof a == "function" ? a.style : a)
    });
  }, {});
}, el = function(t, n, o) {
  var r = n.style, a = n.className, i = n.classNames, s = He(n0), l = Se(function() {
    return r0({
      style: r,
      className: a,
      classNames: i
...
function y6() {
  return a2 || (a2 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var v = l, A = u, N = s, k = i, R = t, H = c, I = o, $ = m, B = h, w = n, M = a, S = r, D = d, L = !1;
    function O(G) {
...
function w6() {
  if (d2) return Li;
  d2 = 1;
  var e = a0(), t = v6(), n = tl(), o = i0(), r = x6(), a = function() {
  };
  ...
  return Li = function(s, l) {
    ...
    function N(T) {
      ...
      function F(z, V, W, q, K) {
        for (var X = z[V], J = 0; J < T.length; J++)
          if (m(X, T[J]))
            return null;
    ...
    function R(T) {
      ...
      for (var F = 0; F < T.length; F++) {
        ...
        if (typeof z != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + L(z) + " at index " + F + "."
          ), i;
      }
    ...
    function H() {
      function T(F, z, V, W, q) {
        return w(F[z]) ? null : new b("Invalid " + W + " `" + q + "` supplied to " + ("`" + V + "`, expected a ReactNode."));
      }
      return y(T);
    }
    function I(T, F, z, V, W) {
      return new b(
        (T || "React class") + ": " + F + " type `" + z + "." + V + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + W + "`."
      );
    }
    function $(T) {
      function F(z, V, W, q, K) {
...
if (process.env.NODE_ENV !== "production") {
  var _6 = a0(), S6 = !0;
  ds.exports = w6()(_6.isElement, S6);
} else
  ds.exports = E6()();
var k6 = ds.exports;
const Q = /* @__PURE__ */ ro(k6);
var Ar = function(t) {
  ...
  return new RegExp(t.map(function(o) {
    var r = n.exec(o.toString()), a = Pr(r, 3), i = a[1], s = a[2];
    return Gn(!s, "RegExp flags are not supported. Change /".concat(i, "/").concat(s, " into /").concat(i, "/")), "(".concat(i, ")");
  }).join("|"), "g");
}, s0 = function(t) {
  var n = 0;
  ...
  for (var r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : M6, a = A6(n.map(function(v) {
    return v.regex;
    ...
    var d = s.find(function(v) {
      return !!l[v];
    }), g = s.indexOf(d), h = n[g], m = h.markup, b = h.displayTransform, y = d + g2(m, "id"), p = d + g2(m, "display"), C = l[y], x = b(C, l[p]), E = t.substring(u, l.index);
    r(E, u, c), c += E.length, o(l[0], l.index, c, C, x, g, u), c += x.length, u = a.lastIndex;
  }
  u < t.length && r(t.substring(u), u, c);
}, mn = function(t, n) {
  var o = "";
  return qo(t, n, function(r, a, i, s, l) {
    o += l;
  }, function(r) {
    o += r;
  }), o;
  ...
  return qo(t, n, s, i), a === void 0 ? t.length : a;
}, _o = function(t, n, o, r) {
  return t.substring(0, n) + r + t.substring(o);
}, T6 = function(t, n, o, r) {
  var a = o.selectionStartBefore, i = o.selectionEndBefore, s = o.selectionEndAfter, l = mn(t, r), u = l.length - n.length;
  ...
  var h = Ye(t, r, d, "START"), m = Ye(t, r, g, "END"), b = Ye(t, r, d, "NULL"), y = Ye(t, r, g, "NULL"), p = b === null || y === null, C = _o(t, h, m, c);
  if (!p) {
    var x = mn(C, r);
    if (x !== n) {
      for (d = 0; n[d] === x[d]; )
        d++;
      c = n.slice(d, s), g = l.lastIndexOf(n.substring(s)), h = Ye(t, r, d, "START"), m = Ye(t, r, g, "END"), C = _o(t, h, m, c);
    }
  }
  return C;
}, h2 = function(t, n, o) {
  ...
  var o = [];
  return qo(t, n, function(r, a, i, s, l, u, c) {
    o.push({
      id: s,
      display: l,
      childIndex: u,
  ...
  var o = new RegExp(t.toString() + "|").exec("").length - 1, r = s0(n);
...
function fa(e, t) {
  var n = function(r) {
    var a = function(l) {
      var u = l.style, c = l.className, d = l.classNames, g = e6(l, z6), h = t ? t(g) : void 0, m = el(e, {
        style: u,
        className: c,
        classNames: d
      }, h);
      return /* @__PURE__ */ P.createElement(r, ut({}, g, {
        style: m
      }));
...
function u0(e) {
  ...
  var l = e.style, u = ae({
    left: void 0,
    top: void 0
  }), c = Pr(u, 2), d = c[0], g = c[1], h = ae(), m = Pr(h, 2), b = m[0], y = m[1];
  re(function() {
    p();
  });
  var p = function() {
  ...
  var E = [], v = {}, A = E, N = 0, k = function(w, M, S) {
    if (fs(x) && x >= M && x <= M + w.length) {
      var D = x - M;
      A.push(H(w.substring(0, D), N)), A = [H(w.substring(D), N)];
    } else
      A.push(H(w, N));
    N++;
  }, R = function(w, M, S, D, L, O, T) {
    var F = P6(v, D);
    A.push(I(D, L, O, F));
  }, H = function(w, M) {
    return /* @__PURE__ */ P.createElement("span", ut({}, l("substring"), {
      key: M
    }), w);
  }, I = function(w, M, S, D) {
    var L = {
    ...
    return /* @__PURE__ */ P.cloneElement(O, L);
  }, $ = function(w) {
    return /* @__PURE__ */ P.createElement("span", ut({}, l("caret"), {
      ref: y,
      key: "caret"
    }), w);
  };
  return qo(r, C, R, k), A.push(" "), A !== E && E.push($(A)), /* @__PURE__ */ P.createElement("div", ut({}, l, {
    ref: i
  }), E);
}
u0.propTypes = {
...
function d0(e) {
  ...
  return /* @__PURE__ */ P.createElement("li", ut({
    id: t,
    role: "option",
    "aria-selected": n
  }, d, c), g());
...
function Z6(e) {
  var t = e.style, n = e.className, o = e.classNames, r = el(U6, {
    style: t,
    className: n,
    classNames: o
  }), a = r("spinner");
...
function f0(e) {
  var t = e.id, n = e.suggestions, o = n === void 0 ? {} : n, r = e.a11ySuggestionsListLabel, a = e.focusIndex, i = e.position, s = e.left, l = e.right, u = e.top, c = e.scrollFocusedIntoView, d = e.isLoading, g = e.isOpened, h = e.onSelect, m = h === void 0 ? function() {
    return null;
  } : h, b = e.ignoreAccents, y = e.containerRef, p = e.children, C = e.style, x = e.customSuggestionsContainer, E = e.onMouseDown, v = e.onMouseEnter, A = ae(void 0), N = Pr(A, 2), k = N[0], R = N[1];
  re(function() {
    if (!(!k || k.offsetHeight >= k.scrollHeight || !c)) {
      var S = k.scrollTop, D = k.children[a].getBoundingClientRect(), L = D.top, O = D.bottom, T = k.getBoundingClientRect(), F = T.top;
      L = L - F + S, O = O - F + S, L < S ? k.scrollTop = L : O > k.offsetHeight && (k.scrollTop = O - k.offsetHeight);
    }
  }, [a, c, k]);
  var H = function() {
    var D = /* @__PURE__ */ P.createElement("ul", ut({
      ref: R,
      id: t,
      role: "listbox",
      "aria-label": r
    }, C("list")), Object.values(o).reduce(function(L, O) {
      var T = O.results, F = O.queryInfo;
      return [].concat(Ir(L), Ir(T.map(function(z, V) {
        return I(z, F, L.length + V);
      })));
    }, []));
    return x ? x(D) : D;
  }, I = function(D, L, O) {
    var T = O === a, F = L.childIndex, z = L.query, V = qn.toArray(p)[F].props.renderSuggestion;
    return /* @__PURE__ */ P.createElement($6, {
      style: C("item"),
      key: "".concat(F, "-").concat(M(D)),
      id: l0(t, O),
      query: z,
      index: O,
      ignoreAccents: b,
  ...
  return g ? /* @__PURE__ */ P.createElement("div", ut({}, b6({
    position: i || "absolute",
    left: s,
    right: l,
    top: u
...
var X6 = function(t) {
  ...
  function n(o) {
    var r;
    return W4(this, n), r = t.call(this, o), le(de(r), "setContainerElement", function(a) {
      r.containerElement = a;
    }), le(de(r), "getInputProps", function() {
      var a = r.props, i = a.readOnly, s = a.disabled, l = a.style, u = I6(
        r.props,
      ...
      return mt(mt(mt(mt({}, u), l("input")), {}, {
        ...
        "aria-activedescendant": l0(r.uuidSuggestionsOverlay, r.state.focusIndex)
      });
      ...
      return /* @__PURE__ */ P.createElement("input", ut({
        type: "text",
        ref: r.setInputRef
      }, a));
    }), le(de(r), "renderTextarea", function(a) {
      return /* @__PURE__ */ P.createElement("textarea", ut({
        ref: r.setInputRef
      }, a));
      ...
      if (!fs(r.state.selectionStart))
        return null;
      var a = r.state.suggestionsPosition, i = a.position, s = a.left, l = a.top, u = a.right, c = /* @__PURE__ */ P.createElement(Y6, {
      ...
      return /* @__PURE__ */ P.createElement(V6, {
      ...
      return mn(r.props.value || "", en(r.props.children));
      ...
      var s = r.props.value || "", l = en(r.props.children), u = a.target.value, c = r.state.selectionStart;
      ...
      u = mn(g, l);
      var h = a.target.selectionStart, m = a.target.selectionEnd, b = !1, y = h2(s, l, h);
      ...
      var a = r.state, i = a.suggestions, s = a.focusIndex, l = Object.values(i).reduce(function(d, g) {
        ...
        return [].concat(Ir(d), Ir(h.map(function(b) {
          return {
            result: b,
            queryInfo: m
          };
      ...
      if (!(!a || !r.suggestionsElement)) {
        var c = r.suggestionsElement, d = r.highlighterElement, g = d.getBoundingClientRect(), h = Hi(d, "font-size"), m = {
          left: g.left + a.left,
          top: g.top + a.top + h
        ...
        if (c) {
          ...
          if (s) {
            ...
            p -= Hi(c, "margin-left"), C -= Hi(c, "margin-top"), p -= d.scrollLeft, C -= d.scrollTop;
      ...
      var s = r.props.value || "", l = r.props.children, u = en(l), c = Ye(s, u, i, "NULL");
      if (c !== null) {
        var d = N6(s.substring(0, c), u), g = a.substring(d, i);
        P.Children.forEach(l, function(h, m) {
          if (h) {
            var b = X6(h.props.trigger, r.props), y = g.match(b);
            if (y) {
      ...
      var c = r.props, d = c.children, g = c.ignoreAccents, h = qn.toArray(d)[i], m = J6(h.props.data, g), b = m(a, r.updateSuggestions.bind(null, r._queryId, i, a, s, l, u));
      ...
      if (a === r._queryId) {
        ...
        var g = r.state.focusIndex, h = cr(r.suggestions);
        r.setState({
      ...
      var s = a.id, l = a.display, u = i.childIndex, c = i.querySequenceStart, d = i.querySequenceEnd, g = i.plainTextValue, h = r.props.value || "", m = en(r.props.children), b = qn.toArray(r.props.children)[u], y = b.props, p = y.markup, C = y.displayTransform, x = y.appendSpaceOnAdd, E = y.onAdd, v = Ye(h, m, c, "START"), A = v + d - c, N = L6(p, s, l);
      x && (N += " ");
      var k = _o(h, v, A, N);
      ...
      r.executeOnChange(I, k, B, $), E && E(s, l, v, A), r.clearSuggestions();
      ...
      return fs(r.state.selectionStart) && (cr(r.state.suggestions) !== 0 || r.isLoading());
  ...
  return Z4(n, [{
    ...
    key: "render",
    value: function() {
      return /* @__PURE__ */ P.createElement("div", ut({
    ...
    value: function(r) {
      if (r.target === this.inputElement && this.supportsClipboardActions(r)) {
        r.preventDefault();
        var a = this.state, i = a.selectionStart, s = a.selectionEnd, l = this.props, u = l.value, c = l.children, d = en(c), g = Ye(u, d, i, "START"), h = Ye(u, d, s, "END"), m = r.clipboardData.getData("text/react-mentions"), b = r.clipboardData.getData("text/plain"), y = _o(u, g, h, m || b).replace(/\r/g, ""), p = mn(y, d), C = {
          target: mt(mt({}, r.target), {}, {
            value: y
          })
        };
        this.executeOnChange(C, y, p, yo(y, d));
        var x = h2(u, d, i), E = (x || i) + mn(m || b, d).length;
        this.setState({
          selectionStart: E,
          selectionEnd: E,
    ...
    value: function(r) {
      var a = this.inputElement.selectionStart, i = this.inputElement.selectionEnd, s = this.props, l = s.children, u = s.value, c = en(l), d = Ye(u, c, a, "START"), g = Ye(u, c, i, "END");
    ...
    value: function(r) {
      if (r.target === this.inputElement && this.supportsClipboardActions(r)) {
        ...
        var a = this.state, i = a.selectionStart, s = a.selectionEnd, l = this.props, u = l.children, c = l.value, d = en(u), g = Ye(c, d, i, "START"), h = Ye(c, d, s, "END"), m = [c.slice(0, g), c.slice(h)].join(""), b = mn(m, d), y = {
          target: mt(mt({}, r.target), {}, {
            value: b
          })
        };
...
var Hi = function(t, n) {
...
}, Q6 = typeof navigator < "u" && /iPhone|iPad|iPod/i.test(navigator.userAgent), e8 = fa({
  position: "relative",
  overflowY: "visible",
  input: {
    display: "block",
  ...
  var n = t.display, o = t.style, r = t.className, a = t.classNames, i = el(n8, {
    style: o,
    className: r,
    classNames: a
  });
...
const o8 = {
  ...
  r ? /* @__PURE__ */ f.jsx(Xc, { user: r }) : null,
  /* @__PURE__ */ f.jsx(
    r8,
    {
      value: e,
  ...
  /* @__PURE__ */ f.jsx(ra, { loading: n, color: "primary", children: /* @__PURE__ */ f.jsx(g4, {}) })
] }), p0 = ({
  ...
  const e = we(
    ...
    (c) => c.shareId
  ), r = ft(), [a, i] = ae(!1), [s, l] = ae(""), u = async (c) => {
    if (c == null || c.stopPropagation(), c == null || c.preventDefault(), !(!t || !o)) {
      ...
      r(Uc()), i(!1), r(Ks(!0)), r(Xs()), l("");
    }
  };
  return /* @__PURE__ */ f.jsx(ln, { className: $t.newConversationForm, children: /* @__PURE__ */ f.jsx(Tn, { children: /* @__PURE__ */ f.jsxs("form", { onSubmit: u, children: [
...
(function(e, t) {
  (function(n, o) {
    ...
    var n = 1e3, o = 6e4, r = 36e5, a = "millisecond", i = "second", s = "minute", l = "hour", u = "day", c = "week", d = "month", g = "quarter", h = "year", m = "date", b = "Invalid Date", y = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, p = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, C = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(w) {
      ...
      var D = String(w);
      return !D || D.length >= M ? w : "" + Array(M + 1 - D.length).join(S) + w;
    }, E = { s: x, z: function(w) {
      var M = -w.utcOffset(), S = Math.abs(M), D = Math.floor(S / 60), L = S % 60;
      return (M <= 0 ? "+" : "-") + x(D, 2, "0") + ":" + x(L, 2, "0");
    }, m: function w(M, S) {
      if (M.date() < S.date()) return -w(S, M);
      var D = 12 * (S.year() - M.year()) + (S.month() - M.month()), L = M.clone().add(D, d), O = S - L < 0, T = M.clone().add(D + (O ? -1 : 1), d);
      return +(-(D + (S - L) / (O ? L - T : T - L)) || 0);
    }, a: function(w) {
    ...
    A[v] = C;
    var N = "$isDayjsObject", k = function(w) {
    ...
    I.l = R, I.i = k, I.w = function(w, M) {
      return H(w, { locale: M.$L, utc: M.$u, x: M.$x, $offset: M.$offset });
    };
    var $ = function() {
      function w(S) {
        this.$L = R(S.locale, null, !0), this.parse(S), this.$x = this.$x || S.x || {}, this[N] = !0;
      }
      var M = w.prototype;
      return M.parse = function(S) {
        this.$d = function(D) {
          ...
          if (typeof L == "string" && !/Z$/i.test(L)) {
            var T = L.match(y);
            if (T) {
              var F = T[2] - 1 || 0, z = (T[7] || "0").substring(0, 3);
              return O ? new Date(Date.UTC(T[1], F, T[3] || 1, T[4] || 0, T[5] || 0, T[6] || 0, z)) : new Date(T[1], F, T[3] || 1, T[4] || 0, T[5] || 0, T[6] || 0, z);
            }
          }
          return new Date(L);
        }(S), this.init();
      ...
      }, M.isSame = function(S, D) {
        var L = H(S);
        return this.startOf(D) <= L && L <= this.endOf(D);
      }, M.isAfter = function(S, D) {
        return H(S) < this.startOf(D);
      }, M.isBefore = function(S, D) {
        return this.endOf(D) < H(S);
      }, M.$g = function(S, D, L) {
        return I.u(S) ? this[D] : this.set(L, S);
      }, M.unix = function() {
        return Math.floor(this.valueOf() / 1e3);
      }, M.valueOf = function() {
        return this.$d.getTime();
      }, M.startOf = function(S, D) {
        var L = this, O = !!I.u(D) || D, T = I.p(S), F = function(te, Z) {
          var fe = I.w(L.$u ? Date.UTC(L.$y, Z, te) : new Date(L.$y, Z, te), L);
          return O ? fe : fe.endOf(u);
        }, z = function(te, Z) {
          return I.w(L.toDate()[te].apply(L.toDate("s"), (O ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(Z)), L);
        }, V = this.$W, W = this.$M, q = this.$D, K = "set" + (this.$u ? "UTC" : "");
        switch (T) {
          case h:
            return O ? F(1, 0) : F(31, 11);
          case d:
            return O ? F(1, W) : F(0, W + 1);
          case c:
            var X = this.$locale().weekStart || 0, J = (V < X ? V + 7 : V) - X;
            return F(O ? q - J : q + (6 - J), W);
          case u:
          case m:
            return z(K + "Hours", 0);
          case l:
        ...
        var L, O = I.p(S), T = "set" + (this.$u ? "UTC" : ""), F = (L = {}, L[u] = T + "Date", L[m] = T + "Date", L[d] = T + "Month", L[h] = T + "FullYear", L[l] = T + "Hours", L[s] = T + "Minutes", L[i] = T + "Seconds", L[a] = T + "Milliseconds", L)[O], z = O === u ? this.$D + (D - this.$W) : D;
        if (O === d || O === h) {
          var V = this.clone().set(m, 1);
          V.$d[F](z), V.init(), this.$d = V.set(m, Math.min(this.$D, V.daysInMonth())).$d;
        } else F && this.$d[F](z);
        ...
        var L, O = this;
        S = Number(S);
        var T = I.p(D), F = function(W) {
          var q = H(O);
          return I.w(q.date(q.date() + Math.round(W * S)), O);
        };
        if (T === d) return this.set(d, this.$M + S);
        if (T === h) return this.set(h, this.$y + S);
        if (T === u) return F(1);
        if (T === c) return F(7);
        var z = (L = {}, L[s] = o, L[l] = r, L[i] = n, L)[T] || 1, V = this.$d.getTime() + S * z;
        return I.w(V, this);
      }, M.subtract = function(S, D) {
        return this.add(-1 * S, D);
      }, M.format = function(S) {
        var D = this, L = this.$locale();
        if (!this.isValid()) return L.invalidDate || b;
        var O = S || "YYYY-MM-DDTHH:mm:ssZ", T = I.z(this), F = this.$H, z = this.$m, V = this.$M, W = L.weekdays, q = L.months, K = L.meridiem, X = function(Z, fe, G, ye) {
          return Z && (Z[fe] || Z(D, O)) || G[fe].slice(0, ye);
        }, J = function(Z) {
        ...
        return O.replace(p, function(Z, fe) {
          return fe || function(G) {
            switch (G) {
              ...
              case "d":
                return String(D.$W);
              case "dd":
                return X(L.weekdaysMin, D.$W, W, 2);
              case "ddd":
                return X(L.weekdaysShort, D.$W, W, 3);
              case "dddd":
                return W[D.$W];
              case "H":
                return String(F);
      ...
      }, M.diff = function(S, D, L) {
        var O, T = this, F = I.p(D), z = H(S), V = (z.utcOffset() - this.utcOffset()) * o, W = this - z, q = function() {
          return I.m(T, z);
        };
        switch (F) {
          case h:
        ...
        return A[this.$L];
      }, M.locale = function(S, D) {
        if (!S) return this.$L;
        var L = this.clone(), O = R(S, D, !0);
        return O && (L.$L = O), L;
      }, M.clone = function() {
    ...
    return H.prototype = B, [["$ms", a], ["$s", i], ["$m", s], ["$H", l], ["$W", u], ["$M", d], ["$y", h], ["$D", m]].forEach(function(w) {
      B[w[1]] = function(M) {
        return this.$g(M, w[0], w[1]);
      };
    }), H.extend = function(w, M) {
      return w.$i || (w(M, $, H), w.$i = !0), H;
    }, H.locale = R, H.isDayjs = k, H.unix = function(w) {
      return H(1e3 * w);
    }, H.en = A[v], H.Ls = A, H.p = {}, H;
  });
})(m0);
var i8 = m0.exports;
const gs = /* @__PURE__ */ ro(i8), s8 = ({
  conversationGroupId: e,
  shareId: t
}) => {
  const { onResolve: n, source: o } = No(), [r, a] = ae(!1), i = async () => {
    e && (a(!0), await w4(t, e, o), n(), a(!1));
  };
  ...
  /* @__PURE__ */ f.jsxs("div", { className: "d-flex align-items-center gap-1", children: [
    /* @__PURE__ */ f.jsx(Xc, { user: e }),
    /* @__PURE__ */ f.jsxs("h4", { children: [
      e == null ? void 0 : e.first_name,
      " ",
      e == null ? void 0 : e.last_name
    ] }),
    /* @__PURE__ */ f.jsx("span", { children: gs(t).format("HH:mm, DD MMM YY") })
  ] }),
  n ? /* @__PURE__ */ f.jsx(
    s8,
    {
...
] }), l8 = ({ conversation: e, shareId: t }) => {
  const { users: n } = No(), o = Se(() => {
    if (e != null && e.user_id)
      return n[e.user_id];
  }, [e.user_id, n]);
  return /* @__PURE__ */ f.jsxs(ln, { children: [
    ...
    /* @__PURE__ */ f.jsx(Tn, { children: /* @__PURE__ */ f.jsx("p", { children: e.message.replace(/@\[(.*?)\]\((.*?)\)/g, "@$2") }) })
  ] });
}, c8 = ({ conversationGroupId: e, shareId: t }) => {
  const { currentUser: n, users: o, onReplyAdd: r, source: a } = No(), i = Object.values(o), [s, l] = ae(""), [u, c] = ae(!1), d = async (g) => {
  ...
  var g;
  const { users: o } = No(), r = Se(() => {
    if (e.owner)
      return o[e.owner];
  }, [e.owner, o]), { isSelected: a } = No(), [i, s] = ae(!1), l = pe(
    (h) => {
      !a || !h || (console.log(
  ...
  return /* @__PURE__ */ f.jsx("div", { ref: l, className: $t.conversationGroup, children: /* @__PURE__ */ f.jsxs(ln, { className: `${a ? "active" : ""}`, onClick: n, children: [
    ...
    /* @__PURE__ */ f.jsxs(Tn, { children: [
      /* @__PURE__ */ f.jsx(p0, { meta: e.meta }),
      /* @__PURE__ */ f.jsx("p", { children: u.message.replace(/@\[(.*?)\]\((.*?)\)/g, "@$2") }),
      /* @__PURE__ */ f.jsx(ke, { onClick: () => s((h) => !h), color: "link", children: d }),
  ...
  return !t || !n ? null : /* @__PURE__ */ f.jsx(C0.Provider, { value: u, children: /* @__PURE__ */ f.jsx(
    u8,
    {
      conversationGroup: t,
      shareId: n,
  ...
  if (!a || !o)
    return null;
  const s = r[a], l = (d) => {
    i(V5({ shareId: o, conversationGroupId: d }));
  }, u = (d) => {
    i(Gs(d));
  }, c = (d) => {
    console.log("onReplyAdd", d), i(Uc());
  };
  ...
  return !!n || e || t ? /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
    ...
    /* @__PURE__ */ f.jsxs("div", { className: $t.conversationRightPanel, children: [
      ...
      n ? /* @__PURE__ */ f.jsx(a8, {}) : /* @__PURE__ */ f.jsx(f8, {})
    ] })
  ] }) : null;
}, h8 = 10, p8 = () => {
  const e = se(), t = we(
    ...
    (i) => {
      clearTimeout(e.current), v4(i).then((s) => {
        console.log("useConversations", s), o(B5(s == null ? void 0 : s.dbt_docs_share_conversations)), e.current = setTimeout(() => {
          a(i);
        }, h8 * 1e3);
      }).catch(
  ...
  return re(() => {
    n !== lt.UNINITIALIZED || !t || (o(K1(lt.LOADING)), a(t));
  }, [o, n, r, t, a]), { isLoading: n === lt.LOADING };
}, m8 = () => {
  const e = ft(), t = we(
    (r) => Object.keys(r.users || {})
  ), [n, o] = ae(lt.UNINITIALIZED);
  return re(() => {
    n !== lt.UNINITIALIZED || Object.keys(t).length || (o(lt.LOADING), x4().then((r) => {
      console.log("useConversationUsers", r), e(P5(r));
    }).catch((r) => console.error("error while fetching users list", r)).finally(() => {
      o(lt.INITIALIZED);
    }));
  }, [e, n, t]), { isLoading: n === lt.LOADING };
}, b8 = () => (m8(), p8(), /* @__PURE__ */ f.jsxs("div", { children: [
  /* @__PURE__ */ f.jsx(g8, {}),
  /* @__PURE__ */ f.jsx(k4, {})
] })), y0 = ({ target: e, ...t }) => cn(
  /* @__PURE__ */ f.jsx(
  ...
  const e = ft(), t = we(
    ...
    (u) => u.manifest
  ), [o, r] = ae(0), a = (l = Ws()) == null ? void 0 : l.parentElement, i = () => {
    var g;
    if (!a || !n.nodes)
      return;
    const u = $s();
...
`)[o],
  ...
  return !t || !n ? null : /* @__PURE__ */ f.jsx(y0, { target: n, onClick: o });
}, v8 = () => /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
  /* @__PURE__ */ f.jsx(y8, {}),
  /* @__PURE__ */ f.jsx(C8, {})
] }), x8 = Vd(() => import("./DbtDocsRenderer.js")), w8 = () => {
  const { loading: e, shareDetails: t } = E4(), n = ft(), { getHighlightedSelectionData: o, pos: r, onSelectionEnd: a } = _4(), i = (s) => {
    s.stopPropagation();
    const l = o();
    l && n(Js(l));
  };
  return e ? /* @__PURE__ */ f.jsx("div", { children: "Loading..." }) : !(t != null && t.catalog_presigned_url) || !(t != null && t.manifest_presigned_url) ? /* @__PURE__ */ f.jsx("div", { children: "Unable to load required artifacts. Please try again." }) : /* @__PURE__ */ f.jsxs("div", { children: [
    ...
    r ? /* @__PURE__ */ f.jsx(p4, { pos: r, onAddComment: i }) : null
  ] });
}, By = ({ shareId: e, userId: t, conversationGroupId: n, source: o }) => /* @__PURE__ */ f.jsx("div", { className: "altimate-component", children: /* @__PURE__ */ f.jsx(
  $5,
  {
    shareId: e,
    userId: t,
  ...
  setSelectedTable: kn,
  setMoreTables: rl,
  mergeSeeMoreTables: al,
  setSidebarScreen: Mt,
  setSelectedColumn: bn,
  setCollectColumns: Do,
  mergeCollectColumns: il,
  setConfidence: _8,
  ...
  setNodeCount: Kn,
  setSelectCheck: v0,
  setNonSelectCheck: x0,
  setDefaultExpansion: w0,
  setAiEnabled: S8,
  setModalArgs: Xn,
  setTheme: k8,
  setLineageType: Vy,
  setStaticLineage: Wy,
  setAllowSyncColumnsWithDB: $y,
  setSqlLineageDetails: A8,
  setHighlightedNodes: M8,
  setSelectedNode: T8,
  setNodesSavingsPerformance: N8,
  setNodesCost: D8
} = Br.actions;
function Ge(e) {
...
var hs = { exports: {} }, Ii = {}, dr = { exports: {} }, zi = {};
/**
 * @license React
...
function L8() {
  return v2 || (v2 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function n(x) {
      {
        for (var E = arguments.length, v = new Array(E > 1 ? E - 1 : 0), A = 1; A < E; A++)
          v[A - 1] = arguments[A];
        o("error", x, v);
      }
    }
    function o(x, E, v) {
      {
        ...
        k.unshift("Warning: " + E), Function.prototype.apply.call(console[x], console, k);
      }
    }
    function r(x, E) {
    ...
    function g(x, E, v) {
      ...
      if (!d) {
        var N = E();
        a(A, N) || (n("The result of getSnapshot should be cached to avoid an infinite loop"), d = !0);
      }
      var k = i({
        inst: {
          value: A,
      ...
      return l(function() {
        R.value = A, R.getSnapshot = E, h(R) && H({
          inst: R
        });
      }, [x, A, E]), s(function() {
        h(R) && H({
    ...
    Pi.useSyncExternalStore = C, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
  }()), Pi;
}
var x2;
function E0() {
  return x2 || (x2 = 1, process.env.NODE_ENV === "production" ? dr.exports = O8() : dr.exports = L8()), dr.exports;
}
/**
 * @license React
...
function j8() {
  ...
  return Ii.useSyncExternalStoreWithSelector = function(u, c, d, g, h) {
    var m = a(null);
    if (m.current === null) {
    ...
    m = s(function() {
      function p(A) {
        if (!C) {
          if (C = !0, x = A, A = g(A), h !== void 0 && b.hasValue) {
            var N = b.value;
            if (h(N, A)) return E = N;
          }
          return E = A;
        }
        if (N = E, o(x, A)) return N;
        var k = g(A);
        return h !== void 0 && h(N, k) ? N : (x = A, E = k);
      }
      ...
      var p = s(function() {
        var v = !1, A, N, k = function($) {
          ...
          if (o(M, $))
            return S;
          var D = h($);
          return m !== void 0 && m(S, D) ? S : (A = $, N = D, D);
        }, R = g === void 0 ? null : g, H = function() {
          return k(d());
...
process.env.NODE_ENV === "production" ? hs.exports = j8() : hs.exports = H8();
var R8 = hs.exports;
const F8 = /* @__PURE__ */ ro(R8), I8 = { BASE_URL: "/", DEV: !1, MODE: "production", PROD: !0, SSR: !1 }, _2 = (e) => {
  let t;
  const n = /* @__PURE__ */ new Set(), o = (c, d) => {
    ...
    (I8 ? "production" : void 0) !== "production" && console.warn(
      "[DEPRECATED] The `destroy` method will be unsupported in a future version. Instead use unsubscribe function returned by subscribe. Everything will be garbage-collected if store is garbage-collected."
    ), n.clear();
  } }, u = t = e(o, r, l);
  return l;
}, z8 = (e) => e ? _2(e) : _2, { useDebugValue: P8 } = P, { useSyncExternalStoreWithSelector: B8 } = F8, V8 = (e) => e;
function _0(e, t = V8, n) {
  const o = B8(
    e.subscribe,
    e.getState,
...
Mr.prototype = ga.prototype = {
  ...
  on: function(e, t) {
    ...
    if (arguments.length < 2) {
      for (; ++a < i; ) if ((r = (e = o[a]).type) && (r = U8(n[r], e.name))) return r;
      return;
    }
...
function k2(e, t, n) {
  for (var o = 0, r = e.length; o < r; ++o)
    if (e[o].name === t) {
      e[o] = $8, e = e.slice(0, o).concat(e.slice(o + 1));
      break;
    }
...
function S0(e) {
  var t = ha(e);
  return (t.local ? Y8 : q8)(t);
}
function G8() {
}
function ll(e) {
  return e == null ? G8 : function() {
...
function k0(e) {
  return e == null ? J8 : function() {
    return this.querySelectorAll(e);
  };
}
function Q8(e) {
  return function() {
    return X8(e.apply(this, arguments));
  };
}
function e7(e) {
  typeof e == "function" ? e = Q8(e) : e = k0(e);
...
var t7 = Array.prototype.find;
function n7(e) {
  return function() {
    return t7.call(this.children, e);
  };
}
function o7() {
...
function r7(e) {
  return this.select(e == null ? o7 : n7(typeof e == "function" ? e : M0(e)));
}
var a7 = Array.prototype.filter;
function i7() {
...
function l7(e) {
  return this.selectAll(e == null ? i7 : s7(typeof e == "function" ? e : M0(e)));
}
function c7(e) {
  typeof e != "function" && (e = A0(e));
  for (var t = this._groups, n = t.length, o = new Array(n), r = 0; r < n; ++r)
...
function u7() {
  return new rt(this._enter || this._groups.map(T0), this._parents);
}
function Vr(e, t) {
...
function f7(e, t, n, o, r, a) {
  for (var i = 0, s, l = t.length, u = a.length; i < u; ++i)
    (s = t[i]) ? (s.__data__ = a[i], o[i] = s) : n[i] = new Vr(e, a[i]);
  for (; i < l; ++i)
    (s = t[i]) && (r[i] = s);
}
function g7(e, t, n, o, r, a, i) {
  ...
  for (s = 0; s < d; ++s)
    h = i.call(e, a[s], s, a) + "", (l = u.get(h)) ? (o[s] = l, l.__data__ = a[s], u.delete(h)) : n[s] = new Vr(e, a[s]);
  for (s = 0; s < c; ++s)
...
function p7(e, t) {
  if (!arguments.length) return Array.from(this, h7);
  var n = t ? g7 : f7, o = this._parents, r = this._groups;
  typeof e != "function" && (e = d7(e));
  for (var a = r.length, i = new Array(a), s = new Array(a), l = new Array(a), u = 0; u < a; ++u) {
    var c = o[u], d = r[u], g = d.length, h = m7(e.call(c, c && c.__data__, u, o)), m = h.length, b = s[u] = new Array(m), y = i[u] = new Array(m), p = l[u] = new Array(g);
    n(c, d, b, y, p, h, t);
  ...
  return i = new rt(i, o), i._enter = s, i._exit = l, i;
}
function m7(e) {
  return typeof e == "object" && "length" in e ? e : Array.from(e);
}
function b7() {
  return new rt(this._exit || this._groups.map(T0), this._parents);
}
function C7(e, t, n) {
...
function H7(e, t) {
  ...
  return this.each((t == null ? n.local ? N7 : T7 : typeof t == "function" ? n.local ? j7 : L7 : n.local ? O7 : D7)(n, t));
}
function N0(e) {
...
function z7(e, t, n) {
  return arguments.length > 1 ? this.each((t == null ? R7 : typeof t == "function" ? I7 : F7)(e, t, n ?? "")) : Jn(this.node(), e);
}
function Jn(e, t) {
  return e.style.getPropertyValue(t) || N0(e).getComputedStyle(e, null).getPropertyValue(t);
}
function P7(e) {
  return function() {
    delete this[e];
...
function W7(e, t) {
  return arguments.length > 1 ? this.each((t == null ? P7 : typeof t == "function" ? V7 : B7)(e, t)) : this.node()[e];
}
function D0(e) {
  return e.trim().split(/^|\s+/);
}
function cl(e) {
  return e.classList || new O0(e);
}
function O0(e) {
  this._node = e, this._names = D0(e.getAttribute("class") || "");
}
O0.prototype = {
  add: function(e) {
...
function L0(e, t) {
  for (var n = cl(e), o = -1, r = t.length; ++o < r; ) n.add(t[o]);
}
function j0(e, t) {
  for (var n = cl(e), o = -1, r = t.length; ++o < r; ) n.remove(t[o]);
}
function $7(e) {
  return function() {
    L0(this, e);
...
function U7(e, t) {
  return function() {
    (t.apply(this, arguments) ? L0 : j0)(this, e);
  };
}
function q7(e, t) {
  var n = D0(e + "");
  if (arguments.length < 2) {
    for (var o = cl(this.node()), r = -1, a = n.length; ++r < a; ) if (!o.contains(n[r])) return !1;
    return !0;
  }
  return this.each((typeof t == "function" ? U7 : t ? $7 : Z7)(n, t));
}
function Y7() {
  this.textContent = "";
}
...
function X7(e) {
  return arguments.length ? this.each(e == null ? Y7 : (typeof e == "function" ? K7 : G7)(e)) : this.node().textContent;
}
function J7() {
  this.innerHTML = "";
}
...
function t9(e) {
  return arguments.length ? this.each(e == null ? J7 : (typeof e == "function" ? e9 : Q7)(e)) : this.node().innerHTML;
}
function n9() {
...
function i9(e) {
  var t = typeof e == "function" ? e : S0(e);
...
function l9(e, t) {
  var n = typeof e == "function" ? e : S0(e), o = t == null ? s9 : typeof t == "function" ? t : ll(t);
  return this.select(function() {
...
function y9(e, t, n) {
  ...
  for (s = t ? C9 : b9, r = 0; r < a; ++r) this.each(s(o[r], t, n));
  return this;
}
function H0(e, t, n) {
  var o = N0(e), r = o.CustomEvent;
...
function x9(e, t) {
  return function() {
    return H0(this, e, t.apply(this, arguments));
  };
}
function w9(e, t) {
  return this.each((typeof t == "function" ? x9 : v9)(e, t));
}
function* E9() {
  for (var e = this._groups, t = 0, n = e.length; t < n; ++t)
...
function Yo() {
  return new rt([[document.documentElement]], R0);
}
function _9() {
  return this;
}
rt.prototype = Yo.prototype = {
  constructor: rt,
  select: K8,
  selectAll: e7,
  selectChild: r7,
...
function bt(e) {
  return typeof e == "string" ? new rt([[document.querySelector(e)]], [document.documentElement]) : new rt([[e]], R0);
}
function S9(e) {
  let t;
...
function kt(e, t) {
  if (e = S9(e), t === void 0 && (t = e.currentTarget), t) {
...
const k9 = { passive: !1 }, Lo = { capture: !0, passive: !1 };
function Vi(e) {
...
function F0(e) {
  var t = e.document.documentElement, n = bt(e).on("dragstart.drag", Vn, Lo);
  "onselectstart" in t ? n.on("selectstart.drag", Vn, Lo) : (t.__noselect = t.style.MozUserSelect, t.style.MozUserSelect = "none");
}
function I0(e, t) {
  var n = e.document.documentElement, o = bt(e).on("dragstart.drag", null);
  t && (o.on("click.drag", Vn, Lo), setTimeout(function() {
...
function D9() {
  var e = A9, t = M9, n = T9, o = N9, r = {}, a = ga("start", "drag", "end"), i = 0, s, l, u, c, d = 0;
  function g(E) {
    E.on("mousedown.drag", h).filter(o).on("touchstart.drag", y).on("touchmove.drag", p, k9).on("touchend.drag touchcancel.drag", C).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function h(E, v) {
    if (!(c || !e.call(this, E, v))) {
      var A = x(this, t.call(this, E, v), E, v, "mouse");
      A && (bt(E.view).on("mousemove.drag", m, Lo).on("mouseup.drag", b, Lo), F0(E.view), Vi(E), u = !1, s = E.clientX, l = E.clientY, A("start", E));
    }
  }
  function m(E) {
    if (Vn(E), !u) {
      var v = E.clientX - s, A = E.clientY - l;
      u = v * v + A * A > d;
    }
    r.mouse("drag", E);
  }
  function b(E) {
    bt(E.view).on("mousemove.drag mouseup.drag", null), I0(E.view, u), Vn(E), r.mouse("end", E);
  }
  function y(E, v) {
    if (e.call(this, E, v)) {
      var A = E.changedTouches, N = t.call(this, E, v), k = A.length, R, H;
      for (R = 0; R < k; ++R)
        (H = x(this, N, E, v, A[R].identifier, A[R])) && (Vi(E), H("start", E, A[R]));
    }
  }
  function p(E) {
    var v = E.changedTouches, A = v.length, N, k;
    for (N = 0; N < A; ++N)
      (k = r[v[N].identifier]) && (Vn(E), k("drag", E, v[N]));
  }
  function C(E) {
    var v = E.changedTouches, A = v.length, N, k;
    for (c && clearTimeout(c), c = setTimeout(function() {
      ...
      (k = r[v[N].identifier]) && (Vi(E), k("end", E, v[N]));
  }
  function x(E, v, A, N, k, R) {
    var H = a.copy(), I = kt(R || A, v), $, B, w;
    if ((w = n.call(E, new ms("beforestart", {
      sourceEvent: A,
      target: g,
      identifier: k,
      active: i,
      ...
      return $ = w.x - I[0] || 0, B = w.y - I[1] || 0, function M(S, D, L) {
        var O = I, T;
        switch (S) {
          case "start":
            r[k] = M, T = i++;
  ...
  return g.filter = function(E) {
    return arguments.length ? (e = typeof E == "function" ? E : fr(!!E), g) : e;
  }, g.container = function(E) {
    return arguments.length ? (t = typeof E == "function" ? E : fr(E), g) : t;
  }, g.subject = function(E) {
    return arguments.length ? (n = typeof E == "function" ? E : fr(E), g) : n;
  }, g.touchable = function(E) {
    return arguments.length ? (o = typeof E == "function" ? E : fr(!!E), g) : o;
  }, g.on = function() {
...
var jo = 0.7, Wr = 1 / jo, Wn = "\\s*([+-]?\\d+)\\s*", Ho = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Tt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", O9 = /^#([0-9a-f]{3,8})$/, L9 = new RegExp(`^rgb\\(${Wn},${Wn},${Wn}\\)$`), j9 = new RegExp(`^rgb\\(${Tt},${Tt},${Tt}\\)$`), H9 = new RegExp(`^rgba\\(${Wn},${Wn},${Wn},${Ho}\\)$`), R9 = new RegExp(`^rgba\\(${Tt},${Tt},${Tt},${Ho}\\)$`), F9 = new RegExp(`^hsl\\(${Ho},${Tt},${Tt}\\)$`), I9 = new RegExp(`^hsla\\(${Ho},${Tt},${Tt},${Ho}\\)$`), M2 = {
  aliceblue: 15792383,
...
function B9(e) {
  return e instanceof Go || (e = Ro(e)), e ? (e = e.rgb(), new Je(e.r, e.g, e.b, e.opacity)) : new Je();
}
function bs(e, t, n, o) {
  return arguments.length === 1 ? B9(e) : new Je(e, t, n, o ?? 1);
}
function Je(e, t, n, o) {
...
ul(Je, bs, z0(Go, {
  ...
  darker(e) {
    return e = e == null ? jo : Math.pow(jo, e), new Je(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  rgb() {
    return this;
  },
...
function P0(e) {
  ...
  if (e instanceof Go || (e = Ro(e)), !e) return new Ct();
...
function W9(e, t, n, o) {
  return arguments.length === 1 ? P0(e) : new Ct(e, t, n, o ?? 1);
}
function Ct(e, t, n, o) {
...
ul(Ct, W9, z0(Go, {
  ...
  darker(e) {
    return e = e == null ? jo : Math.pow(jo, e), new Ct(this.h, this.s, this.l * e, this.opacity);
  },
  rgb() {
  ...
  clamp() {
    return new Ct(H2(this.h), hr(this.s), hr(this.l), $r(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = $r(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${H2(this.h)}, ${hr(this.s) * 100}%, ${hr(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function H2(e) {
...
function U9(e) {
  return (e = +e) == 1 ? V0 : function(t, n) {
    return n - t ? Z9(t, n, e) : B0(isNaN(t) ? n : t);
  };
}
function V0(e, t) {
  var n = t - e;
  return n ? $9(e, n) : B0(isNaN(e) ? t : e);
}
const R2 = function e(t) {
  var n = U9(t);
  function o(r, a) {
    var i = n((r = bs(r)).r, (a = bs(a)).r), s = n(r.g, a.g), l = n(r.b, a.b), u = V0(r.opacity, a.opacity);
    return function(c) {
...
var Cs = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, $i = new RegExp(Cs.source, "g");
function q9(e) {
  return function() {
    return e;
  };
...
function G9(e, t) {
  var n = Cs.lastIndex = $i.lastIndex = 0, o, r, a, i = -1, s = [], l = [];
  for (e = e + "", t = t + ""; (o = Cs.exec(e)) && (r = $i.exec(t)); )
    (a = r.index) > n && (a = t.slice(n, a), s[i] ? s[i] += a : s[++i] = a), (o = o[0]) === (r = r[0]) ? s[i] ? s[i] += r : s[++i] = r : (s[++i] = null, l.push({ i, x: tn(o, r) })), n = $i.lastIndex;
  return n < t.length && (a = t.slice(n), s[i] ? s[i] += a : s[++i] = a), s.length < 2 ? l[0] ? Y9(l[0].x) : q9(t) : (t = l.length, function(u) {
    for (var c = 0, d; c < t; ++c) s[(d = l[c]).i] = d.x(u);
    return s.join("");
  });
}
var F2 = 180 / Math.PI, ys = {
  translateX: 0,
  translateY: 0,
  rotate: 0,
  skewX: 0,
...
function K9(e) {
  ...
  return t.isIdentity ? ys : W0(t.a, t.b, t.c, t.d, t.e, t.f);
}
function X9(e) {
  return e == null || (pr || (pr = document.createElementNS("http://www.w3.org/2000/svg", "g")), pr.setAttribute("transform", e), !(e = pr.transform.baseVal.consolidate())) ? ys : (e = e.matrix, W0(e.a, e.b, e.c, e.d, e.e, e.f));
}
function $0(e, t, n, o) {
  function r(u) {
  ...
  function a(u, c, d, g, h, m) {
    if (u !== d || c !== g) {
      ...
      m.push({ i: b - 4, x: tn(u, d) }, { i: b - 2, x: tn(c, g) });
    } else (d || g) && h.push("translate(" + d + t + g + n);
  }
  function i(u, c, d, g) {
    u !== c ? (u - c > 180 ? c += 360 : c - u > 180 && (u += 360), g.push({ i: d.push(r(d) + "rotate(", null, o) - 2, x: tn(u, c) })) : c && d.push(r(d) + "rotate(" + c + o);
  }
  function s(u, c, d, g) {
    u !== c ? g.push({ i: d.push(r(d) + "skewX(", null, o) - 2, x: tn(u, c) }) : c && d.push(r(d) + "skewX(" + c + o);
  }
...
var J9 = $0(K9, "px, ", "px)", "deg)"), Q9 = $0(X9, ", ", ")", ")"), ef = 1e-12;
function I2(e) {
...
const of = function e(t, n, o) {
  function r(a, i) {
    ...
    if (b < ef)
      ...
      var C = Math.sqrt(b), x = (g * g - u * u + o * b) / (2 * u * n * C), E = (g * g - u * u - o * b) / (2 * g * n * C), v = Math.log(Math.sqrt(x * x + 1) - x), A = Math.log(Math.sqrt(E * E + 1) - E);
      p = (A - v) / t, y = function(N) {
        var k = N * p, R = I2(v), H = u / (n * C) * (R * nf(t * k + v) - tf(v));
        return [
          s + H * h,
          l + H * m,
          u * R / I2(t * k + v)
...
var Qn = 0, vo = 0, go = 0, Z0 = 1e3, Zr, xo, Ur = 0, An = 0, pa = 0, Fo = typeof performance == "object" && performance.now ? performance : Date, U0 = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function dl() {
  return An || (U0(rf), An = Fo.now() + pa);
}
function rf() {
  An = 0;
}
...
qr.prototype = q0.prototype = {
  constructor: qr,
  restart: function(e, t, n) {
    if (typeof e != "function") throw new TypeError("callback is not a function");
    n = (n == null ? dl() : +n) + (t == null ? 0 : +t), !this._next && xo !== this && (xo ? xo._next = this : Zr = this, xo = this), this._call = e, this._time = n, vs();
  },
  stop: function() {
...
function vs(e) {
  if (!Qn) {
    ...
    var t = e - An;
    t > 24 ? (e < 1 / 0 && (vo = setTimeout(z2, e - Fo.now() - pa)), go && (go = clearInterval(go))) : (go || (Ur = Fo.now(), go = setInterval(sf, Z0)), Qn = 1, U0(z2));
  }
}
function P2(e, t, n) {
  var o = new qr();
...
var cf = ga("start", "end", "cancel", "interrupt"), uf = [], Y0 = 0, B2 = 1, xs = 2, Tr = 3, V2 = 4, ws = 5, Nr = 6;
...
function fl(e, t) {
  var n = xt(e, t);
  if (n.state > Y0) throw new Error("too late; already scheduled");
  return n;
}
function Nt(e, t) {
  var n = xt(e, t);
...
function df(e, t, n) {
  ...
  o[t] = n, n.timer = q0(a, 0, n.time);
  function a(u) {
    n.state = B2, n.timer.restart(i, n.delay, n.time), n.delay <= u && i(u - n.delay);
  }
  function i(u) {
    var c, d, g, h;
    if (n.state !== B2) return l();
    for (c in o)
      if (h = o[c], h.name === n.name) {
        if (h.state === Tr) return P2(i);
        h.state === V2 ? (h.state = Nr, h.timer.stop(), h.on.call("interrupt", e, e.__data__, h.index, h.group), delete o[c]) : +c < t && (h.state = Nr, h.timer.stop(), h.on.call("cancel", e, e.__data__, h.index, h.group), delete o[c]);
      }
    if (P2(function() {
      n.state === Tr && (n.state = V2, n.timer.restart(s, n.delay, n.time), s(u));
    }), n.state = xs, n.on.call("start", e, e.__data__, n.index, n.group), n.state === xs) {
      for (n.state = Tr, r = new Array(g = n.tween.length), c = 0, d = -1; c < g; ++c)
        (h = n.tween[c].value.call(e, e.__data__, n.index, n.group)) && (r[++d] = h);
      r.length = d + 1;
    }
  }
  function s(u) {
    for (var c = u < n.duration ? n.ease.call(null, u / n.duration) : (n.timer.restart(l), n.state = ws, 1), d = -1, g = r.length; ++d < g; )
      r[d].call(e, c);
...
function Dr(e, t) {
  ...
  if (n) {
    ...
    for (i in n) {
      ...
      r = o.state > xs && o.state < ws, o.state = Nr, o.timer.stop(), o.on.call(r ? "interrupt" : "cancel", e, e.__data__, o.index, o.group), delete n[i];
    }
...
function pf(e, t) {
  ...
  return this.each((t == null ? gf : hf)(n, e, t));
}
function gl(e, t, n) {
  var o = e._id;
...
function G0(e, t) {
  var n;
  return (typeof t == "number" ? tn : t instanceof Ro ? R2 : (n = Ro(t)) ? (t = n, R2) : G9)(e, t);
}
function mf(e) {
  return function() {
    this.removeAttribute(e);
...
function wf(e, t) {
  var n = ha(e), o = n === "transform" ? Q9 : G0;
  return this.attrTween(e, typeof t == "function" ? (n.local ? xf : vf)(n, o, gl(this, "attr." + e, t)) : t == null ? (n.local ? bf : mf)(n) : (n.local ? yf : Cf)(n, o, t));
}
function Ef(e, t) {
  return function(n) {
...
function Af(e, t) {
  ...
  var o = ha(e);
  return this.tween(n, (o.local ? Sf : kf)(o, t));
}
function Mf(e, t) {
  return function() {
    fl(this, e).delay = +t.apply(this, arguments);
  };
}
function Tf(e, t) {
  return t = +t, function() {
...
function Nf(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? Mf : Tf)(t, e)) : xt(this.node(), t).delay;
}
function Df(e, t) {
  return function() {
...
function Lf(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? Df : Of)(t, e)) : xt(this.node(), t).duration;
}
function jf(e, t) {
  if (typeof t != "function") throw new Error();
  return function() {
...
function Hf(e) {
  var t = this._id;
  return arguments.length ? this.each(jf(t, e)) : xt(this.node(), t).ease;
}
function Rf(e, t) {
  return function() {
    var n = t.apply(this, arguments);
...
function Ff(e) {
  ...
  return this.each(Rf(this._id, e));
}
function If(e) {
  typeof e != "function" && (e = A0(e));
  for (var t = this._groups, n = t.length, o = new Array(n), r = 0; r < n; ++r)
...
function Vf(e, t) {
  var n = this._id;
  return arguments.length < 2 ? xt(this.node(), n).on.on(e) : this.each(Bf(n, e, t));
}
function Wf(e) {
  return function() {
...
function Zf(e) {
  ...
  for (var o = this._groups, r = o.length, a = new Array(r), i = 0; i < r; ++i)
    for (var s = o[i], l = s.length, u = a[i] = new Array(l), c, d, g = 0; g < l; ++g)
      (c = s[g]) && (d = e.call(c, c.__data__, g, s)) && ("__data__" in c && (d.__data__ = c.__data__), u[g] = d, ma(u[g], t, n, g, u, xt(c, n)));
    ...
    for (var l = o[s], u = l.length, c, d = 0; d < u; ++d)
      if (c = l[d]) {
        for (var g = e.call(c, c.__data__, d, l), h, m = xt(c, n), b = 0, y = g.length; b < y; ++b)
          (h = g[b]) && ma(h, t, n, b, g, m);
        a.push(g), i.push(c);
      }
  return new Zt(a, i, t, n);
}
var qf = Yo.prototype.constructor;
function Yf() {
...
function Xf(e, t, n) {
  var o, r, a;
  return function() {
    var i = Jn(this, e), s = n(this), l = s + "";
    return s == null && (l = s = (this.style.removeProperty(e), Jn(this, e))), i === l ? null : i === o && l === r ? a : (r = l, a = t(o = i, s));
  };
}
function Jf(e, t) {
  var n, o, r, a = "style." + t, i = "end." + a, s;
  return function() {
    var l = Nt(this, e), u = l.on, c = l.value[a] == null ? s || (s = K0(t)) : void 0;
    (u !== n || r !== c) && (o = (n = u).copy()).on(i, r = c), l.on = o;
  };
}
function Qf(e, t, n) {
  var o = (e += "") == "transform" ? J9 : G0;
  return t == null ? this.styleTween(e, Gf(e, o)).on("end.style." + e, K0(e)) : typeof t == "function" ? this.styleTween(e, Xf(e, o, gl(this, "style." + e, t))).each(Jf(this._id, e)) : this.styleTween(e, Kf(e, o, t), n).on("end.style." + e, null);
}
function eg(e, t, n) {
  return function(o) {
...
function ag(e) {
  return this.tween("text", typeof e == "function" ? rg(gl(this, "text", e)) : og(e == null ? "" : e + ""));
}
function ig(e) {
  return function(t) {
...
function cg() {
  for (var e = this._name, t = this._id, n = X0(), o = this._groups, r = o.length, a = 0; a < r; ++a)
...
function pg(e) {
  var t, n;
  e instanceof Zt ? (t = e._id, e = e._name) : (t = X0(), (n = gg).time = dl(), e = e == null ? null : e + "");
  for (var o = this._groups, r = o.length, a = 0; a < r; ++a)
    for (var i = o[a], s = i.length, l, u = 0; u < s; ++u)
      (l = i[u]) && ma(l, e, t, u, i, n || hg(l, t));
  return new Zt(o, this._parents, e, t);
}
Yo.prototype.interrupt = ff;
Yo.prototype.transition = pg;
const mr = (e) => () => e;
function mg(e, {
  sourceEvent: t,
  target: n,
...
function wg() {
  var e = bg, t = Cg, n = xg, o = yg, r = vg, a = [0, 1 / 0], i = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], s = 250, l = of, u = ga("start", "zoom", "end"), c, d, g, h = 500, m = 150, b = 0, y = 10;
  function p(w) {
    w.property("__zoom", W2).on("wheel.zoom", k, { passive: !1 }).on("mousedown.zoom", R).on("dblclick.zoom", H).filter(r).on("touchstart.zoom", I).on("touchmove.zoom", $).on("touchend.zoom touchcancel.zoom", B).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  p.transform = function(w, M, S, D) {
    var L = w.selection ? w.selection() : w;
    L.property("__zoom", W2), w !== L ? v(w, M, S, D) : L.interrupt().each(function() {
      A(this, arguments).event(D).start().zoom(null, typeof M == "function" ? M.apply(this, arguments) : M).end();
    });
  }, p.scaleBy = function(w, M, S, D) {
    p.scaleTo(w, function() {
      var L = this.__zoom.k, O = typeof M == "function" ? M.apply(this, arguments) : M;
      return L * O;
    }, S, D);
  }, p.scaleTo = function(w, M, S, D) {
    p.transform(w, function() {
      var L = t.apply(this, arguments), O = this.__zoom, T = S == null ? E(L) : typeof S == "function" ? S.apply(this, arguments) : S, F = O.invert(T), z = typeof M == "function" ? M.apply(this, arguments) : M;
      return n(x(C(O, z), T, F), L, i);
    }, S, D);
  }, p.translateBy = function(w, M, S, D) {
    p.transform(w, function() {
  ...
  }, p.translateTo = function(w, M, S, D, L) {
    p.transform(w, function() {
      var O = t.apply(this, arguments), T = this.__zoom, F = D == null ? E(O) : typeof D == "function" ? D.apply(this, arguments) : D;
      return n(rn.translate(F[0], F[1]).scale(T.k).translate(
        typeof M == "function" ? -M.apply(this, arguments) : -M,
        typeof S == "function" ? -S.apply(this, arguments) : -S
      ), O, i);
    }, D, L);
  ...
  function x(w, M, S) {
    var D = M[0] - S[0] * w.k, L = M[1] - S[1] * w.k;
    return D === w.x && L === w.y ? w : new Bt(w.k, D, L);
  }
  function E(w) {
  ...
  function v(w, M, S, D) {
    w.on("start.zoom", function() {
      ...
      var L = this, O = arguments, T = A(L, O).event(D), F = t.apply(L, O), z = S == null ? E(F) : typeof S == "function" ? S.apply(L, O) : S, V = Math.max(F[1][0] - F[0][0], F[1][1] - F[0][1]), W = L.__zoom, q = typeof M == "function" ? M.apply(L, O) : M, K = l(W.invert(z).concat(V / W.k), q.invert(z).concat(V / q.k));
      return function(X) {
        if (X === 1) X = q;
        else {
          var J = K(X), te = V / J[2];
  ...
  function A(w, M, S) {
    return !S && w.__zooming || new N(w, M);
  }
  function N(w, M) {
  ...
  function k(w, ...M) {
    ...
    var S = A(this, M).event(w), D = this.__zoom, L = Math.max(a[0], Math.min(a[1], D.k * Math.pow(2, o.apply(this, arguments)))), O = kt(w);
    if (S.wheel)
    ...
    ho(w), S.wheel = setTimeout(T, m), S.zoom("mouse", n(x(C(D, L), S.mouse[0], S.mouse[1]), S.extent, i));
    function T() {
      S.wheel = null, S.end();
    }
  }
  function R(w, ...M) {
    ...
    var S = w.currentTarget, D = A(this, M, !0).event(w), L = bt(w.view).on("mousemove.zoom", z, !0).on("mouseup.zoom", V, !0), O = kt(w, S), T = w.clientX, F = w.clientY;
    F0(w.view), Zi(w), D.mouse = [O, this.__zoom.invert(O)], Dr(this), D.start();
    function z(W) {
      if (ho(W), !D.moved) {
        var q = W.clientX - T, K = W.clientY - F;
        D.moved = q * q + K * K > b;
      }
      D.event(W).zoom("mouse", n(x(D.that.__zoom, D.mouse[0] = kt(W, S), D.mouse[1]), D.extent, i));
    }
    function V(W) {
      L.on("mousemove.zoom mouseup.zoom", null), I0(W.view, D.moved), ho(W), D.event(W).end();
    }
  }
  function H(w, ...M) {
    if (e.apply(this, arguments)) {
      var S = this.__zoom, D = kt(w.changedTouches ? w.changedTouches[0] : w, this), L = S.invert(D), O = S.k * (w.shiftKey ? 0.5 : 2), T = n(x(C(S, O), D, L), t.apply(this, M), i);
      ho(w), s > 0 ? bt(this).transition().duration(s).call(v, T, D, w) : bt(this).call(p.transform, T, D, w);
    }
  }
  function I(w, ...M) {
    if (e.apply(this, arguments)) {
      var S = w.touches, D = S.length, L = A(this, M, w.changedTouches.length === D).event(w), O, T, F, z;
      for (Zi(w), T = 0; T < D; ++T)
        F = S[T], z = kt(F, this), z = [z, this.__zoom.invert(z), F.identifier], L.touch0 ? !L.touch1 && L.touch0[2] !== z[2] && (L.touch1 = z, L.taps = 0) : (L.touch0 = z, O = !0, L.taps = 1 + !!c);
      c && (c = clearTimeout(c)), O && (L.taps < 2 && (d = z[0], c = setTimeout(function() {
        c = null;
      }, h)), Dr(this), L.start());
    }
  }
  function $(w, ...M) {
    if (this.__zooming) {
      var S = A(this, M).event(w), D = w.changedTouches, L = D.length, O, T, F, z;
      for (ho(w), O = 0; O < L; ++O)
        T = D[O], F = kt(T, this), S.touch0 && S.touch0[2] === T.identifier ? S.touch0[0] = F : S.touch1 && S.touch1[2] === T.identifier && (S.touch1[0] = F);
      if (T = S.that.__zoom, S.touch1) {
        var V = S.touch0[0], W = S.touch0[1], q = S.touch1[0], K = S.touch1[1], X = (X = q[0] - V[0]) * X + (X = q[1] - V[1]) * X, J = (J = K[0] - W[0]) * J + (J = K[1] - W[1]) * J;
        T = C(T, Math.sqrt(X / J)), F = [(V[0] + q[0]) / 2, (V[1] + q[1]) / 2], z = [(W[0] + K[0]) / 2, (W[1] + K[1]) / 2];
      } else if (S.touch0) F = S.touch0[0], z = S.touch0[1];
      else return;
      S.zoom("touch", n(x(T, F, z), S.extent, i));
    }
  }
  function B(w, ...M) {
    if (this.__zooming) {
      var S = A(this, M).event(w), D = w.changedTouches, L = D.length, O, T;
      for (Zi(w), g && clearTimeout(g), g = setTimeout(function() {
        g = null;
      }, h), O = 0; O < L; ++O)
        T = D[O], S.touch0 && S.touch0[2] === T.identifier ? delete S.touch0 : S.touch1 && S.touch1[2] === T.identifier && delete S.touch1;
      if (S.touch1 && !S.touch0 && (S.touch0 = S.touch1, delete S.touch1), S.touch0) S.touch0[1] = this.__zoom.invert(S.touch0[0]);
      else if (S.end(), S.taps === 2 && (T = kt(T, this), Math.hypot(d[0] - T[0], d[1] - T[1]) < y)) {
...
const ba = dt(null), Eg = ba.Provider, vt = {
...
}, _g = (e) => e.userSelectionActive ? "none" : "all";
function Q0({ position: e, children: t, className: n, style: o, ...r }) {
  const a = Me(_g), i = `${e}`.split("-");
  return P.createElement("div", { className: Ge(["react-flow__panel", n, ...i]), style: { ...o, pointerEvents: a }, ...r }, t);
}
function Sg({ proOptions: e, position: t = "bottom-right" }) {
...
const kg = ({ x: e, y: t, label: n, labelStyle: o = {}, labelShowBg: r = !0, labelBgStyle: a = {}, labelBgPadding: i = [2, 4], labelBgBorderRadius: s = 2, children: l, className: u, ...c }) => {
...
}), eo = (e, t = 0, n = 1) => Math.min(Math.max(e, t), n), pl = (e = { x: 0, y: 0 }, t) => ({
  x: eo(e.x, t[0][0], t[1][0]),
  y: eo(e.y, t[0][1], t[1][1])
}), $2 = (e, t, n) => e < t ? eo(Math.abs(e - t), 1, 50) / 50 : e > n ? -eo(Math.abs(e - n), 1, 50) / 50 : 0, eu = (e, t) => {
...
}), ml = ({ x: e, y: t, width: n, height: o }) => ({
  x: e,
  y: t,
  x2: e + n,
  y2: t + o
}), Tg = ({ x: e, y: t, x2: n, y2: o }) => ({
  x: e,
  y: t,
  width: n - e,
  height: o - t
...
}, Ng = (e) => ct(e.width) && ct(e.height) && ct(e.x) && ct(e.y), ct = (e) => !isNaN(e) && isFinite(e), Ne = Symbol.for("internals"), nu = ["Enter", " ", "Escape"], ou = (e, t) => {
  process.env.NODE_ENV === "development" && console.warn(`[React Flow]: ${t} Help: https://reactflow.dev/error#${e}`);
}, Dg = (e) => "nativeEvent" in e;
function _s(e) {
  var r, a;
  const t = Dg(e) ? e.nativeEvent : e, n = ((a = (r = t.composedPath) == null ? void 0 : r.call(t)) == null ? void 0 : a[0]) || e.target;
...
const ru = (e) => "clientX" in e, an = (e, t) => {
  var a, i;
  const n = ru(e), o = n ? e.clientX : (a = e.touches) == null ? void 0 : a[0].clientX, r = n ? e.clientY : (i = e.touches) == null ? void 0 : i[0].clientY;
  return {
...
}, io = ({ id: e, path: t, labelX: n, labelY: o, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u, style: c, markerEnd: d, markerStart: g, interactionWidth: h = 20 }) => P.createElement(
  P.Fragment,
  null,
  ...
  r && ct(n) && ct(o) ? P.createElement(Ag, { x: n, y: o, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u }) : null
);
...
function iu({ sourceX: e, sourceY: t, targetX: n, targetY: o, sourceControlX: r, sourceControlY: a, targetControlX: i, targetControlY: s }) {
...
function su({ sourceX: e, sourceY: t, sourcePosition: n = ne.Bottom, targetX: o, targetY: r, targetPosition: a = ne.Top }) {
  const [i, s] = U2({
    pos: n,
    x1: e,
    y1: t,
...
const bl = De(({ sourceX: e, sourceY: t, targetX: n, targetY: o, sourcePosition: r = ne.Bottom, targetPosition: a = ne.Top, label: i, labelStyle: s, labelShowBg: l, labelBgStyle: u, labelBgPadding: c, labelBgBorderRadius: d, style: g, markerEnd: h, markerStart: m, interactionWidth: b }) => {
  const [y, p, C] = su({
    sourceX: e,
    sourceY: t,
    sourcePosition: r,
  ...
  return P.createElement(io, { path: y, labelX: p, labelY: C, label: i, labelStyle: s, labelShowBg: l, labelBgStyle: u, labelBgPadding: c, labelBgBorderRadius: d, style: g, markerEnd: h, markerStart: m, interactionWidth: b });
});
bl.displayName = "SimpleBezierEdge";
const q2 = {
  [ne.Left]: { x: -1, y: 0 },
  [ne.Right]: { x: 1, y: 0 },
  [ne.Top]: { x: 0, y: -1 },
  [ne.Bottom]: { x: 0, y: 1 }
}, Og = ({ source: e, sourcePosition: t = ne.Bottom, target: n }) => t === ne.Left || t === ne.Right ? e.x < n.x ? { x: 1, y: 0 } : { x: -1, y: 0 } : e.y < n.y ? { x: 0, y: 1 } : { x: 0, y: -1 }, Y2 = (e, t) => Math.sqrt(Math.pow(t.x - e.x, 2) + Math.pow(t.y - e.y, 2));
function Lg({ source: e, sourcePosition: t = ne.Bottom, target: n, targetPosition: o = ne.Top, center: r, offset: a }) {
  const i = q2[t], s = q2[o], l = { x: e.x + i.x * a, y: e.y + i.y * a }, u = { x: n.x + s.x * a, y: n.y + s.y * a }, c = Og({
    source: l,
    sourcePosition: t,
    target: u
  }), d = c.x !== 0 ? "x" : "y", g = c[d];
  let h = [], m, b;
  const y = { x: 0, y: 0 }, p = { x: 0, y: 0 }, [C, x, E, v] = au({
    sourceX: e.x,
    sourceY: e.y,
    targetX: n.x,
    targetY: n.y
  ...
  if (i[d] * s[d] === -1) {
    ...
    i[d] === g ? h = d === "x" ? N : k : h = d === "x" ? k : N;
  } else {
    const N = [{ x: l.x, y: u.y }], k = [{ x: u.x, y: l.y }];
    if (d === "x" ? h = i.x === g ? k : N : h = i.y === g ? N : k, t === o) {
    ...
    if (t !== o) {
      const B = d === "x" ? "y" : "x", w = i[d] === s[B], M = l[B] > u[B], S = l[B] < u[B];
      (i[d] === 1 && (!w && M || w && S) || i[d] !== 1 && (!w && S || w && M)) && (h = d === "x" ? N : k);
    }
    const R = { x: l.x + y.x, y: l.y + y.y }, H = { x: u.x + p.x, y: u.y + p.y }, I = Math.max(Math.abs(R.x - h[0].x), Math.abs(H.x - h[0].x)), $ = Math.max(Math.abs(R.y - h[0].y), Math.abs(H.y - h[0].y));
    I >= $ ? (m = (R.x + H.x) / 2, b = h[0].y) : (m = h[0].x, b = (R.y + H.y) / 2);
  }
  return [[
    e,
    { x: l.x + y.x, y: l.y + y.y },
...
function Ss({ sourceX: e, sourceY: t, sourcePosition: n = ne.Bottom, targetX: o, targetY: r, targetPosition: a = ne.Top, borderRadius: i = 5, centerX: s, centerY: l, offset: u = 20 }) {
  const [c, d, g, h, m] = Lg({
    source: { x: e, y: t },
    sourcePosition: n,
    target: { x: o, y: r },
  ...
  return [c.reduce((y, p, C) => {
    let x = "";
    return C > 0 && C < c.length - 1 ? x = jg(c[C - 1], p, c[C + 1], i) : x = `${C === 0 ? "M" : "L"}${p.x} ${p.y}`, y += x, y;
  }, ""), d, g, h, m];
}
const Ca = De(({ sourceX: e, sourceY: t, targetX: n, targetY: o, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u, style: c, sourcePosition: d = ne.Bottom, targetPosition: g = ne.Top, markerEnd: h, markerStart: m, pathOptions: b, interactionWidth: y }) => {
  const [p, C, x] = Ss({
    sourceX: e,
    sourceY: t,
    sourcePosition: d,
  ...
  return P.createElement(io, { path: p, labelX: C, labelY: x, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u, style: c, markerEnd: h, markerStart: m, interactionWidth: y });
});
Ca.displayName = "SmoothStepEdge";
const Cl = De((e) => {
  var t;
  return P.createElement(Ca, { ...e, pathOptions: Se(() => {
    var n;
    return { borderRadius: 0, offset: (n = e.pathOptions) == null ? void 0 : n.offset };
  }, [(t = e.pathOptions) == null ? void 0 : t.offset]) });
});
Cl.displayName = "StepEdge";
...
const yl = De(({ sourceX: e, sourceY: t, targetX: n, targetY: o, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u, style: c, markerEnd: d, markerStart: g, interactionWidth: h }) => {
  const [m, b, y] = Hg({ sourceX: e, sourceY: t, targetX: n, targetY: o });
  return P.createElement(io, { path: m, labelX: b, labelY: y, label: r, labelStyle: a, labelShowBg: i, labelBgStyle: s, labelBgPadding: l, labelBgBorderRadius: u, style: c, markerEnd: d, markerStart: g, interactionWidth: h });
});
...
function lu({ sourceX: e, sourceY: t, sourcePosition: n = ne.Bottom, targetX: o, targetY: r, targetPosition: a = ne.Top, curvature: i = 0.25 }) {
  const [s, l] = G2({
    pos: n,
    x1: e,
    y1: t,
...
const Kr = De(({ sourceX: e, sourceY: t, targetX: n, targetY: o, sourcePosition: r = ne.Bottom, targetPosition: a = ne.Top, label: i, labelStyle: s, labelShowBg: l, labelBgStyle: u, labelBgPadding: c, labelBgBorderRadius: d, style: g, markerEnd: h, markerStart: m, pathOptions: b, interactionWidth: y }) => {
  const [p, C, x] = lu({
    sourceX: e,
    sourceY: t,
    sourcePosition: r,
  ...
  return P.createElement(io, { path: p, labelX: C, labelY: x, label: i, labelStyle: s, labelShowBg: l, labelBgStyle: u, labelBgPadding: c, labelBgBorderRadius: d, style: g, markerEnd: h, markerStart: m, interactionWidth: y });
});
Kr.displayName = "BezierEdge";
const vl = dt(null), Rg = vl.Provider;
vl.Consumer;
const Fg = () => He(vl), Ig = (e) => "id" in e && "source" in e && "target" in e, zg = (e) => "id" in e && !("source" in e) && !("target" in e), Pg = ({ source: e, sourceHandle: t, target: n, targetHandle: o }) => `reactflow__edge-${e}${t || ""}-${n}${o || ""}`, ks = (e, t) => typeof e > "u" ? "" : typeof e == "string" ? e : `${t ? `${t}__` : ""}${Object.keys(e).sort().map((o) => `${o}=${e[o]}`).join("&")}`, Bg = (e, t) => t.some((n) => n.source === e.source && n.target === e.target && (n.sourceHandle === e.sourceHandle || !n.sourceHandle && !e.sourceHandle) && (n.targetHandle === e.targetHandle || !n.targetHandle && !e.targetHandle)), Vg = (e, t) => {
  if (!e.source || !e.target)
    return ou("006", vt.error006()), t;
  let n;
  return Ig(e) ? n = { ...e } : n = {
    ...e,
    id: Pg(e)
  }, Bg(n, t) ? t : t.concat(n);
}, As = ({ x: e, y: t }, [n, o, r], a, [i, s]) => {
  const l = {
    x: (e - n) / r,
    y: (t - o) / r
  };
  ...
  return Tg(n);
}, uu = (e, t, [n, o, r] = [0, 0, 1], a = !1, i = !1, s = [0, 0]) => {
  const l = {
    x: (t.x - n) / r,
    y: (t.y - o) / r,
    width: t.width / r,
  ...
  return e.forEach((c) => {
    ...
    if (i && !h || m)
      return !1;
    const { positionAbsolute: b } = $n(c, s), y = {
      x: b.x,
      y: b.y,
      width: d || 0,
      height: g || 0
    }, p = Es(l, y), C = typeof d > "u" || typeof g > "u" || d === null || g === null, x = a && p > 0, E = (d || 0) * (g || 0);
  ...
  const i = t / (e.width * (1 + a)), s = n / (e.height * (1 + a)), l = Math.min(i, s), u = eo(l, o, r), c = e.x + e.width / 2, d = e.y + e.height / 2, g = t / 2 - c * u, h = n / 2 - d * u;
...
function Wg(e, t, n, o, r, a) {
  const { x: i, y: s } = an(e), u = t.elementsFromPoint(i, s).find((m) => m.classList.contains("react-flow__handle"));
  if (u) {
    const m = u.getAttribute("data-nodeid");
    if (m) {
      const b = wl(void 0, u), y = u.getAttribute("data-handleid"), p = a({ nodeId: m, id: y, type: b });
      if (p) {
  ...
  if (r.forEach((m) => {
    ...
    return { handle: null, validHandleResult: gu() };
  if (c.length === 1)
    return c[0];
...
const $g = { source: null, target: null, sourceHandle: null, targetHandle: null }, gu = () => ({
  handleDomNode: null,
  isValid: !1,
  connection: $g,
  endHandle: null
});
function hu(e, t, n, o, r, a, i) {
  ...
  if (l) {
    const c = wl(void 0, l), d = l.getAttribute("data-nodeid"), g = l.getAttribute("data-handleid"), h = l.classList.contains("connectable"), m = l.classList.contains("connectableend"), b = {
      source: s ? d : n,
      sourceHandle: s ? g : o,
      target: s ? n : d,
      targetHandle: s ? o : g
    };
    u.connection = b, h && m && (t === Mn.Strict ? s && c === "source" || !s && c === "target" : d !== n || g !== o) && (u.endHandle = {
      nodeId: d,
      handleId: g,
      type: c
    }, u.isValid = a(b));
...
function Zg({ nodes: e, nodeId: t, handleId: n, handleType: o }) {
  return e.reduce((r, a) => {
    if (a[Ne]) {
      const { handleBounds: i } = a[Ne];
      let s = [], l = [];
      i && (s = K2(a, i, "source", `${t}-${n}-${o}`), l = K2(a, i, "target", `${t}-${n}-${o}`)), r.push(...s, ...l);
    }
    return r;
  }, []);
}
...
function pu({ event: e, handleId: t, nodeId: n, onConnect: o, isTarget: r, getState: a, setState: i, isValidConnection: s, edgeUpdaterType: l, onReconnectEnd: u }) {
  const c = tu(e.target), { connectionMode: d, domNode: g, autoPanOnConnect: h, connectionRadius: m, onConnectStart: b, panBy: y, getNodes: p, cancelConnection: C } = a();
  let x = 0, E;
  const { x: v, y: A } = an(e), N = c == null ? void 0 : c.elementFromPoint(v, A), k = wl(l, N), R = g == null ? void 0 : g.getBoundingClientRect();
  if (!R || !k)
    return;
  let H, I = an(e, R), $ = !1, B = null, w = !1, M = null;
  const S = Zg({
    nodes: p(),
    nodeId: n,
    handleId: t,
    ...
    if (!h)
      return;
    const [T, F] = eu(I, R);
    y({ x: T, y: F }), x = requestAnimationFrame(D);
  };
  i({
  ...
  function L(T) {
    const { transform: F } = a();
    I = an(T, R);
    const { handle: z, validHandleResult: V } = Wg(T, c, As(I, F, !1, [1, 1]), m, S, (W) => hu(W, d, n, t, r ? "target" : "source", s, c));
    if (E = z, $ || (D(), $ = !0), M = V.handleDomNode, B = V.connection, w = V.isValid, i({
      connectionPosition: E && w ? cu({
        x: E.x,
        y: E.y
      }, F) : I,
      connectionStatus: Ug(!!E, w),
      connectionEndHandle: V.endHandle
    }), !E && !w && !M)
      return Ui(H);
    B.source !== B.target && M && (Ui(H), H = M, M.classList.add("connecting", "react-flow__handle-connecting"), M.classList.toggle("valid", w), M.classList.toggle("react-flow__handle-valid", w));
  }
  function O(T) {
    var F, z;
    (E || M) && B && w && (o == null || o(B)), (z = (F = a()).onConnectEnd) == null || z.call(F, T), l && (u == null || u(T)), Ui(H), C(), cancelAnimationFrame(x), $ = !1, w = !1, B = null, M = null, c.removeEventListener("mousemove", L), c.removeEventListener("mouseup", O), c.removeEventListener("touchmove", L), c.removeEventListener("touchend", O);
  }
  c.addEventListener("mousemove", L), c.addEventListener("mouseup", O), c.addEventListener("touchmove", L), c.addEventListener("touchend", O);
}
const X2 = () => !0, qg = (e) => ({
...
}, mu = zs(({ type: e = "source", position: t = ne.Top, isValidConnection: n, isConnectable: o = !0, isConnectableStart: r = !0, isConnectableEnd: a = !0, id: i, onConnect: s, children: l, className: u, onMouseDown: c, onTouchStart: d, ...g }, h) => {
  var R, H;
  const m = i || null, b = e === "target", y = Ie(), p = Fg(), { connectOnClick: C, noPanClassName: x } = Me(qg, Pe), { connecting: E, clickConnecting: v } = Me(Yg(p, m, e), Pe);
  p || (H = (R = y.getState()).onError) == null || H.call(R, "010", vt.error010());
  const A = (I) => {
    ...
    if (w) {
      const { edges: S, setEdges: D } = y.getState();
      D(Vg(M, S));
    }
    ...
    r && ($ && I.button === 0 || !$) && pu({
      ...
      getState: y.getState,
      setState: y.setState,
      isValidConnection: n || y.getState().isValidConnection || X2
    }), $ ? c == null || c(I) : d == null || d(I);
  }, k = (I) => {
    const { onClickConnectStart: $, onClickConnectEnd: B, connectionClickStartHandle: w, connectionMode: M, isValidConnection: S } = y.getState();
    if (!p || !w && !r)
      return;
    if (!w) {
    ...
    const D = tu(I.target), L = n || S || X2, { connection: O, isValid: T } = hu({
      nodeId: p,
      id: m,
      type: e
    }, M, w.nodeId, w.handleId || null, w.type, L, D);
    T && A(O), B == null || B(I), y.setState({ connectionClickStartHandle: null });
  };
  ...
  ]), onMouseDown: N, onTouchStart: N, onClick: C ? k : void 0, ref: h, ...g }, l);
});
mu.displayName = "Handle";
var st = De(mu);
const bu = ({ data: e, isConnectable: t, targetPosition: n = ne.Top, sourcePosition: o = ne.Bottom }) => P.createElement(
  P.Fragment,
  null,
  P.createElement(st, { type: "target", position: n, isConnectable: t }),
  e == null ? void 0 : e.label,
  P.createElement(st, { type: "source", position: o, isConnectable: t })
);
bu.displayName = "DefaultNode";
var Ms = De(bu);
const Cu = ({ data: e, isConnectable: t, sourcePosition: n = ne.Bottom }) => P.createElement(
  P.Fragment,
  null,
  e == null ? void 0 : e.label,
  P.createElement(st, { type: "source", position: n, isConnectable: t })
);
Cu.displayName = "InputNode";
var yu = De(Cu);
const vu = ({ data: e, isConnectable: t, targetPosition: n = ne.Top }) => P.createElement(
  P.Fragment,
  null,
  P.createElement(st, { type: "target", position: n, isConnectable: t }),
  e == null ? void 0 : e.label
);
vu.displayName = "OutputNode";
var xu = De(vu);
const El = () => null;
El.displayName = "GroupNode";
const Gg = (e) => ({
...
const wu = De(({ onSelectionChange: e }) => {
  const t = Ie(), { selectedNodes: n, selectedEdges: o } = Me(Gg, Kg);
  return re(() => {
...
const Xg = (e) => !!e.onSelectionChange;
function Jg({ onSelectionChange: e }) {
  const t = Me(Xg);
  return e || t ? P.createElement(wu, { onSelectionChange: e }) : null;
}
const Qg = (e) => ({
  setNodes: e.setNodes,
  setEdges: e.setEdges,
...
const eh = ({ nodes: e, edges: t, defaultNodes: n, defaultEdges: o, onConnect: r, onConnectStart: a, onConnectEnd: i, onClickConnectStart: s, onClickConnectEnd: l, nodesDraggable: u, nodesConnectable: c, nodesFocusable: d, edgesFocusable: g, edgesUpdatable: h, elevateNodesOnSelect: m, minZoom: b, maxZoom: y, nodeExtent: p, onNodesChange: C, onEdgesChange: x, elementsSelectable: E, connectionMode: v, snapGrid: A, snapToGrid: N, translateExtent: k, connectOnClick: R, defaultEdgeOptions: H, fitView: I, fitViewOptions: $, onNodesDelete: B, onEdgesDelete: w, onNodeDrag: M, onNodeDragStart: S, onNodeDragStop: D, onSelectionDrag: L, onSelectionDragStart: O, onSelectionDragStop: T, noPanClassName: F, nodeOrigin: z, rfId: V, autoPanOnConnect: W, autoPanOnNodeDrag: q, onError: K, connectionRadius: X, isValidConnection: J, nodeDragThreshold: te }) => {
  ...
  clipPath: "inset(100%)"
}, Eu = "react-flow__node-desc", _u = "react-flow__edge-desc", nh = "react-flow__aria-live", oh = (e) => e.ariaLiveMessage;
function rh({ rfId: e }) {
  const t = Me(oh);
  return P.createElement("div", { id: `${nh}-${e}`, "aria-live": "assertive", "aria-atomic": "true", style: th }, t);
}
function ah({ rfId: e, disableKeyboardA11y: t }) {
  return P.createElement(
    ...
    P.createElement("div", { id: `${_u}-${e}`, style: J2 }, "Press enter or space to select an edge. You can then press delete to remove it or escape to cancel."),
    !t && P.createElement(rh, { rfId: e })
  );
}
var zo = (e = null, t = { actInsideInputWithModifier: !0 }) => {
  ...
  return re(() => {
    ...
    if (e !== null) {
      const c = (h) => {
        if (r.current = h.ctrlKey || h.metaKey || h.shiftKey, (!r.current || r.current && !t.actInsideInputWithModifier) && _s(h))
          return !1;
        const b = ec(h.code, s);
        a.current.add(h[b]), Q2(i, a.current, !1) && (h.preventDefault(), o(!0));
      }, d = (h) => {
        if ((!r.current || r.current && !t.actInsideInputWithModifier) && _s(h))
          return !1;
        const b = ec(h.code, s);
        Q2(i, a.current, !0) ? (o(!1), a.current.clear()) : a.current.delete(h[b]), h.key === "Meta" && a.current.clear(), r.current = !1;
      }, g = () => {
        a.current.clear(), o(!1);
      };
...
function qi(e, t, n, o) {
  ...
  return e.forEach((s) => {
    var h;
    const l = (ct(s.zIndex) ? s.zIndex : 0) + (s.selected ? i : 0), u = t.get(s.id), c = {
      ...s,
      positionAbsolute: {
        x: s.position.x,
        y: s.position.y
...
function Au(e, t = {}) {
  ...
  if (s && l && (g || !t.initial)) {
    ...
    if (m.length > 0 && b) {
      const y = xl(m, d), { x: p, y: C, zoom: x } = fu(y, o, r, t.minZoom ?? a, t.maxZoom ?? i, t.padding ?? 0.1), E = rn.translate(p, C).scale(x);
      return typeof t.duration == "number" && t.duration > 0 ? s.transform(pn(l, t.duration), E) : s.transform(l, E), !0;
    }
  }
  return !1;
}
...
function yr({ changedNodes: e, changedEdges: t, get: n, set: o }) {
  ...
  e != null && e.length && (l && o({ nodeInternals: ih(e, r) }), i == null || i(e)), t != null && t.length && (u && o({ edges: sh(t, a) }), s == null || s(t));
}
const Hn = () => {
}, lh = {
  zoomIn: Hn,
  ...
  const e = Ie(), { d3Zoom: t, d3Selection: n } = Me(ch, Pe);
  return Se(() => n && t ? {
    ...
    setViewport: (r, a) => {
      const [i, s, l] = e.getState().transform, u = rn.translate(r.x ?? i, r.y ?? s).scale(r.zoom ?? l);
    ...
    fitView: (r) => Au(e.getState, r),
    setCenter: (r, a, i) => {
      const { width: s, height: l, maxZoom: u } = e.getState(), c = typeof (i == null ? void 0 : i.zoom) < "u" ? i.zoom : u, d = s / 2 - r * c, g = l / 2 - a * c, h = rn.translate(d, g).scale(c);
      t.transform(pn(n, i == null ? void 0 : i.duration), h);
    },
    fitBounds: (r, a) => {
      const { width: i, height: s, minZoom: l, maxZoom: u } = e.getState(), { x: c, y: d, zoom: g } = fu(r, i, s, l, u, (a == null ? void 0 : a.padding) ?? 0.1), h = rn.translate(c, d).scale(g);
      t.transform(pn(n, a == null ? void 0 : a.duration), h);
    },
    // @deprecated Use `screenToFlowPosition`.
    project: (r) => {
      const { transform: a, snapToGrid: i, snapGrid: s } = e.getState();
      return console.warn("[DEPRECATED] `project` is deprecated. Instead use `screenToFlowPosition`. There is no need to subtract the react flow bounds anymore! https://reactflow.dev/api-reference/types/react-flow-instance#screen-to-flow-position"), As(r, a, i, s);
    },
    ...
    flowToScreenPosition: (r) => {
      ...
      if (!i)
        return r;
      const { x: s, y: l } = i.getBoundingClientRect(), u = cu(r, a);
      return {
        x: u.x + s,
        y: u.y + l
      };
...
function wt() {
  const e = uh(), t = Ie(), n = pe(() => t.getState().getNodes().map((b) => ({ ...b })), []), o = pe((b) => t.getState().nodeInternals.get(b), []), r = pe(() => {
    ...
    if (C)
      ...
      const A = v.length === 0 ? E.map((N) => ({ type: "remove", id: N.id })) : v.map((N) => ({ item: N, type: "reset" }));
      x(A);
    }
  }, []), s = pe((b) => {
    ...
    if (C)
      ...
      const v = E.length === 0 ? y.map((A) => ({ type: "remove", id: A.id })) : E.map((A) => ({ item: A, type: "reset" }));
      x(v);
    }
  }, []), l = pe((b) => {
    ...
    if (x) {
      ...
      const v = y.map((A) => ({ item: A, type: "add" }));
      E(v);
    }
  }, []), u = pe((b) => {
    ...
    const { nodeInternals: p, getNodes: C, edges: x, hasDefaultNodes: E, hasDefaultEdges: v, onNodesDelete: A, onEdgesDelete: N, onNodesChange: k, onEdgesChange: R } = t.getState(), H = (b || []).map((M) => M.id), I = (y || []).map((M) => M.id), $ = C().reduce((M, S) => {
      const D = S.parentNode || S.parentId, L = !H.includes(S.id) && D && M.find((T) => T.id === D);
      return (typeof S.deletable == "boolean" ? S.deletable : !0) && (H.includes(S.id) || L) && M.push(S), M;
    }, []), B = x.filter((M) => typeof M.deletable == "boolean" ? M.deletable : !0), w = B.filter((M) => I.includes(M.id));
    if ($ || w) {
      const M = du($, B), S = [...w, ...M], D = S.reduce((L, O) => (L.includes(O.id) || L.push(O.id), L), []);
      if ((v || E) && (v && t.setState({
        edges: x.filter((L) => !D.includes(L.id))
      }), E && ($.forEach((L) => {
        p.delete(L.id);
      }), t.setState({
        nodeInternals: new Map(p)
      }))), D.length > 0 && (N == null || N(S), R && R(D.map((L) => ({
        id: L,
        type: "remove"
      })))), $.length > 0 && (A == null || A($), k)) {
        const L = $.map((O) => ({ id: O.id, type: "remove" }));
        k(L);
      }
    }
  }, []), g = pe((b) => {
    const y = Ng(b), p = y ? null : t.getState().nodeInternals.get(b.id);
    return !y && !p ? [null, null, y] : [y ? b : Z2(p), p, y];
  }, []), h = pe((b, y = !0, p) => {
    const [C, x, E] = g(b);
    return C ? (p || t.getState().getNodes()).filter((v) => {
      if (!E && (v.id === x.id || !v.positionAbsolute))
        return !1;
      const A = Z2(v), N = Es(A, C);
...
const dh = { actInsideInputWithModifier: !1 };
var fh = ({ deleteKeyCode: e, multiSelectionKeyCode: t }) => {
  const n = Ie(), { deleteElements: o } = wt(), r = zo(e, dh), a = zo(t);
  re(() => {
    if (r) {
...
const _l = {
  ...
  top: 0,
  left: 0
}, hh = (e, t) => e.x !== t.x || e.y !== t.y || e.zoom !== t.k, vr = (e) => ({
  x: e.x,
  y: e.y,
  zoom: e.k
}), Rn = (e, t) => e.target.closest(`.${t}`), tc = (e, t) => t === 2 && Array.isArray(e) && e.includes(2), nc = (e) => {
...
}), mh = ({ onMove: e, onMoveStart: t, onMoveEnd: n, onPaneContextMenu: o, zoomOnScroll: r = !0, zoomOnPinch: a = !0, panOnScroll: i = !1, panOnScrollSpeed: s = 0.5, panOnScrollMode: l = yn.Free, zoomOnDoubleClick: u = !0, elementsSelectable: c, panOnDrag: d = !0, defaultViewport: g, translateExtent: h, minZoom: m, maxZoom: b, zoomActivationKeyCode: y, preventScrolling: p = !0, children: C, noWheelClassName: x, noPanClassName: E }) => {
  const v = se(), A = Ie(), N = se(!1), k = se(!1), R = se(null), H = se({ x: 0, y: 0, zoom: 0 }), { d3Zoom: I, d3Selection: $, d3ZoomHandler: B, userSelectionActive: w } = Me(ph, Pe), M = zo(y), S = se(0), D = se(!1), L = se();
  return gh(R), re(() => {
    if (R.current) {
      const O = R.current.getBoundingClientRect(), T = wg().scaleExtent([m, b]).translateExtent(h), F = bt(R.current).call(T), z = rn.translate(g.x, g.y).scale(eo(g.zoom, m, b)), V = [
        [0, 0],
        [O.width, O.height]
      ], W = T.constrain()(z, V, h);
      T.transform(F, W), T.wheelDelta(nc), A.setState({
        d3Zoom: T,
        d3Selection: F,
    ...
    $ && I && (i && !M && !w ? $.on("wheel.zoom", (O) => {
      if (Rn(O, x))
        return !1;
      O.preventDefault(), O.stopImmediatePropagation();
      const T = $.property("__zoom").k || 1;
      if (O.ctrlKey && a) {
        const J = kt(O), te = nc(O), Z = T * Math.pow(2, te);
        I.scaleTo($, Z, J, O);
        return;
      }
      const F = O.deltaMode === 1 ? 20 : 1;
      let z = l === yn.Vertical ? 0 : O.deltaX * F, V = l === yn.Horizontal ? 0 : O.deltaY * F;
      !Yr() && O.shiftKey && l !== yn.Vertical && (z = O.deltaY * F, V = 0), I.translateBy(
        $,
        -(z / T) * s,
        -(V / T) * s,
        // @ts-ignore
      ...
      const W = vr($.property("__zoom")), { onViewportChangeStart: q, onViewportChange: K, onViewportChangeEnd: X } = A.getState();
      clearTimeout(L.current), D.current || (D.current = !0, t == null || t(O, W), q == null || q(W)), D.current && (e == null || e(O, W), K == null || K(W), L.current = setTimeout(() => {
        n == null || n(O, W), X == null || X(W), D.current = !1;
      }, 150));
    }, { passive: !1 }) : typeof B < "u" && $.on("wheel.zoom", function(O, T) {
      if (!p && O.type === "wheel" && !O.ctrlKey || Rn(O, x))
        return null;
      O.preventDefault(), B.call(this, O, T);
    }, { passive: !1 }));
  }, [
    w,
    i,
    ...
    I && I.on("start", (O) => {
      ...
      const { onViewportChangeStart: T } = A.getState(), F = vr(O.transform);
      N.current = !0, H.current = F, ((V = O.sourceEvent) == null ? void 0 : V.type) === "mousedown" && A.setState({ paneDragging: !0 }), T == null || T(F), t == null || t(O.sourceEvent, F);
    });
  }, [I, t]), re(() => {
    I && (w && !N.current ? I.on("zoom", null) : w || I.on("zoom", (O) => {
      var F;
      const { onViewportChange: T } = A.getState();
      if (A.setState({ transform: [O.transform.x, O.transform.y, O.transform.k] }), k.current = !!(o && tc(d, S.current ?? 0)), (e || T) && !((F = O.sourceEvent) != null && F.internal)) {
        const z = vr(O.transform);
        T == null || T(z), e == null || e(O.sourceEvent, z);
      }
    }));
  }, [w, I, e, d, o]), re(() => {
    I && I.on("end", (O) => {
      ...
      if (N.current = !1, A.setState({ paneDragging: !1 }), o && tc(d, S.current ?? 0) && !k.current && o(O.sourceEvent), k.current = !1, (n || T) && hh(H.current, O.transform)) {
        const F = vr(O.transform);
        H.current = F, clearTimeout(v.current), v.current = setTimeout(() => {
          T == null || T(F), n == null || n(O.sourceEvent, F);
        }, i ? 150 : 0);
      }
    });
  }, [I, i, d, n, o]), re(() => {
    I && I.filter((O) => {
      const T = M || r, F = a && O.ctrlKey;
      if ((d === !0 || Array.isArray(d) && d.includes(1)) && O.button === 1 && O.type === "mousedown" && (Rn(O, "react-flow__node") || Rn(O, "react-flow__edge")))
        return !0;
      if (!d && !T && !i && !u && !a || w || !u && O.type === "dblclick" || Rn(O, x) && O.type === "wheel" || Rn(O, E) && (O.type !== "wheel" || i && O.type === "wheel" && !M) || !a && O.ctrlKey && O.type === "wheel" || !T && !i && !F && O.type === "wheel" || !d && (O.type === "mousedown" || O.type === "touchstart") || Array.isArray(d) && !d.includes(O.button) && O.type === "mousedown")
        return !1;
    ...
    c,
    M
  ]), P.createElement("div", { className: "react-flow__renderer", ref: R, style: _l }, C);
}, bh = (e) => ({
  userSelectionActive: e.userSelectionActive,
  userSelectionRect: e.userSelectionRect
});
function Ch() {
  const { userSelectionActive: e, userSelectionRect: t } = Me(bh, Pe);
    ...
    for (const s of a)
      if (s)
        switch (s.type) {
          ...
          case "position": {
            typeof s.position < "u" && (i.position = s.position), typeof s.positionAbsolute < "u" && (i.positionAbsolute = s.positionAbsolute), typeof s.dragging < "u" && (i.dragging = s.dragging), i.expandParent && oc(o, i);
            break;
          }
          case "dimensions": {
            typeof s.dimensions < "u" && (i.width = s.dimensions.width, i.height = s.dimensions.height), typeof s.updateStyle < "u" && (i.style = { ...i.style || {}, ...s.dimensions }), typeof s.resizing == "boolean" && (i.resizing = s.resizing), i.expandParent && oc(o, i);
            break;
          }
          case "remove":
            return o;
...
function In(e, t) {
  return e.reduce((n, o) => {
    ...
    return !o.selected && r ? (o.selected = !0, n.push(nn(o.id, !0))) : o.selected && !r && (o.selected = !1, n.push(nn(o.id, !1))), n;
  }, []);
}
const Yi = (e, t) => (n) => {
...
}), Mu = De(({ isSelecting: e, selectionMode: t = Io.Full, panOnDrag: n, onSelectionStart: o, onSelectionEnd: r, onPaneClick: a, onPaneContextMenu: i, onPaneScroll: s, onPaneMouseEnter: l, onPaneMouseMove: u, onPaneMouseLeave: c, children: d }) => {
  const g = se(null), h = Ie(), m = se(0), b = se(0), y = se(), { userSelectionActive: p, elementsSelectable: C, dragging: x } = Me(xh, Pe), E = () => {
    ...
    const { userSelectionRect: w, nodeInternals: M, edges: S, transform: D, onNodesChange: L, onEdgesChange: O, nodeOrigin: T, getNodes: F } = h.getState();
    if (!e || !y.current || !w)
      return;
    h.setState({ userSelectionActive: !0, nodesSelectionActive: !1 });
    const z = an(B, y.current), V = w.startX ?? 0, W = w.startY ?? 0, q = {
      ...w,
      x: z.x < V ? z.x : V,
      y: z.y < W ? z.y : W,
      width: Math.abs(z.x - V),
      height: Math.abs(z.y - W)
    }, K = F(), X = uu(M, q, D, t === Io.Partial, !0, T), J = du(X, S).map((Z) => Z.id), te = X.map((Z) => Z.id);
  ...
  return P.createElement(
    "div",
    { className: Ge(["react-flow__pane", { dragging: x, selection: e }]), onClick: $ ? void 0 : Yi(v, g), onContextMenu: Yi(A, g), onWheel: Yi(N, g), onMouseEnter: $ ? void 0 : l, onMouseDown: $ ? k : void 0, onMouseMove: $ ? R : u, onMouseUp: $ ? H : void 0, onMouseLeave: $ ? I : c, ref: g, style: _l },
    d,
    P.createElement(Ch, null)
  );
});
Mu.displayName = "Pane";
function Tu(e, t) {
  ...
  if (!n)
    return !1;
  const o = t.get(n);
  return o ? o.selected ? !0 : Tu(o, t) : !1;
}
function rc(e, t, n) {
  let o = e;
  do {
...
function wh(e, t, n, o) {
  return Array.from(e.values()).filter((r) => (r.selected || r.id === o) && (!r.parentNode || r.parentId || !Tu(r, e)) && (r.draggable || t && typeof r.draggable > "u")).map((r) => {
    var a, i;
    return {
      id: r.id,
...
function Nu(e, t, n, o, r = [0, 0], a) {
  const i = Eh(e, e.extent || o);
  let s = i;
  const l = e.parentNode || e.parentId;
  if (e.extent === "parent" && !e.expandParent)
    if (l && e.width && e.height) {
      const d = n.get(l), { x: g, y: h } = $n(d, r).positionAbsolute;
      s = d && ct(g) && ct(h) && ct(d.width) && ct(d.height) ? [
...
function Ts({ id: e, store: t, unselect: n = !1, nodeRef: o }) {
...
function Du({ nodeRef: e, disabled: t = !1, noDragClassName: n, handleSelector: o, nodeId: r, isSelectable: a, selectNodesOnDrag: i }) {
  const s = Ie(), [l, u] = ae(!1), c = se([]), d = se({ x: null, y: null }), g = se(0), h = se(null), m = se({ x: 0, y: 0 }), b = se(null), y = se(!1), p = se(!1), C = se(!1), x = _h();
  return re(() => {
    if (e != null && e.current) {
      const E = bt(e.current), v = ({ x: k, y: R }) => {
        const { nodeInternals: H, onNodeDrag: I, onSelectionDrag: $, updateNodePositions: B, nodeExtent: w, snapGrid: M, snapToGrid: S, nodeOrigin: D, onError: L } = s.getState();
        d.current = { x: k, y: R };
        let O = !1, T = { x: 0, y: 0, x2: 0, y2: 0 };
        if (c.current.length > 1 && w) {
          const z = xl(c.current, D);
          T = ml(z);
        }
        if (c.current = c.current.map((z) => {
          const V = { x: k - z.distance.x, y: R - z.distance.y };
          S && (V.x = M[0] * Math.round(V.x / M[0]), V.y = M[1] * Math.round(V.y / M[1]));
          const W = [
            [w[0][0], w[0][1]],
            [w[1][0], w[1][1]]
          ];
          c.current.length > 1 && w && !z.extent && (W[0][0] = z.positionAbsolute.x - T.x + w[0][0], W[1][0] = z.positionAbsolute.x + (z.width ?? 0) - T.x2 + w[1][0], W[0][1] = z.positionAbsolute.y - T.y + w[0][1], W[1][1] = z.positionAbsolute.y + (z.height ?? 0) - T.y2 + w[1][1]);
          const q = Nu(z, V, H, W, D, L);
        ...
        if (!h.current)
          return;
        const [k, R] = eu(m.current, h.current);
        if (k !== 0 || R !== 0) {
          const { transform: H, panBy: I } = s.getState();
          d.current.x = (d.current.x ?? 0) - k / H[2], d.current.y = (d.current.y ?? 0) - R / H[2], I({ x: k, y: R }) && v(d.current);
        }
        g.current = requestAnimationFrame(A);
      }, N = (k) => {
        var D;
        const { nodeInternals: R, multiSelectionActive: H, nodesDraggable: I, unselectNodesAndEdges: $, onNodeDragStart: B, onSelectionDragStart: w } = s.getState();
        p.current = !0;
        const M = r ? B : Ki(w);
        (!i || !a) && !H && r && ((D = R.get(r)) != null && D.selected || $()), r && a && i && Ts({
          id: r,
          store: s,
          nodeRef: e
        });
        const S = x(k);
        if (d.current = S, c.current = wh(R, I, S, r), M && c.current) {
          const [L, O] = Gi({
            nodeId: r,
            dragItems: c.current,
            nodeInternals: R
      ...
      if (t)
        ...
        const k = D9().on("start", (R) => {
          const { domNode: H, nodeDragThreshold: I } = s.getState();
          I === 0 && N(R), C.current = !1;
          const $ = x(R);
          d.current = $, h.current = (H == null ? void 0 : H.getBoundingClientRect()) || null, m.current = an(R.sourceEvent, h.current);
        }).on("drag", (R) => {
          var B, w;
          const H = x(R), { autoPanOnNodeDrag: I, nodeDragThreshold: $ } = s.getState();
          if (R.sourceEvent.type === "touchmove" && R.sourceEvent.touches.length > 1 && (C.current = !0), !C.current) {
            if (!y.current && p.current && I && (y.current = !0, A()), !p.current) {
              const M = H.xSnapped - (((B = d == null ? void 0 : d.current) == null ? void 0 : B.x) ?? 0), S = H.ySnapped - (((w = d == null ? void 0 : d.current) == null ? void 0 : w.y) ?? 0);
              Math.sqrt(M * M + S * S) > $ && N(R);
            }
            (d.current.x !== H.xSnapped || d.current.y !== H.ySnapped) && c.current && p.current && (b.current = R.sourceEvent, m.current = an(R.sourceEvent, h.current), v(H));
          }
        }).on("end", (R) => {
          if (!(!p.current || C.current) && (u(!1), y.current = !1, p.current = !1, cancelAnimationFrame(g.current), c.current)) {
            const { updateNodePositions: H, nodeInternals: I, onNodeDragStop: $, onSelectionDragStop: B } = s.getState(), w = r ? $ : Ki(B);
            if (H(c.current, !1, !1), w) {
              const [M, S] = Gi({
                nodeId: r,
                dragItems: c.current,
                nodeInternals: I
          ...
          const H = R.target;
          return !R.button && (!n || !rc(H, `.${n}`, e)) && (!o || rc(H, o, e));
        });
        return E.call(k), () => {
          E.on(".drag", null);
        };
  ...
  return pe((n) => {
    const { nodeInternals: o, nodeExtent: r, updateNodePositions: a, getNodes: i, snapToGrid: s, snapGrid: l, onError: u, nodesDraggable: c } = e.getState(), d = i().filter((C) => C.selected && (C.draggable || c && typeof C.draggable > "u")), g = s ? l[0] : 5, h = s ? l[1] : 5, m = n.isShiftPressed ? 4 : 1, b = n.x * g * m, y = n.y * h * m, p = d.map((C) => {
      if (C.positionAbsolute) {
        ...
        const { positionAbsolute: E, position: v } = Nu(C, x, o, r, void 0, u);
  ...
  const t = ({ id: n, type: o, data: r, xPos: a, yPos: i, xPosOrigin: s, yPosOrigin: l, selected: u, onClick: c, onMouseEnter: d, onMouseMove: g, onMouseLeave: h, onContextMenu: m, onDoubleClick: b, style: y, className: p, isDraggable: C, isSelectable: x, isConnectable: E, isFocusable: v, selectNodesOnDrag: A, sourcePosition: N, targetPosition: k, hidden: R, resizeObserver: H, dragHandle: I, zIndex: $, isParent: B, noDragClassName: w, noPanClassName: M, initialized: S, disableKeyboardA11y: D, ariaLabel: L, rfId: O, hasHandleBounds: T }) => {
    const F = Ie(), z = se(null), V = se(null), W = se(N), q = se(k), K = se(o), X = x || C || c || d || g || h, J = Ou(), te = mo(n, F.getState, d), Z = mo(n, F.getState, g), fe = mo(n, F.getState, h), G = mo(n, F.getState, m), ye = mo(n, F.getState, b), je = (xe) => {
      ...
      if (!_s(xe) && !D)
        ...
        } else C && u && Object.prototype.hasOwnProperty.call(Zn, xe.key) && (F.setState({
    ...
    re(() => () => {
      V.current && (H == null || H.unobserve(V.current), V.current = null);
    }, []), re(() => {
      if (z.current && !R) {
        const xe = z.current;
        (!S || !T || V.current !== xe) && (V.current && (H == null || H.unobserve(V.current)), H == null || H.observe(xe), V.current = xe);
      }
    }, [R, S, T]), re(() => {
      const xe = K.current !== o, oe = W.current !== N, Re = q.current !== k;
      z.current && (xe || oe || Re) && (xe && (K.current = o), oe && (W.current = N), Re && (q.current = k), F.getState().updateNodeDimensions([{ id: n, nodeElement: z.current, forceUpdate: !0 }]));
    }, [n, o, N, k]);
    const Ve = Du({
      nodeRef: z,
      disabled: R || !C,
    ...
    return R ? null : P.createElement(
      ...
      { className: Ge([
        ...
        ...y
      }, "data-id": n, "data-testid": `rf__node-${n}`, onMouseEnter: te, onMouseMove: Z, onMouseLeave: fe, onContextMenu: G, onClick: je, onDoubleClick: ye, onKeyDown: v ? Ee : void 0, tabIndex: v ? 0 : void 0, role: v ? "button" : void 0, "aria-describedby": D ? void 0 : `${Eu}-${O}`, "aria-label": L },
      P.createElement(
        Rg,
        { value: n },
        P.createElement(e, { id: n, data: r, type: o, xPos: a, yPos: i, selected: u, isConnectable: E, sourcePosition: N, targetPosition: k, dragging: Ve, dragHandle: I, zIndex: $ })
      )
    );
  };
...
function kh({ onSelectionContextMenu: e, noPanClassName: t, disableKeyboardA11y: n }) {
  const o = Ie(), { width: r, height: a, x: i, y: s, transformString: l, userSelectionActive: u } = Me(Sh, Pe), c = Ou(), d = se(null);
  if (re(() => {
    var m;
...
var Ah = De(kh);
const Mh = (e) => e.nodesSelectionActive, Lu = ({ children: e, onPaneClick: t, onPaneMouseEnter: n, onPaneMouseMove: o, onPaneMouseLeave: r, onPaneContextMenu: a, onPaneScroll: i, deleteKeyCode: s, onMove: l, onMoveStart: u, onMoveEnd: c, selectionKeyCode: d, selectionOnDrag: g, selectionMode: h, onSelectionStart: m, onSelectionEnd: b, multiSelectionKeyCode: y, panActivationKeyCode: p, zoomActivationKeyCode: C, elementsSelectable: x, zoomOnScroll: E, zoomOnPinch: v, panOnScroll: A, panOnScrollSpeed: N, panOnScrollMode: k, zoomOnDoubleClick: R, panOnDrag: H, defaultViewport: I, translateExtent: $, minZoom: B, maxZoom: w, preventScrolling: M, onSelectionContextMenu: S, noWheelClassName: D, noPanClassName: L, disableKeyboardA11y: O }) => {
  const T = Me(Mh), F = zo(d), z = zo(p), V = z || H, W = z || A, q = F || g && V !== !0;
  return fh({ deleteKeyCode: s, multiSelectionKeyCode: y }), P.createElement(
    mh,
    ...
    P.createElement(
      ...
      e,
      T && P.createElement(Ah, { onSelectionContextMenu: S, noPanClassName: L, disableKeyboardA11y: O })
    )
  );
};
...
var Th = De(Lu);
function Nh(e) {
  return Me(pe((n) => e ? uu(n.nodeInternals, { x: 0, y: 0, width: n.width, height: n.height }, n.transform, !0) : n.getNodes(), [e]));
}
function Dh(e) {
  const t = {
    input: bo(e.input || yu),
    default: bo(e.default || Ms),
    output: bo(e.output || xu),
    group: bo(e.group || El)
  }, n = {}, o = Object.keys(e).filter((r) => !["input", "default", "output", "group"].includes(r)).reduce((r, a) => (r[a] = bo(e[a] || Ms), r), n);
  return {
    ...t,
    ...o
  };
}
const Oh = ({ x: e, y: t, width: n, height: o, origin: r }) => !n || !o ? { x: e, y: t } : r[0] < 0 || r[1] < 0 || r[0] > 1 || r[1] > 1 ? { x: e, y: t } : {
  x: e - n * r[0],
  y: t - o * r[1]
}, Lh = (e) => ({
  ...
  const { nodesDraggable: t, nodesConnectable: n, nodesFocusable: o, elementsSelectable: r, updateNodeDimensions: a, onError: i } = Me(Lh, Pe), s = Nh(e.onlyRenderVisibleElements), l = se(), u = Se(() => {
  ...
  }, []), P.createElement("div", { className: "react-flow__nodes", style: _l }, s.map((c) => {
    var v, A, N;
    let d = c.type || "default";
    e.nodeTypes[d] || (i == null || i("003", vt.error003(d)), d = "default");
    const g = e.nodeTypes[d] || e.nodeTypes.default, h = !!(c.draggable || t && typeof c.draggable > "u"), m = !!(c.selectable || r && typeof c.selectable > "u"), b = !!(c.connectable || n && typeof c.connectable > "u"), y = !!(c.focusable || o && typeof c.focusable > "u"), p = e.nodeExtent ? pl(c.positionAbsolute, e.nodeExtent) : c.positionAbsolute, C = (p == null ? void 0 : p.x) ?? 0, x = (p == null ? void 0 : p.y) ?? 0, E = Oh({
      x: C,
      y: x,
      width: c.width ?? 0,
      height: c.height ?? 0,
...
ju.displayName = "NodeRenderer";
var jh = De(ju);
const Hh = (e, t, n) => n === ne.Left ? e - t : n === ne.Right ? e + t : e, Rh = (e, t, n) => n === ne.Top ? e - t : n === ne.Bottom ? e + t : e, ic = "react-flow__edgeupdater", sc = ({ position: e, centerX: t, centerY: n, radius: o = 10, onMouseDown: r, onMouseEnter: a, onMouseOut: i, type: s }) => P.createElement("circle", { onMouseDown: r, onMouseEnter: a, onMouseOut: i, className: Ge([ic, `${ic}-${s}`]), cx: Hh(t, o, e), cy: Rh(n, o, e), r: o, stroke: "transparent", fill: "transparent" }), Fh = () => !0;
var Fn = (e) => {
  const t = ({ id: n, className: o, type: r, data: a, onClick: i, onEdgeDoubleClick: s, selected: l, animated: u, label: c, labelStyle: d, labelShowBg: g, labelBgStyle: h, labelBgPadding: m, labelBgBorderRadius: b, style: y, source: p, target: C, sourceX: x, sourceY: E, targetX: v, targetY: A, sourcePosition: N, targetPosition: k, elementsSelectable: R, hidden: H, sourceHandleId: I, targetHandleId: $, onContextMenu: B, onMouseEnter: w, onMouseMove: M, onMouseLeave: S, reconnectRadius: D, onReconnect: L, onReconnectStart: O, onReconnectEnd: T, markerEnd: F, markerStart: z, rfId: V, ariaLabel: W, isFocusable: q, isReconnectable: K, pathOptions: X, interactionWidth: J, disableKeyboardA11y: te }) => {
    const Z = se(null), [fe, G] = ae(!1), [ye, je] = ae(!1), Ee = Ie(), Ve = Se(() => `url('#${ks(z, V)}')`, [z, V]), xe = Se(() => `url('#${ks(F, V)}')`, [F, V]);
    if (H)
      return null;
    const oe = (Oe) => {
      var it;
      const { edges: et, addSelectedEdges: Ht, unselectNodesAndEdges: Rt, multiSelectionActive: Ft } = Ee.getState(), ht = et.find((fn) => fn.id === n);
      ht && (R && (Ee.setState({ nodesSelectionActive: !1 }), ht.selected && Ft ? (Rt({ nodes: [], edges: [ht] }), (it = Z.current) == null || it.blur()) : Ht([n])), i && i(Oe, ht));
    }, Re = po(n, Ee.getState, s), Ot = po(n, Ee.getState, B), dn = po(n, Ee.getState, w), Et = po(n, Ee.getState, M), qt = po(n, Ee.getState, S), gt = (Oe, et) => {
      if (Oe.button !== 0)
        return;
      const { edges: Ht, isValidConnection: Rt } = Ee.getState(), Ft = et ? C : p, ht = (et ? $ : I) || null, it = et ? "target" : "source", fn = Rt || Fh, gn = et, Kt = Ht.find((pt) => pt.id === n);
      je(!0), O == null || O(Oe, Kt, it);
      const St = (pt) => {
        je(!1), T == null || T(pt, Kt, it);
      };
      pu({
        event: Oe,
        handleId: ht,
        nodeId: Ft,
        onConnect: (pt) => L == null ? void 0 : L(Kt, pt),
        isTarget: gn,
    ...
    }, Lt = (Oe) => gt(Oe, !0), _t = (Oe) => gt(Oe, !1), Qe = () => G(!0), Yt = () => G(!1), jt = !R && !i, Gt = (Oe) => {
      var et;
      if (!te && nu.includes(Oe.key) && R) {
        const { unselectNodesAndEdges: Ht, addSelectedEdges: Rt, edges: Ft } = Ee.getState();
        Oe.key === "Escape" ? ((et = Z.current) == null || et.blur(), Ht({ edges: [Ft.find((it) => it.id === n)] })) : Rt([n]);
      }
    };
    return P.createElement(
      "g",
      ...
      ]), onClick: oe, onDoubleClick: Re, onContextMenu: Ot, onMouseEnter: dn, onMouseMove: Et, onMouseLeave: qt, onKeyDown: q ? Gt : void 0, tabIndex: q ? 0 : void 0, role: q ? "button" : "img", "data-testid": `rf__edge-${n}`, "aria-label": W === null ? void 0 : W || `Edge from ${p} to ${C}`, "aria-describedby": q ? `${_u}-${V}` : void 0, ref: Z },
      !ye && P.createElement(e, { id: n, source: p, target: C, selected: l, animated: u, label: c, labelStyle: d, labelShowBg: g, labelBgStyle: h, labelBgPadding: m, labelBgBorderRadius: b, data: a, style: y, sourceX: x, sourceY: E, targetX: v, targetY: A, sourcePosition: N, targetPosition: k, sourceHandleId: I, targetHandleId: $, markerStart: Ve, markerEnd: xe, pathOptions: X, interactionWidth: J }),
      K && P.createElement(
        P.Fragment,
        null,
        (K === "source" || K === !0) && P.createElement(sc, { position: N, centerX: x, centerY: E, radius: D, onMouseDown: Lt, onMouseEnter: Qe, onMouseOut: Yt, type: "source" }),
        (K === "target" || K === !0) && P.createElement(sc, { position: k, centerX: v, centerY: A, radius: D, onMouseDown: _t, onMouseEnter: Qe, onMouseOut: Yt, type: "target" })
      )
    );
  };
...
function Ih(e) {
  const t = {
    ...
    straight: Fn(e.bezier || yl),
    step: Fn(e.step || Cl),
    smoothstep: Fn(e.step || Ca),
    simplebezier: Fn(e.simplebezier || bl)
...
const zh = (e, t, n, o, r, a) => {
  const i = lc(n, e, t), s = lc(a, o, r);
  return {
    sourceX: i.x,
    sourceY: i.y,
    targetX: s.x,
...
function Ph({ sourcePos: e, targetPos: t, sourceWidth: n, sourceHeight: o, targetWidth: r, targetHeight: a, width: i, height: s, transform: l }) {
  const u = {
    x: Math.min(e.x, t.x),
    y: Math.min(e.y, t.y),
...
const Bh = [{ level: 0, isMaxLevel: !0, edges: [] }];
function Vh(e, t, n = !1) {
  let o = -1;
  ...
  return a.length === 0 ? Bh : a;
}
function Wh(e, t, n) {
  const o = Me(pe((r) => e ? r.edges.filter((a) => {
    const i = t.get(a.source), s = t.get(a.target);
    return (i == null ? void 0 : i.width) && (i == null ? void 0 : i.height) && (s == null ? void 0 : s.width) && (s == null ? void 0 : s.height) && Ph({
...
const $h = ({ color: e = "none", strokeWidth: t = 1 }) => P.createElement("polyline", { style: {
  stroke: e,
  strokeWidth: t
...
const qh = ({ id: e, type: t, color: n, width: o = 12.5, height: r = 12.5, markerUnits: a = "strokeWidth", strokeWidth: i, orient: s = "auto-start-reverse" }) => {
  const l = Uh(t);
  ...
  const n = Me(
    pe(Yh({ defaultColor: e, rfId: t }), [e, t]),
    // the id includes all marker options, so we just need to look at that part of the marker
    (o, r) => !(o.length !== r.length || o.some((a, i) => a.id !== r[i].id))
  );
  return P.createElement("defs", null, n.map((o) => P.createElement(qh, { id: o.id, key: o.id, type: o.type, color: o.color, width: o.width, height: o.height, markerUnits: o.markerUnits, strokeWidth: o.strokeWidth, orient: o.orient })));
};
...
const Kh = (e) => ({
  ...
  const { edgesFocusable: C, edgesUpdatable: x, elementsSelectable: E, width: v, height: A, connectionMode: N, nodeInternals: k, onError: R } = Me(Kh, Pe), H = Wh(t, k, n);
  return v ? P.createElement(
    P.Fragment,
    null,
    H.map(({ level: I, edges: $, isMaxLevel: B }) => P.createElement(
      "svg",
      { key: I, style: { zIndex: I }, width: v, height: A, className: "react-flow__edges react-flow__container" },
      B && P.createElement(Gh, { defaultColor: e, rfId: o }),
      P.createElement("g", null, $.map((w) => {
        const [M, S, D] = uc(k.get(w.source)), [L, O, T] = uc(k.get(w.target));
        if (!D || !T)
          return null;
        let F = w.type || "default";
        r[F] || (R == null || R("011", vt.error011(F)), F = "default");
        const z = r[F] || r.default, V = N === Mn.Strict ? O.target : (O.target ?? []).concat(O.source ?? []), W = cc(S.source, w.sourceHandle), q = cc(V, w.targetHandle), K = (W == null ? void 0 : W.position) || ne.Bottom, X = (q == null ? void 0 : q.position) || ne.Top, J = !!(w.focusable || C && typeof w.focusable > "u"), te = w.reconnectable || w.updatable, Z = typeof g < "u" && (te || x && typeof te > "u");
        if (!W || !q)
          return R == null || R("008", vt.error008(W, w)), null;
        const { sourceX: fe, sourceY: G, targetX: ye, targetY: je } = zh(M, W, K, L, q, X);
...
Ru.displayName = "EdgeRenderer";
var Xh = De(Ru);
const Jh = (e) => `translate(${e.transform[0]}px,${e.transform[1]}px) scale(${e.transform[2]})`;
...
const tp = {
  ...
  [ne.Top]: ne.Bottom,
  [ne.Bottom]: ne.Top
}, Fu = ({ nodeId: e, handleType: t, style: n, type: o = on.Bezier, CustomComponent: r, connectionStatus: a }) => {
  var A, N, k;
  const { fromNode: i, handleId: s, toX: l, toY: u, connectionMode: c } = Me(pe((R) => ({
  ...
  if (c === Mn.Loose && (g = g || (d == null ? void 0 : d[t === "source" ? "target" : "source"])), !i || !g)
    return null;
  const h = s ? g.find((R) => R.id === s) : g[0], m = h ? h.x + h.width / 2 : (i.width ?? 0) / 2, b = h ? h.y + h.height / 2 : i.height ?? 0, y = (((N = i.positionAbsolute) == null ? void 0 : N.x) ?? 0) + m, p = (((k = i.positionAbsolute) == null ? void 0 : k.y) ?? 0) + b, C = h == null ? void 0 : h.position, x = C ? tp[C] : null;
  if (!C || !x)
    return null;
  if (r)
  ...
  return o === on.Bezier ? [E] = lu(v) : o === on.Step ? [E] = Ss({
    ...v,
    borderRadius: 0
  }) : o === on.SmoothStep ? [E] = Ss(v) : o === on.SimpleBezier ? [E] = su(v) : E = `M${y},${p} ${l},${u}`, P.createElement("path", { d: E, fill: "none", className: "react-flow__connection-path", style: n });
};
Fu.displayName = "ConnectionLine";
const np = (e) => ({
...
function op({ containerStyle: e, style: t, type: n, component: o }) {
  const { nodeId: r, handleType: a, nodesConnectable: i, width: s, height: l, connectionStatus: u } = Me(np, Pe);
  return !(r && a && s && i) ? null : P.createElement(
    ...
    P.createElement(
      ...
      P.createElement(Fu, { nodeId: r, handleType: a, style: t, type: n, CustomComponent: o, connectionStatus: u })
    )
  );
}
function fc(e, t) {
...
const Ns = [
  ...
  updateNodeDimensions: (n) => {
    ...
    const d = window.getComputedStyle(c), { m22: g } = new window.DOMMatrixReadOnly(d.transform), h = n.reduce((b, y) => {
      ...
      if (p != null && p.hidden)
        ...
        const C = hl(y.nodeElement);
        !!(C.width && C.height && (p.width !== C.width || p.height !== C.height || y.forceUpdate)) && (r.set(p.id, {
          ...p,
          [Ne]: {
            ...p[Ne],
            handleBounds: {
              source: ac(".source", y.nodeElement, g, u),
              target: ac(".target", y.nodeElement, g, u)
            }
          },
          ...C
        }), b.push({
    ...
    ku(r, u);
    const m = i || a && !i && Au(t, { initial: !0, ...s });
  ...
  addSelectedNodes: (n) => {
    ...
    let i, s = null;
    o ? i = n.map((l) => nn(l, !0)) : (i = In(a(), n), s = In(r, [])), yr({
      changedNodes: i,
      changedEdges: s,
      get: t,
      set: e
  ...
  addSelectedEdges: (n) => {
    const { multiSelectionActive: o, edges: r, getNodes: a } = t();
    let i, s = null;
    o ? i = n.map((l) => nn(l, !0)) : (i = In(r, n), s = In(a(), [])), yr({
      changedNodes: s,
      changedEdges: i,
      get: t,
      set: e
  ...
  unselectNodesAndEdges: ({ nodes: n, edges: o } = {}) => {
    const { edges: r, getNodes: a } = t(), i = n || a(), s = o || r, l = i.map((c) => (c.selected = !1, nn(c.id, !1))), u = s.map((c) => nn(c.id, !1));
    yr({
      changedNodes: l,
      changedEdges: u,
      get: t,
  ...
  resetSelectedElements: () => {
    const { edges: n, getNodes: o } = t(), a = o().filter((s) => s.selected).map((s) => nn(s.id, !1)), i = n.filter((s) => s.selected).map((s) => nn(s.id, !1));
    yr({
      changedNodes: a,
      changedEdges: i,
      get: t,
  ...
  setNodeExtent: (n) => {
    ...
    o.forEach((r) => {
      r.positionAbsolute = pl(r.position, n);
    }), e({
      nodeExtent: n,
  ...
  panBy: (n) => {
    ...
    if (!i || !s || !n.x && !n.y)
      return !1;
    const u = rn.translate(o[0] + n.x, o[1] + n.y).scale(o[2]), c = [
      [0, 0],
      [r, a]
  ...
  reset: () => e({ ...Jt })
}), Object.is), Ko = ({ children: e }) => {
  const t = se(null);
  return t.current || (t.current = ap()), P.createElement(Eg, { value: t.current }, e);
};
Ko.displayName = "ReactFlowProvider";
const zu = ({ children: e }) => He(ba) ? P.createElement(P.Fragment, null, e) : P.createElement(Ko, null, e);
zu.displayName = "ReactFlowWrapper";
const ip = {
  input: yu,
  default: Ms,
  output: xu,
  ...
  smoothstep: Ca,
  simplebezier: bl
}, lp = [0, 0], cp = [15, 15], up = { x: 0, y: 0, zoom: 1 }, dp = {
  width: "100%",
  height: "100%",
  overflow: "hidden",
  position: "relative",
  zIndex: 0
}, ya = zs(({ nodes: e, edges: t, defaultNodes: n, defaultEdges: o, className: r, nodeTypes: a = ip, edgeTypes: i = sp, onNodeClick: s, onEdgeClick: l, onInit: u, onMove: c, onMoveStart: d, onMoveEnd: g, onConnect: h, onConnectStart: m, onConnectEnd: b, onClickConnectStart: y, onClickConnectEnd: p, onNodeMouseEnter: C, onNodeMouseMove: x, onNodeMouseLeave: E, onNodeContextMenu: v, onNodeDoubleClick: A, onNodeDragStart: N, onNodeDrag: k, onNodeDragStop: R, onNodesDelete: H, onEdgesDelete: I, onSelectionChange: $, onSelectionDragStart: B, onSelectionDrag: w, onSelectionDragStop: M, onSelectionContextMenu: S, onSelectionStart: D, onSelectionEnd: L, connectionMode: O = Mn.Strict, connectionLineType: T = on.Bezier, connectionLineStyle: F, connectionLineComponent: z, connectionLineContainerStyle: V, deleteKeyCode: W = "Backspace", selectionKeyCode: q = "Shift", selectionOnDrag: K = !1, selectionMode: X = Io.Full, panActivationKeyCode: J = "Space", multiSelectionKeyCode: te = Yr() ? "Meta" : "Control", zoomActivationKeyCode: Z = Yr() ? "Meta" : "Control", snapToGrid: fe = !1, snapGrid: G = cp, onlyRenderVisibleElements: ye = !1, selectNodesOnDrag: je = !0, nodesDraggable: Ee, nodesConnectable: Ve, nodesFocusable: xe, nodeOrigin: oe = lp, edgesFocusable: Re, edgesUpdatable: Ot, elementsSelectable: dn, defaultViewport: Et = up, minZoom: qt = 0.5, maxZoom: gt = 2, translateExtent: Lt = Ns, preventScrolling: _t = !0, nodeExtent: Qe, defaultMarkerColor: Yt = "#b1b1b7", zoomOnScroll: jt = !0, zoomOnPinch: Gt = !0, panOnScroll: Oe = !1, panOnScrollSpeed: et = 0.5, panOnScrollMode: Ht = yn.Free, zoomOnDoubleClick: Rt = !0, panOnDrag: Ft = !0, onPaneClick: ht, onPaneMouseEnter: it, onPaneMouseMove: fn, onPaneMouseLeave: gn, onPaneScroll: Kt, onPaneContextMenu: St, children: Dn, onEdgeContextMenu: pt, onEdgeDoubleClick: Qo, onEdgeMouseEnter: _a, onEdgeMouseMove: er, onEdgeMouseLeave: Sa, onEdgeUpdate: tr, onEdgeUpdateStart: nr, onEdgeUpdateEnd: ka, onReconnect: Aa, onReconnectStart: or, onReconnectEnd: rr, reconnectRadius: Ma = 10, edgeUpdaterRadius: Ta = 10, onNodesChange: Na, onEdgesChange: Da, noDragClassName: j = "nodrag", noWheelClassName: Y = "nowheel", noPanClassName: ee = "nopan", fitView: ie = !1, fitViewOptions: he, connectOnClick: ve = !0, attributionPosition: ge, proOptions: ce, defaultEdgeOptions: ze, elevateNodesOnSelect: Ae = !0, elevateEdgesOnSelect: Te = !1, disableKeyboardA11y: Ze = !1, autoPanOnConnect: Xt = !0, autoPanOnNodeDrag: It = !0, connectionRadius: We = 20, isValidConnection: lo, onError: Oa, style: La, id: Zl, nodeDragThreshold: wd, ...Ed }, _d) => {
  const ja = Zl || "1";
  return P.createElement(
    "div",
    { ...Ed, style: { ...La, ...dp }, ref: _d, className: Ge(["react-flow", r]), "data-testid": "rf__wrapper", id: Zl },
    P.createElement(
      zu,
      null,
      P.createElement(rp, { onInit: u, onMove: c, onMoveStart: d, onMoveEnd: g, onNodeClick: s, onEdgeClick: l, onNodeMouseEnter: C, onNodeMouseMove: x, onNodeMouseLeave: E, onNodeContextMenu: v, onNodeDoubleClick: A, nodeTypes: a, edgeTypes: i, connectionLineType: T, connectionLineStyle: F, connectionLineComponent: z, connectionLineContainerStyle: V, selectionKeyCode: q, selectionOnDrag: K, selectionMode: X, deleteKeyCode: W, multiSelectionKeyCode: te, panActivationKeyCode: J, zoomActivationKeyCode: Z, onlyRenderVisibleElements: ye, selectNodesOnDrag: je, defaultViewport: Et, translateExtent: Lt, minZoom: qt, maxZoom: gt, preventScrolling: _t, zoomOnScroll: jt, zoomOnPinch: Gt, zoomOnDoubleClick: Rt, panOnScroll: Oe, panOnScrollSpeed: et, panOnScrollMode: Ht, panOnDrag: Ft, onPaneClick: ht, onPaneMouseEnter: it, onPaneMouseMove: fn, onPaneMouseLeave: gn, onPaneScroll: Kt, onPaneContextMenu: St, onSelectionContextMenu: S, onSelectionStart: D, onSelectionEnd: L, onEdgeContextMenu: pt, onEdgeDoubleClick: Qo, onEdgeMouseEnter: _a, onEdgeMouseMove: er, onEdgeMouseLeave: Sa, onReconnect: Aa ?? tr, onReconnectStart: or ?? nr, onReconnectEnd: rr ?? ka, reconnectRadius: Ma ?? Ta, defaultMarkerColor: Yt, noDragClassName: j, noWheelClassName: Y, noPanClassName: ee, elevateEdgesOnSelect: Te, rfId: ja, disableKeyboardA11y: Ze, nodeOrigin: oe, nodeExtent: Qe }),
      P.createElement(eh, { nodes: e, edges: t, defaultNodes: n, defaultEdges: o, onConnect: h, onConnectStart: m, onConnectEnd: b, onClickConnectStart: y, onClickConnectEnd: p, nodesDraggable: Ee, nodesConnectable: Ve, nodesFocusable: xe, edgesFocusable: Re, edgesUpdatable: Ot, elementsSelectable: dn, elevateNodesOnSelect: Ae, minZoom: qt, maxZoom: gt, nodeExtent: Qe, onNodesChange: Na, onEdgesChange: Da, snapToGrid: fe, snapGrid: G, connectionMode: O, translateExtent: Lt, connectOnClick: ve, defaultEdgeOptions: ze, fitView: ie, fitViewOptions: he, onNodesDelete: H, onEdgesDelete: I, onNodeDragStart: N, onNodeDrag: k, onNodeDragStop: R, onSelectionDrag: w, onSelectionDragStart: B, onSelectionDragStop: M, noPanClassName: ee, nodeOrigin: oe, rfId: ja, autoPanOnConnect: Xt, autoPanOnNodeDrag: It, onError: Oa, connectionRadius: We, isValidConnection: lo, nodeDragThreshold: wd }),
      P.createElement(Jg, { onSelectionChange: $ }),
      Dn,
      P.createElement(Sg, { proOptions: ce, position: ge }),
      P.createElement(ah, { rfId: ja, disableKeyboardA11y: Ze })
    )
  );
});
...
const wo = ({ children: e, className: t, ...n }) => P.createElement("button", { type: "button", className: Ge(["react-flow__controls-button", t]), ...n }, e);
wo.displayName = "ControlButton";
const bp = (e) => ({
  isInteractive: e.nodesDraggable || e.nodesConnectable || e.elementsSelectable,
  minZoomReached: e.transform[2] <= e.minZoom,
  maxZoomReached: e.transform[2] >= e.maxZoom
}), Pu = ({ style: e, showZoom: t = !0, showFitView: n = !0, showInteractive: o = !0, fitViewOptions: r, onZoomIn: a, onZoomOut: i, onFitView: s, onInteractiveChange: l, className: u, children: c, position: d = "bottom-left" }) => {
  const g = Ie(), [h, m] = ae(!1), { isInteractive: b, minZoomReached: y, maxZoomReached: p } = Me(bp, Pe), { zoomIn: C, zoomOut: x, fitView: E } = wt();
  if (re(() => {
    m(!0);
  }, []), !h)
    return null;
  ...
  return P.createElement(
    ...
    t && P.createElement(
      ...
      P.createElement(
        wo,
        { onClick: A, className: "react-flow__controls-zoomout", title: "zoom out", "aria-label": "zoom out", disabled: y },
    ...
    o && P.createElement(wo, { className: "react-flow__controls-interactive", onClick: k, title: "toggle interactivity", "aria-label": "toggle interactivity" }, b ? P.createElement(mp, null) : P.createElement(pp, null)),
    c
  );
};
Pu.displayName = "Controls";
var Sl = De(Pu), yt;
(function(e) {
  e.Lines = "lines", e.Dots = "dots", e.Cross = "cross";
})(yt || (yt = {}));
function Cp({ color: e, dimensions: t, lineWidth: n }) {
  return P.createElement("path", { stroke: e, strokeWidth: n, d: `M${t[0] / 2} 0 V${t[1]} M0 ${t[1] / 2} H${t[0]}` });
}
function yp({ color: e, radius: t }) {
...
function Bu({
  ...
  const u = se(null), { transform: c, patternId: d } = Me(wp, Pe), g = i || vp[t], h = o || xp[t], m = t === yt.Dots, b = t === yt.Cross, y = Array.isArray(n) ? n : [n, n], p = [y[0] * c[2] || 1, y[1] * c[2] || 1], C = h * c[2], x = b ? [C, C] : p, E = m ? [C / a, C / a] : [x[0] / a, x[1] / a];
  return P.createElement(
    "svg",
    ...
    P.createElement("pattern", { id: d + e, x: c[0] % p[0], y: c[1] % p[1], width: p[0], height: p[1], patternUnits: "userSpaceOnUse", patternTransform: `translate(-${E[0]},-${E[1]})` }, m ? P.createElement(yp, { color: g, radius: C / a }) : P.createElement(Cp, { dimensions: x, color: g, lineWidth: r })),
    P.createElement("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: `url(#${d + e})` })
  );
}
Bu.displayName = "Background";
var kl = De(Bu);
const Vu = "columns", Wu = "exposure", $u = "tables", Ep = "feedback", Zu = "settings", Vt = "column-", Uu = "see-more-", _p = 5, Sp = 100, Xi = 100, Xo = 300, Un = 80, kp = 12, Ap = Un, qu = 30, gc = 4, Mp = 280, Tp = 80, Np = 80, Dp = 250, Ds = 0.05, Yu = "#7A899E", Al = "#E38E00", Ml = {
  Original: "#FDD835",
  Alias: "#40C8AE",
  ...
  height: 16,
  color: Al
}, tt = (e) => e.id.startsWith(Vt), xr = (e) => e.id.startsWith(Uu), Ut = (e) => !e.id.startsWith(Vt), Dl = (e, t, n, o, r, a = !1) => {
  const [i, s] = r ? [n, o] : [o, n], [l, u] = r ? Os(e, t, a) : Os(t, e, a);
  return {
    id: `${i}-${s}`,
    source: i,
    target: s,
  ...
  var n;
  e.style = t ? ((n = e.data) == null ? void 0 : n.type) === "indirect" ? Nl : Tl : va, e.markerEnd = t ? Ku : Gu;
}, Os = (e, t, n) => n ? e < t ? ["bottom", "top"] : e > t ? ["top", "bottom"] : e < 0 ? ["top", "top"] : ["bottom", "bottom"] : e < t ? ["right", "left"] : e > t ? ["left", "right"] : e < 0 ? ["left", "left"] : ["right", "right"], Op = (e, t) => {
  const n = {};
  e.forEach((a) => {
    Ut(a) && (n[a.id] = a.data.level);
  });
  const o = {};
...
}, Po = (e, t) => Vt + `${e}/${t}`, ea = (e, t) => Uu + e + "-" + (t ? "1" : "0"), hc = (e, t) => {
  for (const n of e)
    if (n[0] === t[0] && n[1] === t[1]) return !0;
  return !1;
}, pc = (e, t, n) => {
  e[t] = e[t] || [], e[t].push(...n);
}, Or = (e, t = 1) => e * (qu + gc) + t * gc, mc = (e, t) => (n) => e <= n && n <= t, Lp = (e, t) => (n) => e < n && n < t, bc = (e, t) => {
  const n = e.findIndex((o) => o.id === t);
  n !== -1 && e.splice(n, 1);
}, Cc = (e, t, n) => e === -1 || n >= t ? t : n >= e ? n : e, Bo = (e, t, n = !0) => {
  e.forEach((o) => {
    tt(o) || (o.hidden = !t, n && no(o, t));
  });
}, Vo = (e, t, n = !0) => {
  e.forEach((o) => {
    tt(o) && (o.hidden = !t, n && no(o, t));
...
const jp = "_table_node_i3r0s_1", Hp = "_header_i3r0s_8", Rp = "_collapse_i3r0s_16", Fp = "_selected_i3r0s_21", Ip = "_content_i3r0s_24", zp = "_table_header_i3r0s_37", Pp = "_seed_i3r0s_47", Bp = "_model_i3r0s_52", Vp = "_source_i3r0s_57", Wp = "_exposure_i3r0s_62", $p = "_snapshot_i3r0s_67", Zp = "_metrics_i3r0s_72", Up = "_macros_i3r0s_77", qp = "_analysis_i3r0s_82", Yp = "_node_icon_i3r0s_87", Gp = "_dialect_icon_i3r0s_99", Kp = "_table_handle_i3r0s_107", Xp = "_see_more_node_i3r0s_121", Jp = "_table_card_i3r0s_132", Qp = "_disabled_i3r0s_144", em = "_column_card_i3r0s_149", tm = "_edit_icon_i3r0s_162", nm = "_active_i3r0s_170", om = "_expand_lineage_icon_i3r0s_174", rm = "_processing_div_i3r0s_187", am = "_gif_img_i3r0s_190", im = "_card_i3r0s_195", sm = "_column_node_i3r0s_210", lm = "_column_name_i3r0s_221", cm = "_column_top_right_i3r0s_226", um = "_divider_i3r0s_234", dm = "_table_details_header_i3r0s_240", fm = "_verticle_divider_i3r0s_248", gm = "_low_confidence_i3r0s_253", hm = "_high_confidence_i3r0s_260", pm = "_alert_icon_i3r0s_267", mm = "_menu_card_i3r0s_273", bm = "_menu_card_container_i3r0s_278", Cm = "_table_details_tabs_i3r0s_285", ym = "_tab_i3r0s_1", vm = "_table_node_pill_i3r0s_305", xm = "_icon_i3r0s_315", wm = "_node-checkbox_i3r0s_322", Em = "_non_select_node_checkbox_i3r0s_322", _m = "_select_node_checkbox_i3r0s_322", Sm = "_node_extra_info_i3r0s_338", km = "_help_body_i3r0s_342", Am = "_feedback_body_i3r0s_346", Mm = "_cancel_btn_i3r0s_349", Tm = "_expand_nav_i3r0s_354", Nm = "_expand_nav_btn_i3r0s_362", Dm = "_lineage_legend_i3r0s_389", Om = "_column_legend_i3r0s_406", Lm = "_dot_i3r0s_422", jm = "_model_views_type_i3r0s_434", Hm = "_close_button_i3r0s_443", Rm = "_op_node_i3r0s_456", Fm = "_light_mode_i3r0s_475", Im = "_dark_mode_i3r0s_478", zm = "_highlighted_i3r0s_481", Pm = "_cost_data_i3r0s_487", Bm = "_op_type_text_i3r0s_502", Vm = "_node_stats_i3r0s_505", Wm = "_savings-performance_i3r0s_521", $m = "_performance_i3r0s_521", Zm = "_savings_i3r0s_521", Um = "_value_i3r0s_536", qm = "_percent_i3r0s_539", Ym = "_static_table_node_i3r0s_554", Gm = "_details_btn_i3r0s_618", Km = "_enable_i3r0s_627", Xm = "_disable_i3r0s_144", Jm = "_code_editor_container_i3r0s_638", Qm = "_code_editor_i3r0s_638", eb = "_tooltip_container_i3r0s_652", tb = "_tooltip_text_i3r0s_658", nb = "_views_type_badge_i3r0s_675", ob = "_column_code_icon_i3r0s_706", rb = "_edge_select_i3r0s_722", ab = "_edge_non_select_i3r0s_732", ib = "_modal_views_code_container_i3r0s_742", sb = "_custom_node_code_block_i3r0s_747", lb = "_reset_btn_i3r0s_759", U = {
  table_node: jp,
  header: Hp,
  collapse: Rp,
  selected: Fp,
  ...
  column_top_right: cm,
  divider: um,
  table_details_header: dm,
  verticle_divider: fm,
  low_confidence: gm,
  high_confidence: hm,
  alert_icon: pm,
  menu_card: mm,
  menu_card_container: bm,
  table_details_tabs: Cm,
  tab: ym,
  table_node_pill: vm,
  icon: xm,
  "node-checkbox": "_node-checkbox_i3r0s_322",
  nodeCheckbox: wm,
  non_select_node_checkbox: Em,
  select_node_checkbox: _m,
  node_extra_info: Sm,
  help_body: km,
  feedback_body: Am,
  cancel_btn: Mm,
  ...
  return /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
    /* @__PURE__ */ f.jsxs(
      ke,
      {
        ...
        children: [
          "Legend",
          e ? /* @__PURE__ */ f.jsx(wb, {}) : /* @__PURE__ */ f.jsx(xb, {})
        ]
      }
    ),
    /* @__PURE__ */ f.jsx(
      kc,
      {
        ...
        placement: "top",
        children: /* @__PURE__ */ f.jsxs(Ac, { children: [
          Object.keys(Ml).map((o) => /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-sm mb-1 align-items-center", children: [
            /* @__PURE__ */ f.jsx(Ll, { viewsType: o }),
            /* @__PURE__ */ f.jsx("div", { children: o })
          ] }, o)),
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-sm mb-1 align-items-center", children: [
            /* @__PURE__ */ f.jsx("div", { className: U.column_code_icon, children: /* @__PURE__ */ f.jsx(Gc, {}) }),
...
var Qb = nd.exports;
const me = /* @__PURE__ */ ro(Qb), eC = (e) => _e.get("upstreamTables", { table: e }), tC = (e) => _e.get("downstreamTables", { table: e }), nC = (e) => _e.get("getExposureDetails", {
  name: e
}), jl = (e, t) => _e.get("getColumns", {
  table: e,
  refresh: t
}), oC = (e) => _e.get("getConnectedColumns", e), rC = (e) => _e.get("sendFeedback", e), aC = () => _e.get("getLineageSettings", {}), Ji = (e) => _e.get("persistLineageSettings", e), od = () => _e.get("init", {}), iC = (e) => _e.get("openFile", { url: e }), sC = () => _e.get("openChat", {}), Hl = (e) => _e.get("showInfoNotification", { message: e }), lC = () => _e.get("previewFeature", {}), Qi = (e) => _e.get("columnLineage", { event: e }), cC = (e) => _e.get("telemetryEvents", e), uC = (e) => _e.post("dbt/v4/export-lineage", e);
var dC = /* @__PURE__ */ ((e) => (e.CANCEL = "cancel", e.END = "end", e.START = "start", e))(dC || {});
const qe = class qe {
  static onCancel() {
...
let Le = qe;
const fC = ({ datatype: e, color: t, size: n = "1rem" }) => {
  const [o, r] = Se(() => {
  ...
  subquery: {
    light: /* @__PURE__ */ f.jsx(Lb, { style: { color: "#FDF6EA" } }),
    dark: /* @__PURE__ */ f.jsx(jb, { style: { color: "#4B473F" } })
  },
  source: {
  ...
  analysis: { light: /* @__PURE__ */ f.jsx(Ls, {}), dark: /* @__PURE__ */ f.jsx(Ls, {}) },
  snapshot: {
    light: /* @__PURE__ */ f.jsx(Ec, { style: { color: "#F6F4FF" } }),
    dark: /* @__PURE__ */ f.jsx(Ec, { style: { color: "#444554" } })
  },
  semantic_model: { light: /* @__PURE__ */ f.jsx(Hb, {}), dark: /* @__PURE__ */ f.jsx(Ob, {}) },
  macros: { light: /* @__PURE__ */ f.jsx(js, {}), dark: /* @__PURE__ */ f.jsx(js, {}) },
  unknown: {
    light: /* @__PURE__ */ f.jsx(Er, { style: { color: "#FFECE6" } }),
    dark: /* @__PURE__ */ f.jsx(Er, { style: { color: "#4D4343" } })
  }
  ...
  e === "seed" && /* @__PURE__ */ f.jsx(mb, {}),
  e === "model" && /* @__PURE__ */ f.jsx(wr, {}),
  e === "cte" && /* @__PURE__ */ f.jsx(wr, {}),
  e === "subquery" && /* @__PURE__ */ f.jsx(wr, {}),
  e === "source" && /* @__PURE__ */ f.jsx(bb, {}),
  e === "exposure" && /* @__PURE__ */ f.jsx(Cb, {}),
  e === "analysis" && /* @__PURE__ */ f.jsx(Ls, {}),
  e === "snapshot" && /* @__PURE__ */ f.jsx(yb, {}),
  e === "semantic_model" && /* @__PURE__ */ f.jsx(vb, {}),
  e === "macros" && /* @__PURE__ */ f.jsx(js, {}),
  e === "unknown" && /* @__PURE__ */ f.jsx(wr, {})
] }), hC = ({ nodeType: e }) => {
  const {
    state: { theme: t }
  } = Be();
  return /* @__PURE__ */ f.jsx(f.Fragment, { children: gC[e][t] });
}, So = ({ id: e, icon: t, text: n, label: o }) => /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
  ...
  subquery: "SUB",
  unknown: "UNK"
}, rd = (e, t) => e ? eC(t) : tC(t), ad = (e, t) => e ? t + 1 : t - 1, Ea = (e, t, n, o, r, a, i = _p, s = !1, l) => {
  const u = ad(r, a), c = (g) => {
    var y, p;
    const h = ((p = (y = e.find((C) => C.id === g)) == null ? void 0 : y.data) == null ? void 0 : p.level) || 0, m = Dl(a, h, o, g, r, s);
  ...
  for (const g of n) {
    ...
    e.find((m) => m.id === g.table) || (d++, l ? l[g.table].type in Wo ? e.push(to(g, u, o)) : e.push(Xu(g.table, u, o, l[g.table])) : e.push(to(g, u, o))), c(g.table);
  }
}, Dt = (e, t, n = !1) => {
  let o = 1 / 0;
  const r = {};
  ...
  const a = {}, i = {}, s = {}, l = {}, u = {}, c = {};
  for (const p of t)
    tt(p) || xr(e.find((C) => C.id === p.source)) || xr(e.find((C) => C.id === p.target)) || (u[p.source] = u[p.source] || [], u[p.source].push(p.target), c[p.target] = c[p.target] || [], c[p.target].push(p.source));
  const d = (p) => {
    const { level: C } = p.data;
  ...
  for (const p of e)
    tt(p) || xr(p) || l[p.id] || (g(p.id, u), l[p.id] = !1, g(p.id, c));
  for (const p of e)
    tt(p) || xr(p) && d(p);
  const h = (p) => {
    const C = s[p.id] || 0, x = a[p.id] || 0;
    return Xi + C * (Un + Np) + Or(x, C);
  }, m = (p) => (p - o) * (Xo + Mp) + Sp, b = (p) => (p - o) * (Un + Tp) + Xi, y = (p) => {
    const C = s[p.id] || 0, x = a[p.id] || 0;
    return Xi + C * (Un + Dp) + Or(x, C);
  };
  for (const p of e) {
    if (tt(p)) continue;
    const { level: C } = p.data;
...
}, id = (e, t) => (e.forEach((n) => Qr(n, !0)), t.forEach((n) => no(n, !1)), [e, t]), $o = (e, t, n) => {
  Bo(t, !0), Vo(t, !1);
  const o = {}, r = {}, a = (l, u) => {
    const c = [n], d = {};
    for (; c.length > 0; ) {
  ...
  const i = [...t];
  i.forEach((l) => no(l, r[l.id]));
  const s = [...e];
  return s.forEach((l) => Qr(l, !!o[l.id])), [s, i];
}, Hs = (e, t) => {
  const n = e.getNodes(), o = e.getEdges(), [r, a] = $o(n, o, t);
  e.setNodes(r), e.setEdges(a);
}, pC = async (e, t, n, o, r, a, i, s, l) => {
  var x, E;
  const u = [], c = [], { column_lineage: d, confidence: g } = await oC({
    targets: r,
    upstreamExpansion: a,
    currAnd1HopTables: i,
    selectedColumn: s,
  ...
  const h = d.filter(
    (v) => a ? hc(r, v.source) : hc(r, v.target)
  ), m = h.map((v) => a ? v.target : v.source), b = {}, y = ([v, A], N) => {
    b[v] = b[v] || [], b[v].find((k) => k.column === A) || b[v].push({ column: A, viewsType: N });
  }, p = (v, A, N, k, R) => {
    const H = xa(N, k);
    c.find((I) => I.id === H) || c.push(
      Jr(
        N,
        k,
        t[v],
  ...
  for (const v of h) {
    ...
    const [A] = v.source, [N] = v.target, k = o[A], R = o[N], H = v.source.join("/"), I = v.target.join("/"), $ = Vt + H, B = Vt + I, w = v.type;
    if (k && R)
      p(A, N, $, B, w);
    else if (k) {
      const M = n[N];
  ...
  for (const v in b) {
    if (!o[v]) continue;
    const A = [...b[v]];
    A.sort((N, k) => N.column.localeCompare(k.column));
    for (const N of A) {
      const k = {};
      h.filter((R) => R.target.join("/") === `${v}/${N.column}`).forEach((R) => {
        R.type !== "indirect" && (k[R.source.join("/")] = R.viewsCode || []);
      }), u.push(
        Xr(
          v,
          N.column,
          N.viewsType,
          k,
          (E = (x = e.find((R) => R.id = v)) == null ? void 0 : x.data) == null ? void 0 : E.nodeType
        )
      );
    }
  }
  ...
  var h, m, b, y;
  let r = e.filter(Ut), a = t.filter(Ut);
  [r, a] = id(r, a);
  const i = {};
  ...
  for (const p in c) {
    ...
    for (const x of C) {
      ...
      r.push(Xr(p, x.column, x.viewsType, {}, E));
    }
  }
  a.forEach((p) => p.style = va);
  const g = (p, C, x, E) => {
    const v = xa(x, E);
    a.find((A) => A.id === v) || a.push(
      Jr(x, E, i[p], i[C], "direct", {
        direct: !0
      })
    );
  };
  for (const p of d) {
    const [C] = p[0].split("/"), [x] = p[1].split("/"), E = s[C], v = s[x], A = Vt + p[0], N = Vt + p[1];
    if (E && v)
      g(C, x, A, N);
    else if (E) {
      const k = l[x];
  ...
  if (t.nodes.forEach((i) => {
    ...
    const i = {}, s = Po(n.table, n.name), l = { [s]: "direct" }, u = [s], c = {}, d = o ? "source" : "target", g = o ? "target" : "source";
    for (; u.length > 0; ) {
      const h = u.shift();
      if (!c[h]) {
        c[h] = !0;
    ...
    for (const h of a)
      Ut(h) || (h.data.type = i[h.id] || h.data.type, h.style = h.data.type === "direct" ? Tl : Nl);
  }
  return Dt(r, a), [r, a];
}, CC = (e, t) => {
  const n = e.filter((r) => Ut(r)), o = t.filter((r) => Ut(r));
  return [n, o];
}, sd = async (e, t, n, o) => {
  const r = [...e], a = [...t], i = [
  ...
  for (; i.length > 0; ) {
    ...
    if (s[l]) continue;
    s[l] = !0;
    const { tables: c } = await rd(o, l);
    Ea(r, a, c, l, o, u), c.forEach((d) => {
  ...
  const a = [...e], i = [...t];
  if (o >= r) return [a, i];
  const s = Lp(o, r), l = a.find((c) => c.id === n).data.level, u = async (c) => {
    const d = [
      { table: n, level: l }
    ], g = {};
    for (; d.length > 0; ) {
      ...
      g[h.table] = !0;
      const { tables: m } = await rd(c, h.table);
      Ea(
        a,
        i,
        m,
  ...
  _c(e, t, n, !1),
  _c(e, t, n, !0)
], Fl = async (e, t, n, o, r, a, i, s, l, u, c) => {
  var E, v, A, N, k, R;
  let d = !1;
  const { levelMap: g, tableNodes: h, seeMoreIdTableReverseMap: m } = Op(e, t), b = (H) => e.find((I) => I.id === H), y = {}, p = {};
  let C = o.map((H) => [
    H.table,
    H.name
  ]), x = [];
  for (; !(Le.isCancelled || (C = C.filter((V) => !y[V.join("/")]), C.length === 0 && x.length === 0)); ) {
    ...
    const [I, $] = n ? ["source", "target"] : ["target", "source"], B = [], w = [], M = [];
    let S = !1;
    for (const V of t) {
      if (tt(V)) continue;
      const W = V[I], q = V[$], K = h[q] ? [(E = b(q)) == null ? void 0 : E.data] : (N = (A = (v = b(q)) == null ? void 0 : v.data) == null ? void 0 : A.tables) == null ? void 0 : N.filter(
        (X) => !h[X.table]
      );
      K == null || K.forEach((X) => {
        if (!X) return;
        const { table: J, materialization: te } = X;
        H[W] ? (S = !0, te === "ephemeral" ? (pc(
          p,
          J,
          C.filter((Z) => Z[0] === W)
        ), w.push(J)) : B.push(J)) : x.includes(W) && (S = !0, te === "ephemeral" ? (pc(
          p,
          J,
          p[W]
    ...
    if (!S)
      break;
    x = w;
    const D = Object.keys(H).concat(B);
    M.forEach((V) => {
      C.push(...p[V]), D.push(...p[V].map((W) => W[0]));
    });
    const L = await pC(
      e,
      g,
    ...
    ((k = L.confidence) == null ? void 0 : k.confidence) === "low" && r(((R = L.confidence) == null ? void 0 : R.operator_list) || []), C = L.newCurr, !d && C.length > 0 && (d = !0), C = C.filter(
    ...
    a(L.seeMoreLineage), Dt(F, z), l(F, z), i(L.collectColumns);
  }
  return d;
  ...
  if (t.push(Dl(d, i, o, u, a)), s == null || s.forEach((h) => {
    const m = Po(h.source[0], h.source[1]), b = Po(h.target[0], h.target[1]), y = {};
    if (a && s.filter((p) => p.target.join("/") === h.target.join("/")).forEach((p) => {
      ...
      e.push(
        ...
        Jr(m, b, i, i + 1, h.type, l)
      );
    }
  }), r.every((h) => !!e.find((m) => m.id === h.table))) {
    const h = ea(o, a), m = a ? `${o}-${h}` : `${h}-${o}`;
    return bc(e, h), bc(t, m), !0;
  }
  return !1;
}, oo = async (e, t, n, o, r) => {
  var u;
  ...
  if (!a) return 0;
  const { level: i } = a, s = e.length, [l] = await ta(
    e,
    t,
    n,
    i - o,
  ...
  const r = Rs(e, n, o, [], !0), a = Rs(e, n, o, [], !1);
...
}, Qt = "-1px", Jo = () => /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
  /* @__PURE__ */ f.jsx(
    st,
    {
      id: "left",
  ...
  const {
    ...
    rerender: x
  } = Be(), E = $e(), v = Object.keys(h[n] || {}).length, A = v > 0, N = g === n, k = async (w) => {
    if (Le.inProgress) {
    ...
    if ([M, S] = $o(M, S, g), Dt(M, S), d.setNodes(M), d.setEdges(S), E(
      Oo(Zo(M, S, g))
    ), E(
      Kn(
        await oo(
      ...
      try {
        Le.start();
        const D = d.getEdges();
        Bo(D, !1), Vo(D, !0), d.setEdges(D), await Fl(
          M,
          S,
          w,
          ...
          (L, O) => {
            d.setNodes(L), d.setEdges(O);
          },
          m,
          { direct: p, indirect: C }
        ), x();
      } catch (D) {
        console.log("cll:error:", D);
      } finally {
        Le.end();
      }
  }, R = () => k(!0), H = () => k(!1), I = (w) => {
    w.stopPropagation(), i !== "semantic_model" && (E(kn(n)), E(Mt(i === "exposure" ? Wu : Vu)));
  ...
  return /* @__PURE__ */ f.jsxs(
    "div",
    {
      ...
      style: {
        opacity: m != null && m.name ? A ? 1 : 0.5 : 1
      },
      children: [
        /* @__PURE__ */ f.jsxs(
          "div",
                ...
                "div",
                {
                  ...
                  children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column align-items-start gap-xs w-100", children: [
                    /* @__PURE__ */ f.jsxs("div", { className: U.table_header, children: [
                      i in Wo && /* @__PURE__ */ f.jsx(f.Fragment, { children: /* @__PURE__ */ f.jsxs(
                        "div",
                        {
                          className: me(
                            U.node_icon,
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ f.jsx("div", { children: Wo[i] })
                          ]
                        }
                      ) }),
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ f.jsx(
                            "div",
                            {
                              className: me("nodrag", U.table_handle, {
                                invisible: a === 0 || a === $.filter((w) => w.target === n).length || d.getNode(ea(n, !1))
                              }),
                              onClick: (w) => {
                                w.stopPropagation(), H();
                              },
                          ...
                          /* @__PURE__ */ f.jsx(
                            ...
                            {
                              className: me("nodrag", U.table_handle, {
                                invisible: r === 0 || r === $.filter((w) => w.source === n).length || d.getNode(ea(n, !0))
                              }),
                              onClick: (w) => {
                                w.stopPropagation(), R();
                              },
  ...
  percentValue: e,
  className: t
}) => e ? /* @__PURE__ */ f.jsx(un, { title: e.tooltip, children: /* @__PURE__ */ f.jsxs("div", { className: t, children: [
        ...
        children: /* @__PURE__ */ f.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex align-items-center w-100 ps-2 pe-2 gap-xxs", children: [
              u[t] && /* @__PURE__ */ f.jsx(un, { title: u[t].tooltip, children: /* @__PURE__ */ f.jsxs("div", { className: me(U.cost_data), children: [
              ...
              /* @__PURE__ */ f.jsx(
                "div",
                {
                  className: me(U.node_icon, Rl[d]),
                  children: /* @__PURE__ */ f.jsx(hC, { nodeType: d })
                }
              ),
              /* @__PURE__ */ f.jsx("div", {}),
  ...
  const { tables: t = [], prevTable: n, right: o, level: r } = e, {
    ...
    (u) => {
      u.stopPropagation(), i(Mt($u)), i(
        rl({ ...a, tables: t, prevTable: n, right: o, level: r })
      );
    },
    [r, i, a, n, o, t]
  );
  ...
  return /* @__PURE__ */ f.jsx(io, { path: l, markerEnd: a });
}, Pl = ({ data: e }) => {
  const { column: t, table: n, viewsType: o, viewsCode: r, nodeType: a } = e, {
    state: { selectedColumn: i }
  } = Be(), s = $e(), l = (i == null ? void 0 : i.table) === n && (i == null ? void 0 : i.name) === t, u = o && Ml[o], c = u ? { borderColor: u } : {}, d = wt(), g = () => {
    const m = d.getNode(Po(n, t));
    m && (s(kn("")), s(bn({ name: t, table: n })), xC(m, d));
  }, h = Se(() => {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ f.jsxs("div", { className: U.column_top_right, children: [
          h.length > 0 && /* @__PURE__ */ f.jsx(un, { title: "Click to view code", children: /* @__PURE__ */ f.jsx(
            "div",
            {
          ...
          o && o !== "Non select" && /* @__PURE__ */ f.jsx(Ll, { viewsType: o })
        ] })
      ]
    }
  );
}, cd = {
  INNER_JOIN: /* @__PURE__ */ f.jsx(Ib, {}),
  OUTER_JOIN: /* @__PURE__ */ f.jsx(Vb, {}),
  LEFT_JOIN: /* @__PURE__ */ f.jsx(zb, {}),
  FULL_JOIN: /* @__PURE__ */ f.jsx(Ub, {}),
  RIGHT_JOIN: /* @__PURE__ */ f.jsx(Wb, {}),
  CROSS_JOIN: /* @__PURE__ */ f.jsx($b, {}),
  LATERAL_JOIN: /* @__PURE__ */ f.jsx(Zb, {}),
  FILTER: /* @__PURE__ */ f.jsx(Rb, {}),
  GROUP: /* @__PURE__ */ f.jsx(Fb, {}),
  LIMIT: /* @__PURE__ */ f.jsx(Pb, {}),
  SORT: /* @__PURE__ */ f.jsx(Bb, {}),
  UNION: /* @__PURE__ */ f.jsx(qb, {}),
  SELECT: /* @__PURE__ */ f.jsx(Yb, {})
}, Sc = {
  postgres: Kb,
  snowflake: Gb,
  s3: Xb
  ...
  return /* @__PURE__ */ f.jsxs("div", { style: { width: Xo, display: "flex", justifyContent: "center" }, children: [
    /* @__PURE__ */ f.jsx(Jo, {}),
    /* @__PURE__ */ f.jsx("div", { className: "d-flex flex-column", children: /* @__PURE__ */ f.jsxs(
      "div",
      {
        ...
        children: [
          u[o] && /* @__PURE__ */ f.jsx(un, { title: u[o].tooltip, children: /* @__PURE__ */ f.jsxs("div", { className: me(U.cost_data), children: [
...
function SC({
  ...
  return /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column align-items-start gap-xs w-100", children: [
    /* @__PURE__ */ f.jsxs("div", { className: U.table_header, children: [
      /* @__PURE__ */ f.jsxs("div", { className: me(U.node_icon, Rl[a]), children: [
        /* @__PURE__ */ f.jsx(wa, { nodeType: a }),
        /* @__PURE__ */ f.jsx("div", { children: Wo[a] })
      ] }),
      /* @__PURE__ */ f.jsx("div", { className: "lines-2", children: t })
    ] }),
...
function kC() {
  const {
    ...
    rerender: o
  } = Be(), r = $e(), { tables: a, level: i } = e, s = wt(), l = async (d) => {
    ...
    yC(
      ...
      e,
      { direct: t, indirect: n }
    ) && r(Mt("")), Dt(g, h), s.setNodes(g), s.setEdges(h), o();
  }, [u, c] = ae(a);
...
const AC = "_component_13r39_1", MC = "_spin_13r39_1", TC = {
  component: AC,
  spin: MC
}, dd = ({ top: e = 50, left: t = 50, label: n }) => /* @__PURE__ */ f.jsx(
  "div",
  {
...
), NC = "_level_tag_x6wwh_1", DC = {
  level_tag: NC
}, OC = ({ label: e }) => /* @__PURE__ */ f.jsx("div", { className: me(DC.level_tag), children: e }), fd = ({ purpose: e }) => /* @__PURE__ */ f.jsx("div", { className: me(U.card, "purpose-section"), children: /* @__PURE__ */ f.jsx("div", { className: "d-flex flex-column gap-sm", children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-xs flex-column", children: [
...
] }) }) }), gd = ({ column: e, handleClick: t, selected: n, isSelectable: o }) => {
  const {
    state: { theme: r }
  } = He(Nn);
  return /* @__PURE__ */ f.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ f.jsxs("div", { className: "d-flex align-items-center gap-xs", children: [
          /* @__PURE__ */ f.jsx(fC, { datatype: e.datatype || "" }),
          /* @__PURE__ */ f.jsx("div", { className: "lines-2", children: e.name }),
          /* @__PURE__ */ f.jsx("div", { className: "spacer" }),
          e.can_lineage_expand && /* @__PURE__ */ f.jsx("div", { className: U.expand_lineage_icon, children: /* @__PURE__ */ f.jsx(Eb, {}) }),
          e.datatype && /* @__PURE__ */ f.jsx(OC, { label: e.datatype })
        ] }),
  ...
  } = Be(), s = $e(), l = wt(), [u, c] = ae([]), [d, g] = ae(null), [h, m] = ae(0), [b, y] = ae(!0);
  re(() => {
    t && (y(!0), jl(t, !1).then((v) => {
      g(v), c(v.columns), y(!1);
    }));
  ...
  const p = async (v) => {
    ...
    if ((n == null ? void 0 : n.table) === v.table && (n == null ? void 0 : n.name) === v.name) {
      ...
      Bo(D, !0), Vo(D, !0), l.setNodes(S), l.setEdges(D), s(bn({ table: "", name: "" })), s(Do({})), s(Mt(""));
      return;
    }
    const A = (M = l.getNode(v.table)) == null ? void 0 : M.data;
    if (!A)
      throw new Error(`table node ${v.table} isn't visible`);
    let N = l.getNodes(), k = l.getEdges();
    Bo(k, !1), Vo(k, !0);
    const R = async (S) => {
      [N, k] = await sd(
        N,
    ...
    }, { upstreamCount: H, downstreamCount: I } = A;
    H > 0 && k.filter((S) => S.source === v.table).length < H && await R(!0), I > 0 && k.filter((S) => S.target === v.table).length < I && await R(!1), s(bn({ ...v })), s(Mt("")), s(Do({})), s(_8({ confidence: "high" }));
    const [$, B] = id(
      N.filter(Ut),
      k.filter(Ut)
    );
    B.forEach((S) => S.style = va), l.setNodes($), l.setEdges(B), e();
    const w = (S) => Fl(
      $,
      B,
      S,
    ...
    try {
      Le.start(), (await Promise.all([
        w(!0),
        w(!1)
      ])).every((D) => !D) && (s(bn({ table: "", name: "" })), Hs(l, v.table), Le.isCancelled || Hl(
      ...
      console.error(
        ...
        ", error:",
        S
      ), s(bn({ table: "", name: "" })), Hs(l, v.table);
    } finally {
      Le.end();
    }
  }, C = (E = l.getNode(t)) == null ? void 0 : E.data;
  if (b || !d || !t) return /* @__PURE__ */ f.jsx(dd, {});
  const x = ["Column"];
  return C.tests.length && x.push("Tests"), /* @__PURE__ */ f.jsxs("div", { className: "p-2 h-100 d-flex flex-column gap-md overflow-y", children: [
    ...
    d.purpose && /* @__PURE__ */ f.jsx(fd, { purpose: d.purpose }),
    x.length > 1 && /* @__PURE__ */ f.jsx("div", { className: U.table_details_tabs, children: x.map((v, A) => /* @__PURE__ */ f.jsx(
      "div",
      {
        className: me(U.tab, {
          [U.selected]: h === A
    ...
    h === 1 && /* @__PURE__ */ f.jsx(jC, { tests: C.tests })
  ] });
}, RC = () => {
  var h, m, b, y;
  const {
  ...
  } = Be(), r = (b = (m = (h = t == null ? void 0 : t.details) == null ? void 0 : h[n]) == null ? void 0 : m.columns) == null ? void 0 : b.map(
    (p) => ({
      ...p,
  ...
  return /* @__PURE__ */ f.jsxs("div", { className: "p-2 h-100 d-flex flex-column gap-md overflow-y", children: [
    /* @__PURE__ */ f.jsx(Bl, { nodeType: d || "cte", table: n }),
...
] }), FC = ({ label: e }) => /* @__PURE__ */ f.jsx("div", { children: e }), IC = () => {
  var s;
  const e = wt(), {
    state: { selectedTable: t }
  } = Be(), [n, o] = ae(null), r = (s = e.getNode(t)) == null ? void 0 : s.data, [a, i] = ae(!0);
  return re(() => {
    t && nC(t).then((l) => {
      o(l), i(!1);
    });
  }, [t]), a || !n || !t ? /* @__PURE__ */ f.jsx(dd, {}) : /* @__PURE__ */ f.jsxs("div", { className: "p-2 h-100 d-flex flex-column gap-md overflow-y", children: [
    /* @__PURE__ */ f.jsxs("div", { className: U.table_details_header, children: [
    ...
    n.description ? /* @__PURE__ */ f.jsx(fd, { purpose: n.description }) : null,
    /* @__PURE__ */ f.jsxs("div", { className: me(U.card, "flex-grow column-section"), children: [
      ...
      /* @__PURE__ */ f.jsx(
        ...
        {
          title: "Tags",
          value: n.tags.map((l) => /* @__PURE__ */ f.jsx(FC, { label: l }))
        }
      ),
...
function PC({ applyDefault: e }) {
  ...
  return /* @__PURE__ */ f.jsxs("div", { className: "p-2 h-100 d-flex flex-column", children: [
    ...
    /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-sm", children: [
      /* @__PURE__ */ f.jsxs("div", { children: [
        /* @__PURE__ */ f.jsx(Ha, { check: !0, for: "default-expansion", className: "fs-6 mb-1", children: "Default Expansion" }),
        /* @__PURE__ */ f.jsx(
          so,
          {
            ...
            onChange: (i) => {
              ...
              a(w0(s)), Ji({ defaultExpansion: s }), e(s);
            }
          }
        )
      ] }),
      r && /* @__PURE__ */ f.jsxs(f.Fragment, { children: [
        ...
        /* @__PURE__ */ f.jsxs("div", { className: U.select_node_checkbox, children: [
          ...
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column", children: [
            /* @__PURE__ */ f.jsx(Ha, { check: !0, for: "select-check", className: "fs-6", children: "Select" }),
        ...
        /* @__PURE__ */ f.jsxs("div", { className: U.non_select_node_checkbox, children: [
          ...
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column", children: [
            /* @__PURE__ */ f.jsx(Ha, { check: !0, for: "non-select-check", className: "fs-6", children: "Non-Select" }),
...
const hd = dt({ openedPopover: "", setOpenedPopover: () => {
} });
function pd({
  id: e,
  trigger: t,
  ...
  const o = se(null), { openedPopover: r, setOpenedPopover: a } = He(hd);
  return re(() => {
    const i = (s) => {
      if (!o.current) return;
      const { x: l, y: u, width: c, height: d } = o.current.getBoundingClientRect();
      a(
        mc(l - 10, l + c + 10)(s.x) && mc(u - 10, u + d + 10)(s.y) ? e : ""
      );
    };
    ...
    /* @__PURE__ */ f.jsx(
      kc,
      {
        ...
        isOpen: r === e,
        toggle: () => a(""),
        children: /* @__PURE__ */ f.jsx(Ac, { children: /* @__PURE__ */ f.jsx("div", { ref: o, children: n({ close: () => a("") }) }) })
      }
    )
  ] });
}
const BC = () => {
  ...
  re(() => {
    ...
    (async () => {
      ...
      if (!h) return;
      const { level: m } = h, b = e.getNodes(), y = e.getEdges(), [p] = await ta(
        b,
        y,
        t,
        -1 / 0,
                ...
                /* @__PURE__ */ f.jsxs("div", { className: U.expand_nav_btn, children: [
                  /* @__PURE__ */ f.jsx(
                    "div",
                    {
                      className: U.icon,
                      onClick: (m) => {
                        m.stopPropagation(), t && c(Ri(l[0]));
                      },
                      children: /* @__PURE__ */ f.jsx(Tb, {})
                    }
                  ),
                  /* @__PURE__ */ f.jsx("div", { className: U.divider }),
                  /* @__PURE__ */ f.jsx(
        ...
        /* @__PURE__ */ f.jsxs(
          ke,
          {
            ...
            onClick: async (m) => {
              ...
              $o(y, p, t), Dt(y, p), e.setNodes(y), e.setEdges(p), e.fitView({ minZoom: Ds }), c(
                Oo(Zo(y, p, t))
              ), c(
                Kn(
                  await oo(
  ...
  } = Be(), o = document.getElementById("expand-container");
  return o ? cn(
    /* @__PURE__ */ f.jsx(ln, { className: U.menu_card_container, children: /* @__PURE__ */ f.jsx(Tn, { className: U.menu_card, children: /* @__PURE__ */ f.jsxs("div", { className: "d-flex gap-sm", children: [
      /* @__PURE__ */ f.jsx(BC, {}),
  ...
  return t ? cn(
    /* @__PURE__ */ f.jsxs(
      ke,
      {
        outline: !0,
        onClick: () => {
          e.setNodes([]), e.setEdges([]), n(bn({ table: "", name: "" })), n(Do({})), n(rl({})), od(), Le.cancel();
        },
  ...
  return /* @__PURE__ */ f.jsx(
    Mc,
    {
      ...
      scrollable: !0,
      className: "bs-modal",
      children: /* @__PURE__ */ f.jsxs(Tc, { children: [
        /* @__PURE__ */ f.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-sm", children: [
          r && /* @__PURE__ */ f.jsx(Bl, { nodeType: e.nodeType, table: r }),
          ...
          /* @__PURE__ */ f.jsxs("div", { className: "d-flex flex-column gap-xs", children: [
            ...
            /* @__PURE__ */ f.jsxs("div", { className: U.model_views_type, children: [
              /* @__PURE__ */ f.jsx(Ll, { viewsType: e.viewsType }),
              e.viewsType
            ] })
          ] }),
...
const Vl = () => {
  ...
  return e ? /* @__PURE__ */ f.jsx(
    Mc,
    {
      ...
      children: /* @__PURE__ */ f.jsxs(Tc, { children: [
        ...
        e.type === "op_node" && /* @__PURE__ */ f.jsx(UC, { opNodeArgs: e.args })
      ] })
    }
  ) : null;
}, qC = ({ flow: e }) => {
  ...
  return t ? cn(
    /* @__PURE__ */ f.jsx(
      ...
      {
        id: "export-popover",
        trigger: /* @__PURE__ */ f.jsxs(ke, { outline: !0, children: [
          /* @__PURE__ */ f.jsx(J1, {}),
          "Export"
        ] }),
        render: ({ close: i }) => /* @__PURE__ */ f.jsxs("div", { children: [
          /* @__PURE__ */ f.jsx(
            so,
            {
              id: "export-name",
          ...
          /* @__PURE__ */ f.jsxs(
            ke,
            {
              outline: !0,
              onClick: async () => {
                const s = e.getEdges(), l = {
                  selectedColumn: n,
                  collectColumns: o,
                  tableEdges: s.filter((c) => Ut(c)).map((c) => [c.source, c.target]),
                  columnEdges: s.filter((c) => tt(c)).map((c) => [c.source, c.target]),
                  details: {}
                };
                console.log(l);
                const u = await uC({ name: r, lineage_data: l });
                u != null && u.url && Hl(
                  `Lineage is exported at [link](${u.url})`
                ), i(), a("");
              },
              disabled: r === "",
              children: [
  ...
  const [n, o] = ae(""), {
    ...
    if (e.current) {
      ...
      Bo(C, !0), Vo(C, !1), e.current.setEdges(C);
    }
  }, b = pe(
    async (C) => {
      if (g(Mt("")), !C) return;
      ...
      if (E.getNode(x.table)) {
        g(kn(x.table));
        let k = E.getNodes(), R = E.getEdges();
        u != null && u.name || ([k, R] = $o(k, R, x.table), E.setNodes(k), E.setEdges(R)), g(
          Oo(Zo(k, R, x.table))
        ), g(
          Kn(
            await oo(
      ...
      let A = [], N = [];
      A = [to(x, 0, "")], [A, N] = await ta(
        A,
        N,
        x.table,
        -h.current,
        h.current
      ), g(kn(x.table)), g(bn({ table: "", name: "" })), g(Do({})), g(rl({})), [A, N] = $o(A, N, x.table), Dt(A, N), E.setNodes(A), E.setEdges(N), E.fitView({ minZoom: Ds, duration: 500 }), g(Oo(Zo(A, N, x.table))), g(
        Kn(
          await oo(
            A,
            N,
  ...
  const y = pe(async () => {
    const C = await aC();
    g(v0(C.showSelectEdges)), g(x0(C.showNonSelectEdges)), g(w0(C.defaultExpansion)), h.current = C.defaultExpansion;
  }, [g]);
  re(() => {
    y();
  }, [y]), re(() => {
    ...
    (async () => {
      ...
      for (const N of v) {
        N.hidden = !1;
        const k = (A = N.data) == null ? void 0 : A.type;
        k && (k === "direct" && (N.hidden = !r), k === "indirect" && (N.hidden = !a));
      }
      C.setEdges(v);
    })();
  }, [r, a]);
  ...
  return /* @__PURE__ */ f.jsx(
    "div",
    {
      ...
      "data-theme": t,
      children: /* @__PURE__ */ f.jsx(hd.Provider, { value: { openedPopover: n, setOpenedPopover: o }, children: /* @__PURE__ */ f.jsxs(Ko, { children: [
        /* @__PURE__ */ f.jsxs(
          ya,
          {
            defaultNodes: [],
        ...
        /* @__PURE__ */ f.jsxs(
          ud,
          {
            ...
            width: "30vw",
            children: [
              i === $u && /* @__PURE__ */ f.jsx(kC, {}),
              i === Vu && /* @__PURE__ */ f.jsx(HC, {}),
              i === Wu && /* @__PURE__ */ f.jsx(IC, {}),
              i === Ep && /* @__PURE__ */ f.jsx(zC, { close: () => Mt("") }),
              i === Zu && /* @__PURE__ */ f.jsx(
                PC,
                {
        ...
        /* @__PURE__ */ f.jsx(VC, {}),
        /* @__PURE__ */ f.jsx(WC, {}),
        e.current ? /* @__PURE__ */ f.jsx($C, { flow: e.current }) : null,
        /* @__PURE__ */ f.jsx(Vl, {})
      ] }) })
    }
  );
  ...
  return re(() => {
    i(Do(n)), setTimeout(async () => {
      ...
      const d = [...l], g = {}, h = (y, p) => {
        var E, v;
        const C = y ? r.filter(([A]) => A === p).map(([, A]) => A) : r.filter(([, A]) => A === p).map(([A]) => A), x = ((v = (E = u.find((A) => A.id === p)) == null ? void 0 : E.data) == null ? void 0 : v.level) || 0;
        return Ea(
          u,
          c,
          C.map(s),
      ...
      if (t) {
        const y = `${t.table}/${t.name}`, { nodes: p, edges: C } = await mC(
          u,
          c,
          y,
          async () => ({
    ...
    /* @__PURE__ */ f.jsx("div", { style: { width: "100%", height: "100%" }, children: /* @__PURE__ */ f.jsx(Ko, { children: /* @__PURE__ */ f.jsxs(
      ya,
      {
        defaultNodes: [],
        defaultEdges: [],
  ...
  return re(() => {
    ...
    setTimeout(async () => {
      ...
      if (o) {
        const p = Object.keys(o).map((x) => n[x].type in Wo ? to(i(x), 0, "") : Xu(x, 0, "", n[x])), C = t.map(
          ([x, E]) => Dl(
            o[x][1],
            o[E][1],
            x,
      ...
      const c = [...s], d = {}, g = (p, C) => {
        var v, A;
        const x = p ? t.filter(([N]) => N === C).map(([, N]) => N) : t.filter(([, N]) => N === C).map(([N]) => N), E = ((A = (v = l.find((N) => N.id === C)) == null ? void 0 : v.data) == null ? void 0 : A.level) || 0;
        return Ea(
          l,
          u,
          x.map(i),
      ...
      Dt(l, u, !0), (b = e.current) == null || b.setNodes(l), (y = e.current) == null || y.setEdges(u);
    }, 500);
  }, [n, e, t, o]), re(() => {
    const i = setTimeout(() => {
      var s;
  ...
  return /* @__PURE__ */ f.jsx(Nn.Provider, { value: g, children: /* @__PURE__ */ f.jsxs("div", { className: "lineage-component", children: [
    ...
    t === "dynamic" && o && /* @__PURE__ */ f.jsx(KC, { flow: u, theme: e }),
    t === "static" && r && /* @__PURE__ */ f.jsx(QC, { flow: u, ...r }),
    /* @__PURE__ */ f.jsx("div", { id: "lineage-sidebar" })
  ] }) });
}, Be = () => He(Nn), $e = () => {
  const { dispatch: e } = He(Nn);
  return e;
}, Zy = (e) => /* @__PURE__ */ f.jsx(oy, { ...e }), md = {
  showCoachingForm: !1
}, Fs = Ys({
  name: "teamMate",
  initialState: md,
  ...
  return /* @__PURE__ */ f.jsx(bd.Provider, { value: o, children: e });
}, ay = ({
  errors: e,
  isSubmitting: t,
  taskLabel: n,
  ...
  const { setFieldError: a, values: i, setSubmitting: s } = Ud(), l = async () => await _e.post("coach/training", {
    ...i,
    taskLabel: n
  }), { mutate: u, error: c } = aa({
    // @ts-ignore
  ...
  }, [c, a]), /* @__PURE__ */ f.jsxs(qd, { children: [
    /* @__PURE__ */ f.jsx(
      Yd,
      {
        name: "content",
        render: ({ field: d }) => /* @__PURE__ */ f.jsxs(es, { children: [
          /* @__PURE__ */ f.jsx(
            sn,
            {
              type: "textarea",
          ...
          e.content ? /* @__PURE__ */ f.jsx(Nc, { children: e.content }) : null
        ] })
      }
    ),
    /* @__PURE__ */ f.jsxs(Ke, { className: "justify-content-end", children: [
  ...
  return m != null && m.frontend_url ? /* @__PURE__ */ f.jsxs(Is, { children: [
  ...
  ] }) : /* @__PURE__ */ f.jsxs(Ke, { direction: "column", children: [
    ...
    o && /* @__PURE__ */ f.jsxs(ln, { className: "mt-4", children: [
      ...
      /* @__PURE__ */ f.jsxs(Od, { className: "d-flex justify-content-end mt-2 gap-2 border-0", children: [
        a ? /* @__PURE__ */ f.jsx(ke, { variant: "secondary", onClick: u, children: "Cancel" }) : /* @__PURE__ */ f.jsx(ke, { variant: "secondary", onClick: l, children: "Edit" }),
        /* @__PURE__ */ f.jsx(ra, { loading: h, onClick: d, color: "primary", children: "Save" })
      ] })
    ] })
  ] });
}, sy = () => {
  ...
  const { dispatch: e } = sy(), t = () => {
    e(ry.setShowCoachingForm(!0));
  };
  return /* @__PURE__ */ f.jsx(vn, { onClick: t, children: "Show Coaching Form" });
};
var Wl = /* @__PURE__ */ ((e) => (e.TERM_CLARIFICATION = "TermClarification", e.GENERAL_GUIDELINES = "GeneralGuidelines", e.BUSINESS_EXPLANATION = "BusinessExplanation", e))(Wl || {}), Eo = /* @__PURE__ */ ((e) => (e.DocGen = "DocGen", e.ChartBot = "ChartBot", e.SqlBot = "SqlExpert", e.OpportunitiesBot = "OpportunitiesBot", e))(Eo || {}), $l = /* @__PURE__ */ ((e) => (e.USER_SPECIFIC = "UserSpecific", e.ALL_USERS = "AllUsers", e))($l || {});
const ly = Ue.object({
  train_doc_uid: Ue.string(),
  userId: Ue.string(),
  display_name: Ue.string(),
  taskLabel: Ue.string(),
  category: Ue.enum(Object.values(Wl)),
  personalizationScope: Ue.enum(Object.values($l)).default(
    "UserSpecific"
    /* USER_SPECIFIC */
  ),
...
var zn = /* @__PURE__ */ ((e) => (e.EXTENSION = "VSCode Extension", e.SAAS = "SaaS", e))(zn || {}), Lr = /* @__PURE__ */ ((e) => (e.SEE_IN_ACTION = "SEE_IN_ACTION", e.REQUEST_ACCESS = "REQUEST_ACCESS", e.VIEW_DETAILS = "VIEW_DETAILS", e))(Lr || {}), wn = {}, cy = En && En.__extends || /* @__PURE__ */ function() {
  var e = function(t, n) {
...
}(), Cd = En && En.__awaiter || function(e, t, n, o) {
  function r(a) {
...
}, yd = En && En.__generator || function(e, t) {
...
wn.toFormikValidate = xd = wn.toFormikValidationSchema = wn.ValidationError = void 0;
var vd = (
  /** @class */
  function(e) {
    cy(t, e);
...
wn.ValidationError = vd;
function uy(e) {
  var t = new vd(e.message);
...
var xd = wn.toFormikValidationSchema = dy;
function fy(e) {
...
function gy(e, t) {
  var n = this;
  return function(o) {
    return Cd(n, void 0, void 0, function() {
      var r;
...
wn.toFormikValidate = gy;
const hy = ({ learning: e, afterDelete: t, toggle: n, openId: o }) => {
  const [r, a] = ae(!1), {
    errors: i,
    isValid: s,
    isSubmitting: l,
    ...
    initialValues: e,
    validationSchema: xd(ly),
    onSubmit: async (A) => {
      await _e.post(`coach/training/${e.train_doc_uid}`, A, {
        method: "PUT"
      }), a(!1), g(!1);
    }
  ...
  return /* @__PURE__ */ f.jsx(ln, { className: v ? "active" : "", children: /* @__PURE__ */ f.jsxs("form", { onSubmit: u, children: [
    /* @__PURE__ */ f.jsx(oa, { children: /* @__PURE__ */ f.jsxs(Ke, { className: "align-items-start", children: [
      /* @__PURE__ */ f.jsxs("div", { style: { flex: 1 }, children: [
        /* @__PURE__ */ f.jsx("div", { children: r ? /* @__PURE__ */ f.jsxs(es, { children: [
          /* @__PURE__ */ f.jsx(
            sn,
            {
              name: "content",
          ...
          i.content ? /* @__PURE__ */ f.jsx(Nc, { children: i.content }) : null
        ] }) : /* @__PURE__ */ f.jsx("h6", { className: v ? "" : "lines-2", children: c.content }) }),
        /* @__PURE__ */ f.jsx(Ke, { children: /* @__PURE__ */ f.jsxs("dl", { children: [
          /* @__PURE__ */ f.jsxs(Ke, { children: [
            /* @__PURE__ */ f.jsx("dt", { children: "Created on:" }),
            /* @__PURE__ */ f.jsx("dd", { children: gs(e.createdDate).format(
              "MMMM D, YYYY h:mm A"
            ) })
          ] }),
          /* @__PURE__ */ f.jsxs(Ke, { children: [
      ...
      /* @__PURE__ */ f.jsxs(Ke, { className: "align-items-top gap-0", children: [
        /* @__PURE__ */ f.jsx(es, { switch: !0, children: /* @__PURE__ */ f.jsx(
          un,
          {
          ...
          Xd,
          {
            ...
            children: /* @__PURE__ */ f.jsx(
              vn,
              {
                ...
                disabled: m,
                onClick: p,
                children: /* @__PURE__ */ f.jsx(a4, {})
              }
            )
          }
        ),
        r ? /* @__PURE__ */ f.jsxs(Ke, { className: "align-items-baseline", children: [
          /* @__PURE__ */ f.jsx(ke, { onClick: x, outline: !0, size: "sm", children: "Cancel" }),
          /* @__PURE__ */ f.jsx(
            ke,
            {
              size: "sm",
        ...
        ] }) : /* @__PURE__ */ f.jsx(vn, { title: "Edit this learning", onClick: E, children: /* @__PURE__ */ f.jsx(h4, {}) }),
        /* @__PURE__ */ f.jsx(vn, { onClick: () => n(e.train_doc_uid), children: v ? /* @__PURE__ */ f.jsx(u4, {}) : /* @__PURE__ */ f.jsx(d4, {}) })
      ] })
    ] }) }),
    /* @__PURE__ */ f.jsxs(Ld, { isOpen: v, children: [
      b && /* @__PURE__ */ f.jsx(Is, { color: "danger", children: b.message }),
      /* @__PURE__ */ f.jsxs(Ke, { className: "gap-4", children: [
        /* @__PURE__ */ f.jsxs("div", { children: [
          ...
          r ? /* @__PURE__ */ f.jsx(
            ...
            {
              style: { minWidth: 160 },
              options: Object.values(Wl).map((A) => ({
                value: A,
                label: A
              })),
              value: c.category,
  ...
  return /* @__PURE__ */ f.jsx(Ke, { direction: "column", className: "learnings", children: i ? /* @__PURE__ */ f.jsx("p", { children: "Loading learnings..." }) : r ? /* @__PURE__ */ f.jsxs(Is, { color: "danger", children: [
    ...
    c.train_doc_uid
  )) }) : /* @__PURE__ */ f.jsxs(Ke, { direction: "column", className: "align-items-center", children: [
    /* @__PURE__ */ f.jsx(yy, {}),
  ...
  },
  {
    ...
    availability: [zn.SAAS],
    key: Eo.OpportunitiesBot,
    comingSoon: !0
  }
], xy = ({ config: e, client: t, onSelect: n }) => {
  const o = async () => await n(e, Lr.REQUEST_ACCESS), { loading: r, mutate: a, data: i } = aa({
    // @ts-ignore
    queryFn: o
  });
  return /* @__PURE__ */ f.jsx(jd, { children: /* @__PURE__ */ f.jsxs(ln, { children: [
    /* @__PURE__ */ f.jsxs(Ke, { className: "justify-content-between", children: [
      /* @__PURE__ */ f.jsx(Hd, { alt: "Teammate image", src: e.avatar }),
      /* @__PURE__ */ f.jsx("div", { children: e.availability.map((s) => /* @__PURE__ */ f.jsxs(
        o5,
        {
          color: "success",
          tooltip: "",
    ...
    /* @__PURE__ */ f.jsxs(Tn, { children: [
      ...
      /* @__PURE__ */ f.jsx(Rd, { tag: "h6" }),
      /* @__PURE__ */ f.jsx(Fd, { children: e.description }),
      /* @__PURE__ */ f.jsxs(Ke, { className: "justify-content-start align-items-center", children: [
...
}, Ky = ({ onSelect: e, client: t }) => /* @__PURE__ */ f.jsx("div", { className: "teammates", children: /* @__PURE__ */ f.jsx(Id, { children: vy.map((n) => /* @__PURE__ */ f.jsx(
  xy,
  {
    config: n,
    client: t,
