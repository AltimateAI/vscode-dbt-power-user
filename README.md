...
If you need help with setting up the extension, please check the [documentation](https://help.altimate.ai/dbt-power-user/setup/installation/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs).
...
Auto-fill model names, macros, sources and docs. Click on model names, macros, sources to go to definitions. [(docs)](https://help.altimate.ai/dbt-power-user/develop/autocomplete/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs)

![autocomplete](media/images/autocomplete.gif)

### <a id="querypreview">Preview query results and analyze</a>

Generate dbt™ model / query results. Export as CSV or analyze results by creating graphs, filters, groups. [(docs)](https://help.altimate.ai/dbt-power-user/test/queryResults/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs)

![previewquery](media/images/previewquery.gif)

### <a id="lineage">Column lineage</a>

View model lineage as well as column lineage with components like models, seeds, sources, exposures and info like model types, tests, documentation, linkage types. [(docs)](https://help.altimate.ai/dbt-power-user/test/lineage/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs)

![lineage](media/images/lineage.gif)

### <a id="genmodel"> Generate dbt™ Models from source or SQL</a>

Generate dbt™ models from sources defined in YAML. You can also convert existing SQL to a dbt™ model where references get populated automatically. [(docs)](https://help.altimate.ai/dbt-power-user/develop/clicktorun/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs)

![genmodel](media/images/genmodel.gif)

### <a id="gendoc"> Generate documentation</a>

Generate model and column descriptions automatically or write descriptions manually in the UI editor. Your descriptions are automatically formatted and saved in YAML files. [(docs)](https://help.altimate.ai/dbt-power-user/document/generatedoc/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs)

![gendoc](media/images/gendoc.gif)

### <a id="defertoprod">Defer to prod</a>

Defer building your upstream models when you make changes in development by referencing production models. Here's [(more info)](https://docs.getdbt.com/blog/defer-to-prod) about the concept. This functionality can be used in dbt™ core with the extension. [(docs)](https://help.altimate.ai/dbt-power-user/test/defertoprod/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs)

### <a id="clicktorun"> Click to run parent/child models and tests</a>

Just click to do common button operations like executing tests, building or running parent / child models. [(docs)](https://help.altimate.ai/dbt-power-user/develop/clicktorun/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs)

![autocomplete](media/images/runmodeltests.gif)

### <a id="queryexplanation"> Compiled query preview and explanation</a>

Get live preview of compiled query as your write code. Also, generate explanations for dbt™ code written previously (by somebody else). [(docs)](https://help.altimate.ai/dbt-power-user/develop/explanation/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs)

![explanation](media/images/explanation.gif)

### <a id="healthcheck"> Project health check</a>

Identify issues in your dbt™ project like columns not present, models not materialized. [(docs)](https://help.altimate.ai/dbt-power-user/govern/governance/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs)
...
Estimate data that will be processed by dbt™ model in BigQuery [(docs)](https://help.altimate.ai/dbt-power-user/test/bigquerycost/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs)
...
Please check [documentation](https://help.altimate.ai/dbt-power-user/arch/faq/?utm_source=dbt-power-user&utm_medium=marketplace&utm_campaign=readme-docs) for additional info.
For any issues or bugs, please [contact us](https://www.altimate.ai/support?utm_source=dbt-power-user&utm_medium=marketplace) via chat or Slack.
